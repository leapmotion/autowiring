...
TEST_F(AutoFilterAltitudeTest, VerifyFirstLastCalls) {
...
TEST_F(AutoFilterAltitudeTest, SuccessorAliasRules) {
  AutoRequired<AutoPacketFactory> factory;
...
TEST_F(AutoFilterAltitudeTest, SuccessorHoldViolationCheck) {
  AutoRequired<AutoPacketFactory> factory;
  auto packet1 = factory->NewPacket();
  auto packet2 = packet1->Successor();
...
TEST_F(AutoFilterAltitudeTest, PacketReverseSuccessor) {
  AutoRequired<AutoPacketFactory> factory;
...
TEST_F(AutoFilterAltitudeTest, ManySuccessors) {
  AutoRequired<AutoPacketFactory> factory;
  {
...
TEST_F(AutoFilterAltitudeTest, SimplePrev) {
  AutoRequired<AutoPacketFactory> factory;
...
TEST_F(AutoFilterAltitudeTest, UnsatisfiedPrev) {
  AutoRequired<AutoPacketFactory> factory;
  AutoRequired<PrevFilter> filter;
...
TEST_F(AutoFilterAltitudeTest, OnlyPrev) {
  AutoRequired<AutoPacketFactory> factory;
...
TEST_F(AutoFilterAltitudeTest, FirstPrev) {
  AutoRequired<AutoPacketFactory> factory;
  AutoRequired<OnlyPrev> filter;
...
TEST_F(AutoFilterAltitudeTest, DeferredPrev) {
  AutoRequired<AutoPacketFactory> factory;
...
TEST_F(AutoFilterAltitudeTest, DoublePrev) {
  AutoRequired<AutoPacketFactory> factory;
...
TEST_F(AutoFilterAltitudeTest, PathologicalAsync) {
...
TEST_F(AutoFilterAltitudeTest, UnsatisfiableImmediate) {
  AutoCurrentContext ctxt;
  ctxt->Initiate();
  AutoRequired<AutoPacketFactory> factory;
