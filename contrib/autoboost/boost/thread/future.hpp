  ...
  public:
    ...
    namespace detail
    {
            ...
            detail::shared_state_base
        {
            ...
            typedef typename conditional<autoboost::thread_detail::is_convertible<T&,BOOST_THREAD_RV_REF(T) >::value, BOOST_THREAD_RV_REF(T),T const&>::type rvalue_source_type;
            typedef typename conditional<autoboost::thread_detail::is_convertible<T&,BOOST_THREAD_RV_REF(T) >::value, BOOST_THREAD_RV_REF(T),T>::type move_dest_type;
#endif
        ...
        class future_waiter
        {
            ...
            struct all_futures_lock
            {
                    ...
                    count(futures.size()),locks(new autoboost::unique_lock<autoboost::mutex>[count])
                {
                    ...
                    {
                        locks[i]=BOOST_THREAD_MAKE_RV_REF(autoboost::unique_lock<autoboost::mutex>(futures[i].future_->mutex));
                    }
                }
    ...
    namespace detail
    {
        ...
        BOOST_THREAD_FUTURE<Rp>
        make_future_async_continuation_shared_state(autoboost::unique_lock<autoboost::mutex> &lock, BOOST_THREAD_RV_REF(F) f, BOOST_THREAD_FWD_REF(Fp) c);

        template <class F, class Rp, class Fp>
        BOOST_THREAD_FUTURE<Rp>
        make_future_deferred_continuation_shared_state(autoboost::unique_lock<autoboost::mutex> &lock, BOOST_THREAD_RV_REF(F) f, BOOST_THREAD_FWD_REF(Fp) c);
#endif
        ...
        make_future_unwrap_shared_state(autoboost::unique_lock<autoboost::mutex> &lock, BOOST_THREAD_RV_REF(F) f);
#endif
    }
    ...
    private:
        ...
        detail::make_future_async_continuation_shared_state(autoboost::unique_lock<autoboost::mutex> &lock, BOOST_THREAD_RV_REF(F) f, BOOST_THREAD_FWD_REF(Fp) c);

        template <class F, class Rp, class Fp>
        friend BOOST_THREAD_FUTURE<Rp>
        detail::make_future_deferred_continuation_shared_state(autoboost::unique_lock<autoboost::mutex> &lock, BOOST_THREAD_RV_REF(F) f, BOOST_THREAD_FWD_REF(Fp) c);
#endif
#if defined BOOST_THREAD_PROVIDES_FUTURE_UNWRAP
        template<typename F, typename Rp>
        ...
        template <class F, class Rp>
        friend BOOST_THREAD_FUTURE<Rp>
        detail::make_future_unwrap_shared_state(autoboost::unique_lock<autoboost::mutex> &lock, BOOST_THREAD_RV_REF(F) f);
#endif
    ...
    public:
        ...
        base_type(autoboost::move(static_cast<base_type&>(BOOST_THREAD_RV(other))))
        {
        }
        ...
        {
            this->base_type::operator=(autoboost::move(static_cast<base_type&>(BOOST_THREAD_RV(other))));
            return *this;
        }
...
#if defined BOOST_THREAD_PROVIDES_FUTURE_CONTINUATION
        template<typename F>
        inline BOOST_THREAD_FUTURE<typename autoboost::result_of<F(BOOST_THREAD_FUTURE)>::type>
        ...
        template <typename R2>
        inline typename autoboost::disable_if< is_void<R2>, BOOST_THREAD_FUTURE<R> >::type
    ...
    public:
        ...
        {
            base_type::operator=(autoboost::move(static_cast<base_type&>(BOOST_THREAD_RV(other))));
            return *this;
        }
...
#if defined BOOST_THREAD_PROVIDES_FUTURE_CONTINUATION
        template<typename F>
        inline BOOST_THREAD_FUTURE<typename autoboost::result_of<F(shared_future)>::type>
...
#endif
        void set_value_autoboostat_thread_exit(BOOST_THREAD_RV_REF(R) r)
        {
          if (future_.get()==0)
          {
              autoboost::throw_exception(promise_moved());
...
namespace autoboost
{
    ...
    public:
        ...
        packaged_task(autoboost::allocator_arg_t, Allocator a, BOOST_THREAD_FWD_REF(F) f)
        {
          typedef typename decay<F>::type FR;
        ...
        template <class F, class Allocator>
        packaged_task(autoboost::allocator_arg_t, Allocator a, BOOST_THREAD_RV_REF(F) f)
        {
#if defined BOOST_THREAD_PROVIDES_SIGNATURE_PACKAGED_TASK
  #if defined(BOOST_THREAD_PROVIDES_VARIADIC_THREAD)
          typedef detail::task_shared_state<F,R(ArgTypes...)> task_shared_state_type;
...
namespace detail
{
  ...
  async(launch policy, R(*f)(BOOST_THREAD_FWD_REF(ArgTypes)...), BOOST_THREAD_FWD_REF(ArgTypes)... args) {
    ...
    if (underlying_cast<int>(policy) & int(launch::async)) {
      return BOOST_THREAD_MAKE_RV_REF(autoboost::detail::make_future_async_shared_state<Rp>(
              BF(
                  f
      ...
      return BOOST_THREAD_MAKE_RV_REF(autoboost::detail::make_future_deferred_shared_state<Rp>(
              BF(
                  f
                  , thread_detail::decay_copy(autoboost::forward<ArgTypes>(args))...
              )
  ...
  template <class F, class ...ArgTypes>
  BOOST_THREAD_FUTURE<typename autoboost::result_of<typename decay<F>::type(
  ...
  template <class F>
  BOOST_THREAD_FUTURE<typename autoboost::result_of<typename decay<F>::type()>::type>
...
//#if ! defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
  ...
  async(Executor& ex, R(*f)(BOOST_THREAD_FWD_REF(ArgTypes)...), BOOST_THREAD_FWD_REF(ArgTypes)... args) {
    ...
    return BOOST_THREAD_MAKE_RV_REF(autoboost::detail::make_future_executor_shared_state<Rp>(ex,
        BF(
            f
            , thread_detail::decay_copy(autoboost::forward<ArgTypes>(args))...
        )
  ...
  async(R(*f)(BOOST_THREAD_FWD_REF(ArgTypes)...), BOOST_THREAD_FWD_REF(ArgTypes)... args) {
    return BOOST_THREAD_MAKE_RV_REF(async(launch(launch::any), f, autoboost::forward<ArgTypes>(args)...));
  }
  #else
  template <class R>
  BOOST_THREAD_FUTURE<R>
  ...
  async(BOOST_THREAD_FWD_REF(F) f, BOOST_THREAD_FWD_REF(ArgTypes)... args) {
      return BOOST_THREAD_MAKE_RV_REF(async(launch(launch::any), autoboost::forward<F>(f), autoboost::forward<ArgTypes>(args)...));
  }
#else
  template <class F>
  BOOST_THREAD_FUTURE<typename autoboost::result_of<F()>::type>
  async(BOOST_THREAD_FWD_REF(F) f) {
      return BOOST_THREAD_MAKE_RV_REF(async(launch(launch::any), autoboost::forward<F>(f)));
  }
#endif
...
namespace detail
{
  ...
  BOOST_THREAD_FUTURE<Rp>
  make_future_async_continuation_shared_state(
      autoboost::unique_lock<autoboost::mutex> &lock, BOOST_THREAD_RV_REF(F) f,
  ...
  template <typename R>
  template <typename F>
  inline BOOST_THREAD_FUTURE<typename autoboost::result_of<F(BOOST_THREAD_FUTURE<R>)>::type>
  BOOST_THREAD_FUTURE<R>::then(launch policy, BOOST_THREAD_FWD_REF(F) func) {
    typedef typename autoboost::result_of<F(BOOST_THREAD_FUTURE<R>)>::type future_type;
    BOOST_THREAD_ASSERT_PRECONDITION(this->future_!=0, future_uninitialized());

    autoboost::unique_lock<autoboost::mutex> lock(this->future_->mutex);
    if (underlying_cast<int>(policy) & int(launch::async)) {
      return BOOST_THREAD_MAKE_RV_REF((autoboost::detail::make_future_async_continuation_shared_state<BOOST_THREAD_FUTURE<R>, future_type, F>(
                  lock, autoboost::move(*this), autoboost::forward<F>(func)
              )));
    } else if (underlying_cast<int>(policy) & int(launch::deferred)) {
      return BOOST_THREAD_MAKE_RV_REF((autoboost::detail::make_future_deferred_continuation_shared_state<BOOST_THREAD_FUTURE<R>, future_type, F>(
                  lock, autoboost::move(*this), autoboost::forward<F>(func)
              )));
    } else {
      return BOOST_THREAD_MAKE_RV_REF((autoboost::detail::make_future_async_continuation_shared_state<BOOST_THREAD_FUTURE<R>, future_type, F>(
  ...
  BOOST_THREAD_FUTURE<R>::then(Ex& ex, BOOST_THREAD_FWD_REF(F) func) {
    ...
    autoboost::unique_lock<autoboost::mutex> lock(this->future_->mutex);
    return BOOST_THREAD_MAKE_RV_REF((autoboost::detail::make_future_executor_continuation_shared_state<Ex, BOOST_THREAD_FUTURE<R>, future_type, F>(ex,
                  lock, autoboost::move(*this), autoboost::forward<F>(func)
              )));
  }
#endif
  ...
  BOOST_THREAD_FUTURE<R>::then(BOOST_THREAD_FWD_REF(F) func)  {
    ...
    if (underlying_cast<int>(this->launch_policy(lock)) & int(launch::async)) {
      return autoboost::detail::make_future_async_continuation_shared_state<BOOST_THREAD_FUTURE<R>, future_type, F>(
          lock, autoboost::move(*this), autoboost::forward<F>(func)
      );
    } else if (underlying_cast<int>(this->launch_policy(lock)) & int(launch::deferred)) {
      this->future_->wait_internal(lock);
      return autoboost::detail::make_future_deferred_continuation_shared_state<BOOST_THREAD_FUTURE<R>, future_type, F>(
          lock, autoboost::move(*this), autoboost::forward<F>(func)
      );
    } else {
      return autoboost::detail::make_future_async_continuation_shared_state<BOOST_THREAD_FUTURE<R>, future_type, F>(
  ...
  template <typename R>
  template <typename F>
  inline BOOST_THREAD_FUTURE<typename autoboost::result_of<F(shared_future<R>)>::type>
  shared_future<R>::then(launch policy, BOOST_THREAD_FWD_REF(F) func)  const
  {
    ...
    if (underlying_cast<int>(policy) & int(launch::async)) {
      return BOOST_THREAD_MAKE_RV_REF((autoboost::detail::make_shared_future_async_continuation_shared_state<shared_future<R>, future_type, F>(
                  lock, *this, autoboost::forward<F>(func)
              )));
    } else if (underlying_cast<int>(policy) & int(launch::deferred)) {
      return BOOST_THREAD_MAKE_RV_REF((autoboost::detail::make_shared_future_deferred_continuation_shared_state<shared_future<R>, future_type, F>(
                  lock, *this, autoboost::forward<F>(func)
              )));
    } else {
      return BOOST_THREAD_MAKE_RV_REF((autoboost::detail::make_shared_future_async_continuation_shared_state<shared_future<R>, future_type, F>(
  ...
  shared_future<R>::then(Ex& ex, BOOST_THREAD_FWD_REF(F) func)  const
  {
    ...
    autoboost::unique_lock<autoboost::mutex> lock(this->future_->mutex);
    return BOOST_THREAD_MAKE_RV_REF((autoboost::detail::make_shared_future_executor_continuation_shared_state<Ex, shared_future<R>, future_type, F>(ex,
                  lock, *this, autoboost::forward<F>(func)
              )));
  }
#endif
...
namespace detail
{
  ...
  BOOST_THREAD_FUTURE<BOOST_THREAD_FUTURE<R2> >::unwrap()
  {
    BOOST_THREAD_ASSERT_PRECONDITION(this->future_!=0, future_uninitialized());
    autoboost::unique_lock<autoboost::mutex> lock(this->future_->mutex);
    return autoboost::detail::make_future_unwrap_shared_state<BOOST_THREAD_FUTURE<BOOST_THREAD_FUTURE<R2> >, R2>(lock, autoboost::move(*this));
  }
#endif
