...
namespace autoboost
{
  namespace detail
  {
    ...
    public:
      ...
      BOOST_SYMBOL_VISIBLE
      invoker(BOOST_THREAD_RV_REF(invoker) f) : f_(autoboost::move(BOOST_THREAD_RV(f).f_))
      {}
      ...
      {
        f_ = autoboost::move(BOOST_THREAD_RV(f).f_);
      }
    ...
    public:
      ...
      BOOST_SYMBOL_VISIBLE
      invoker_ret(BOOST_THREAD_RV_REF(invoker_ret) f) : f_(autoboost::move(BOOST_THREAD_RV(f).f_))
      {}
...
#define BOOST_THREAD_FWD_PARAM(z, n, unused) , autoboost::forward<Arg##n>(arg##n)
#define BOOST_THREAD_FWD_PARAM_A(z, n, unused) , autoboost::forward<A##n>(arg##n)
#define BOOST_THREAD_DCL(z, n, unused) Arg##n v##n;
#define BOOST_THREAD_MOVE_PARAM(z, n, unused) , v##n(autoboost::move(arg##n))
#define BOOST_THREAD_FORWARD_PARAM_A(z, n, unused) , v##n(autoboost::forward<A##n>(arg##n))
#define BOOST_THREAD_MOVE_RHS_PARAM(z, n, unused) , v##n(autoboost::move(x.v##n))
#define BOOST_THREAD_MOVE_DCL(z, n, unused) , autoboost::move(v##n)
#define BOOST_THREAD_MOVE_DCL_T(z, n, unused) BOOST_PP_COMMA_IF(n) autoboost::move(v##n)
...
#define BOOST_THREAD_ASYNC_FUNCT(z, n, unused) \
    ...
    public:
      ...
      : fp_(autoboost::move(BOOST_THREAD_RV(f).fp))
      , v0_(autoboost::move(BOOST_THREAD_RV(f).v0_))
      , v1_(autoboost::move(BOOST_THREAD_RV(f).v1_))
      , v2_(autoboost::move(BOOST_THREAD_RV(f).v2_))
      , v3_(autoboost::move(BOOST_THREAD_RV(f).v3_))
      , v4_(autoboost::move(BOOST_THREAD_RV(f).v4_))
      , v5_(autoboost::move(BOOST_THREAD_RV(f).v5_))
      , v6_(autoboost::move(BOOST_THREAD_RV(f).v6_))
      , v7_(autoboost::move(BOOST_THREAD_RV(f).v7_))
      , v8_(autoboost::move(BOOST_THREAD_RV(f).v8_))
      {}
