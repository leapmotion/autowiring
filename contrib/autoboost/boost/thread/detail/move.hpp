...
#define BOOST_THREAD_RV_REF(TYPE) autoboost::detail::thread_move_t< TYPE >
#define BOOST_THREAD_RV_REF_BEG autoboost::detail::thread_move_t<
...
{
  template <typename T>
  BOOST_THREAD_RV_REF(typename ::autoboost::remove_cv<typename ::autoboost::remove_reference<T>::type>::type)
  make_rv_ref(T v)  BOOST_NOEXCEPT
  {
    return (BOOST_THREAD_RV_REF(typename ::autoboost::remove_cv<typename ::autoboost::remove_reference<T>::type>::type))(v);
  }
//  template <typename T>
//  BOOST_THREAD_RV_REF(typename ::autoboost::remove_cv<typename ::autoboost::remove_reference<T>::type>::type)
//  make_rv_ref(T &v)  BOOST_NOEXCEPT
...
//  }
//  template <typename T>
//  const BOOST_THREAD_RV_REF(typename ::autoboost::remove_cv<typename ::autoboost::remove_reference<T>::type>::type)
//  make_rv_ref(T const&v)  BOOST_NOEXCEPT
//  {
//    return (const BOOST_THREAD_RV_REF(typename ::autoboost::remove_cv<typename ::autoboost::remove_reference<T>::type>::type))(v);
//  }
}
}

#define BOOST_THREAD_MAKE_RV_REF(RVALUE) RVALUE.move()
//#define BOOST_THREAD_MAKE_RV_REF(RVALUE) autoboost::detail::make_rv_ref(RVALUE)
#endif
...
#define BOOST_THREAD_MOVABLE(TYPE) \
    ::autoboost::rv<TYPE>& move()  BOOST_NOEXCEPT \
    { \
      return *static_cast< ::autoboost::rv<TYPE>* >(this); \
    } \
    const ::autoboost::rv<TYPE>& move() const BOOST_NOEXCEPT \
    { \
...
#define BOOST_THREAD_MOVABLE(TYPE) \
    operator ::autoboost::detail::thread_move_t<TYPE>() BOOST_NOEXCEPT \
    { \
        return move(); \
    } \
    ::autoboost::detail::thread_move_t<TYPE> move() BOOST_NOEXCEPT \
    { \
