...
//            {}
    ...
    //public:
        ...
        static inline detail::thread_data_ptr make_thread_info(F f
            , typename disable_if_c<
                //autoboost::thread_detail::is_convertible<F&,BOOST_THREAD_RV_REF(F)>::value ||
    ...
    public:
        ...
        thread(attributes const& attrs, F f
            ...
            //, typename disable_if<autoboost::thread_detail::is_convertible<F&,BOOST_THREAD_RV_REF(F) >, dummy* >::type=0
        ):
            thread_info(make_thread_info(f))
        {
            start_thread(attrs);
