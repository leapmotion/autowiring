...
namespace autoboost
{
  ...
  {
    template <>
    struct BOOST_SYMBOL_VISIBLE is_error_code_enum< ::autoboost::future_errc> : public true_type {};

    #ifdef BOOST_NO_CXX11_SCOPED_ENUMS
    template <>
    struct BOOST_SYMBOL_VISIBLE is_error_code_enum< ::autoboost::future_errc::enum_type> : public true_type { };
    #endif
  } // system
