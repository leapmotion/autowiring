...
#if !defined(BOOST_NO_LONG_LONG)
    BOOST_HASH_SPECIALIZE(autoboost::long_long_type)
    BOOST_HASH_SPECIALIZE(autoboost::ulong_long_type)
#endif

#if defined(BOOST_HAS_INT128)
    BOOST_HASH_SPECIALIZE(autoboost::int128_type)
    BOOST_HASH_SPECIALIZE(autoboost::uint128_type)
#endif
