...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::autoboost::ulong_long_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::autoboost::long_long_type,true)
...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,autoboost::int128_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,autoboost::uint128_type,true)
#endif
