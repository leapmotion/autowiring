...
#  define BOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<autoboost::is_void<From>, autoboost::is_function<To>, autoboost::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(autoboost::declval<From1>()), one()) test(int);
...
#pragma option push -w-8074
    ...
    {
        static ::autoboost::type_traits::no_type BOOST_TT_DECL _m_check(...);
        static ::autoboost::type_traits::yes_type BOOST_TT_DECL _m_check(T);
    };
...
template <typename T> struct checker
{
    static autoboost::type_traits::no_type _m_check(any_conversion ...);
    static autoboost::type_traits::yes_type _m_check(T, int);
};
...
struct is_convertible_basic_impl
{
    ...
    static bool const value =
        sizeof( autoboost::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::autoboost::type_traits::yes_type);
#else
    static bool const value =
        sizeof( autoboost::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::autoboost::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::autoboost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion ...);
    static ::autoboost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::autoboost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::autoboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::autoboost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::autoboost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::autoboost::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::autoboost::type_traits::yes_type)
        };
#endif
};
...
{
    static ::autoboost::type_traits::no_type BOOST_TT_DECL _m_check(...);
    static ::autoboost::type_traits::yes_type BOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
...
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::autoboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::autoboost::is_function<typename ::autoboost::remove_reference<From>::type>::value
  >
{};
...
struct is_convertible_impl_dispatch_base
{
   ...
   typedef is_convertible_impl_select< 
      ...
      ::autoboost::is_abstract<To>::value
#else
      false
#endif
   > selector;
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(is_convertible,From,To,(::autoboost::detail::is_convertible_impl_dispatch<From,To>::value))
