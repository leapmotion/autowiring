...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_abstract,T,::autoboost::detail::is_abstract_imp<T>::value)
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_abstract,T,::autoboost::detail::is_polymorphic_imp<T>::value)
#endif
