...
struct false_or_cpp11_noexcept_move_constructible <
        T,
        typename ::autoboost::enable_if_c<sizeof(T) && BOOST_NOEXCEPT_EXPR(T(::autoboost::declval<T>()))>::type
    > : public ::autoboost::integral_constant<bool, BOOST_NOEXCEPT_EXPR(T(::autoboost::declval<T>()))>
{};

template <class T>
struct is_nothrow_move_constructible_imp{
   BOOST_STATIC_CONSTANT(bool, value = ::autoboost::detail::false_or_cpp11_noexcept_move_constructible<T>::value);
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_nothrow_move_constructible,T,::autoboost::detail::is_nothrow_move_constructible_imp<T>::value)
