...
{
   BOOST_STATIC_CONSTANT(bool, value = (::autoboost::detail::is_unsigned_values<T>::minus_one > ::autoboost::detail::is_unsigned_values<T>::zero));
};
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_unsigned,T,::autoboost::detail::is_unsigned_imp<T>::value)
#endif
