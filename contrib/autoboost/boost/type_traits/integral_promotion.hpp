...
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(autoboost::ulong_long_type)
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(autoboost::long_long_type )
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTE_FROM_INDEX(5, autoboost::long_long_type )
BOOST_TT_AUX_PROMOTE_FROM_INDEX(6, autoboost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(5, autoboost::long_long_type )
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(6, autoboost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
