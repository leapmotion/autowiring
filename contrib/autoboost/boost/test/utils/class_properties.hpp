...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return autoboost::addressof( base_prop::value ); }
};
...
#define BOOST_READONLY_PROPERTY( property_type, friends ) autoboost::unit_test::readwrite_property<property_type >
...
: public autoboost::unit_test::readonly_property<property_type > {                      \
    typedef autoboost::unit_test::readonly_property<property_type > base_prop;          \
...
public:
    ...
    arrow_res_t     operator->()            { return autoboost::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return autoboost::addressof( base_prop::value ); }
