...
template<class CharT>
inline bool
operator <( autoboost::unit_test::basic_cstring<CharT> const& x,
            autoboost::unit_test::basic_cstring<CharT> const& y )
{
    typedef typename autoboost::unit_test::basic_cstring<CharT>::traits_type traits_type;
    return x.size() != y.size() 
            ? x.size() < y.size() 
