...
#include <boost/test/utils/basic_cstring/io.hpp> // operator<<(autoboost::runtime::cstring)
...
#define BOOST_RT_PARAM_PUTENV ::autoboost::BOOST_RT_PARAM_NAMESPACE::putenv_impl
