...
#define BOOST_TEST_LOG_ENTRY( ll )                                                  \
    (::autoboost::unit_test::unit_test_log                                              \
        << ::autoboost::unit_test::log::begin( BOOST_TEST_L(__FILE__), __LINE__ ))(ll)  \
/**/
...
#define BOOST_TEST_MESSAGE( M )                                 \
    BOOST_TEST_LOG_ENTRY( ::autoboost::unit_test::log_messages )    \
    << (::autoboost::unit_test::lazy_ostream::instance() << M)      \
/**/

//____________________________________________________________________________//

#define BOOST_TEST_PASSPOINT()                                  \
    ::autoboost::unit_test::unit_test_log.set_checkpoint(           \
...
#define BOOST_TEST_CHECKPOINT( M )                              \
    ::autoboost::unit_test::unit_test_log.set_checkpoint(           \
        BOOST_TEST_L(__FILE__),                                 \
        static_cast<std::size_t>(__LINE__),                     \
        (::autoboost::wrap_stringstream().ref() << M).str() )       \
/**/
