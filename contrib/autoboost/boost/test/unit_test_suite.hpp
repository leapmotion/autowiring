...
autoboost::unit_test::make_test_case( autoboost::unit_test::callback0<>(test_function), BOOST_TEST_STRINGIZE( test_function ) )
#define BOOST_CLASS_TEST_CASE( test_function, tc_instance ) \
autoboost::unit_test::make_test_case((test_function), BOOST_TEST_STRINGIZE( test_function ), tc_instance )
...
( new autoboost::unit_test::test_suite( testsuite_name ) )
...
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    autoboost::unit_test::make_test_case(                                   \
        &BOOST_AUTO_TC_INVOKER( test_name ), #test_name ),              \
    autoboost::unit_test::ut_detail::auto_tc_exp_fail<                      \
...
struct BOOST_AUTO_TC_INVOKER( test_name ) {                             \
    ...
    static void run( autoboost::type<TestType>* = 0 )                       \
    {                                                                   \
...
#define BOOST_TEST_CASE_TEMPLATE( name, typelist )                          \
    autoboost::unit_test::ut_detail::template_test_case_gen<name,typelist >(    \
...
template<typename type_name>                                    \
void BOOST_JOIN( name, _impl )( autoboost::type<type_name>* );      \
                                                                \
struct name {                                                   \
    template<typename TestType>                                 \
    static void run( autoboost::type<TestType>* frwrd = 0 )         \
    {                                                           \
...
static autoboost::unit_test::ut_detail::global_fixture_impl<F> BOOST_JOIN( gf_, F ) ; \
/**/
...
namespace autoboost { namespace unit_test { namespace ut_detail {
...
typedef ::autoboost::unit_test::ut_detail::nil_t BOOST_AUTO_TEST_CASE_FIXTURE;
...
static autoboost::unit_test::ut_detail::auto_test_unit_registrar BOOST_JOIN( BOOST_JOIN( test_name, _registrar ), __LINE__ )
...
bool init_unit_test()                   {
#else
::autoboost::unit_test::test_suite*
init_unit_test_suite( int, char* [] )   {
#endif

#ifdef BOOST_TEST_MODULE
    using namespace ::autoboost::unit_test;
