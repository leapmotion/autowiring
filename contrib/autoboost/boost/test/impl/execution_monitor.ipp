...
extract( autoboost::exception const* ex )
{
    if( !ex )
        return 0;

    typename ErrorInfo::value_type const * val = autoboost::get_error_info<ErrorInfo>( *ex );
...
static void
report_error( execution_exception::error_code ec, autoboost::exception const* be, char const* format, va_list* args )
{
...
static void
report_error( execution_exception::error_code ec, autoboost::exception const* be, char const* format, ... )
{
    va_list args;
    va_start( args, format );
...
// ************************************************************************** //
// **************    autoboost::detail::system_signal_exception    ************** //
// ************************************************************************** //
...
// ************************************************************************** //
// **************         autoboost::detail::signal_action         ************** //
// ************************************************************************** //
...
// ************************************************************************** //
// **************        autoboost::detail::signal_handler         ************** //
// ************************************************************************** //
...
execution_monitor::execute( unit_test::callback0<int> const& F )
{
    ...
    //  std:: exceptions
      ...
      { detail::report_error( execution_exception::cpp_exception_error, 
                              current_exception_cast<autoboost::exception const>(),
    ...
    catch( autoboost::exception const& ex )
    { detail::report_error( execution_exception::cpp_exception_error, 
                            &ex,
                            "unknown autoboost::exception" ); }
