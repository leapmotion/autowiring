...
#define BOOST_MOVE_CATCH_CONST(U)  \
   typename ::autoboost::move_detail::if_< ::autoboost::move_detail::is_class_or_union<U>, BOOST_CATCH_CONST_RLVALUE(U), const U &>::type
#define BOOST_MOVE_CATCH_RVALUE(U)\
   typename ::autoboost::move_detail::if_< ::autoboost::move_detail::is_class_or_union<U>, BOOST_RV_REF(U), ::autoboost::move_detail::nat>::type
...
\
   ...
   typename ::autoboost::move_detail::enable_if_c\
                     <  ::autoboost::move_detail::is_class_or_union<TYPE>::value &&\
                        ::autoboost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value &&\
                       !::autoboost::has_move_emulation_enabled<BOOST_MOVE_TEMPL_PARAM>::value\
                     , RETURN_VALUE >::type\
...
\
   template<class BOOST_MOVE_TEMPL_PARAM>\
   typename ::autoboost::move_detail::enable_if_c\
                     < (!::autoboost::move_detail::is_class_or_union<BOOST_MOVE_TEMPL_PARAM>::value || \
                        !::autoboost::move_detail::is_rv<BOOST_MOVE_TEMPL_PARAM>::value) && \
                        !::autoboost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value \
                     , RETURN_VALUE >::type\
   PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u)\
   {\
...
\
   ...
   typename ::autoboost::move_detail::enable_if_c<\
                       !::autoboost::move_detail::is_rv<BOOST_MOVE_TEMPL_PARAM>::value && \
                       !::autoboost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value && \
                       !::autoboost::move_detail::is_convertible<BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO>::value \
                     , RETURN_VALUE >::type\
   PUB_FUNCTION(ARG1 arg1, const BOOST_MOVE_TEMPL_PARAM &u)\
   {\
      TYPE t(u);\
