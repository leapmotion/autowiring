...
#include <boost/static_assert.hpp>
   ...
   inline typename ::autoboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && ::autoboost::move_detail::is_rv<T>::value, T &>::type
         forward(const typename ::autoboost::move_detail::identity<T>::type &x) BOOST_NOEXCEPT
   {
   ...
   inline typename ::autoboost::move_detail::enable_if_c
      ...
      , T &>::type
         move_if_not_lvalue_reference(const typename ::autoboost::move_detail::identity<T>::type &x) BOOST_NOEXCEPT
   {
      return const_cast<T&>(x);
   }
   ...
   inline typename ::autoboost::move_detail::enable_if_c
      ...
      >::type
         move_if_not_lvalue_reference(typename ::autoboost::move_detail::remove_reference<T>::type &x) BOOST_NOEXCEPT
   {
      return x;
   }
         ...
         move_if_not_lvalue_reference(typename ::autoboost::move_detail::remove_reference<T>::type &x) BOOST_NOEXCEPT
   {
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         template <class T>
         inline typename ::autoboost::move_detail::remove_reference<T>::type && move(T&& t) BOOST_NOEXCEPT
         {  return t;   }
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         template <class T>
         inline T&& forward(typename ::autoboost::move_detail::identity<T>::type&& t) BOOST_NOEXCEPT
         {  return t;   }

      #else //Old move

         template <class T>
         inline T&& forward(typename ::autoboost::move_detail::remove_reference<T>::type& t) BOOST_NOEXCEPT
         ...
         inline T&& forward(typename ::autoboost::move_detail::remove_reference<T>::type&& t) BOOST_NOEXCEPT
         {
            ...
            BOOST_STATIC_ASSERT(!autoboost::move_detail::is_lvalue_reference<T>::value);
            return static_cast<T&&>(t);
         }
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         template <class T>
         inline T&& move_if_not_lvalue_reference(typename ::autoboost::move_detail::identity<T>::type&& t) BOOST_NOEXCEPT
         {  return t;   }

      #else //Old move

         template <class T>
         inline T&& move_if_not_lvalue_reference(typename ::autoboost::move_detail::remove_reference<T>::type& t) BOOST_NOEXCEPT
         {  return static_cast<T&&>(t);   }
