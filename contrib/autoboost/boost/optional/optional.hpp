...
class optional_base : public optional_tag
{
  ...
  protected :
    ...
    void construct ( Expr&& factory, in_place_factory_base const* )
     {
       BOOST_STATIC_ASSERT ( ::autoboost::mpl::not_<is_reference_predicate>::value ) ;
...
class optional : public optional_detail::optional_base<T>
{
  ...
  explicit optional ( Expr&& expr, 
                      BOOST_DEDUCED_TYPENAME autoboost::disable_if_c<
                        (autoboost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME autoboost::decay<Expr>::type>::value) || 
                        autoboost::is_same<BOOST_DEDUCED_TYPENAME autoboost::decay<Expr>::type, none_t>::value >::type* = 0 
  ) 
	...
	optional ( optional && rhs ) 
	  BOOST_NOEXCEPT_IF(::autoboost::is_nothrow_move_constructible<T>::value)
   ...
   // No-throw (assuming T::~T() doesn't)
    ...
    BOOST_DEDUCED_TYPENAME autoboost::disable_if_c<
      autoboost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME autoboost::decay<Expr>::type>::value || 
        autoboost::is_same<BOOST_DEDUCED_TYPENAME autoboost::decay<Expr>::type, none_t>::value,
      optional&
    >::type 
    operator= ( Expr&& expr )
      {
    ...
    optional& operator= ( optional && rhs ) 
	  BOOST_NOEXCEPT_IF(::autoboost::is_nothrow_move_constructible<T>::value && ::autoboost::is_nothrow_move_assignable<T>::value)
      {
...
struct swap_selector<false>
{
    template<class T>
    static void optional_swap ( optional<T>& x, optional<T>& y ) 
    //BOOST_NOEXCEPT_IF(::autoboost::is_nothrow_move_constructible<T>::value && BOOST_NOEXCEPT_EXPR(autoboost::swap(*x, *y)))
    {
        if(x)
        {
            if (y)
