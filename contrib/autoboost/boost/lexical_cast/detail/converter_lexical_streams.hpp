...
/************************************ HELPER FUNCTIONS FOR OPERATORS << ( ... ) ********************************/
            ...
            bool shl_input_streamable(InputStreamable& input) {
                ...
                BOOST_STATIC_ASSERT((autoboost::is_same<char, CharT>::value));
#endif
            ...
            inline bool shl_signed(const T n) {
                CharT* tmp_finish = buffer + CharacterBufferSize;
                typedef BOOST_DEDUCED_TYPENAME autoboost::make_unsigned<T>::type utype;
...
/************************************ OPERATORS << ( ... ) ********************************/
        public:
            ...
            template<class Alloc>
            bool operator<<(autoboost::container::basic_string<CharT,Traits,Alloc> const& str) BOOST_NOEXCEPT {
                start = str.data();
                finish = start + str.length();
                return true;
            }
            ...
            template <class C>
            BOOST_DEDUCED_TYPENAME autoboost::disable_if<autoboost::is_const<C>, bool>::type 
            ...
            BOOST_DEDUCED_TYPENAME autoboost::disable_if<autoboost::is_const<C>, bool>::type
            operator<<(autoboost::array<C, N> const& input) BOOST_NOEXCEPT { 
            ...
            bool operator<<(autoboost::array<const CharT, N> const& input) BOOST_NOEXCEPT { 
                return shl_char_array_limited(input.begin(), N); 
            }

            template <std::size_t N>
            bool operator<<(autoboost::array<const unsigned char, N> const& input) BOOST_NOEXCEPT { 
                return ((*this) << reinterpret_cast<autoboost::array<const char, N> const& >(input)); 
            }

            template <std::size_t N>
            bool operator<<(autoboost::array<const signed char, N> const& input) BOOST_NOEXCEPT { 
                return ((*this) << reinterpret_cast<autoboost::array<const char, N> const& >(input)); 
            }
...
#if defined(BOOST_NO_STRINGSTREAM) || defined(BOOST_NO_STD_LOCALE)
                BOOST_STATIC_ASSERT_MSG((autoboost::is_same<char, CharT>::value),
...
/************************************ OPERATORS >> ( ... ) ********************************/
        public:
            ...
            template <std::size_t N>
            bool operator>>(autoboost::array<CharT, N>& output) BOOST_NOEXCEPT { 
                return shr_std_array<N>(output); 
            }

            template <std::size_t N>
            bool operator>>(autoboost::array<unsigned char, N>& output) BOOST_NOEXCEPT { 
                return ((*this) >> reinterpret_cast<autoboost::array<char, N>& >(output)); 
            }

            template <std::size_t N>
            bool operator>>(autoboost::array<signed char, N>& output) BOOST_NOEXCEPT { 
                return ((*this) >> reinterpret_cast<autoboost::array<char, N>& >(output)); 
            }
