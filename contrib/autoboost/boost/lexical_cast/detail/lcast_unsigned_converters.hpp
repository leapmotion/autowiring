...
namespace autoboost 
{
    namespace detail // lcast_to_unsigned
    {
        template<class T>
        inline
        BOOST_DEDUCED_TYPENAME autoboost::make_unsigned<T>::type lcast_to_unsigned(const T value) BOOST_NOEXCEPT {
            typedef BOOST_DEDUCED_TYPENAME autoboost::make_unsigned<T>::type result_type;
            return value < 0 
    ...
    namespace detail // lcast_put_unsigned
    {
        ...
        class lcast_put_unsigned: autoboost::noncopyable {
            ...
            BOOST_DEDUCED_TYPENAME autoboost::mpl::if_c<
