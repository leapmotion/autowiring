...
namespace autoboost {
    ...
    namespace detail // deduce_source_char_impl<T>
    {
        ...
        { 
            typedef BOOST_DEDUCED_TYPENAME autoboost::detail::normalize_single_byte_char< Char >::type type; 
        };
        ...
        struct deduce_source_char_impl< deduce_character_type_later< T > > 
        {
            ...
            BOOST_STATIC_ASSERT_MSG((result_t::value || autoboost::has_left_shift< std::basic_ostream< type >, T >::value), 
    ...
    namespace detail  // deduce_target_char_impl<T>
    {
        ...
        { 
            ...
            BOOST_STATIC_ASSERT_MSG((result_t::value || autoboost::has_right_shift<std::basic_istream<wchar_t>, T >::value), 
    ...
    namespace detail // lcast_src_length
    {
        ...
        struct lcast_src_length<
                    Source, BOOST_DEDUCED_TYPENAME autoboost::enable_if<autoboost::is_integral<Source> >::type
                >
        {
        ...
        template<class Source>
        struct lcast_src_length<
                Source, BOOST_DEDUCED_TYPENAME autoboost::enable_if<autoboost::is_float<Source> >::type
            >
        {
            BOOST_STATIC_ASSERT(
    ...
    namespace detail // lexical_cast_stream_traits<Source, Target>
    {
        ...
        struct lexical_cast_stream_traits {
            ...
            typedef BOOST_DEDUCED_TYPENAME autoboost::remove_cv<src>::type            no_cv_src;
            ...
            typedef BOOST_DEDUCED_TYPENAME autoboost::detail::deduce_target_char<Target>::type target_char_t;
                
            typedef BOOST_DEDUCED_TYPENAME autoboost::detail::widest_char<
                target_char_t, src_char_t
            >::type char_type;

#if !defined(BOOST_NO_CXX11_CHAR16_T) && defined(BOOST_NO_CXX11_UNICODE_LITERALS)
            BOOST_STATIC_ASSERT_MSG(( !autoboost::is_same<char16_t, src_char_t>::value
                                        && !autoboost::is_same<char16_t, target_char_t>::value),
                "Your compiler does not have full support for char16_t" );
#endif
#if !defined(BOOST_NO_CXX11_CHAR32_T) && defined(BOOST_NO_CXX11_UNICODE_LITERALS)
            BOOST_STATIC_ASSERT_MSG(( !autoboost::is_same<char32_t, src_char_t>::value
            ...
            typedef BOOST_DEDUCED_TYPENAME autoboost::mpl::if_c<
                ...
                BOOST_DEDUCED_TYPENAME autoboost::detail::extract_char_traits<char_type, Target>,
                BOOST_DEDUCED_TYPENAME autoboost::detail::extract_char_traits<char_type, no_cv_src>
            >::type::trait_t traits;
