...
public:
  ...
  BOOST_ASIO_DECL address(const autoboost::asio::ip::address_v4& ipv4_address);

  /// Construct an address from an IPv6 address.
  BOOST_ASIO_DECL address(const autoboost::asio::ip::address_v6& ipv6_address);
  ...
  BOOST_ASIO_DECL autoboost::asio::ip::address_v4 to_v4() const;

  /// Get the address as an IP version 6 address.
  BOOST_ASIO_DECL autoboost::asio::ip::address_v6 to_v6() const;

  /// Get the address as a string in dotted decimal format.
  BOOST_ASIO_DECL std::string to_string() const;

  /// Get the address as a string in dotted decimal format.
  BOOST_ASIO_DECL std::string to_string(autoboost::system::error_code& ec) const;
