...
public:
  ...
  BOOST_ASIO_DECL endpoint(const autoboost::asio::ip::address& addr,
  ...
  BOOST_ASIO_DECL autoboost::asio::ip::address address() const;

  // Set the IP address associated with the endpoint.
  BOOST_ASIO_DECL void address(const autoboost::asio::ip::address& addr);
