...
public:
  ...
  BOOST_ASIO_DECL autoboost::system::error_code open(implementation_type& impl,
...
private:
  ...
  BOOST_ASIO_DECL autoboost::system::error_code do_set_option(
  ...
  BOOST_ASIO_DECL autoboost::system::error_code do_get_option(
