...
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL signal_set_service(autoboost::asio::io_service& io_service);
  ...
  BOOST_ASIO_DECL autoboost::system::error_code add(implementation_type& impl,
      int signal_number, autoboost::system::error_code& ec);

  // Remove a signal to a signal_set.
  BOOST_ASIO_DECL autoboost::system::error_code remove(implementation_type& impl,
      int signal_number, autoboost::system::error_code& ec);

  // Remove all signals from a signal_set.
  BOOST_ASIO_DECL autoboost::system::error_code clear(implementation_type& impl,
      autoboost::system::error_code& ec);

  // Cancel all operations associated with the signal set.
  BOOST_ASIO_DECL autoboost::system::error_code cancel(implementation_type& impl,
      autoboost::system::error_code& ec);
