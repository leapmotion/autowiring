...
public:
  ...
  BOOST_ASIO_DECL win_iocp_io_service(autoboost::asio::io_service& io_service,
  ...
  BOOST_ASIO_DECL autoboost::system::error_code register_handle(
      HANDLE handle, autoboost::system::error_code& ec);

  // Run the event loop until stopped or no more work.
  BOOST_ASIO_DECL size_t run(autoboost::system::error_code& ec);

  // Run until stopped or one operation is performed.
  BOOST_ASIO_DECL size_t run_one(autoboost::system::error_code& ec);

  // Poll for operations without blocking.
  BOOST_ASIO_DECL size_t poll(autoboost::system::error_code& ec);

  // Poll for one operation without blocking.
  BOOST_ASIO_DECL size_t poll_one(autoboost::system::error_code& ec);
...
private:
  ...
  // either 0 or 1).
  BOOST_ASIO_DECL size_t do_one(bool block, autoboost::system::error_code& ec);
