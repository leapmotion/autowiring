...
public:
  ...
  BOOST_ASIO_DECL win_iocp_handle_service(autoboost::asio::io_service& io_service);
  ...
  BOOST_ASIO_DECL autoboost::system::error_code assign(implementation_type& impl,
  ...
  // Destroy a handle implementation.
  BOOST_ASIO_DECL autoboost::system::error_code close(implementation_type& impl,
