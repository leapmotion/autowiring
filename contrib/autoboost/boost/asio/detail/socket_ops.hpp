...
BOOST_ASIO_DECL bool sockatmark(socket_type s, autoboost::system::error_code& ec);

BOOST_ASIO_DECL size_t available(socket_type s, autoboost::system::error_code& ec);
...
BOOST_ASIO_DECL int poll_connect(socket_type s, autoboost::system::error_code& ec);
...
BOOST_ASIO_DECL autoboost::system::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, autoboost::system::error_code& ec);

BOOST_ASIO_DECL autoboost::system::error_code background_getaddrinfo(
...
BOOST_ASIO_DECL autoboost::system::error_code getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int flags, autoboost::system::error_code& ec);

BOOST_ASIO_DECL autoboost::system::error_code sync_getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, autoboost::system::error_code& ec);

BOOST_ASIO_DECL autoboost::system::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, autoboost::system::error_code& ec);
