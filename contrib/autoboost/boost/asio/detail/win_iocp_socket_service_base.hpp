...
public:
  ...
  // Destroy a socket implementation.
  BOOST_ASIO_DECL autoboost::system::error_code close(
      base_implementation_type& impl, autoboost::system::error_code& ec);

  // Cancel all operations associated with the socket.
  BOOST_ASIO_DECL autoboost::system::error_code cancel(
      base_implementation_type& impl, autoboost::system::error_code& ec);
...
protected:
  ...
  BOOST_ASIO_DECL autoboost::system::error_code do_open(
      base_implementation_type& impl, int family, int type,
      int protocol, autoboost::system::error_code& ec);

  // Assign a native socket to a socket implementation.
  BOOST_ASIO_DECL autoboost::system::error_code do_assign(
