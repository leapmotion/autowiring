...
public:
   ...
   * without blocking.
   */
  BOOST_ASIO_DECL std::size_t run(autoboost::system::error_code& ec);
   ...
   * @return The number of handlers that were executed.
   */
  BOOST_ASIO_DECL std::size_t run_one(autoboost::system::error_code& ec);
   ...
   * @return The number of handlers that were executed.
   */
  BOOST_ASIO_DECL std::size_t poll(autoboost::system::error_code& ec);
   ...
   * @return The number of handlers that were executed.
   */
  BOOST_ASIO_DECL std::size_t poll_one(autoboost::system::error_code& ec);
   ...
   */
  BOOST_ASIO_DECL void notify_fork(autoboost::asio::io_service::fork_event event);
...
protected:
   ...
   */
  BOOST_ASIO_DECL service(autoboost::asio::io_service& owner);
