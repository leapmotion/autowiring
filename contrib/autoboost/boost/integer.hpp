...
#include <boost/integer_traits.hpp>  // for autoboost::::autoboost::integer_traits
#include <boost/limits.hpp>          // for ::std::numeric_limits
#include <boost/cstdint.hpp>         // for autoboost::int64_t and BOOST_NO_INTEGRAL_INT64_T
...
namespace autoboost
{
  ...
  {
      BOOST_STATIC_ASSERT_MSG(Bits <= (int)(sizeof(autoboost::intmax_t) * CHAR_BIT),
  ...
  {
     BOOST_STATIC_ASSERT_MSG(Bits <= (int)(sizeof(autoboost::uintmax_t) * CHAR_BIT),
