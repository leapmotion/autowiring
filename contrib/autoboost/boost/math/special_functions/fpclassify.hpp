...
#ifdef isnan
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<float>(float t){ return ::autoboost::math_detail::is_nan_helper(t, autoboost::true_type()); }
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<double>(double t){ return ::autoboost::math_detail::is_nan_helper(t, autoboost::true_type()); }
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<long double>(long double t){ return ::autoboost::math_detail::is_nan_helper(t, autoboost::true_type()); }
