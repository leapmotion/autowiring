...
#include <boost/cstdint.hpp> // for autoboost::uintmax_t
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         autoboost::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    autoboost::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  autoboost::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  autoboost::non_type<t, v>*
...
#    define BOOST_FPU_EXCEPTION_GUARD autoboost::math::detail::fpu_guard local_guard_object;
