...
#define BOOST_MATH_META_INT(Type, name, Default)\
   ...
   {\
      static T inst;\
      BOOST_STATIC_CONSTANT(bool, value = sizeof( ::autoboost::math::policies::detail::is_##name##_tester<T>::test(inst)) == 1);\
   };\
   }\
   template <class T> struct is_##name : public autoboost::mpl::bool_< ::autoboost::math::policies::detail::is_##name##_imp<T>::value>\
   {\
...
{
   BOOST_STATIC_CONSTANT(bool, value = sizeof(::autoboost::math::policies::detail::test_is_valid_arg(static_cast<T*>(0))) == 1);
};

template <class T>
struct is_default_policy_imp
{
   BOOST_STATIC_CONSTANT(bool, value = sizeof(::autoboost::math::policies::detail::test_is_default_arg(static_cast<T*>(0))) == 1);
};
...
private:
   ...
   //
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A1>::value);
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A2>::value);
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A3>::value);
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A4>::value);
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A5>::value);
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A6>::value);
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A7>::value);
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A8>::value);
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A9>::value);
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A10>::value);
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A11>::value);
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A12>::value);
   BOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A13>::value);
   //
...
{
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(::autoboost::math::policies::detail::test_is_policy(static_cast<P*>(0))) == 1));
};
