...
#else
#  define BOOST_FUNCTION_VOID_RETURN_TYPE autoboost::detail::function::unusable
...
namespace autoboost {
    ...
    namespace function {
      ...
      struct BOOST_FUNCTION_MEMBER_INVOKER
      {
...

        {
          ...
          return autoboost::mem_fn(*f)(BOOST_FUNCTION_ARGS);
        }
      };
      ...
      struct BOOST_FUNCTION_VOID_MEMBER_INVOKER
      {
...

        {
          MemberPtr* f = 
            reinterpret_cast<MemberPtr*>(&function_obj_ptr.data);
          BOOST_FUNCTION_RETURN(autoboost::mem_fn(*f)(BOOST_FUNCTION_ARGS));
        }
      };
#endif
  ...
  private:
    typedef autoboost::detail::function::BOOST_FUNCTION_VTABLE<
