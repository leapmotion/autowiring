...
struct trait           \
{                      \
    BOOST_STATIC_CONSTANT( bool, value = (trait_tester< T, autoboost::is_class< T >::value >::value) );     \
...
{ \
    ...
    { \
        ...
        static autoboost::mpl::aux::yes_tag test( \
            ...
            , autoboost::mpl::aux::type_wrapper<BOOST_MSVC_TYPENAME U::name>* = 0 \
            ); \
    \
...
#   define BOOST_MPL_HAS_MEMBER_IMPLEMENTATION( \
      ...
      template< \
          typename T \
        , typename fallback_ \
              = autoboost::mpl::bool_< BOOST_PP_ARRAY_ELEM(3, args) > \
      > \
