...
namespace ratio_detail
{
  ...
  class br_mul
  {
      static const autoboost::intmax_t nan =
          autoboost::intmax_t(BOOST_RATIO_UINTMAX_C(1) << (sizeof(autoboost::intmax_t) * CHAR_BIT - 1));
      static const autoboost::intmax_t min = autoboost::integer_traits<autoboost::intmax_t>::const_min;
      static const autoboost::intmax_t max = autoboost::integer_traits<autoboost::intmax_t>::const_max;
  ...
  class br_div
  {
      static const autoboost::intmax_t nan = autoboost::intmax_t(BOOST_RATIO_UINTMAX_C(1) << (sizeof(autoboost::intmax_t) * CHAR_BIT - 1));
      static const autoboost::intmax_t min = autoboost::integer_traits<autoboost::intmax_t>::const_min;
      static const autoboost::intmax_t max = autoboost::integer_traits<autoboost::intmax_t>::const_max;
