...
public:
    ...
    explicit library_version_type(const unsigned int & t_) : t(t_){
        BOOST_ASSERT(t_ <= autoboost::integer_traits<base_type>::const_max);
    }
...
BOOST_CLASS_IMPLEMENTATION(autoboost::archive::library_version_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(autoboost::archive::version_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(autoboost::archive::class_id_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(autoboost::archive::class_id_reference_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(autoboost::archive::class_id_optional_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(autoboost::archive::class_name_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(autoboost::archive::object_id_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(autoboost::archive::object_reference_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(autoboost::archive::tracking_type, primitive_type)
...
BOOST_IS_BITWISE_SERIALIZABLE(autoboost::archive::library_version_type)
BOOST_IS_BITWISE_SERIALIZABLE(autoboost::archive::version_type)
BOOST_IS_BITWISE_SERIALIZABLE(autoboost::archive::class_id_type)
BOOST_IS_BITWISE_SERIALIZABLE(autoboost::archive::class_id_reference_type)
BOOST_IS_BITWISE_SERIALIZABLE(autoboost::archive::class_id_optional_type)
BOOST_IS_BITWISE_SERIALIZABLE(autoboost::archive::class_name_type)
BOOST_IS_BITWISE_SERIALIZABLE(autoboost::archive::object_id_type)
BOOST_IS_BITWISE_SERIALIZABLE(autoboost::archive::object_reference_type)
BOOST_IS_BITWISE_SERIALIZABLE(autoboost::archive::tracking_type)
