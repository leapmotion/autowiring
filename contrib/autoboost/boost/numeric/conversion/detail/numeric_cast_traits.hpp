...
namespace autoboost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(autoboost::long_long_type)(autoboost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (autoboost::long_long_type)(autoboost::ulong_long_type)
