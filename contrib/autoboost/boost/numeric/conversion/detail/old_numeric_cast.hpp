...
#  define BOOST_EXPLICIT_DEFAULT_TARGET , ::autoboost::type<Target>* = 0
# else
...
# ifdef BOOST_HAS_LONG_LONG
      ...
      struct fixed_numeric_limits_base< ::autoboost::long_long_type, false>
      {
          ...
          static  ::autoboost::long_long_type max BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MAX
              return LONGLONG_MAX;
#  else
...
#  endif
          ...
          static  ::autoboost::long_long_type min BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MIN
              return LONGLONG_MIN;
#  else
...
#  endif
      ...
      struct fixed_numeric_limits_base< ::autoboost::ulong_long_type, false>
      {
          ...
          static  ::autoboost::ulong_long_type max BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef ULONGLONG_MAX
...
#  endif
          ...
          static  ::autoboost::ulong_long_type min BOOST_PREVENT_MACRO_SUBSTITUTION () { return 0; }
      };
# endif
    } // namespace detail
