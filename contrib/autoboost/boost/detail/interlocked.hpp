...
# define BOOST_INTERLOCKED_INCREMENT ::autoboost::detail::InterlockedIncrement
# define BOOST_INTERLOCKED_DECREMENT ::autoboost::detail::InterlockedDecrement
# define BOOST_INTERLOCKED_COMPARE_EXCHANGE ::autoboost::detail::InterlockedCompareExchange
# define BOOST_INTERLOCKED_EXCHANGE ::autoboost::detail::InterlockedExchange
# define BOOST_INTERLOCKED_EXCHANGE_ADD ::autoboost::detail::InterlockedExchangeAdd

# if defined(_M_IA64) || defined(_M_AMD64)
#  define BOOST_INTERLOCKED_COMPARE_EXCHANGE_POINTER ::autoboost::detail::InterlockedCompareExchangePointer
#  define BOOST_INTERLOCKED_EXCHANGE_POINTER ::autoboost::detail::InterlockedExchangePointer
# else
#  define BOOST_INTERLOCKED_COMPARE_EXCHANGE_POINTER(dest,exchange,compare) \
    ((void*)BOOST_INTERLOCKED_COMPARE_EXCHANGE((long volatile*)(dest),(long)(exchange),(long)(compare)))
#  define BOOST_INTERLOCKED_EXCHANGE_POINTER(dest,exchange) \
