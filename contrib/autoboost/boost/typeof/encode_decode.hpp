...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace autoboost_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER autoboost_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace autoboost { namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER autoboost::type_of
