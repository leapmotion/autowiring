...
# define BOOST_TYPEOF_INDEX(T) (sizeof(*autoboost::type_of::encode_index((autoboost::type_of::encode_counter<1000>*)0)))
...
# define BOOST_TYPEOF_NESTED_TYPEDEF_TPL(name,expr) \
    struct name {\
        BOOST_STATIC_CONSTANT(int,_typeof_register_value=sizeof(autoboost::type_of::typeof_register_type<name>(expr)));\
