...
#define BOOST_TYPEOF_VECTOR(n) BOOST_PP_CAT(autoboost::type_of::vector, n)
...
#define BOOST_TYPEOF_TYPEITEM(z, n, expr)\
    autoboost::mpl::size_t<sizeof(autoboost::type_of::encode<BOOST_TYPEOF_VECTOR(0)<> >(expr).item ## n)>
...
#define BOOST_TYPEOF(Expr)\
    autoboost::type_of::decode_begin<BOOST_TYPEOF_ENCODED_VECTOR(Expr) >::type
...
#define BOOST_TYPEOF_NESTED_TYPEITEM(z, n, expr)\
    BOOST_STATIC_CONSTANT(int,BOOST_PP_CAT(value,n) = sizeof(autoboost::type_of::encode<_typeof_start_vector>(expr).item ## n));\
    typedef autoboost::mpl::size_t<BOOST_PP_CAT(self_t::value,n)> BOOST_PP_CAT(item,n);
...
#define BOOST_TYPEOF_NESTED_TYPEDEF_IMPL(expr) \
        ...
        struct _typeof_encode_fraction {\
            ...
            typedef autoboost::type_of::offset_vector<BOOST_TYPEOF_VECTOR(0)<>,autoboost::mpl::size_t<self_t::_typeof_encode_offset> > _typeof_start_vector;\
