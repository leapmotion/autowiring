    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
            ...
            , EqualityComparable<Iterator>
        {
            ...
            BOOST_CONCEPT_USAGE(SinglePassIteratorConcept)
            {
                ...
                BOOST_DEDUCED_TYPENAME autoboost::detail::iterator_traits<Iterator>::reference r1(*i);
                autoboost::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME autoboost::detail::iterator_traits<Iterator>::reference r2(*(++i));
        ...
        {
#if BOOST_RANGE_ENABLE_CONCEPT_ASSERT
            typedef BOOST_DEDUCED_TYPENAME autoboost::detail::iterator_traits<Iterator>::difference_type difference_type;
            ...
            BOOST_CONCEPT_USAGE(ForwardIteratorConcept)
            {
                ...
                Iterator i2(i++);
                autoboost::ignore_unused_variable_warning(i2);
                BOOST_DEDUCED_TYPENAME autoboost::detail::iterator_traits<Iterator>::reference r(*(i++));
