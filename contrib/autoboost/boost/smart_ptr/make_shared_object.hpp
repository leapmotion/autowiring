...
# define BOOST_SP_MSD( T ) autoboost::detail::sp_inplace_tag< autoboost::detail::sp_ms_deleter< T > >()
#else
# define BOOST_SP_MSD( T ) autoboost::detail::sp_ms_deleter< T >()
#endif
...
{
    autoboost::shared_ptr< T > pt( static_cast< T* >( 0 ), BOOST_SP_MSD( T ) );
...
{
    autoboost::shared_ptr< T > pt( static_cast< T* >( 0 ), BOOST_SP_MSD( T ), a );
