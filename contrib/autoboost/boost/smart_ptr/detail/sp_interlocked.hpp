...
# define BOOST_SP_INTERLOCKED_INCREMENT ::autoboost::detail::InterlockedIncrement
# define BOOST_SP_INTERLOCKED_DECREMENT ::autoboost::detail::InterlockedDecrement
# define BOOST_SP_INTERLOCKED_COMPARE_EXCHANGE ::autoboost::detail::InterlockedCompareExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE ::autoboost::detail::InterlockedExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE_ADD ::autoboost::detail::InterlockedExchangeAdd
