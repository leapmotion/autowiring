...
//!
   ...
   BOOST_PP_CAT(m_p, n) (::autoboost::forward< BOOST_PP_CAT(P, n) >( BOOST_PP_CAT(p, n) ))           \
   //!
   ...
   //!
      ...
      #define BOOST_CONTAINER_PP_PARAM_DEFINE(z, n, data)  \
         ::autoboost::container::container_detail::ref_holder<BOOST_PP_CAT(P, n)> BOOST_PP_CAT(m_p, n);  \
      //!
   ...
   ::autoboost::forward< BOOST_PP_CAT(P, n) >( BOOST_PP_CAT(this->m_p, n) ) \
   //!
...
::autoboost::forward< BOOST_PP_CAT(P, n) >( BOOST_PP_CAT(p, n) ) \
//!

#define BOOST_CONTAINER_PP_DECLVAL(z, n, data) \
::autoboost::move_detail::declval< BOOST_PP_CAT(P, n) >() \
//!
...
#define BOOST_CONTAINER_PP_FWD_TYPE(z, n, data) \
   typename ::autoboost::move_detail::forward_type< BOOST_PP_CAT(P, n) >::type \
//!
