...
namespace autoboost_concepts
{
  ...
  {
      typedef BOOST_DEDUCED_TYPENAME autoboost::detail::iterator_traits<Iterator>::value_type value_type;
      typedef BOOST_DEDUCED_TYPENAME autoboost::detail::iterator_traits<Iterator>::reference reference;
  ...
  template <
      typename Iterator
    , typename ValueType = BOOST_DEDUCED_TYPENAME autoboost::detail::iterator_traits<Iterator>::value_type
  >
    ...
    , autoboost::DefaultConstructible<Iterator>
  {
      ...
      BOOST_MPL_ASSERT((autoboost::is_integral<difference_type>));
