...
private:
   ...
   //
   BOOST_STATIC_ASSERT((::autoboost::is_pointer<F>::value || ::autoboost::is_function<F>::value || ::autoboost::is_class<F>::value));
...
public:
   ...
   //
   BOOST_STATIC_ASSERT( autoboost::is_class<F>::value && !has_const_iterator<F>::value ? (type::value > 1) : true);
};
