...
#endif
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type, autoboost::uint32_t mask, char c);
#ifndef BOOST_NO_WREGEX
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type, autoboost::uint32_t mask, wchar_t c);
#ifdef BOOST_REGEX_HAS_OTHER_WCHAR_T
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type state_id, autoboost::uint32_t m, unsigned short c);
#endif
#endif
//
