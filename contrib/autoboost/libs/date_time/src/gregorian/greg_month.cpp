...
#include "autoboost/date_time/gregorian/greg_facet.hpp"
...
#include "autoboost/date_time/gregorian/formatters_limited.hpp"
#else
#include "autoboost/date_time/gregorian/formatters.hpp"
#endif
...
namespace gregorian {
  ...
  {
    typedef
      autoboost::date_time::all_date_names_put<greg_facet_config, char> facet_def;
  ...
  {
    typedef
      autoboost::date_time::all_date_names_put<greg_facet_config,wchar_t> facet_def;
