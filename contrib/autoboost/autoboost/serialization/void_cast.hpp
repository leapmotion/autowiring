#ifndef  AUTOBOOST_SERIALIZATION_VOID_CAST_HPP
#define AUTOBOOST_SERIALIZATION_VOID_CAST_HPP
...
class AUTOBOOST_SERIALIZATION_DECL(AUTOBOOST_PP_EMPTY()) void_caster :
    private autoboost::noncopyable
{
    ...
    friend 
    AUTOBOOST_SERIALIZATION_DECL(void const *)  
    autoboost::serialization::void_downcast(
        extended_type_info const & derived,
        extended_type_info const & base,
        void const * const
    );
    ...
    public void_caster
{
    virtual void const * downcast(void const * const t) const {
        const Derived * d = 
            autoboost::serialization::smart_cast<const Derived *, const Base *>(
    ...
    virtual void const * upcast(void const * const t) const {
        const Base * b = 
            autoboost::serialization::smart_cast<const Base *, const Derived *>(
...
{
    typedef
        typename mpl::eval_if<autoboost::is_virtual_base_of<Base,Derived>,
            mpl::identity<
...
#endif // AUTOBOOST_SERIALIZATION_VOID_CAST_HPP
