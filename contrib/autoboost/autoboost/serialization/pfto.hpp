#ifndef AUTOBOOST_SERIALIZATION_PFTO_HPP
#define AUTOBOOST_SERIALIZATION_PFTO_HPP
...
// or causes other problems (GCC).  note: this 
    ...
    #define AUTOBOOST_PFTO long
#else
    #define AUTOBOOST_PFTO
#endif
...
template<class T>
pfto_wrapper< T > make_pfto_wrapper(const T & t, AUTOBOOST_PFTO int){
...
pfto_wrapper< T > make_pfto_wrapper(const pfto_wrapper< T > & t, int){
    ...
    #define AUTOBOOST_PFTO_WRAPPER(T) \
        autoboost::serialization::pfto_wrapper< T >
    #define AUTOBOOST_MAKE_PFTO_WRAPPER(t) \
        autoboost::serialization::make_pfto_wrapper(t, 0)
#else
    #define AUTOBOOST_PFTO_WRAPPER(T) T
    #define AUTOBOOST_MAKE_PFTO_WRAPPER(t) t
#endif

#endif // AUTOBOOST_SERIALIZATION_PFTO_HPP
