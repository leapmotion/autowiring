#ifndef AUTOBOOST_SERIALIZATION_EXTENDED_TYPE_INFO_TYPEID_HPP
#define AUTOBOOST_SERIALIZATION_EXTENDED_TYPE_INFO_TYPEID_HPP
...
class AUTOBOOST_SERIALIZATION_DECL(AUTOBOOST_PP_EMPTY()) extended_type_info_typeid_0 : 
...
public:
    ...
    const char * get_key() const {
        return autoboost::serialization::guid< T >();
    }
...
// before any of the other headers.
    ...
    struct extended_type_info_impl {
        typedef typename 
            autoboost::serialization::extended_type_info_typeid< T > type;
    };
    } // namespace serialization
    } // namespace autoboost
#endif
...
#endif // AUTOBOOST_SERIALIZATION_EXTENDED_TYPE_INFO_TYPEID_HPP
