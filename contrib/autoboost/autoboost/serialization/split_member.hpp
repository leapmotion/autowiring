#ifndef AUTOBOOST_SERIALIZATION_SPLIT_MEMBER_HPP
#define AUTOBOOST_SERIALIZATION_SPLIT_MEMBER_HPP
...
#define AUTOBOOST_SERIALIZATION_SPLIT_MEMBER()                       \
template<class Archive>                                          \
void serialize(                                                  \
    Archive &ar,                                                 \
    const unsigned int file_version                              \
){                                                               \
    autoboost::serialization::split_member(ar, *this, file_version); \
}                                                                \
/**/

#endif // AUTOBOOST_SERIALIZATION_SPLIT_MEMBER_HPP
