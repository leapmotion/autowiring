#ifndef AUTOBOOST_SERIALIZATION_SERIALIZATION_HPP
#define AUTOBOOST_SERIALIZATION_SERIALIZATION_HPP
...
// by specifying friend class autoboost::serialization::access
...
AUTOBOOST_STRONG_TYPEDEF(unsigned int, version_type)

// default implementation - call the member function "serialize"
template<class Archive, class T>
inline void serialize(
    Archive & ar, T & t, const AUTOBOOST_PFTO unsigned int file_version
){
...
inline void save_construct_data(
    Archive & /*ar*/, 
    const T * /*t*/, 
    const AUTOBOOST_PFTO unsigned int /*file_version */
){
...
// i.e. autoboost::serialization will be searched.
// 
...
#endif //AUTOBOOST_SERIALIZATION_SERIALIZATION_HPP
