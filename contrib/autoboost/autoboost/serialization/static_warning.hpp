#ifndef AUTOBOOST_SERIALIZATION_STATIC_WARNING_HPP
#define AUTOBOOST_SERIALIZATION_STATIC_WARNING_HPP
...
// Enable the warnings relied on by AUTOBOOST_STATIC_WARNING, where possible. The 
...
#include <autoboost/mpl/print.hpp>
...
template<int L> 
struct AUTOBOOST_SERIALIZATION_STATIC_WARNING_LINE{};
...
struct static_warning_test{
    typename autoboost::mpl::eval_if_c<
        B,
        autoboost::mpl::true_,
        typename autoboost::mpl::identity<
            autoboost::mpl::print<
                AUTOBOOST_SERIALIZATION_STATIC_WARNING_LINE<L>
            >
        >
    >::type type;
};
...
template<int i>
struct AUTOBOOST_SERIALIZATION_SS {};

} // serialization
} // boost

#define AUTOBOOST_SERIALIZATION_BSW(B, L) \
    typedef autoboost::serialization::AUTOBOOST_SERIALIZATION_SS< \
        sizeof( autoboost::serialization::static_warning_test< B, L > ) \
    > AUTOBOOST_JOIN(STATIC_WARNING_LINE, L) AUTOBOOST_STATIC_ASSERT_UNUSED_ATTRIBUTE; 
#define AUTOBOOST_STATIC_WARNING(B) AUTOBOOST_SERIALIZATION_BSW(B, __LINE__)

#endif // AUTOBOOST_SERIALIZATION_STATIC_WARNING_HPP
