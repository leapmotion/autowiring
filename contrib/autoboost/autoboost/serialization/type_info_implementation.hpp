#ifndef AUTOBOOST_SERIALIZATION_TYPE_INFO_IMPLEMENTATION_HPP
#define AUTOBOOST_SERIALIZATION_TYPE_INFO_IMPLEMENTATION_HPP
...
#define AUTOBOOST_CLASS_TYPE_INFO(T, ETI)              \
namespace autoboost {                                  \
namespace serialization {                          \
template<>                                         \
...
#endif /// AUTOBOOST_SERIALIZATION_TYPE_INFO_IMPLEMENTATION_HPP
