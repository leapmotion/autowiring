#ifndef AUTOBOOST_SERIALIZATION_TRAITS_HPP
#define AUTOBOOST_SERIALIZATION_TRAITS_HPP
...
struct traits : public basic_traits {
    AUTOBOOST_STATIC_ASSERT(Version == 0 || Level >= object_class_info);
    AUTOBOOST_STATIC_ASSERT(Tracking == track_never || Level >= object_serializable);
...
#endif // AUTOBOOST_SERIALIZATION_TRAITS_HPP
