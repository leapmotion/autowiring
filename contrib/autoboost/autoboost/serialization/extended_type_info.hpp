#ifndef AUTOBOOST_SERIALIZATION_EXTENDED_TYPE_INFO_HPP
#define AUTOBOOST_SERIALIZATION_EXTENDED_TYPE_INFO_HPP
...
#define AUTOBOOST_SERIALIZATION_MAX_KEY_SIZE 128
...
class AUTOBOOST_SERIALIZATION_DECL(AUTOBOOST_PP_EMPTY()) extended_type_info :
    private autoboost::noncopyable
{
private:
    friend class autoboost::serialization::void_cast_detail::void_caster;
...
template<class T>
struct guid_defined : autoboost::mpl::false_ {};
...
#endif // AUTOBOOST_SERIALIZATION_EXTENDED_TYPE_INFO_HPP
