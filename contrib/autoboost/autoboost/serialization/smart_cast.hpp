#ifndef AUTOBOOST_SERIALIZATION_SMART_CAST_HPP
#define AUTOBOOST_SERIALIZATION_SMART_CAST_HPP
...
T smart_cast(U u) {
    typedef
        typename mpl::eval_if<
            typename mpl::or_<
                autoboost::is_same<void *, U>,
                autoboost::is_same<void *, T>,
                autoboost::is_same<const void *, U>,
                autoboost::is_same<const void *, T>
            >,
            mpl::identity<smart_cast_impl::void_pointer< T > >,
        // else
        typename mpl::eval_if<autoboost::is_pointer<U>,
            mpl::identity<smart_cast_impl::pointer< T > >,
        // else
        typename mpl::eval_if<autoboost::is_reference<U>,
...
#endif // AUTOBOOST_SERIALIZATION_SMART_CAST_HPP
