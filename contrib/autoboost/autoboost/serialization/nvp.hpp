#ifndef AUTOBOOST_SERIALIZATION_NVP_HPP
#define AUTOBOOST_SERIALIZATION_NVP_HPP
...
struct implementation_level<nvp< T > >
{
    ...
    AUTOBOOST_STATIC_CONSTANT(int, value = implementation_level::type::value);
};
...
struct tracking_level<nvp< T > >
{
    ...
    AUTOBOOST_STATIC_CONSTANT(int, value = tracking_level::type::value);
};
...
#define AUTOBOOST_SERIALIZATION_NVP(name)                              \
    autoboost::serialization::make_nvp(AUTOBOOST_PP_STRINGIZE(name), name)
/**/

#define AUTOBOOST_SERIALIZATION_BASE_OBJECT_NVP(name)                  \
    autoboost::serialization::make_nvp(                                \
        AUTOBOOST_PP_STRINGIZE(name),                                  \
        autoboost::serialization::base_object<name >(*this)            \
    )
/**/

#endif // AUTOBOOST_SERIALIZATION_NVP_HPP
