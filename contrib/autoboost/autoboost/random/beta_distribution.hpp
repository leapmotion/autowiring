/* autoboost random/beta_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_BETA_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_BETA_DISTRIBUTION_HPP
...
public:
    ...
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, beta_distribution, wd)
    {
        os << wd.param();
        return os;
    }
    ...
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, beta_distribution, wd)
    {
        param_type parm;
        if(is >> parm) {
            wd.param(parm);
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(beta_distribution, lhs, rhs)
    { return lhs._alpha == rhs._alpha && lhs._beta == rhs._beta; }
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(beta_distribution)
...
#endif // AUTOBOOST_RANDOM_BETA_DISTRIBUTION_HPP
