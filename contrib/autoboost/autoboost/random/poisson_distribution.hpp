/* autoboost random/poisson_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_POISSON_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_POISSON_DISTRIBUTION_HPP
...
public:
    ...
    IntType min AUTOBOOST_PREVENT_MACRO_SUBSTITUTION() const { return 0; }
...
private:
    ...
    {
        AUTOBOOST_ASSERT(k >= 0);
        AUTOBOOST_ASSERT(k < 10);
...
#endif // AUTOBOOST_RANDOM_POISSON_DISTRIBUTION_HPP
