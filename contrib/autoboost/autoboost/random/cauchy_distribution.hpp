/* autoboost random/cauchy_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_CAUCHY_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_CAUCHY_DISTRIBUTION_HPP
...
public:
    ...
    {
        // Can we have a autoboost::mathconst please?
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, cauchy_distribution, cd)
    {
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, cauchy_distribution, cd)
    {
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(cauchy_distribution, lhs, rhs)
    { return lhs._median == rhs._median && lhs._sigma == rhs._sigma; }
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(cauchy_distribution)
...
#endif // AUTOBOOST_RANDOM_CAUCHY_DISTRIBUTION_HPP
