/* autoboost random/student_t_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_STUDENT_T_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_STUDENT_T_DISTRIBUTION_HPP
...
public:
    ...
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, student_t_distribution, td)
    {
        os << td.param();
        return os;
    }
    ...
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, student_t_distribution, td)
    {
        param_type parm;
        if(is >> parm) {
            td.param(parm);
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(student_t_distribution, lhs, rhs)
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(student_t_distribution)
...
#endif // AUTOBOOST_RANDOM_STUDENT_T_DISTRIBUTION_HPP
