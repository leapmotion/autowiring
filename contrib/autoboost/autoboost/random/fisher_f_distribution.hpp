/* autoboost random/fisher_f_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_FISHER_F_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_FISHER_F_DISTRIBUTION_HPP
...
public:
    ...
    RealType min AUTOBOOST_PREVENT_MACRO_SUBSTITUTION () const { return 0; }
    ...
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, fisher_f_distribution, fd)
    {
        os << fd.param();
        return os;
    }
    ...
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, fisher_f_distribution, fd)
    {
        param_type parm;
        if(is >> parm) {
            fd.param(parm);
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(fisher_f_distribution, lhs, rhs)
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(fisher_f_distribution)
