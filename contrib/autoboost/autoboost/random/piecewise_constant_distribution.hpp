/* autoboost random/piecewise_constant_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_PIECEWISE_CONSTANT_DISTRIBUTION_HPP_INCLUDED
#define AUTOBOOST_RANDOM_PIECEWISE_CONSTANT_DISTRIBUTION_HPP_INCLUDED
...
public:
    ...
    public:
        ...
        param_type(const IntervalRange& intervals_arg,
          ...
          : _intervals(autoboost::begin(intervals_arg), autoboost::end(intervals_arg)),
            _weights(autoboost::begin(weights_arg), autoboost::end(weights_arg))
        {
            if(_intervals.size() < 2) {
                _intervals.clear();
                _intervals.push_back(RealType(0));
    ...
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(
    ...
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(piecewise_constant_distribution)
