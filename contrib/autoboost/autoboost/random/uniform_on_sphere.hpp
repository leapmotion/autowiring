/* autoboost random/uniform_on_sphere.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_UNIFORM_ON_SPHERE_HPP
#define AUTOBOOST_RANDOM_UNIFORM_ON_SPHERE_HPP
...
public:
    ...
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, uniform_on_sphere, sd)
    {
        os << sd._dim;
        return os;
    }
    ...
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, uniform_on_sphere, sd)
    {
        is >> sd._dim;
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(uniform_on_sphere, lhs, rhs)
    { return lhs._dim == rhs._dim; }
     ...
     * sequences of values, given equal generators.
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(uniform_on_sphere)
...
#endif // AUTOBOOST_RANDOM_UNIFORM_ON_SPHERE_HPP
