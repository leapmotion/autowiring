/* autoboost random/binomial_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_BINOMIAL_DISTRIBUTION_HPP_INCLUDED
#define AUTOBOOST_RANDOM_BINOMIAL_DISTRIBUTION_HPP_INCLUDED
...
public:
    ...
    IntType max AUTOBOOST_PREVENT_MACRO_SUBSTITUTION() const { return _t; }
