...
#include <autoboost/random/detail/int_float_pair.hpp>
...
struct unit_normal_distribution
{
    ...
    RealType generate_tail(Engine& eng) {
        ...
        autoboost::random::exponential_distribution<RealType> exp_x(tail_start);
        autoboost::random::exponential_distribution<RealType> exp_y;
        for(;;) {
