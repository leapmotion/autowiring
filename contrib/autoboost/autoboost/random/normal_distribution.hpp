/* autoboost random/normal_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_NORMAL_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_NORMAL_DISTRIBUTION_HPP
...
inline typename autoboost::make_unsigned<typename Engine::result_type>::type
generate_one_digit(Engine& eng, std::size_t bits)
{
    typedef typename Engine::result_type base_result;
    typedef typename autoboost::make_unsigned<base_result>::type base_unsigned;
...
std::pair<RealType, int> generate_int_float_pair(Engine& eng, autoboost::mpl::true_)
{
    typedef typename Engine::result_type base_result;
    typedef typename autoboost::make_unsigned<base_result>::type base_unsigned;
...
template<class RealType, std::size_t w, class Engine>
inline std::pair<RealType, int> generate_int_float_pair(Engine& eng, autoboost::mpl::false_)
{
...
inline std::pair<RealType, int> generate_int_float_pair(Engine& eng)
{
    ...
    return generate_int_float_pair<RealType, w>(eng,
        autoboost::is_integral<base_result>());
}
...
struct unit_normal_distribution
{
    ...
    RealType generate_tail(Engine& eng) {
        autoboost::random::exponential_distribution<RealType> exponential;
...
public:
    ...
    {
        AUTOBOOST_ASSERT(_sigma >= RealType(0));
    }
    ...
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, normal_distribution, nd)
    {
    ...
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, normal_distribution, nd)
    {
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(normal_distribution, lhs, rhs)
    {
        return lhs._mean == rhs._mean && lhs._sigma == rhs._sigma;
    }
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(normal_distribution)
...
#endif // AUTOBOOST_RANDOM_NORMAL_DISTRIBUTION_HPP
