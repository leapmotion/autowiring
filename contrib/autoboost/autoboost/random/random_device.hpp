/* autoboost random/random_device.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_RANDOM_DEVICE_HPP
#define AUTOBOOST_RANDOM_RANDOM_DEVICE_HPP

#include <string>
#include <autoboost/config.hpp>
#include <autoboost/noncopyable.hpp>
#include <autoboost/random/detail/auto_link.hpp>
#include <autoboost/system/config.hpp> // force autolink to find Boost.System
...
public:
    ...
    static result_type max AUTOBOOST_PREVENT_MACRO_SUBSTITUTION () { return ~0u; }

    /** Constructs a @c random_device, optionally using the default device. */
    AUTOBOOST_RANDOM_DECL random_device();
    /**
     ...
     */
    AUTOBOOST_RANDOM_DECL explicit random_device(const std::string& token);
     ...
     * Throws: Nothing.
     */
    AUTOBOOST_RANDOM_DECL double entropy() const;
    /** Returns a random value in the range [min, max]. */
    AUTOBOOST_RANDOM_DECL unsigned int operator()();
...
#endif /* AUTOBOOST_RANDOM_RANDOM_DEVICE_HPP */
