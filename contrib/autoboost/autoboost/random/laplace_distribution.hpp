/* autoboost random/laplace_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_LAPLACE_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_LAPLACE_DISTRIBUTION_HPP
...
public:
    ...
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, laplace_distribution, wd)
    {
        os << wd.param();
        return os;
    }
    ...
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, laplace_distribution, wd)
    {
        param_type parm;
        if(is >> parm) {
            wd.param(parm);
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(laplace_distribution, lhs, rhs)
    { return lhs._mean == rhs._mean && lhs._beta == rhs._beta; }
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(laplace_distribution)
...
#endif // AUTOBOOST_RANDOM_LAPLACE_DISTRIBUTION_HPP
