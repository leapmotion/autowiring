/* autoboost random/gamma_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_GAMMA_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_GAMMA_DISTRIBUTION_HPP
...
public:
    ...
    {
        AUTOBOOST_ASSERT(_alpha > result_type(0));
        AUTOBOOST_ASSERT(_beta > result_type(0));
        init();
    }
...
#endif // AUTOBOOST_RANDOM_GAMMA_DISTRIBUTION_HPP
