/* autoboost random/extreme_value_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_EXTREME_VALUE_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_EXTREME_VALUE_DISTRIBUTION_HPP
...
public:
    ...
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, extreme_value_distribution, wd)
    {
        os << wd.param();
        return os;
    }
    ...
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, extreme_value_distribution, wd)
    {
        param_type parm;
        if(is >> parm) {
            wd.param(parm);
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(extreme_value_distribution, lhs, rhs)
    { return lhs._a == rhs._a && lhs._b == rhs._b; }
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(extreme_value_distribution)
...
#endif // AUTOBOOST_RANDOM_EXTREME_VALUE_DISTRIBUTION_HPP
