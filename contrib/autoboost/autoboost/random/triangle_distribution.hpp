/* autoboost random/triangle_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_TRIANGLE_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_TRIANGLE_DISTRIBUTION_HPP
...
public:
    ...
    RealType min AUTOBOOST_PREVENT_MACRO_SUBSTITUTION () const { return _a; }
    /** Returns the largest value that the distribution can produce. */
    RealType max AUTOBOOST_PREVENT_MACRO_SUBSTITUTION () const { return _c; }
    ...
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, triangle_distribution, td)
    {
        os << td.param();
        return os;
    }
    ...
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, triangle_distribution, td)
    {
        param_type parm;
        if(is >> parm) {
            td.param(parm);
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(triangle_distribution, lhs, rhs)
    { return lhs._a == rhs._a && lhs._b == rhs._b && lhs._c == rhs._c; }
     ...
     * sequences of values given equal generators.
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(triangle_distribution)
...
#endif // AUTOBOOST_RANDOM_TRIANGLE_DISTRIBUTION_HPP
