/* autoboost random/lognormal_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_LOGNORMAL_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_LOGNORMAL_DISTRIBUTION_HPP

#include <autoboost/config/no_tr1/cmath.hpp>      // std::exp, std::sqrt
#include <cassert>
#include <iosfwd>
#include <istream>
 ...
 * autoboost::lognormal_distribution.  A backwards compatible
 * version is provided in namespace autoboost.
 * @endxmlwarning
 */
...
public:
    ...
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, lognormal_distribution, ld)
    {
        os << ld._normal;
        return os;
    }
    ...
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, lognormal_distribution, ld)
    {
        is >> ld._normal;
        return is;
    }
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(lognormal_distribution, lhs, rhs)
     ...
     * sequences of values given equal generators.
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(lognormal_distribution)
...
#endif // AUTOBOOST_RANDOM_LOGNORMAL_DISTRIBUTION_HPP
