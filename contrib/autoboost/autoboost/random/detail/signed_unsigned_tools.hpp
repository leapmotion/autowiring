...
#ifndef AUTOBOOST_RANDOM_DETAIL_SIGNED_UNSIGNED_TOOLS
#define AUTOBOOST_RANDOM_DETAIL_SIGNED_UNSIGNED_TOOLS
...
{
  typedef typename autoboost::random::traits::make_unsigned_or_unbounded<T>::type result_type;
...
#endif // AUTOBOOST_RANDOM_DETAIL_SIGNED_UNSIGNED_TOOLS
