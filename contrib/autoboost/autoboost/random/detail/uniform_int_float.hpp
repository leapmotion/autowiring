/* autoboost random/detail/uniform_int_float.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_DETAIL_UNIFORM_INT_FLOAT_HPP
#define AUTOBOOST_RANDOM_DETAIL_UNIFORM_INT_FLOAT_HPP
...
public:
    ...
    typedef typename autoboost::uint_t<
        (std::numeric_limits<autoboost::uintmax_t>::digits <
...
#endif // AUTOBOOST_RANDOM_DETAIL_UNIFORM_INT_FLOAT_HPP
