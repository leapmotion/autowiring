/* autoboost random/seed_seq.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_SEED_SEQ_HPP
#define AUTOBOOST_RANDOM_SEED_SEQ_HPP
...
class seed_seq {
public:
    typedef autoboost::uint_least32_t result_type;
    ...
    explicit seed_seq(const Range& range)
      : v(autoboost::begin(range), autoboost::end(range)) {}
