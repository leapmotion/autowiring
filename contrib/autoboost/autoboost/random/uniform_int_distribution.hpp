/* autoboost random/uniform_int_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_UNIFORM_INT_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_UNIFORM_INT_DISTRIBUTION_HPP
...
#include <autoboost/random/detail/uniform_int_float.hpp>
#include <autoboost/random/detail/signed_unsigned_tools.hpp>
#include <autoboost/random/traits.hpp>
#include <autoboost/mpl/bool.hpp>
#ifdef AUTOBOOST_NO_CXX11_EXPLICIT_CONVERSION_OPERATORS
...
T generate_uniform_int(
    ...
    autoboost::mpl::true_ /** is_integral<Engine::result_type> */)
{
    typedef T result_type;
    typedef typename autoboost::random::traits::make_unsigned_or_unbounded<T>::type range_type;
    typedef typename Engine::result_type base_result;
    // ranges are always unsigned or unbounded
    typedef typename autoboost::random::traits::make_unsigned_or_unbounded<base_result>::type base_unsigned;
...
inline T generate_uniform_int(
    Engine& eng, T min_value, T max_value,
    autoboost::mpl::false_ /** is_integral<Engine::result_type> */)
{
    uniform_int_float<Engine> wrapper(eng);
    return generate_uniform_int(wrapper, min_value, max_value, autoboost::mpl::true_());
}
...
inline T generate_uniform_int(Engine& eng, T min_value, T max_value)
{
    ...
    return generate_uniform_int(eng, min_value, max_value,
        autoboost::random::traits::is_integral<base_result>());
}
...
public:
    ...
    public:
        ...
        AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, param_type, parm)
        {
        ...
        AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, param_type, parm)
        {
        ...
        AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(param_type, lhs, rhs)
        { return lhs._min == rhs._min && lhs._max == rhs._max; }

        /** Returns true if the two sets of parameters are different. */
        AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(param_type)
    ...
    explicit uniform_int_distribution(
      ...
      : _min(min_arg), _max(max_arg)
    {
        AUTOBOOST_ASSERT(min_arg <= max_arg);
    }
    ...
    /**  Returns the minimum value of the distribution */
    IntType min AUTOBOOST_PREVENT_MACRO_SUBSTITUTION () const { return _min; }
    /**  Returns the maximum value of the distribution */
    IntType max AUTOBOOST_PREVENT_MACRO_SUBSTITUTION () const { return _max; }
    ...
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, uniform_int_distribution, ud)
    {
        os << ud.param();
        return os;
    }
    ...
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, uniform_int_distribution, ud)
    {
        param_type parm;
        if(is >> parm) {
            ud.param(parm);
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(uniform_int_distribution, lhs, rhs)
    { return lhs._min == rhs._min && lhs._max == rhs._max; }
     ...
     * of values given equal generators.
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(uniform_int_distribution)
...
#endif // AUTOBOOST_RANDOM_UNIFORM_INT_HPP
