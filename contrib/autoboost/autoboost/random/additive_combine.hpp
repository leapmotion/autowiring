/* autoboost random/additive_combine.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_ADDITIVE_COMBINE_HPP
#define AUTOBOOST_RANDOM_ADDITIVE_COMBINE_HPP
...
public:
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(additive_combine_engine,
     ...
     * @endxmlwarning
     */
    AUTOBOOST_RANDOM_DETAIL_SEED_SEQ_CONSTRUCTOR(additive_combine_engine,
        SeedSeq, seq)
    {
        _mlcg1.seed(seq);
        _mlcg2.seed(seq);
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_ARITHMETIC_SEED(additive_combine_engine,
        result_type, seed_arg)
    {
        _mlcg1.seed(seed_arg);
        _mlcg2.seed(seed_arg);
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_SEED_SEQ_SEED(additive_combine_engine,
        SeedSeq, seq)
    {
        _mlcg1.seed(seq);
        _mlcg2.seed(seq);
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, additive_combine_engine, r)
     ...
     * @c std::istream.
     */
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, additive_combine_engine, r)
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(additive_combine_engine, x, y)
    { return x._mlcg1 == y._mlcg1 && x._mlcg2 == y._mlcg2; }
    /**
     * Returns: true iff the two @c additive_combine_engines will
     * produce different sequences of values.
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(additive_combine_engine)
...
#endif // AUTOBOOST_RANDOM_ADDITIVE_COMBINE_HPP
