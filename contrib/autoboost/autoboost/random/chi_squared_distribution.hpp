/* autoboost random/chi_squared_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_CHI_SQUARED_DISTRIBUTION_HPP_INCLUDED
#define AUTOBOOST_RANDOM_CHI_SQUARED_DISTRIBUTION_HPP_INCLUDED
