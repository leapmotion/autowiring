/* autoboost random/exponential_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_EXPONENTIAL_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_EXPONENTIAL_DISTRIBUTION_HPP
...
public:
    ...
    public:
        ...
        param_type(RealType lambda_arg = RealType(1.0))
          : _lambda(lambda_arg) { AUTOBOOST_ASSERT(_lambda > RealType(0)); }
    ...
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, exponential_distribution, ed)
    {
        os << ed._lambda;
        return os;
    }
    ...
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, exponential_distribution, ed)
    {
        is >> ed._lambda;
        return is;
    }
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(exponential_distribution, lhs, rhs)
    { return lhs._lambda == rhs._lambda; }
     ...
     * sequences of values given equal generators.
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(exponential_distribution)
...
#endif // AUTOBOOST_RANDOM_EXPONENTIAL_DISTRIBUTION_HPP
