/* autoboost random/bernoulli_distribution.hpp header file
 *
...
#ifndef AUTOBOOST_RANDOM_BERNOULLI_DISTRIBUTION_HPP
#define AUTOBOOST_RANDOM_BERNOULLI_DISTRIBUTION_HPP
...
public:
    ...
    public:
        ...
        explicit param_type(RealType p_arg = RealType(0.5))
          : _p(p_arg)
        {
            AUTOBOOST_ASSERT(_p >= 0);
            AUTOBOOST_ASSERT(_p <= 1);
        }
    ...
    bool min AUTOBOOST_PREVENT_MACRO_SUBSTITUTION () const
    { return false; }
    /** Returns the largest value that the distribution can produce. */
    bool max AUTOBOOST_PREVENT_MACRO_SUBSTITUTION () const
    { return true; }
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, bernoulli_distribution, bd)
    {
        os << bd._p;
        return os;
    }
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, bernoulli_distribution, bd)
    {
        is >> bd._p;
        return is;
    }
     ...
     */
    AUTOBOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(bernoulli_distribution, lhs, rhs)
    { return lhs._p == rhs._p; }
     ...
     * sequences of values given equal generators.
     */
    AUTOBOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(bernoulli_distribution)
...
#endif // AUTOBOOST_RANDOM_BERNOULLI_DISTRIBUTION_HPP
