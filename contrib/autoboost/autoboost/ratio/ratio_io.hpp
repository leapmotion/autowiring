...
#ifndef AUTOBOOST_RATIO_RATIO_IO_HPP
#define AUTOBOOST_RATIO_RATIO_IO_HPP
...
#ifdef AUTOBOOST_RATIO_PROVIDES_DEPRECATED_FEATURES_SINCE_V2_0_0
#include <autoboost/ratio/detail/ratio_io.hpp>
#else
...
#if defined(AUTOBOOST_NO_CXX11_UNICODE_LITERALS) || defined(AUTOBOOST_NO_CXX11_CHAR16_T) || defined(AUTOBOOST_NO_CXX11_CHAR32_T) || defined(AUTOBOOST_NO_CXX11_U16STRING) || defined(AUTOBOOST_NO_CXX11_U32STRING)
#if defined AUTOBOOST_RATIO_HAS_UNICODE_SUPPORT
#undef AUTOBOOST_RATIO_HAS_UNICODE_SUPPORT
#endif
#else
#define AUTOBOOST_RATIO_HAS_UNICODE_SUPPORT 1
#endif
...
#ifdef AUTOBOOST_RATIO_HAS_STATIC_STRING
...
#if AUTOBOOST_RATIO_HAS_UNICODE_SUPPORT
...
#endif  // AUTOBOOST_RATIO_PROVIDES_DEPRECATED_FEATURES_SINCE_V2_0_0
#endif  // AUTOBOOST_RATIO_RATIO_IO_HPP
