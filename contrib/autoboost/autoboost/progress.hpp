//  autoboost progress.hpp header file  ------------------------------------------//
...
//   6 Jul 99  Initial autoboost version

#ifndef AUTOBOOST_PROGRESS_HPP
#define AUTOBOOST_PROGRESS_HPP

#include <autoboost/timer.hpp>
#include <autoboost/noncopyable.hpp>
#include <autoboost/cstdint.hpp>  // for uintmax_t
...
// NOTE: (Jan 12, 2001) Tried to change unsigned long to autoboost::uintmax_t, but
