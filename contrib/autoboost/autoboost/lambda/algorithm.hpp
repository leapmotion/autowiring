...
#ifndef AUTOBOOST_LAMBDA_ALGORITHM_HPP
#define AUTOBOOST_LAMBDA_ALGORITHM_HPP
...
struct for_each {
  ...
  template <class Args>
  struct sig {
    typedef typename autoboost::remove_const<
        typename autoboost::tuples::element<3, Args>::type
     >::type type;
  };
...
struct transform {
  ...
  struct sig {
    typedef typename autoboost::remove_const<
        typename autoboost::tuples::element<
          autoboost::tuples::length<Args>::value - 2,
          Args
      >::type
     >::type type;
  };
...
struct merge {
  ...
  struct sig {
    typedef typename autoboost::remove_const<
        typename autoboost::tuples::element<5, Args>::type
     >::type type;
  };
