...
#if !defined(AUTOBOOST_LAMBDA_EXCEPTIONS_HPP)
#define AUTOBOOST_LAMBDA_EXCEPTIONS_HPP
...
namespace {
  autoboost::lambda::placeholderE_type freeE;
  autoboost::lambda::placeholderE_type& _e = freeE;
}
...
>
{
  static const bool value =
    throws_for_sure_phase2<
      typename autoboost::tuples::element<0, Args>::type>::value
    ||
    (
       throws_for_sure_phase2<
         typename autoboost::tuples::element<1, Args>::type
       >::value
       &&
       throws_for_sure_phase2<
         typename autoboost::tuples::element<2, Args>::type
       >::value
    );
};
...
>
{
  static const bool value =
    throws_for_sure_phase2<
      typename autoboost::tuples::element<0, Args>::type
    >::value
    ||
    throws_for_sure_phase2<
      typename autoboost::tuples::element<1, Args>::type
...
struct return_or_throw_phase2 {
  ...
  static RET call(Arg& arg, CALL_FORMAL_ARGS) {
    AUTOBOOST_STATIC_ASSERT(throws_for_sure<Arg>::value);
  ...
  static RET call(Arg& arg, CALL_FORMAL_ARGS)
  {
    ...
    return
      return_or_throw_phase2<
        ::autoboost::is_convertible<RT, RET>::value
...
catch_exception(const lambda_functor<Arg>& a) {
  ...
  //    AUTOBOOST_STATIC_ASSERT((!has_placeholder<Arg, THIRD>::value));
  return
    tagged_lambda_functor<
      detail::exception_catch_tag<detail::catch_block<CatchType> >,
      lambda_functor<Arg>
...
// or the catch part throws for sure)
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    {
      return
       detail::return_or_throw<RET, typename ::autoboost::tuples::element<1, Args>::type>
               ::call(::autoboost::tuples::get<1>(args), CALL_ACTUAL_ARGS_NO_ENV, e);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    catch (...)
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<1, Args>::type>
               ::call(::autoboost::tuples::get<1>(args), CALL_ACTUAL_ARGS);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<2, Args>::type>
               ::call(::autoboost::tuples::get<2>(args), CALL_ACTUAL_ARGS_NO_ENV, e);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    catch (...)
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<2, Args>::type>
               ::call(::autoboost::tuples::get<2>(args), CALL_ACTUAL_ARGS);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<3, Args>::type>
               ::call(::autoboost::tuples::get<3>(args), CALL_ACTUAL_ARGS_NO_ENV, e);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    catch (...)
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<3, Args>::type>
               ::call(::autoboost::tuples::get<3>(args), CALL_ACTUAL_ARGS);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<4, Args>::type>
               ::call(::autoboost::tuples::get<4>(args), CALL_ACTUAL_ARGS_NO_ENV, e);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    catch (...)
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<4, Args>::type>
               ::call(::autoboost::tuples::get<4>(args), CALL_ACTUAL_ARGS);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    catch (Catch5& e)
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<4, Args>::type>
               ::call(::autoboost::tuples::get<5>(args), CALL_ACTUAL_ARGS_NO_ENV, e);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<5, Args>::type>
               ::call(::autoboost::tuples::get<5>(args), CALL_ACTUAL_ARGS);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<6, Args>::type>
               ::call(::autoboost::tuples::get<6>(args), CALL_ACTUAL_ARGS_NO_ENV, e);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    catch (...)
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<6, Args>::type>
               ::call(::autoboost::tuples::get<6>(args), CALL_ACTUAL_ARGS);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<7, Args>::type>
               ::call(::autoboost::tuples::get<7>(args), CALL_ACTUAL_ARGS_NO_ENV, e);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    catch (...)
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<7, Args>::type>
               ::call(::autoboost::tuples::get<7>(args), CALL_ACTUAL_ARGS);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<8, Args>::type>
               ::call(::autoboost::tuples::get<8>(args), CALL_ACTUAL_ARGS_NO_ENV, e);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    catch (...)
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<8, Args>::type>
               ::call(::autoboost::tuples::get<8>(args), CALL_ACTUAL_ARGS);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<9, Args>::type>
               ::call(::autoboost::tuples::get<9>(args), CALL_ACTUAL_ARGS_NO_ENV, e);
    }
  }
};
...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    ...
    catch (...)
    {
      return
        detail::return_or_throw<RET, typename ::autoboost::tuples::element<9, Args>::type>
               ::call(::autoboost::tuples::get<9>(args), CALL_ACTUAL_ARGS);
    }
  }
};
