...
#if !defined(AUTOBOOST_LAMBDA_CONSTRUCT_HPP)
#define AUTOBOOST_LAMBDA_CONSTRUCT_HPP
...
struct destructor_helper {
  ...
  static void exec(A1& a1) {
    ...
    typedef typename autoboost::remove_cv<A1>::type plainA1;
     a1.~plainA1();
  }
};
...
struct destructor {
  ...
  void operator()(A1& a1) const {
    typedef typename autoboost::remove_cv<A1>::type plainA1;
    detail::destructor_helper<autoboost::is_pointer<plainA1>::value>::exec(a1);
  }
};
