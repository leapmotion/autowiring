...
// #define AUTOBOOST_COMPILER_CONFIG <myheader>

// define this to locate a stdlib config file:
// #define AUTOBOOST_STDLIB_CONFIG   <myheader>

// define this to locate a platform config file:
// #define AUTOBOOST_PLATFORM_CONFIG <myheader>

// define this to disable compiler config,
// use if your compiler config has nothing to set:
// #define AUTOBOOST_NO_COMPILER_CONFIG

// define this to disable stdlib config,
// use if your stdlib config has nothing to set:
// #define AUTOBOOST_NO_STDLIB_CONFIG

// define this to disable platform config,
// use if your platform config has nothing to set:
// #define AUTOBOOST_NO_PLATFORM_CONFIG
...
// with the standard:
// #define AUTOBOOST_STRICT_CONFIG

// define this to cause the config to halt compilation
// with an #error if it encounters anything unknown --
// either an unknown compiler version or an unknown
// compiler/platform/library:
// #define AUTOBOOST_ASSERT_CONFIG
...
//
// -DAUTOBOOST_LIB_BUILDID = amd64
//
// to ensure the correct libraries are selected at link time.
// #define AUTOBOOST_LIB_BUILDID amd64
