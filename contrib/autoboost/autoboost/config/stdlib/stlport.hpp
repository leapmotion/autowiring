...
//
// __STL_STATIC_CONST_INIT_BUG implies AUTOBOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
#  if !(_STLPORT_VERSION >= 0x500) && !defined(_STLP_OWN_IOSTREAMS) && defined(_STLP_USE_NAMESPACES) && defined(AUTOBOOST_NO_USING_TEMPLATE) && !defined(__BORLANDC__)
#     define AUTOBOOST_NO_STD_LOCALE
#  endif
#else
#  if !defined(__SGI_STL_OWN_IOSTREAMS) && defined(__STL_USE_NAMESPACES) && defined(AUTOBOOST_NO_USING_TEMPLATE) && !defined(__BORLANDC__)
#     define AUTOBOOST_NO_STD_LOCALE
#  endif
#endif
...
#if defined(_STLP_NO_MEMBER_TEMPLATE_KEYWORD) && defined(AUTOBOOST_MSVC) && (AUTOBOOST_MSVC <= 1300)
#  define AUTOBOOST_NO_STD_ALLOCATOR
#endif
...
// but doesn't always get them all, define AUTOBOOST_NO_STDC_NAMESPACE, since our
...
#     define AUTOBOOST_NO_EXCEPTION_STD_NAMESPACE
#  endif
...
#  define AUTOBOOST_HAS_STLP_USE_FACET
#endif
...
//
#if !defined( _STLP_HAS_WCHAR_T) || defined(_STLP_WCHAR_T_IS_USHORT)
#  undef  AUTOBOOST_NO_INTRINSIC_WCHAR_T
...
#  define AUTOBOOST_USING_STD_MIN() ((void)0)
#  define AUTOBOOST_USING_STD_MAX() ((void)0)
namespace autoboost { using std::min; using std::max; }
#endif
