...
#  endif
#  if !(defined(_HAS_MEMBER_TEMPLATES_REBIND) && (_HAS_MEMBER_TEMPLATES_REBIND+0 > 0)) && !(defined(_MSC_VER) && (_MSC_VER > 1300)) && defined(AUTOBOOST_MSVC)
...
// and no <slist> at all
#else
#  define AUTOBOOST_MSVC_STD_ITERATOR 1
...
#  define AUTOBOOST_STD_EXTENSION_NAMESPACE stdext
#endif
...
#if ((!defined(_HAS_TR1_IMPORTS) || (_HAS_TR1_IMPORTS+0 == 0)) && !defined(AUTOBOOST_NO_CXX11_HDR_TUPLE)) \
...
#  define AUTOBOOST_NO_CXX11_HDR_ATOMIC
#endif
#ifndef AUTOBOOST_NO_CXX11_HDR_FUTURE
#  define AUTOBOOST_NO_CXX11_HDR_FUTURE
#endif
...
#  define AUTOBOOST_NO_CXX11_HDR_THREAD
#endif
#ifndef AUTOBOOST_NO_CXX14_HDR_SHARED_MUTEX
#  define AUTOBOOST_NO_CXX14_HDR_SHARED_MUTEX
#endif
#ifndef AUTOBOOST_NO_CXX14_STD_EXCHANGE
#  define AUTOBOOST_NO_CXX14_STD_EXCHANGE
#endif
#ifndef AUTOBOOST_NO_FENV_H
...
#else
#  define AUTOBOOST_DINKUMWARE_STDLIB 1
#endif

#ifdef _CPPLIB_VER
#  define AUTOBOOST_STDLIB "Dinkumware standard library version " AUTOBOOST_STRINGIZE(_CPPLIB_VER)
#else
#  define AUTOBOOST_STDLIB "Dinkumware standard library version 1.x"
#endif
