...
#ifdef __FreeBSD__
#define AUTOBOOST_PLATFORM "FreeBSD " AUTOBOOST_STRINGIZE(__FreeBSD__)
#elif defined(__NetBSD__)
#define AUTOBOOST_PLATFORM "NetBSD " AUTOBOOST_STRINGIZE(__NetBSD__)
#elif defined(__OpenBSD__)
#define AUTOBOOST_PLATFORM "OpenBSD " AUTOBOOST_STRINGIZE(__OpenBSD__)
#elif defined(__DragonFly__)
#define AUTOBOOST_PLATFORM "DragonFly " AUTOBOOST_STRINGIZE(__DragonFly__)
#endif
...
#  define AUTOBOOST_NO_CTYPE_FUNCTIONS
#endif
