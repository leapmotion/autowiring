...
//
// Helper macro AUTOBOOST_MSVC_FULL_VER for use in Boost code:
//
#if _MSC_FULL_VER > 100000000
#  define AUTOBOOST_MSVC_FULL_VER _MSC_FULL_VER
#else
#  define AUTOBOOST_MSVC_FULL_VER (_MSC_FULL_VER * 10)
#endif
...
// turned off:
//
#if !defined(_MSC_EXTENSIONS) && !defined(AUTOBOOST_DISABLE_WIN32)
#  define AUTOBOOST_DISABLE_WIN32
#endif
#if !defined(_CPPRTTI) && !defined(AUTOBOOST_NO_RTTI)
...
//
#if _MSC_VER >= 1700
// # define AUTOBOOST_HAS_TR1_HASH			// don't know if this is true yet.
// # define AUTOBOOST_HAS_TR1_TYPE_TRAITS	// don't know if this is true yet.
...
//
#ifdef _M_CEE
#ifndef AUTOBOOST_NO_CXX11_THREAD_LOCAL
#  define AUTOBOOST_NO_CXX11_THREAD_LOCAL
#endif
#ifndef AUTOBOOST_NO_SFINAE_EXPR
#  define AUTOBOOST_NO_SFINAE_EXPR
#endif
...
#endif
#ifdef _M_CEE_PURE
#ifndef AUTOBOOST_NO_CXX11_CONSTEXPR
#  define AUTOBOOST_NO_CXX11_CONSTEXPR
#endif
#endif
...
#  define AUTOBOOST_ABI_PREFIX "autoboost/config/abi/msvc_prefix.hpp"
#endif
#ifndef AUTOBOOST_ABI_SUFFIX
#  define AUTOBOOST_ABI_SUFFIX "autoboost/config/abi/msvc_suffix.hpp"
#endif
...
#      endif
#   elif _MSC_VER < 1500
#     define AUTOBOOST_COMPILER_VERSION evc8
#   elif _MSC_VER < 1600
#     define AUTOBOOST_COMPILER_VERSION evc9
#   elif _MSC_VER < 1700
#     define AUTOBOOST_COMPILER_VERSION evc10
#   elif _MSC_VER < 1800
#     define AUTOBOOST_COMPILER_VERSION evc11
#   elif _MSC_VER < 1900
#     define AUTOBOOST_COMPILER_VERSION evc12
#   elif _MSC_VER < 2000
#     define AUTOBOOST_COMPILER_VERSION evc14
#   else
#      if defined(AUTOBOOST_ASSERT_CONFIG)
#         error "Unknown EVC++ compiler version - please run the configure tests and report the results"
#      else
...
#     define AUTOBOOST_COMPILER_VERSION 5.0
#   elif _MSC_VER < 1300
#     define AUTOBOOST_COMPILER_VERSION 6.0
#   elif _MSC_VER < 1310
#     define AUTOBOOST_COMPILER_VERSION 7.0
#   elif _MSC_VER < 1400
#     define AUTOBOOST_COMPILER_VERSION 7.1
#   elif _MSC_VER < 1500
#     define AUTOBOOST_COMPILER_VERSION 8.0
#   elif _MSC_VER < 1600
#     define AUTOBOOST_COMPILER_VERSION 9.0
#   elif _MSC_VER < 1700
#     define AUTOBOOST_COMPILER_VERSION 10.0
#   elif _MSC_VER < 1800
#     define AUTOBOOST_COMPILER_VERSION 11.0
#   elif _MSC_VER < 1900
#     define AUTOBOOST_COMPILER_VERSION 12.0
#   elif _MSC_VER < 1910
#     define AUTOBOOST_COMPILER_VERSION 14.0
#   elif _MSC_VER < 1920
#     define AUTOBOOST_COMPILER_VERSION 14.1
#   else
#     define AUTOBOOST_COMPILER_VERSION _MSC_VER
#   endif
# endif

#  define AUTOBOOST_COMPILER "Microsoft Visual C++ version " AUTOBOOST_STRINGIZE(AUTOBOOST_COMPILER_VERSION)
#endif
