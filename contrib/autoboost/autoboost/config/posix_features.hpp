...
#     if defined(_POSIX_THREADS) && (_POSIX_THREADS+0 >= 0) && !defined(AUTOBOOST_HAS_WINTHREADS) && !defined(AUTOBOOST_HAS_MPTASKS)
#        define AUTOBOOST_HAS_PTHREADS
#     endif

      // AUTOBOOST_HAS_NANOSLEEP:
...
#     endif
      ...
      // AUTOBOOST_HAS_GETTIMEOFDAY:
      // AUTOBOOST_HAS_PTHREAD_MUTEXATTR_SETTYPE:
