...
==============================================================================*/
#if !defined(AUTOBOOST_FUSION_CATEGORY_OF_IMPL_20060217_2141)
#define AUTOBOOST_FUSION_CATEGORY_OF_IMPL_20060217_2141

#include <autoboost/fusion/support/config.hpp>
#include <autoboost/fusion/support/detail/mpl_iterator_category.hpp>
...
namespace autoboost { namespace fusion {
    ...
    namespace detail
    {
        ...
        struct mpl_sequence_category_of
        {
            ...
            AUTOBOOST_STATIC_ASSERT(mpl::is_sequence<T>::value);
            typedef typename 
