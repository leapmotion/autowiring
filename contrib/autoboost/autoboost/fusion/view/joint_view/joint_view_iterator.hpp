...
#include <autoboost/fusion/view/joint_view/detail/deref_impl.hpp>
#include <autoboost/fusion/view/joint_view/detail/next_impl.hpp>
#include <autoboost/fusion/view/joint_view/detail/value_of_impl.hpp>
#include <autoboost/fusion/view/joint_view/detail/deref_data_impl.hpp>
#include <autoboost/fusion/view/joint_view/detail/value_of_data_impl.hpp>
#include <autoboost/fusion/view/joint_view/detail/key_of_impl.hpp>
...
namespace autoboost { namespace fusion
{
        ...
        : iterator_base<joint_view_iterator<Category, First, Last, Concat> >
    {
        ...
        AUTOBOOST_STATIC_ASSERT((!result_of::equal_to<first_type, last_type>::value));
