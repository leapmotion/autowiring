...
#if !defined(AUTOBOOST_FUSION_ITERATOR_RANGE_VALUE_AT_IMPL_HPP_INCLUDED)
#define AUTOBOOST_FUSION_ITERATOR_RANGE_VALUE_AT_IMPL_HPP_INCLUDED

#include <autoboost/fusion/support/config.hpp>
#include <autoboost/fusion/iterator/advance.hpp>
