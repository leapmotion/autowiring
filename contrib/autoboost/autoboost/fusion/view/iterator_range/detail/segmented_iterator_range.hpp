...
==============================================================================*/
#if !defined(AUTOBOOST_FUSION_SEGMENTED_ITERATOR_RANGE_HPP_INCLUDED)
...
#include <autoboost/fusion/algorithm/transformation/push_back.hpp>
#include <autoboost/fusion/algorithm/transformation/push_front.hpp>
#include <autoboost/fusion/iterator/equal_to.hpp>
#include <autoboost/fusion/container/list/detail/reverse_cons.hpp>
#include <autoboost/fusion/iterator/detail/segment_sequence.hpp>
