...
#include <autoboost/fusion/container/list/cons_iterator.hpp>
#include <autoboost/fusion/container/list/detail/begin_impl.hpp>
#include <autoboost/fusion/container/list/detail/end_impl.hpp>
#include <autoboost/fusion/container/list/detail/at_impl.hpp>
#include <autoboost/fusion/container/list/detail/value_at_impl.hpp>
#include <autoboost/fusion/container/list/detail/empty_impl.hpp>
...
namespace autoboost { namespace fusion
{
    ...
    struct cons : sequence_base<cons<Car, Cdr> >
    {
        ...
        template <typename Sequence>
        AUTOBOOST_FUSION_GPU_ENABLED
        typename autoboost::disable_if<is_convertible<Sequence, Car>, cons&>::type
