...
#include <autoboost/fusion/support/detail/pp_round.hpp>
...
#define FUSION_MAX_VECTOR_SIZE_STR AUTOBOOST_PP_STRINGIZE(AUTOBOOST_FUSION_PP_ROUND_UP(FUSION_MAX_VECTOR_SIZE))
