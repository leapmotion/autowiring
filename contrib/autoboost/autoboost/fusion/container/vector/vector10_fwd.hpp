...
==============================================================================*/
#if !defined(AUTOBOOST_FUSION_VECTOR10_FWD_HPP_INCLUDED)
#define AUTOBOOST_FUSION_VECTOR10_FWD_HPP_INCLUDED
...
#include <autoboost/fusion/container/vector/detail/preprocessed/vector10_fwd.hpp>
#else
...
namespace autoboost { namespace fusion
{
    ...
    #define AUTOBOOST_PP_FILENAME_1 <autoboost/fusion/container/vector/vector10_fwd.hpp>
