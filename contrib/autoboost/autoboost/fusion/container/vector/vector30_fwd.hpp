...
==============================================================================*/
#if !defined(AUTOBOOST_FUSION_VECTOR30_FWD_HPP_INCLUDED)
#define AUTOBOOST_FUSION_VECTOR30_FWD_HPP_INCLUDED
...
#include <autoboost/fusion/container/vector/detail/preprocessed/vector30_fwd.hpp>
#else
...
namespace autoboost { namespace fusion
{
    ...
    #define AUTOBOOST_PP_FILENAME_1 <autoboost/fusion/container/vector/vector30_fwd.hpp>
    #define AUTOBOOST_PP_ITERATION_LIMITS (21, 30)
