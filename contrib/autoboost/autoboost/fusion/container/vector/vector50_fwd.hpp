...
==============================================================================*/
#if !defined(AUTOBOOST_FUSION_VECTOR50_FWD_HPP_INCLUDED)
#define AUTOBOOST_FUSION_VECTOR50_FWD_HPP_INCLUDED
...
#include <autoboost/fusion/container/vector/detail/preprocessed/vector50_fwd.hpp>
#else
...
namespace autoboost { namespace fusion
{
    ...
    #define AUTOBOOST_PP_FILENAME_1 <autoboost/fusion/container/vector/vector50_fwd.hpp>
