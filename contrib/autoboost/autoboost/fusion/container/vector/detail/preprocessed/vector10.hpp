...
# endif
        ...
        vector1(
            Sequence const& seq
          , typename autoboost::disable_if<is_convertible<Sequence, T0> >::type* = 0
            )
        ...
        AUTOBOOST_FUSION_GPU_ENABLED typename add_reference<T0>::type at_impl(mpl::int_<0>) { return this->m0; } AUTOBOOST_FUSION_GPU_ENABLED typename add_reference<typename add_const<T0>::type>::type at_impl(mpl::int_<0>) const { return this->m0; }
        template<typename I>
        AUTOBOOST_FUSION_GPU_ENABLED
