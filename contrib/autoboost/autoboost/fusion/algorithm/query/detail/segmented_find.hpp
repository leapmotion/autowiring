...
==============================================================================*/
#if !defined(AUTOBOOST_FUSION_SEGMENTED_FIND_HPP_INCLUDED)
#define AUTOBOOST_FUSION_SEGMENTED_FIND_HPP_INCLUDED

#include <autoboost/fusion/support/config.hpp>
#include <autoboost/mpl/eval_if.hpp>
#include <autoboost/mpl/identity.hpp>
#include <autoboost/fusion/algorithm/query/find_fwd.hpp>
