...
==============================================================================*/
#if !defined(AUTOBOOST_FUSION_SEGMENTED_FOR_EACH_HPP_INCLUDED)
#define AUTOBOOST_FUSION_SEGMENTED_FOR_EACH_HPP_INCLUDED

#include <autoboost/fusion/support/config.hpp>
#include <autoboost/mpl/bool.hpp>
#include <autoboost/fusion/support/void.hpp>
#include <autoboost/fusion/algorithm/iteration/for_each_fwd.hpp>
