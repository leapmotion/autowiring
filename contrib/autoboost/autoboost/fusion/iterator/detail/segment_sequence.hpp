...
==============================================================================*/
#if !defined(AUTOBOOST_FUSION_SEGMENTED_SEQUENCE_HPP_INCLUDED)
#define AUTOBOOST_FUSION_SEGMENTED_SEQUENCE_HPP_INCLUDED
...
namespace autoboost { namespace fusion { namespace detail
{
        ...
        : sequence_base<segment_sequence<Sequence> >
    {
        ...
        AUTOBOOST_FUSION_GPU_ENABLED explicit segment_sequence(Sequence const & seq)
            : sequence(seq)
        {}
    };
}
