...
==============================================================================*/
#if !defined(AUTOBOOST_FUSION_SEGMENTED_ITERATOR_SEGMENTED_ITERATOR_HPP_INCLUDED)
#define AUTOBOOST_FUSION_SEGMENTED_ITERATOR_SEGMENTED_ITERATOR_HPP_INCLUDED

#include <autoboost/fusion/support/config.hpp>
#include <autoboost/mpl/bool.hpp>
#include <autoboost/fusion/sequence/intrinsic_fwd.hpp>
#include <autoboost/fusion/iterator/iterator_facade.hpp>
...
#include <autoboost/fusion/iterator/detail/segmented_equal_to.hpp>
...
namespace autoboost { namespace fusion
{
    ...
    {
        AUTOBOOST_FUSION_GPU_ENABLED explicit segmented_iterator(Context const& ctx)
          : context(ctx)
        {}
