...
==============================================================================*/
#if !defined(AUTOBOOST_FUSION_SEGMENTED_FOLD_UNTIL_HPP_INCLUDED)
#define AUTOBOOST_FUSION_SEGMENTED_FOLD_UNTIL_HPP_INCLUDED
...
#include <autoboost/fusion/support/detail/segmented_fold_until_impl.hpp>
