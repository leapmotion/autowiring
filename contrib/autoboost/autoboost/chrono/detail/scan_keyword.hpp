...
#ifndef AUTOBOOST_CHRONO_DETAIL_SCAN_KEYWORD_HPP
#define AUTOBOOST_CHRONO_DETAIL_SCAN_KEYWORD_HPP
               ...
               )
{
    ...
    // Error: Could not find a match for autoboost::interprocess::unique_ptr<unsigned char, void(*)(void*)>::unique_ptr(int, extern "C" void(void*))
...
#endif // AUTOBOOST_CHRONO_DETAIL_SCAN_KEYWORD_HPP
