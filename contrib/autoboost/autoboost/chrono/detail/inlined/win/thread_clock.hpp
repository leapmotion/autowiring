...
//--------------------------------------------------------------------------------------//
#ifndef AUTOBOOST_CHRONO_DETAIL_INLINED_WIN_THREAD_CLOCK_HPP
#define AUTOBOOST_CHRONO_DETAIL_INLINED_WIN_THREAD_CLOCK_HPP
...
thread_clock::time_point thread_clock::now() AUTOBOOST_NOEXCEPT
{
