...
#ifndef AUTOBOOST_CHRONO_PROCESS_CPU_CLOCKS_HPP
#define AUTOBOOST_CHRONO_PROCESS_CPU_CLOCKS_HPP
...
namespace autoboost { namespace chrono {
    ...
    class AUTOBOOST_CHRONO_DECL process_real_cpu_clock {
    public:
...
#if ! AUTOBOOST_OS_WINDOWS || AUTOBOOST_PLAT_WINDOWS_DESKTOP
    class AUTOBOOST_CHRONO_DECL process_user_cpu_clock {
    public:
        typedef nanoseconds                          duration;
        typedef duration::rep                        rep;
        typedef duration::period                     period;
    ...
    class AUTOBOOST_CHRONO_DECL process_system_cpu_clock {
    public:
        typedef nanoseconds                          duration;
        typedef duration::rep                        rep;
        typedef duration::period                     period;
...
namespace chrono
{
  ...
  typedef process_times<nanoseconds::rep> process_cpu_clock_times;
#if ! AUTOBOOST_OS_WINDOWS || AUTOBOOST_PLAT_WINDOWS_DESKTOP
    class AUTOBOOST_CHRONO_DECL process_cpu_clock
    {
    public:

        typedef process_cpu_clock_times times;
        typedef autoboost::chrono::duration<times,  nano>                duration;
        typedef duration::rep                       rep;
        typedef duration::period                    period;
    ...
    public:
        ...
        static Res max AUTOBOOST_PREVENT_MACRO_SUBSTITUTION ()
        {
          return Res((std::numeric_limits<Rep>::max)(),
                      (std::numeric_limits<Rep>::max)(),
                      (std::numeric_limits<Rep>::max)());
        }
        static Res min AUTOBOOST_PREVENT_MACRO_SUBSTITUTION ()
        {
...
namespace std {
    ...
    template <typename Rep>
    struct numeric_limits<autoboost::chrono::process_times<Rep> >
    {
        typedef autoboost::chrono::process_times<Rep> Res;
...
#else
#include <autoboost/chrono/detail/inlined/process_cpu_clocks.hpp>
#endif
#endif

#endif  // AUTOBOOST_CHRONO_PROCESS_CPU_CLOCKS_HPP
