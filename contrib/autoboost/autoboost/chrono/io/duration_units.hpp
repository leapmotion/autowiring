...
#ifndef AUTOBOOST_CHRONO_IO_DURATION_UNITS_HPP
#define AUTOBOOST_CHRONO_IO_DURATION_UNITS_HPP

#include <autoboost/chrono/config.hpp>
#include <autoboost/ratio/ratio_io.hpp>
#include <autoboost/chrono/duration.hpp>
#include <autoboost/chrono/io/duration_style.hpp>
  ...
  namespace chrono
  {
    ...
    protected:
      ...
      bool do_is_named_unit(rt_ratio rt) const
      {
        if (rt.num==1) {
          switch (rt.den)
          {
          case AUTOBOOST_RATIO_INTMAX_C(1):
          case AUTOBOOST_RATIO_INTMAX_C(10):
          case AUTOBOOST_RATIO_INTMAX_C(100):
          case AUTOBOOST_RATIO_INTMAX_C(1000):
          case AUTOBOOST_RATIO_INTMAX_C(1000000):
          case AUTOBOOST_RATIO_INTMAX_C(1000000000):
          case AUTOBOOST_RATIO_INTMAX_C(1000000000000):
          case AUTOBOOST_RATIO_INTMAX_C(1000000000000000):
          case AUTOBOOST_RATIO_INTMAX_C(1000000000000000000):
            return true;
          default:
            return false;
          }
          ...
          {
          case AUTOBOOST_RATIO_INTMAX_C(10):
          case AUTOBOOST_RATIO_INTMAX_C(60):
          case AUTOBOOST_RATIO_INTMAX_C(100):
          case AUTOBOOST_RATIO_INTMAX_C(1000):
          case AUTOBOOST_RATIO_INTMAX_C(3600):
          case AUTOBOOST_RATIO_INTMAX_C(1000000):
          case AUTOBOOST_RATIO_INTMAX_C(1000000000):
          case AUTOBOOST_RATIO_INTMAX_C(1000000000000):
          case AUTOBOOST_RATIO_INTMAX_C(1000000000000000):
      ...
      string_type do_get_unit(duration_style style, rt_ratio rt, intmax_t v) const
      {
        ...
        AUTOBOOST_ASSERT(false&&"ratio parameter can not be translated");
        //throw "exception";
        return string_type();
      }
    ...
    protected:
      ...
      static string_type static_get_unit(duration_style style, ratio<1> , std::size_t pf)
      {
        ...
        AUTOBOOST_ASSERT(false&&"style/pf parameters not valid");
        //throw "exception";
        return string_type();
      }
