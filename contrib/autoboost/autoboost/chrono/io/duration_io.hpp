...
#ifndef AUTOBOOST_CHRONO_IO_DURATION_IO_HPP
#define AUTOBOOST_CHRONO_IO_DURATION_IO_HPP
...
#include <autoboost/chrono/io/duration_put.hpp>
#include <autoboost/chrono/io/duration_get.hpp>
...
namespace autoboost
{
  namespace chrono
  {
    ...
    public:
       ...
       */
      explicit duration_fmt(duration_style style)AUTOBOOST_NOEXCEPT
      : style_(style)
      {}
    ...
    typename autoboost::enable_if_c< ! duration_put_enabled<Rep>::value, std::basic_ostream<CharT, Traits>& >::type
