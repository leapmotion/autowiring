 ...
 */
#ifndef AUTOBOOST_CHRONO_IO_DURATION_PUT_HPP
#define AUTOBOOST_CHRONO_IO_DURATION_PUT_HPP

#include <autoboost/chrono/config.hpp>
#include <autoboost/chrono/io/duration_units.hpp>
...
namespace autoboost
{
  namespace chrono
  {
    ...
    namespace detail
    {
      ...
      template <>
      struct propagate<autoboost::int_least32_t> {
        typedef autoboost::int_least64_t type;
      };
    }
    /**
