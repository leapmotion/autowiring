...
#ifndef AUTOBOOST_CHRONO_TIME_POINT_HPP
#define AUTOBOOST_CHRONO_TIME_POINT_HPP
...
//----------------------------------------------------------------------------//
    ...
    class time_point
    {
        AUTOBOOST_CHRONO_STATIC_ASSERT(autoboost::chrono::detail::is_duration<Duration>::value,
                AUTOBOOST_CHRONO_SECOND_TEMPLATE_PARAMETER_OF_TIME_POINT_MUST_BE_A_AUTOBOOST_CHRONO_DURATION, (Duration));
    public:
        typedef Clock                     clock;
    ...
    public:
        ...
        time_point(const time_point<clock, Duration2>& t
                ...
                <
                    autoboost::is_convertible<Duration2, duration>
                >::type* = 0
        )
        ...
        static AUTOBOOST_CHRONO_LIB_CONSTEXPR time_point
        min AUTOBOOST_PREVENT_MACRO_SUBSTITUTION ()
        {
            return time_point((duration::min)());
        }
        static AUTOBOOST_CHRONO_LIB_CONSTEXPR time_point
        max AUTOBOOST_PREVENT_MACRO_SUBSTITUTION ()
        {
...
#endif // AUTOBOOST_CHRONO_TIME_POINT_HPP
