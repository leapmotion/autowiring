...
#ifndef AUTOBOOST_CHRONO_IO_V1_CHRONO_IO_HPP
#define AUTOBOOST_CHRONO_IO_V1_CHRONO_IO_HPP
...
#include <autoboost/integer/common_factor_rt.hpp>
#include <autoboost/chrono/detail/scan_keyword.hpp>
#include <autoboost/utility/enable_if.hpp>
#include <autoboost/chrono/detail/no_warning/signed_unsigned_cmp.hpp>
...
private:
    ...
    template <class Period>
        string_type short_name(Period) const
            {return ::autoboost::ratio_string<Period, CharT>::short_name() + short_seconds_;}
    ...
    template <class Period>
        string_type long_name(Period) const
            {return ::autoboost::ratio_string<Period, CharT>::long_name() + long_seconds_;}
