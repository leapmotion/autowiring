...
#ifndef AUTOBOOST_XTIME_WEK070601_HPP
#define AUTOBOOST_XTIME_WEK070601_HPP
...
struct xtime
{
    ...
    {
        return autoboost::posix_time::from_time_t(0)+
            autoboost::posix_time::seconds(static_cast<long>(sec))+
#ifdef AUTOBOOST_DATE_TIME_HAS_NANOSECONDS
            autoboost::posix_time::nanoseconds(nsec);
#else
        autoboost::posix_time::microseconds((nsec+500)/1000);
#endif
    }

};

inline xtime get_xtime(autoboost::system_time const& abs_time)
{
    xtime res;
...
#endif
#endif //AUTOBOOST_XTIME_WEK070601_HPP
