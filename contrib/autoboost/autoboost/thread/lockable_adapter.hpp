...
#ifndef AUTOBOOST_THREAD_LOCKABLE_ADAPTER_HPP
#define AUTOBOOST_THREAD_LOCKABLE_ADAPTER_HPP
...
namespace autoboost
{
  ...
  public:
    ...
    AUTOBOOST_THREAD_NO_COPYABLE( basic_lockable_adapter) /*< no copyable >*/
