...
#ifndef AUTOBOOST_THREAD_EXECUTORS_EXECUTOR_HPP
#define AUTOBOOST_THREAD_EXECUTORS_EXECUTOR_HPP
...
namespace autoboost
{
  ...
  public:
    ...
    AUTOBOOST_THREAD_NO_COPYABLE(executor)
    executor() {}
     ...
     */
    virtual void submit(AUTOBOOST_THREAD_RV_REF(work) closure) = 0;
