#ifndef AUTOBOOST_THREAD_ONCE_HPP
#define AUTOBOOST_THREAD_ONCE_HPP
...
#include <autoboost/thread/win32/once.hpp>
#elif defined(AUTOBOOST_THREAD_PLATFORM_PTHREAD)
#if defined AUTOBOOST_THREAD_ONCE_FAST_EPOCH
#include <autoboost/thread/pthread/once.hpp>
#elif defined AUTOBOOST_THREAD_ONCE_ATOMIC
#include <autoboost/thread/pthread/once_atomic.hpp>
#else
