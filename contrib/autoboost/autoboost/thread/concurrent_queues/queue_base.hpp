...
namespace detail
{
  ...
  public:
    ...
    virtual void push(AUTOBOOST_THREAD_RV_REF(value_type) x) = 0;
    virtual queue_op_status try_push(AUTOBOOST_THREAD_RV_REF(value_type) x) = 0;
    virtual queue_op_status nonblocking_push(AUTOBOOST_THREAD_RV_REF(value_type) x) = 0;
    virtual queue_op_status wait_push(AUTOBOOST_THREAD_RV_REF(value_type) x) = 0;
  };
