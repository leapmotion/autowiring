#ifndef AUTOBOOST_THREAD_CONCURRENT_QUEUES_SYNC_DEQUE_HPP
#define AUTOBOOST_THREAD_CONCURRENT_QUEUES_SYNC_DEQUE_HPP
...
namespace concurrent
{
  ...
  public:
    ...
    AUTOBOOST_THREAD_NO_COPYABLE(sync_deque)
    inline sync_deque();
...
//  }
  ...
  template <class ValueType, class Container>
  queue_op_status sync_deque<ValueType, Container>::try_push_back(AUTOBOOST_THREAD_RV_REF(ValueType) elem, unique_lock<mutex>& lk)
  {
    if (super::closed(lk)) return queue_op_status::closed;
  ...
  template <class ValueType, class Container>
  queue_op_status sync_deque<ValueType, Container>::try_push_back(AUTOBOOST_THREAD_RV_REF(ValueType) elem)
  {
    unique_lock<mutex> lk(super::mtx_);
  ...
  template <class ValueType, class Container>
  queue_op_status sync_deque<ValueType, Container>::wait_push_back(AUTOBOOST_THREAD_RV_REF(ValueType) elem, unique_lock<mutex>& lk)
  {
    if (super::closed(lk)) return queue_op_status::closed;
    push_back(autoboost::move(elem), lk);
    return queue_op_status::success;
  ...
  template <class ValueType, class Container>
  queue_op_status sync_deque<ValueType, Container>::wait_push_back(AUTOBOOST_THREAD_RV_REF(ValueType) elem)
  {
    unique_lock<mutex> lk(super::mtx_);
  ...
  template <class ValueType, class Container>
  queue_op_status sync_deque<ValueType, Container>::nonblocking_push_back(AUTOBOOST_THREAD_RV_REF(ValueType) elem)
  {
    unique_lock<mutex> lk(super::mtx_, try_to_lock);
    if (!lk.owns_lock())
    {
  ...
  template <class ValueType, class Container>
  void sync_deque<ValueType, Container>::push_back(AUTOBOOST_THREAD_RV_REF(ValueType) elem)
  {
      unique_lock<mutex> lk(super::mtx_);
      super::throw_if_closed(lk);
      push_back(autoboost::move(elem), lk);
  ...
  template <class ValueType, class Container>
  sync_deque<ValueType, Container>& operator<<(sync_deque<ValueType, Container>& sbq, AUTOBOOST_THREAD_RV_REF(ValueType) elem)
  {
