...
#ifndef AUTOBOOST_THREAD_FUTURES_WAIT_FOR_ALL_HPP
#define AUTOBOOST_THREAD_FUTURES_WAIT_FOR_ALL_HPP
...
namespace autoboost
{
  ...
  typename autoboost::disable_if<is_future_type<Iterator>,void>::type wait_for_all(Iterator begin,Iterator end)
  {
    ...
    typename autoboost::enable_if<is_future_type<F1>,void>::type wait_for_all(F1& f1, Fs&... fs)
    {
