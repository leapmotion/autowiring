...
#ifndef AUTOBOOST_THREAD_POLY_SHARED_LOCKABLE_ADAPTER_HPP
#define AUTOBOOST_THREAD_POLY_SHARED_LOCKABLE_ADAPTER_HPP

#include <autoboost/thread/poly_lockable_adapter.hpp>
#include <autoboost/thread/poly_shared_lockable.hpp>
