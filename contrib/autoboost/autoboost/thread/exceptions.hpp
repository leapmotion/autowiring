...
#ifndef AUTOBOOST_THREAD_EXCEPTIONS_PDM070801_H
#define AUTOBOOST_THREAD_EXCEPTIONS_PDM070801_H
...
namespace autoboost
{
    ...
    class AUTOBOOST_SYMBOL_VISIBLE thread_interrupted
    {};
#endif

    class AUTOBOOST_SYMBOL_VISIBLE thread_exception:
    ...
    class AUTOBOOST_SYMBOL_VISIBLE condition_error:
        public system::system_error
        //public std::exception
    {
          typedef system::system_error base_type;
    ...
    class AUTOBOOST_SYMBOL_VISIBLE lock_error:
        public thread_exception
    {
          typedef thread_exception base_type;
    public:
        lock_error()
        : base_type(0, "autoboost::lock_error")
        {}

        lock_error( int ev )
        : base_type(ev, "autoboost::lock_error")
        {
        }
    ...
    class AUTOBOOST_SYMBOL_VISIBLE thread_resource_error:
        public thread_exception
    {
          typedef thread_exception base_type;
    public:
          thread_resource_error()
          : base_type(static_cast<int>(system::errc::resource_unavailable_try_again), "autoboost::thread_resource_error")
          {}

          thread_resource_error( int ev )
          : base_type(ev, "autoboost::thread_resource_error")
          {
          }
    ...
    class AUTOBOOST_SYMBOL_VISIBLE unsupported_thread_option:
        public thread_exception
    {
          typedef thread_exception base_type;
    public:
          unsupported_thread_option()
          : base_type(static_cast<int>(system::errc::invalid_argument), "autoboost::unsupported_thread_option")
          {}

          unsupported_thread_option( int ev )
          : base_type(ev, "autoboost::unsupported_thread_option")
          {
          }
    ...
    class AUTOBOOST_SYMBOL_VISIBLE invalid_thread_argument:
        public thread_exception
    {
          typedef thread_exception base_type;
    public:
        invalid_thread_argument()
        : base_type(static_cast<int>(system::errc::invalid_argument), "autoboost::invalid_thread_argument")
        {}

        invalid_thread_argument( int ev )
        : base_type(ev, "autoboost::invalid_thread_argument")
        {
        }
    ...
    class AUTOBOOST_SYMBOL_VISIBLE thread_permission_error:
        public thread_exception
    {
          typedef thread_exception base_type;
    public:
          thread_permission_error()
          : base_type(static_cast<int>(system::errc::permission_denied), "autoboost::thread_permission_error")
          {}

          thread_permission_error( int ev )
          : base_type(ev, "autoboost::thread_permission_error")
          {
          }
