#ifndef AUTOBOOST_THREAD_PTHREAD_SHARED_MUTEX_HPP
#define AUTOBOOST_THREAD_PTHREAD_SHARED_MUTEX_HPP
...
namespace autoboost
{
    ...
    private:
        ...
        public:
            ...
            {
                AUTOBOOST_ASSERT( ! exclusive );
                AUTOBOOST_ASSERT( ! upgrade );
                AUTOBOOST_ASSERT( shared_count==0 );
            }
            ...
            void assert_lock_shared () const
            {
                AUTOBOOST_ASSERT( ! exclusive );
                AUTOBOOST_ASSERT( shared_count>0 );
                //AUTOBOOST_ASSERT( (! upgrade) || (shared_count>1));
        ...
        state_data state;
        autoboost::mutex state_change;
        autoboost::condition_variable shared_cond;
        autoboost::condition_variable exclusive_cond;
        autoboost::condition_variable upgrade_cond;
    ...
    public:
        ...
        AUTOBOOST_THREAD_NO_COPYABLE(shared_mutex)
        ...
        {
#if defined AUTOBOOST_THREAD_PROVIDES_INTERRUPTIONS
            autoboost::this_thread::disable_interruption do_not_disturb;
#endif
            autoboost::unique_lock<autoboost::mutex> lk(state_change);
