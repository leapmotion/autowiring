#ifndef AUTOBOOST_THREAD_PTHREAD_ONCE_ATOMIC_HPP
#define AUTOBOOST_THREAD_PTHREAD_ONCE_ATOMIC_HPP
...
namespace autoboost
{
  ...
  namespace thread_detail
  {
    ...
    typedef autoboost::atomic<atomic_int_type> atomic_type;
    ...
    inline atomic_type& get_atomic_storage(once_flag& flag)  AUTOBOOST_NOEXCEPT;
  }
  ...
  struct once_flag
  {
    ...
    AUTOBOOST_CONSTEXPR once_flag() AUTOBOOST_NOEXCEPT : storage(0)
    {
    }
  ...
  private:
    ...
    friend AUTOBOOST_THREAD_DECL bool thread_detail::enter_once_region(once_flag& flag) AUTOBOOST_NOEXCEPT;
    friend AUTOBOOST_THREAD_DECL void thread_detail::commit_once_region(once_flag& flag) AUTOBOOST_NOEXCEPT;
    friend AUTOBOOST_THREAD_DECL void thread_detail::rollback_once_region(once_flag& flag) AUTOBOOST_NOEXCEPT;
    friend thread_detail::atomic_type& thread_detail::get_atomic_storage(once_flag& flag) AUTOBOOST_NOEXCEPT;
  };

#define AUTOBOOST_ONCE_INIT autoboost::once_flag()
  ...
  struct once_flag
  {
    ...
    AUTOBOOST_THREAD_ATTRIBUTE_MAY_ALIAS thread_detail::atomic_int_type storage;
  };

  #define AUTOBOOST_ONCE_INIT {0}
