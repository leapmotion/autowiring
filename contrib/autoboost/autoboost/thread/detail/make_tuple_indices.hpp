...
#ifndef AUTOBOOST_THREAD_DETAIL_MAKE_TUPLE_INDICES_HPP
#define AUTOBOOST_THREAD_DETAIL_MAKE_TUPLE_INDICES_HPP
...
namespace autoboost
{
  namespace detail
  {
    ...
    {
      AUTOBOOST_STATIC_ASSERT_MSG(Sp <= Ep, "make_tuple_indices input error");
