...
#ifndef AUTOBOOST_THREAD_POLY_LOCKABLE_ADAPTER_HPP
#define AUTOBOOST_THREAD_POLY_LOCKABLE_ADAPTER_HPP

#include <autoboost/thread/poly_lockable.hpp>
...
namespace autoboost
{
  ...
  public:
    ...
    AUTOBOOST_THREAD_NO_COPYABLE( poly_basic_lockable_adapter) /*< no copyable >*/
