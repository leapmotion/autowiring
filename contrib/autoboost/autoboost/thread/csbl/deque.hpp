...
//            _Ty=non_copyable
//        ]
#if defined AUTOBOOST_THREAD_USES_AUTOBOOST_DEQUE || defined AUTOBOOST_NO_CXX11_HDR_DEQUE || defined AUTOBOOST_NO_CXX11_RVALUE_REFERENCES || (defined _MSC_VER && _MSC_FULL_VER < 180020827)
