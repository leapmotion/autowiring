...
struct allocator_traits
{
   ...
   template<class T>
   static void destroy(Allocator &a, T*p) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   static size_type max_size(const Allocator &a) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   //! otherwise, a.
   static AUTOBOOST_CONTAINER_DOC1ST(Allocator,
   ...
   select_on_container_copy_construction(const Allocator &a)
   {
      ...
      static void construct(Allocator & a, T* p, AUTOBOOST_FWD_REF(Args)... args)
      {
   ...
   //! <code>false</code>.
   static bool storage_is_unpropagable(const Allocator &a, pointer p) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   //! <code>a == b</code>.
   static bool equal(const Allocator &a, const Allocator &b) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   template<class T>
   static void priv_destroy(container_detail::true_type, Allocator &a, T* p) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  a.destroy(p);  }

   template<class T>
   static void priv_destroy(container_detail::false_type, Allocator &, T* p) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  p->~T(); (void)p;  }

   static size_type priv_max_size(container_detail::true_type, const Allocator &a) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return a.max_size();  }

   static size_type priv_max_size(container_detail::false_type, const Allocator &) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return size_type(-1)/sizeof(value_type);  }

   static Allocator priv_select_on_container_copy_construction(container_detail::true_type, const Allocator &a)
   {  return a.select_on_container_copy_construction();  }

   static const Allocator &priv_select_on_container_copy_construction(container_detail::false_type, const Allocator &a) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return a;  }

   #if !defined(AUTOBOOST_NO_CXX11_VARIADIC_TEMPLATES)
      template<class T, class ...Args>
      static void priv_construct(container_detail::true_type, Allocator &a, T *p, AUTOBOOST_FWD_REF(Args) ...args)
      {  a.construct( p, ::autoboost::forward<Args>(args)...);  }

      template<class T, class ...Args>
      static void priv_construct(container_detail::false_type, Allocator &, T *p, AUTOBOOST_FWD_REF(Args) ...args)
      ...
      static void construct(Allocator &a, T *p AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_UREF##N)\
      {\
         static const bool value = ::autoboost::move_detail::and_ \
            < container_detail::is_not_std_allocator<Allocator> \
            , autoboost::container::container_detail::has_member_function_callable_with_construct \
      ...
      template<class T AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_CLASS##N >\
      static void priv_construct(container_detail::true_type, Allocator &a, T *p AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_UREF##N)\
      {  a.construct( p AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_FWD##N );  }\
      \
      template<class T AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_CLASS##N >\
      static void priv_construct(container_detail::false_type, Allocator &, T *p AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_UREF##N)\
   ...
   template<class T>
   static void priv_construct(container_detail::false_type, Allocator &, T *p, const ::autoboost::container::default_init_t&)
