...
AUTOBOOST_CONTAINER_FORCEINLINE static D &force(const S &s)
{  return *const_cast<D*>((reinterpret_cast<const D*>(&s))); }

template<class D, class S>
AUTOBOOST_CONTAINER_FORCEINLINE static D force_copy(S s)
{
...
class flat_map
{
   ...
   flat_map()  AUTOBOOST_NOEXCEPT_IF(container_detail::is_nothrow_default_constructible<Allocator>::value &&
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE std::pair<iterator, bool> insert_or_assign(const key_type& k, AUTOBOOST_FWD_REF(M) obj)
   {
      return container_detail::force_copy< std::pair<iterator, bool> >
         (this->m_flat_tree.insert_or_assign
            ( impl_const_iterator(), k, ::autoboost::forward<M>(obj))
         );
   }
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE std::pair<iterator, bool> insert_or_assign(AUTOBOOST_RV_REF(key_type) k, AUTOBOOST_FWD_REF(M) obj)
   {
      return container_detail::force_copy< std::pair<iterator, bool> >
         (this->m_flat_tree.insert_or_assign
            ( impl_const_iterator(), ::autoboost::move(k), ::autoboost::forward<M>(obj))
         );
   }
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE iterator insert_or_assign(const_iterator hint, AUTOBOOST_RV_REF(key_type) k, AUTOBOOST_FWD_REF(M) obj)
   {
      return container_detail::force_copy< std::pair<iterator, bool> >
         (this->m_flat_tree.insert_or_assign
            ( container_detail::force_copy<impl_const_iterator>(hint)
            , ::autoboost::move(k), ::autoboost::forward<M>(obj))
         );
   }
   ...
   {
      return container_detail::force_copy< std::pair<iterator, bool> >(
         m_flat_tree.try_emplace(impl_const_iterator(), k, autoboost::forward<Args>(args)...));
   }
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE iterator try_emplace(const_iterator hint, const key_type &k, AUTOBOOST_FWD_REF(Args)... args)
   {
      return container_detail::force_copy<iterator>(m_flat_tree.try_emplace
         (container_detail::force_copy<impl_const_iterator>(hint), k, autoboost::forward<Args>(args)...).first);
   }
   ...
   {
      return container_detail::force_copy< std::pair<iterator, bool> >
         (m_flat_tree.try_emplace(impl_const_iterator(), autoboost::move(k), autoboost::forward<Args>(args)...));
   }
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE iterator try_emplace(const_iterator hint, AUTOBOOST_RV_REF(key_type) k, AUTOBOOST_FWD_REF(Args)... args)
   {
      return container_detail::force_copy<iterator>
         (m_flat_tree.try_emplace(container_detail::force_copy
            <impl_const_iterator>(hint), autoboost::move(k), autoboost::forward<Args>(args)...).first);
   }
   ...
   {\
      return container_detail::force_copy< std::pair<iterator, bool> >\
         (m_flat_tree.try_emplace(impl_const_iterator(), k AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_FWD##N));\
   }\
   \
   AUTOBOOST_MOVE_TMPL_LT##N AUTOBOOST_MOVE_CLASS##N AUTOBOOST_MOVE_GT##N \
   ...
   {  return container_detail::force_copy<iterator>(m_flat_tree.try_emplace\
         (container_detail::force_copy<impl_const_iterator>(hint), k AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_FWD##N).first); }\
   \
   AUTOBOOST_MOVE_TMPL_LT##N AUTOBOOST_MOVE_CLASS##N AUTOBOOST_MOVE_GT##N \
   ...
   {\
      return container_detail::force_copy< std::pair<iterator, bool> >\
         (m_flat_tree.try_emplace(impl_const_iterator(), autoboost::move(k) AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_FWD##N));\
   }\
   \
   AUTOBOOST_MOVE_TMPL_LT##N AUTOBOOST_MOVE_CLASS##N AUTOBOOST_MOVE_GT##N \
   ...
   {  return container_detail::force_copy<iterator>(m_flat_tree.try_emplace\
      (container_detail::force_copy<impl_const_iterator>(hint), autoboost::move(k) AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_FWD##N).first); }\
   //
   ...
   template<class C2>
   AUTOBOOST_CONTAINER_FORCEINLINE void merge(flat_map<Key, T, C2, Allocator>& source)
   {  m_flat_tree.merge_unique(source.tree());   }

   //! @copydoc ::autoboost::container::flat_map::merge(flat_map<Key, T, C2, Allocator>&)
   template<class C2>
   AUTOBOOST_CONTAINER_FORCEINLINE void merge(AUTOBOOST_RV_REF_BEG flat_map<Key, T, C2, Allocator> AUTOBOOST_RV_REF_END source)
   {  return this->merge(static_cast<flat_map<Key, T, C2, Allocator>&>(source)); }

   //! @copydoc ::autoboost::container::flat_map::merge(flat_map<Key, T, C2, Allocator>&)
   template<class C2>
   AUTOBOOST_CONTAINER_FORCEINLINE void merge(flat_multimap<Key, T, C2, Allocator>& source)
   {  m_flat_tree.merge_unique(source.tree());   }

   //! @copydoc ::autoboost::container::flat_map::merge(flat_map<Key, T, C2, Allocator>&)
   template<class C2>
   AUTOBOOST_CONTAINER_FORCEINLINE void merge(AUTOBOOST_RV_REF_BEG flat_multimap<Key, T, C2, Allocator> AUTOBOOST_RV_REF_END source)
...
class flat_multimap
{
   ...
   //!
   //! <b>Complexity</b>: Constant.
   flat_multimap() AUTOBOOST_NOEXCEPT_IF(container_detail::is_nothrow_default_constructible<Allocator>::value &&
                                     container_detail::is_nothrow_default_constructible<Compare>::value)
      : m_flat_tree()
   {
      //value_type must be std::pair<Key, T>
   ...
   template<class C2>
   void merge(AUTOBOOST_RV_REF_BEG flat_multimap<Key, T, C2, Allocator> AUTOBOOST_RV_REF_END source)
   {  return this->merge(static_cast<flat_multimap<Key, T, C2, Allocator>&>(source)); }
   ...
   //! @copydoc ::autoboost::container::flat_multimap::merge(flat_multimap<Key, T, C2, Allocator>&)
   template<class C2>
   void merge(AUTOBOOST_RV_REF_BEG flat_map<Key, T, C2, Allocator> AUTOBOOST_RV_REF_END source)
   {  return this->merge(static_cast<flat_map<Key, T, C2, Allocator>&>(source)); }
