      ...
      <Allocator, typename container_detail::intrusive_slist_type<Allocator>::type>
{
   ...
   //!
   //! <b>Complexity</b>: Constant.
   slist(AUTOBOOST_RV_REF(slist) x)
   ...
   {  this->emplace_after(this->cbefore_begin(), autoboost::forward<Args>(args)...); }
   ...
   {  this->emplace_after(this->cbefore_begin() AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_FWD##N);}\
   \
   AUTOBOOST_MOVE_TMPL_LT##N AUTOBOOST_MOVE_CLASS##N AUTOBOOST_MOVE_GT##N \
