...
#ifndef AUTOBOOST_CONTAINER_SET_HPP
#define AUTOBOOST_CONTAINER_SET_HPP
   ...
   ///@endcond
{
   ...
   private:
   AUTOBOOST_COPYABLE_AND_MOVABLE(set)
   ...
   typedef typename AUTOBOOST_CONTAINER_IMPDEF(base_t::node_type)                          node_type;
   typedef typename AUTOBOOST_CONTAINER_IMPDEF(base_t::insert_return_type)                 insert_return_type;
   ...
   set() AUTOBOOST_NOEXCEPT_IF(container_detail::is_nothrow_default_constructible<Allocator>::value &&
   ...
   set(AUTOBOOST_RV_REF(set) x, const allocator_type &a)
   ...
   //!
   //! <b>Complexity</b>: Linear in x.size().
   set& operator=(AUTOBOOST_COPY_ASSIGN_REF(set) x)
   ...
   set& operator=(AUTOBOOST_RV_REF(set) x)
   ...
   {  return static_cast<set&>(this->base_t::operator=(AUTOBOOST_MOVE_BASE(base_t, x)));  }
   ...
   #define AUTOBOOST_CONTAINER_SET_EMPLACE_CODE(N) \
   ...
   //
   AUTOBOOST_MOVE_ITERATE_0TO9(AUTOBOOST_CONTAINER_SET_EMPLACE_CODE)
   #undef AUTOBOOST_CONTAINER_SET_EMPLACE_CODE
   ...
   //! @copydoc ::autoboost::container::map::insert(node_type&&)
   insert_return_type insert(AUTOBOOST_RV_REF_BEG_IF_CXX11 node_type AUTOBOOST_RV_REF_END_IF_CXX11 nh)
   {  return this->base_t::insert_unique_node(autoboost::move(nh));  }

   //! @copydoc ::autoboost::container::map::insert(const_iterator, node_type&&)
   insert_return_type insert(const_iterator hint, AUTOBOOST_RV_REF_BEG_IF_CXX11 node_type AUTOBOOST_RV_REF_END_IF_CXX11 nh)
   {  return this->base_t::insert_unique_node(hint, autoboost::move(nh));  }

   //! @copydoc ::autoboost::container::map::merge(map<Key, T, C2, Allocator, Options>&)
   template<class C2>
   AUTOBOOST_CONTAINER_FORCEINLINE void merge(set<Key, C2, Allocator, Options>& source)
   {
      typedef container_detail::tree
   ...
   //! @copydoc ::autoboost::container::set::merge(set<Key, C2, Allocator, Options>&)
   template<class C2>
   AUTOBOOST_CONTAINER_FORCEINLINE void merge(AUTOBOOST_RV_REF_BEG set<Key, C2, Allocator, Options> AUTOBOOST_RV_REF_END source)
   {  return this->merge(static_cast<set<Key, C2, Allocator, Options>&>(source));   }

   //! @copydoc ::autoboost::container::map::merge(multimap<Key, T, C2, Allocator, Options>&)
   template<class C2>
   AUTOBOOST_CONTAINER_FORCEINLINE void merge(multiset<Key, C2, Allocator, Options>& source)
   {
      typedef container_detail::tree
         <Key, container_detail::identity<Key>, C2, Allocator, Options> base2_t;
      this->base_t::merge_unique(static_cast<base2_t&>(source));
   ...
   //! @copydoc ::autoboost::container::set::merge(multiset<Key, C2, Allocator, Options>&)
   template<class C2>
   AUTOBOOST_CONTAINER_FORCEINLINE void merge(AUTOBOOST_RV_REF_BEG multiset<Key, C2, Allocator, Options> AUTOBOOST_RV_REF_END source)
...
struct has_trivial_destructor_after_move<autoboost::container::set<Key, Compare, Allocator, Options> >
{
   typedef typename ::autoboost::container::allocator_traits<Allocator>::pointer pointer;
   ...
   /// @endcond
{
   #ifndef AUTOBOOST_CONTAINER_DOXYGEN_INVOKED
   private:
   AUTOBOOST_COPYABLE_AND_MOVABLE(multiset)
   typedef container_detail::tree
      <Key,container_detail::identity<Key>, Compare, Allocator, Options> base_t;
   #endif   //#ifndef AUTOBOOST_CONTAINER_DOXYGEN_INVOKED
   ...
   //! @copydoc ::autoboost::container::set::set()
   multiset() AUTOBOOST_NOEXCEPT_IF(container_detail::is_nothrow_default_constructible<Allocator>::value &&
                                container_detail::is_nothrow_default_constructible<Compare>::value)
      : base_t()
   {}

   //! @copydoc ::autoboost::container::set::set(const Compare&, const allocator_type&)
   explicit multiset(const Compare& comp,
                     const allocator_type& a = allocator_type())
      : base_t(comp, a)
   {}

   //! @copydoc ::autoboost::container::set::set(const allocator_type&)
   explicit multiset(const allocator_type& a)
      : base_t(a)
   {}

   //! @copydoc ::autoboost::container::set::set(InputIterator, InputIterator, const Compare& comp, const allocator_type&)
   template <class InputIterator>
   ...
   //! @copydoc ::autoboost::container::set::set(InputIterator, InputIterator, const allocator_type&)
   template <class InputIterator>
...
#if !defined(AUTOBOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::autoboost::container::set::set(std::initializer_list<value_type>, const Compare& comp, const allocator_type&)
   multiset(std::initializer_list<value_type> il, const Compare& comp = Compare(), const allocator_type& a = allocator_type())
      : base_t(false, il.begin(), il.end(), comp, a)
   {}

   //! @copydoc ::autoboost::container::set::set(std::initializer_list<value_type>, const allocator_type&)
   multiset(std::initializer_list<value_type> il, const allocator_type& a)
      : base_t(false, il.begin(), il.end(), Compare(), a)
   {}

   //! @copydoc ::autoboost::container::set::set(ordered_unique_range_t, std::initializer_list<value_type>, const Compare& comp, const allocator_type&)
   ...
   //! @copydoc ::autoboost::container::set::set(const set &)
   multiset(const multiset& x)
      : base_t(static_cast<const base_t&>(x))
   {}

   //! @copydoc ::autoboost::container::set::set(set &&)
   multiset(AUTOBOOST_RV_REF(multiset) x)
      AUTOBOOST_NOEXCEPT_IF(autoboost::container::container_detail::is_nothrow_move_constructible<Compare>::value)
      : base_t(AUTOBOOST_MOVE_BASE(base_t, x))
   {}

   //! @copydoc ::autoboost::container::set::set(const set &, const allocator_type &)
   multiset(const multiset& x, const allocator_type &a)
      : base_t(static_cast<const base_t&>(x), a)
   {}

   //! @copydoc ::autoboost::container::set::set(set &&, const allocator_type &)
   multiset(AUTOBOOST_RV_REF(multiset) x, const allocator_type &a)
      : base_t(AUTOBOOST_MOVE_BASE(base_t, x), a)
   {}

   //! @copydoc ::autoboost::container::set::operator=(const set &)
   multiset& operator=(AUTOBOOST_COPY_ASSIGN_REF(multiset) x)
   {  return static_cast<multiset&>(this->base_t::operator=(static_cast<const base_t&>(x)));  }

   //! @copydoc ::autoboost::container::set::operator=(set &&)
   multiset& operator=(AUTOBOOST_RV_REF(multiset) x)
      AUTOBOOST_NOEXCEPT_IF( (allocator_traits_type::propagate_on_container_move_assignment::value ||
                          allocator_traits_type::is_always_equal::value) &&
                           autoboost::container::container_detail::is_nothrow_move_assignable<Compare>::value)
   {  return static_cast<multiset&>(this->base_t::operator=(AUTOBOOST_MOVE_BASE(base_t, x)));  }

#if !defined(AUTOBOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::autoboost::container::set::operator=(std::initializer_list<value_type>)
   ...
   #define AUTOBOOST_CONTAINER_MULTISET_EMPLACE_CODE(N) \
   AUTOBOOST_MOVE_TMPL_LT##N AUTOBOOST_MOVE_CLASS##N AUTOBOOST_MOVE_GT##N \
   ...
   //
   AUTOBOOST_MOVE_ITERATE_0TO9(AUTOBOOST_CONTAINER_MULTISET_EMPLACE_CODE)
   #undef AUTOBOOST_CONTAINER_MULTISET_EMPLACE_CODE
...
#if !defined(AUTOBOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::autoboost::container::set::insert(std::initializer_list<value_type>)
   void insert(std::initializer_list<value_type> il)
   {  this->base_t::insert_equal(il.begin(), il.end());  }
#endif

   //! @copydoc ::autoboost::container::multimap::insert(node_type&&)
   iterator insert(AUTOBOOST_RV_REF_BEG_IF_CXX11 node_type AUTOBOOST_RV_REF_END_IF_CXX11 nh)
   {  return this->base_t::insert_equal_node(autoboost::move(nh));  }

   //! @copydoc ::autoboost::container::multimap::insert(const_iterator, node_type&&)
   iterator insert(const_iterator hint, AUTOBOOST_RV_REF_BEG_IF_CXX11 node_type AUTOBOOST_RV_REF_END_IF_CXX11 nh)
   {  return this->base_t::insert_equal_node(hint, autoboost::move(nh));  }
   ...
   //! @copydoc ::autoboost::container::multiset::merge(multiset<Key, C2, Allocator, Options>&)
   template<class C2>
   AUTOBOOST_CONTAINER_FORCEINLINE void merge(AUTOBOOST_RV_REF_BEG multiset<Key, C2, Allocator, Options> AUTOBOOST_RV_REF_END source)
   {  return this->merge(static_cast<multiset<Key, C2, Allocator, Options>&>(source));   }

   //! @copydoc ::autoboost::container::multimap::merge(map<Key, T, C2, Allocator, Options>&)
   template<class C2>
   AUTOBOOST_CONTAINER_FORCEINLINE void merge(set<Key, C2, Allocator, Options>& source)
   {
      typedef container_detail::tree
   ...
   //! @copydoc ::autoboost::container::multiset::merge(set<Key, C2, Allocator, Options>&)
   template<class C2>
   AUTOBOOST_CONTAINER_FORCEINLINE void merge(AUTOBOOST_RV_REF_BEG set<Key, C2, Allocator, Options> AUTOBOOST_RV_REF_END source)
   {  return this->merge(static_cast<set<Key, C2, Allocator, Options>&>(source));   }
   ...
   //! @copydoc ::autoboost::container::set::find(const key_type& )
   iterator find(const key_type& x);

   //! @copydoc ::autoboost::container::set::find(const key_type& ) const
   const_iterator find(const key_type& x) const;

   //! @copydoc ::autoboost::container::set::count(const key_type& ) const
   size_type count(const key_type& x) const;

   //! @copydoc ::autoboost::container::set::lower_bound(const key_type& )
   iterator lower_bound(const key_type& x);

   //! @copydoc ::autoboost::container::set::lower_bound(const key_type& ) const
   const_iterator lower_bound(const key_type& x) const;

   //! @copydoc ::autoboost::container::set::upper_bound(const key_type& )
   iterator upper_bound(const key_type& x);

   //! @copydoc ::autoboost::container::set::upper_bound(const key_type& ) const
   const_iterator upper_bound(const key_type& x) const;

   //! @copydoc ::autoboost::container::set::equal_range(const key_type& ) const
   std::pair<const_iterator, const_iterator> equal_range(const key_type& x) const;

   //! @copydoc ::autoboost::container::set::equal_range(const key_type& )
   std::pair<iterator,iterator> equal_range(const key_type& x);

   //! @copydoc ::autoboost::container::set::rebalance()
   void rebalance();
...
//!specialization for optimizations
template <class Key, class Compare, class Allocator, class Options>
struct has_trivial_destructor_after_move<autoboost::container::multiset<Key, Compare, Allocator, Options> >
{
   typedef typename ::autoboost::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::autoboost::has_trivial_destructor_after_move<Allocator>::value &&
                             ::autoboost::has_trivial_destructor_after_move<pointer>::value &&
...
#endif   // AUTOBOOST_CONTAINER_SET_HPP
