...
//! \tparam SetOptions is an packed option type generated using using autoboost::container::tree_assoc_options.
...
struct has_trivial_destructor_after_move<autoboost::container::set<Key, Compare, Allocator, SetOptions> >
{
   typedef typename ::autoboost::container::allocator_traits<Allocator>::pointer pointer;
...
//! \tparam Compare is the comparison functor used to order keys
//! \tparam Allocator is the allocator to be used to allocate memory for this container
//! \tparam MultiSetOptions is an packed option type generated using using autoboost::container::tree_assoc_options.
...
//!specialization for optimizations
template <class Key, class Compare, class Allocator, class MultiSetOptions>
struct has_trivial_destructor_after_move<autoboost::container::multiset<Key, Compare, Allocator, MultiSetOptions> >
{
   typedef typename ::autoboost::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::autoboost::has_trivial_destructor_after_move<Allocator>::value &&
                             ::autoboost::has_trivial_destructor_after_move<pointer>::value &&
