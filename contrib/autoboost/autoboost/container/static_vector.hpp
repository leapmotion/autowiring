...
class static_storage_allocator
{
   ...
   static_storage_allocator() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {}

   static_storage_allocator(const static_storage_allocator &) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {}

   static_storage_allocator & operator=(const static_storage_allocator &) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return *this;  }

   T* internal_storage() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return const_cast<T*>(static_cast<const T*>(static_cast<const void*>(&storage)));  }

   T* internal_storage() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   friend bool operator==(const static_storage_allocator &, const static_storage_allocator &) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return false;  }
...
public:
    ...
    //! @par Complexity
    //!   Constant O(1).
    static_vector() AUTOBOOST_NOEXCEPT_OR_NOTHROW
        : base_t()
    {}
    ...
    //! @par Complexity
    //!   Linear O(N).
    static_vector(AUTOBOOST_RV_REF(static_vector) other)
    ...
    //!   Linear O(N).
    template <std::size_t C>
    static_vector(AUTOBOOST_RV_REF_BEG static_vector<value_type, C> AUTOBOOST_RV_REF_END other)
    ...
    //! @par Complexity
    //! Linear O(N).
    static_vector & operator=(AUTOBOOST_COPY_ASSIGN_REF(static_vector) other)
    {
    ...
    //! @par Complexity
    //!   Linear O(N).
    static_vector & operator=(AUTOBOOST_RV_REF(static_vector) other)
    {
    ...
    //!   Linear O(N).
    template <std::size_t C>
    static_vector & operator=(AUTOBOOST_RV_REF_BEG static_vector<value_type, C> AUTOBOOST_RV_REF_END other)
    {
        return static_cast<static_vector&>(base_t::operator=
