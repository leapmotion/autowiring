...
#ifndef AUTOBOOST_CONTAINER_STATIC_VECTOR_HPP
#define AUTOBOOST_CONTAINER_STATIC_VECTOR_HPP
...
class static_storage_allocator
{
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE static_storage_allocator() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {}

   AUTOBOOST_CONTAINER_FORCEINLINE static_storage_allocator(const static_storage_allocator &) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {}

   AUTOBOOST_CONTAINER_FORCEINLINE static_storage_allocator & operator=(const static_storage_allocator &) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return *this;  }

   AUTOBOOST_CONTAINER_FORCEINLINE T* internal_storage() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return const_cast<T*>(static_cast<const T*>(static_cast<const void*>(&storage)));  }

   AUTOBOOST_CONTAINER_FORCEINLINE T* internal_storage() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   typedef autoboost::container::container_detail::version_type<static_storage_allocator, 0>   version;

   AUTOBOOST_CONTAINER_FORCEINLINE friend bool operator==(const static_storage_allocator &, const static_storage_allocator &) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return false;  }
...
//!
//!static_vector is a sequence container like autoboost::container::vector with contiguous storage that can
//!change in size, along with the static allocation, low overhead, and fixed capacity of autoboost::array.
//!
    ...
    : public vector<Value, container_detail::static_storage_allocator<Value, Capacity> >
{
   ...
   AUTOBOOST_COPYABLE_AND_MOVABLE(static_vector)
...
public:
    ...
    //! @par Complexity
    //!   Constant O(1).
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector() AUTOBOOST_NOEXCEPT_OR_NOTHROW
        : base_t()
    {}
    ...
    //! @par Complexity
    //!   Linear O(N).
    AUTOBOOST_CONTAINER_FORCEINLINE explicit static_vector(size_type count)
        : base_t(count)
    {}
    ...
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector(size_type count, default_init_t)
    ...
    //! @par Complexity
    //!   Linear O(N).
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector(size_type count, value_type const& value)
        : base_t(count, value)
    {}
    ...
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector(Iterator first, Iterator last)
        : base_t(first, last)
    {}
    ...
    //! @par Complexity
    //!   Linear O(N).
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector(std::initializer_list<value_type> il)
        : base_t(il)
    {}
#endif
    ...
    //! @par Complexity
    //!   Linear O(N).
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector(static_vector const& other)
        : base_t(other)
    {}
    ...
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector(static_vector<value_type, C> const& other)
        : base_t(other)
    {}
    ...
    //! @par Complexity
    //!   Linear O(N).
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector(AUTOBOOST_RV_REF(static_vector) other)
      AUTOBOOST_NOEXCEPT_IF(autoboost::container::container_detail::is_nothrow_move_constructible<value_type>::value)
        : base_t(AUTOBOOST_MOVE_BASE(base_t, other))
    {}
    ...
    //!   Linear O(N).
    template <std::size_t C>
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector(AUTOBOOST_RV_REF_BEG static_vector<value_type, C> AUTOBOOST_RV_REF_END other)
        : base_t(AUTOBOOST_MOVE_BASE(typename static_vector<value_type AUTOBOOST_MOVE_I C>::base_t, other))
    {}
    ...
    //! @par Complexity
    //! Linear O(N).
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector & operator=(AUTOBOOST_COPY_ASSIGN_REF(static_vector) other)
    {
    ...
    //! @par Complexity
    //! Linear O(N).
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector & operator=(std::initializer_list<value_type> il)
    ...
    //!   Linear O(N).
    template <std::size_t C>
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector & operator=(static_vector<value_type, C> const& other)
    {
    ...
    //! @par Complexity
    //!   Linear O(N).
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector & operator=(AUTOBOOST_RV_REF(static_vector) other)
    {
        return static_cast<static_vector&>(base_t::operator=(AUTOBOOST_MOVE_BASE(base_t, other)));
    }
    ...
    //!   Linear O(N).
    template <std::size_t C>
    AUTOBOOST_CONTAINER_FORCEINLINE static_vector & operator=(AUTOBOOST_RV_REF_BEG static_vector<value_type, C> AUTOBOOST_RV_REF_END other)
    {
        return static_cast<static_vector&>(base_t::operator=
         (AUTOBOOST_MOVE_BASE(typename static_vector<value_type AUTOBOOST_MOVE_I C>::base_t, other)));
    }
    ...
    //! @par Complexity
    //!   Linear O(N).
    void reserve(size_type count)  AUTOBOOST_NOEXCEPT_OR_NOTHROW;
    ...
    //! @par Complexity
    //!   Constant O(1).
    void push_back(AUTOBOOST_RV_REF(value_type) value);
    ...
    //! @par Complexity
    //!   Constant or linear.
    iterator insert(const_iterator p, AUTOBOOST_RV_REF(value_type) value);
    ...
    //! @par Complexity
    //!   Constant O(1).
    Value * data() AUTOBOOST_NOEXCEPT_OR_NOTHROW;
    ...
    //! @par Complexity
    //!   Constant O(1).
    const Value * data() const AUTOBOOST_NOEXCEPT_OR_NOTHROW;
    ...
    //! @par Complexity
    //!   Constant O(1).
    static size_type capacity() AUTOBOOST_NOEXCEPT_OR_NOTHROW;
    ...
    //! @par Complexity
    //!   Constant O(1).
    static size_type max_size() AUTOBOOST_NOEXCEPT_OR_NOTHROW;
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE friend void swap(static_vector &x, static_vector &y)
   {
      x.swap(y);
   }
...
#endif // AUTOBOOST_CONTAINER_STATIC_VECTOR_HPP
