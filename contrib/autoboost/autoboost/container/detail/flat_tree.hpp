...
class flat_tree
{
 ...
 private:
   ...
   flat_tree(AUTOBOOST_RV_REF(flat_tree) x)
   ...
   flat_tree(AUTOBOOST_RV_REF(flat_tree) x, const allocator_type &a)
   ...
   flat_tree&  operator=(AUTOBOOST_COPY_ASSIGN_REF(flat_tree) x)
   {  m_data = x.m_data;   return *this;  }

   flat_tree&  operator=(AUTOBOOST_RV_REF(flat_tree) x)
   ...
   //
   AUTOBOOST_MOVE_ITERATE_0TO9(AUTOBOOST_CONTAINER_FLAT_TREE_EMPLACE_CODE)
...
class Compare, class Allocator>
struct has_trivial_destructor_after_move<autoboost::container::container_detail::flat_tree<Key, T, KeyOfValue, Compare, Allocator> >
{
