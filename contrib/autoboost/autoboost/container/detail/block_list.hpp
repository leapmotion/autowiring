...
#ifndef AUTOBOOST_CONTAINER_DETAIL_BLOCK_LIST_HEADER
#define AUTOBOOST_CONTAINER_DETAIL_BLOCK_LIST_HEADER
...
class block_list_base
{
   ...
   void deallocate(void *p, memory_resource &mr) AUTOBOOST_NOEXCEPT
   {
...
#endif   //AUTOBOOST_CONTAINER_DETAIL_BLOCK_LIST_HEADER
