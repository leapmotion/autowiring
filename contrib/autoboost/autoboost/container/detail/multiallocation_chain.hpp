...
class basic_multiallocation_chain
{
   ...
   basic_multiallocation_chain(AUTOBOOST_RV_REF(basic_multiallocation_chain) other)
      :  slist_impl_(::autoboost::move(other.slist_impl_))
   {}

   basic_multiallocation_chain& operator=(AUTOBOOST_RV_REF(basic_multiallocation_chain) other)
   {
      slist_impl_ = ::autoboost::move(other.slist_impl_);
      return *this;
   }
   ...
   {
      typedef typename autoboost::intrusive::pointer_traits<char_ptr> char_pointer_traits;
...
{
   private:
   AUTOBOOST_MOVABLE_BUT_NOT_COPYABLE(transform_multiallocation_chain)
   ...
   transform_multiallocation_chain(AUTOBOOST_RV_REF(transform_multiallocation_chain) other)
      : MultiallocationChain(::autoboost::move(static_cast<MultiallocationChain&>(other)))
   {}

   transform_multiallocation_chain(AUTOBOOST_RV_REF(MultiallocationChain) other)
      : MultiallocationChain(::autoboost::move(static_cast<MultiallocationChain&>(other)))
   {}

   transform_multiallocation_chain& operator=(AUTOBOOST_RV_REF(transform_multiallocation_chain) other)
   {
      return static_cast<MultiallocationChain&>
         (this->MultiallocationChain::operator=(::autoboost::move(static_cast<MultiallocationChain&>(other))));
   }
/*
...
#endif   //AUTOBOOST_CONTAINER_DETAIL_MULTIALLOCATION_CHAIN_HPP
