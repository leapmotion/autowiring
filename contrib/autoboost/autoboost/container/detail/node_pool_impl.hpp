...
//
//////////////////////////////////////////////////////////////////////////////
#ifndef AUTOBOOST_CONTAINER_DETAIL_NODE_POOL_IMPL_HPP
#define AUTOBOOST_CONTAINER_DETAIL_NODE_POOL_IMPL_HPP
...
class private_node_pool_impl
{
   ...
   void deallocate_free_blocks()
   {
      ...
      AUTOBOOST_ASSERT(m_freelist.empty());
   ...
   void purge_blocks()
   {
      ...
      AUTOBOOST_ASSERT(m_allocated==0);
      size_type blocksize = (get_rounded_size)
         (m_real_node_size*m_nodes_per_block, (size_type)alignment_of<node_t>::value);
   ...
   {
      AUTOBOOST_ASSERT(m_nodes_per_block == other.m_nodes_per_block);
