...
#ifndef AUTOBOOST_CONTAINER_DETAIL_VARIADIC_TEMPLATES_TOOLS_HPP
#define AUTOBOOST_CONTAINER_DETAIL_VARIADIC_TEMPLATES_TOOLS_HPP
   ...
   : private tuple<Tail...>
{
   ...
   tuple(U &&u, Args && ...args)
      : inherited(::autoboost::forward<Args>(args)...), m_head(::autoboost::forward<U>(u))
   {}
...
{ return tuple<Values&&...>(::autoboost::forward<Values>(values)...); }
...
#endif   //#ifndef AUTOBOOST_CONTAINER_DETAIL_VARIADIC_TEMPLATES_TOOLS_HPP
