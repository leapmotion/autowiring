...
#define AUTOBOOST_CONTAINER_DESTROYERS_HPP
...
struct scoped_deallocator
{
   ...
   AUTOBOOST_MOVABLE_BUT_NOT_COPYABLE(scoped_deallocator)
   ...
   scoped_deallocator(AUTOBOOST_RV_REF(scoped_deallocator) o)
...
{
   typedef autoboost::container::allocator_traits<Allocator> AllocTraits;
...
{
   typedef autoboost::container::allocator_traits<A> AllocTraits;
   public:
...
#endif   //#ifndef AUTOBOOST_CONTAINER_DESTROYERS_HPP
