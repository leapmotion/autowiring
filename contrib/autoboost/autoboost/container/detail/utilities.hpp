...
template<class T, bool IsClass = autoboost::is_class<T>::value >
struct has_member_swap
{
   static const bool value = autoboost::container::container_detail::
...
template<class T> inline
typename container_detail::enable_if_c
      <!container_swap::has_member_swap<T>::value/* && autoboost::has_move_emulation_enabled<T>::value*/, void>::type
   swap_dispatch(T &left, T &right)
{
   T temp(autoboost::move(left)); // may throw
   left = autoboost::move(right); // may throw
   right = autoboost::move(temp); // may throw
}
/*
template<class T> inline
typename container_detail::enable_if_c
...
{  return autoboost::container::container_detail::to_raw_pointer(p.operator->());  }
...
struct is_memtransfer_copy_assignable
{
   static const bool value = are_contiguous_and_same<I, O>::value &&
      autoboost::has_trivial_assign< typename ::std::iterator_traits<I>::value_type >::value;
};
...
{
   static const bool value = are_contiguous_and_same<I, O>::value &&
      autoboost::has_trivial_copy< typename ::std::iterator_traits<I>::value_type >::value;
};
...
inline F memmove(I f, I l, F r) AUTOBOOST_CONTAINER_NOEXCEPT
{
...
template
   <typename I, // I models InputIterator
    typename F> // F models ForwardIterator
F memmove_n(I f, typename std::iterator_traits<I>::difference_type n, F r) AUTOBOOST_CONTAINER_NOEXCEPT
{
   typedef typename std::iterator_traits<I>::value_type value_type;
   ::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
   std::advance(r, n);
...
template
   <typename I, // I models InputIterator
    typename F> // F models ForwardIterator
I memmove_n_source(I f, typename std::iterator_traits<I>::difference_type n, F r) AUTOBOOST_CONTAINER_NOEXCEPT
{
   typedef typename std::iterator_traits<I>::value_type value_type;
   ::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
   std::advance(f, n);
...
template
   <typename I, // I models InputIterator
    typename F> // F models ForwardIterator
I memmove_n_source_dest(I f, typename std::iterator_traits<I>::difference_type n, F &r) AUTOBOOST_CONTAINER_NOEXCEPT
{
   typedef typename std::iterator_traits<I>::value_type value_type;
   ::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
   std::advance(f, n);
   ...
   uninitialized_move_alloc(A &a, I f, I l, F r)
{
   ...
   AUTOBOOST_TRY{
      while (f != l) {
         allocator_traits<A>::construct(a, container_detail::iterator_to_raw_pointer(r), autoboost::move(*f));
         ++f; ++r;
      }
   }
   AUTOBOOST_CATCH(...){
...
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc(A &, I f, I l, F r) AUTOBOOST_CONTAINER_NOEXCEPT
...
template
   <typename A,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc_n(A &, I f, typename std::iterator_traits<I>::difference_type n, F r) AUTOBOOST_CONTAINER_NOEXCEPT
...
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_move_alloc_n_source(A &, I f, typename std::iterator_traits<I>::difference_type n, F r) AUTOBOOST_CONTAINER_NOEXCEPT
...
template
   <typename A,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc(A &, I f, I l, F r) AUTOBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove(f, l, r); }
...
template
   <typename A,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc_n(A &, I f, typename std::iterator_traits<I>::difference_type n, F r) AUTOBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n(f, n, r); }
...
template
   <typename A,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_copy_alloc_n_source(A &, I f, typename std::iterator_traits<I>::difference_type n, F r) AUTOBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n_source(f, n, r); }
...
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   copy(I f, I l, F r) AUTOBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove(f, l, r); }
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   copy_n(I f, typename std::iterator_traits<I>::difference_type n, F r) AUTOBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n(f, n, r); }
...
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source(I f, typename std::iterator_traits<I>::difference_type n, F r) AUTOBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n_source(f, n, r); }
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source_dest(I f, typename std::iterator_traits<I>::difference_type n, F &r) AUTOBOOST_CONTAINER_NOEXCEPT
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   move(I f, I l, F r) AUTOBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove(f, l, r); }
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   move_n(I f, typename std::iterator_traits<I>::difference_type n, F r) AUTOBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n(f, n, r); }
...
,typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source(I f, typename std::iterator_traits<I>::difference_type n, F r) AUTOBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n_source(f, n, r); }
...
,typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source_dest(I f, typename std::iterator_traits<I>::difference_type n, F &r) AUTOBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n_source_dest(f, n, r); }
...
inline void destroy_alloc_n(A &a, I f, typename std::iterator_traits<I>::difference_type n
   ,typename autoboost::container::container_detail::enable_if_c
      < !autoboost::has_trivial_destructor<typename std::iterator_traits<I>::value_type>::value >::type* = 0)
{
   while(n--){
                    ...
                    , G large_range_f, typename allocator_traits<A>::size_type n_j)
{
   ...
   for (; n != n_i ; ++short_range_f, ++large_range_f, ++n){
      autoboost::container::swap_dispatch(*short_range_f, *large_range_f);
   }
