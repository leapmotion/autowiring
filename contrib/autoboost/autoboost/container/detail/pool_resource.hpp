...
#ifndef AUTOBOOST_CONTAINER_POOL_RESOURCE_HPP
#define AUTOBOOST_CONTAINER_POOL_RESOURCE_HPP
...
#include <autoboost/container/detail/block_list.hpp>
#include <autoboost/container/pmr/pool_options.hpp>
...
class pool_resource
{
   ...
   pool_resource(const pool_options& opts, memory_resource* upstream) AUTOBOOST_NOEXCEPT;

   //! <b>Effects</b>: Same as
   //!   `pool_resource(pool_options(), get_default_resource())`.
   pool_resource() AUTOBOOST_NOEXCEPT;

   //! <b>Effects</b>: Same as
   //!   `pool_resource(pool_options(), upstream)`.
   explicit pool_resource(memory_resource* upstream) AUTOBOOST_NOEXCEPT;

   //! <b>Effects</b>: Same as
   //!   `pool_resource(opts, get_default_resource())`.
   explicit pool_resource(const pool_options& opts) AUTOBOOST_NOEXCEPT;
   ...
   virtual bool do_is_equal(const memory_resource& other) const AUTOBOOST_NOEXCEPT;
...
#endif   //AUTOBOOST_CONTAINER_POOL_RESOURCE_HPP
