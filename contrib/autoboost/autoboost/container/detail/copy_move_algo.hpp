...
//
//////////////////////////////////////////////////////////////////////////////
#ifndef AUTOBOOST_CONTAINER_DETAIL_COPY_MOVE_ALGO_HPP
#define AUTOBOOST_CONTAINER_DETAIL_COPY_MOVE_ALGO_HPP
...
template
   <typename I, // I models InputIterator
    ...
    typename F> // F models ForwardIterator
F memmove_n(I f, U n, F r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{
   typedef typename autoboost::container::iterator_traits<I>::value_type value_type;
   if(n){
      std::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
...
template
   <typename I, // I models InputIterator
    typename U, // U models unsigned integral constant
    typename F> // F models ForwardIterator
I memmove_n_source(I f, U n, F r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{
   if(n){
      typedef typename autoboost::container::iterator_traits<I>::value_type value_type;
      std::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
...
template
   <typename I, // I models InputIterator
    typename U, // U models unsigned integral constant
    typename F> // F models ForwardIterator
I memmove_n_source_dest(I f, U n, F &r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{
   typedef typename autoboost::container::iterator_traits<I>::value_type value_type;
   if(n){
      std::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc_n(Allocator &a, I f, typename autoboost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   AUTOBOOST_TRY{
      while (n--) {
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc_n(Allocator &, I f, typename autoboost::container::allocator_traits<Allocator>::size_type n, F r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
...
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_move_alloc_n_source(Allocator &a, I f, typename autoboost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   AUTOBOOST_TRY{
      while (n--) {
...
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_move_alloc_n_source(Allocator &, I f, typename autoboost::container::allocator_traits<Allocator>::size_type n, F r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc_n(Allocator &a, I f, typename autoboost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   AUTOBOOST_TRY{
      while (n--) {
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc_n(Allocator &, I f, typename autoboost::container::allocator_traits<Allocator>::size_type n, F r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n(f, n, r); }
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_copy_alloc_n_source(Allocator &a, I f, typename autoboost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   AUTOBOOST_TRY{
      while (n--) {
         autoboost::container::construct_in_place(a, container_detail::iterator_to_raw_pointer(r), f);
         ++f; ++r;
      }
   }
   AUTOBOOST_CATCH(...){
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_copy_alloc_n_source(Allocator &, I f, typename autoboost::container::allocator_traits<Allocator>::size_type n, F r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n_source(f, n, r); }
...
inline typename container_detail::disable_if_memzero_initializable<F, F>::type
   uninitialized_value_init_alloc_n(Allocator &a, typename autoboost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   AUTOBOOST_TRY{
      while (n--) {
...
inline typename container_detail::enable_if_memzero_initializable<F, F>::type
   uninitialized_value_init_alloc_n(Allocator &, typename autoboost::container::allocator_traits<Allocator>::size_type n, F r)
{
...
template
   <typename Allocator,
    typename F> // F models ForwardIterator
inline F uninitialized_default_init_alloc_n(Allocator &a, typename autoboost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   AUTOBOOST_TRY{
      while (n--) {
...
template
   <typename Allocator,
    typename T,
    typename F> // F models ForwardIterator
inline F uninitialized_fill_alloc_n(Allocator &a, const T &v, typename autoboost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   AUTOBOOST_TRY{
      while (n--) {
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   copy_n(I f, U n, F r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n(f, n, r); }
...
{
   while (n--) {
      autoboost::container::assign_in_place(r, f);
      ++f; ++r;
   }
   return f;
}
...
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source(I f, U n, F r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n_source(f, n, r); }
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source_dest(I f, U n, F &r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   move_n(I f, U n, F r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n(f, n, r); }
...
,typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source_dest(I f, U n, F &r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n_source_dest(f, n, r); }
...
,typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source(I f, U n, F r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n_source(f, n, r); }
...
#endif   //#ifndef AUTOBOOST_CONTAINER_DETAIL_COPY_MOVE_ALGO_HPP
