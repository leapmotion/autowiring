...
#ifndef AUTOBOOST_CONTAINER_NEW_ALLOCATOR_HPP
#define AUTOBOOST_CONTAINER_NEW_ALLOCATOR_HPP
...
class new_allocator<void>
{
   ...
   typedef AUTOBOOST_CONTAINER_IMPDEF(new_allocator_bool<true>) propagate_on_container_move_assignment;
   //!A integral constant of type bool with value true
   typedef AUTOBOOST_CONTAINER_IMPDEF(new_allocator_bool<true>) is_always_equal;
   ...
   //!Default constructor
   //!Never throws
   new_allocator() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {}

   //!Constructor from other new_allocator.
   //!Never throws
   new_allocator(const new_allocator &) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {}

   //!Constructor from related new_allocator.
   //!Never throws
   template<class T2>
   new_allocator(const new_allocator<T2> &) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {}

   //!Swaps two allocators, does nothing
   //!because this new_allocator is stateless
   friend void swap(new_allocator &, new_allocator &) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {}

   //!An new_allocator always compares to true, as memory allocated with one
   //!instance can be deallocated by another instance
   friend bool operator==(const new_allocator &, const new_allocator &) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return true;   }
...
#endif   //AUTOBOOST_CONTAINER_NEW_ALLOCATOR_HPP
