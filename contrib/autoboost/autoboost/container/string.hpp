...
class basic_string_base
{
 ...
 public:
   ...
   basic_string_base(AUTOBOOST_RV_REF(allocator_type) a)
   ...
   typedef typename autoboost::aligned_storage< sizeof(long_t),
   ...
   void swap_data(basic_string_base& other)
   {
      if(this->is_short()){
         ...
         if(other.is_short()){
            ...
            autoboost::container::swap_dispatch(this->members_.m_repr.long_repr(), other.members_.m_repr.long_repr());
         }
      }
   }
};
   ...
   :  private container_detail::basic_string_base<Allocator>
{
   ...
   //!
   //! <b>Throws</b>: Nothing
   explicit basic_string(const allocator_type& a) AUTOBOOST_CONTAINER_NOEXCEPT
      : base_t(a)
   { this->priv_terminate_string(); }
   ...
   basic_string(AUTOBOOST_RV_REF(basic_string) s) AUTOBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   ~basic_string() AUTOBOOST_CONTAINER_NOEXCEPT
   {}
   ...
   //!
   //! <b>Complexity</b>: Constant.
   size_type length() const AUTOBOOST_CONTAINER_NOEXCEPT
   { return this->size(); }
   ...
   //!
   //! <b>Returns</b>: *this
   basic_string& assign(AUTOBOOST_RV_REF(basic_string) ms) AUTOBOOST_CONTAINER_NOEXCEPT
   ...
   const CharT* c_str() const AUTOBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: constant time.
   const CharT* data()  const AUTOBOOST_CONTAINER_NOEXCEPT
   {  return container_detail::to_raw_pointer(this->priv_addr()); }
...
template <class CharT, class Traits, class Allocator> inline
   basic_string<CharT, Traits, Allocator> operator+
      ( AUTOBOOST_RV_REF_BEG basic_string<CharT, Traits, Allocator> AUTOBOOST_RV_REF_END mx
      , AUTOBOOST_RV_REF_BEG basic_string<CharT, Traits, Allocator> AUTOBOOST_RV_REF_END my)
{
   mx += my;
   return autoboost::move(mx);
}
