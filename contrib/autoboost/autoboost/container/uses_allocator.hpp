...
#ifndef AUTOBOOST_CONTAINER_USES_ALLOCATOR_HPP
#define AUTOBOOST_CONTAINER_USES_ALLOCATOR_HPP
...
//!       template<class ...Args>
//!       Y(allocator_arg_t, const allocator_type& a, AUTOBOOST_FWD_REF(Args)... args);
//! };
//!
