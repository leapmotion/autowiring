      ...
      <Allocator, typename container_detail::intrusive_list_type<Allocator>::type>
{
   ...
   {  this->emplace(this->cend(), autoboost::forward<Args>(args)...); }
   ...
   {  this->emplace(this->cbegin(), autoboost::forward<Args>(args)...);  }
   ...
   {  this->emplace(this->cend() AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_FWD##N);  }\
   \
   AUTOBOOST_MOVE_TMPL_LT##N AUTOBOOST_MOVE_CLASS##N AUTOBOOST_MOVE_GT##N \
   void emplace_front(AUTOBOOST_MOVE_UREF##N)\
   {  this->emplace(this->cbegin() AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_FWD##N);}\
   \
   AUTOBOOST_MOVE_TMPL_LT##N AUTOBOOST_MOVE_CLASS##N AUTOBOOST_MOVE_GT##N \
