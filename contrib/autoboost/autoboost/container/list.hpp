      ...
      <Allocator, typename container_detail::intrusive_list_type<Allocator>::type>
{
   ...
   //!
   //! <b>Complexity</b>: Constant.
   explicit list(const allocator_type &a) AUTOBOOST_CONTAINER_NOEXCEPT
      : AllocHolder(a)
   {}
   ...
   list(AUTOBOOST_RV_REF(list) x)
      : AllocHolder(autoboost::move(static_cast<AllocHolder&>(x)))
   {}
   ...
   ~list() AUTOBOOST_CONTAINER_NOEXCEPT
   ...
   {                                                                                            \
      NodePtr pnode (AllocHolder::create_node                                                   \
         (AUTOBOOST_PP_ENUM(n, AUTOBOOST_CONTAINER_PP_PARAM_FORWARD, _)));                              \
      return iterator(this->icont().insert(p.get(), *pnode));                                   \
   }                                                                                            \
   //!
   ...
   void splice(const_iterator p, list& x) AUTOBOOST_CONTAINER_NOEXCEPT
   {
      AUTOBOOST_ASSERT(this != &x);
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of
   //!    this list. Iterators of this list and all the references are not invalidated.
   void splice(const_iterator p, AUTOBOOST_RV_REF(list) x) AUTOBOOST_CONTAINER_NOEXCEPT
   ...
   void splice(const_iterator p, list &x, const_iterator i) AUTOBOOST_CONTAINER_NOEXCEPT
   {
      //AUTOBOOST_ASSERT(this != &x);
      AUTOBOOST_ASSERT(this->node_alloc() == x.node_alloc());
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
   //!   list. Iterators of this list and all the references are not invalidated.
   void splice(const_iterator p, AUTOBOOST_RV_REF(list) x, const_iterator i) AUTOBOOST_CONTAINER_NOEXCEPT
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
   //!   list. Iterators of this list and all the references are not invalidated.
   void splice(const_iterator p, list &x, const_iterator first, const_iterator last) AUTOBOOST_CONTAINER_NOEXCEPT
   {
      AUTOBOOST_ASSERT(this->node_alloc() == x.node_alloc());
   ...
   //! <b>Note</b>: Iterators of values obtained from list x now point to elements of this
   //!   list. Iterators of this list and all the references are not invalidated.
   void splice(const_iterator p, AUTOBOOST_RV_REF(list) x, const_iterator first, const_iterator last) AUTOBOOST_CONTAINER_NOEXCEPT
   ...
   void reverse() AUTOBOOST_CONTAINER_NOEXCEPT
   {  this->icont().reverse(); }
