...
#include <autoboost/container/detail/dispatch_uses_allocator.hpp>
   ...
   : public OuterAlloc
{
   ...
   {
      autoboost::adl_move_swap(this->outer_allocator(), r.outer_allocator());
      autoboost::adl_move_swap(this->m_inner, r.inner_allocator());
   }

   friend void swap(scoped_allocator_adaptor_base &l, scoped_allocator_adaptor_base &r)
   {  l.swap(r);  }

   inner_allocator_type&       inner_allocator() AUTOBOOST_NOEXCEPT_OR_NOTHROW
      { return m_inner; }

   inner_allocator_type const& inner_allocator() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
      { return m_inner; }

   outer_allocator_type      & outer_allocator() AUTOBOOST_NOEXCEPT_OR_NOTHROW
      { return static_cast<outer_allocator_type&>(*this); }

   const outer_allocator_type &outer_allocator() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
...
template <typename OuterAlloc, bool Dummy, AUTOBOOST_MOVE_CLASSDFLT9>
class scoped_allocator_adaptor_base;

//Specializations for the adaptor with InnerAlloc allocators

#define AUTOBOOST_CONTAINER_SCOPED_ALLOCATOR_ADAPTOR_BASE_CODE(N)\
template <typename OuterAlloc AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_CLASS##N>\
class scoped_allocator_adaptor_base<OuterAlloc, true, AUTOBOOST_MOVE_TARG##N>\
   : public OuterAlloc\
{\
   typedef allocator_traits<OuterAlloc> outer_traits_type;\
   AUTOBOOST_COPYABLE_AND_MOVABLE(scoped_allocator_adaptor_base)\
   ...
   struct rebind_base\
   {\
      typedef scoped_allocator_adaptor_base<OuterA2, true, AUTOBOOST_MOVE_TARG##N> other;\
   };\
   \
   typedef OuterAlloc outer_allocator_type;\
   typedef scoped_allocator_adaptor<AUTOBOOST_MOVE_TARG##N> inner_allocator_type;\
   typedef scoped_allocator_adaptor<OuterAlloc, AUTOBOOST_MOVE_TARG##N> scoped_allocator_type;\
   typedef allocator_traits<inner_allocator_type> inner_traits_type;\
   typedef container_detail::bool_<\
      outer_traits_type::propagate_on_container_copy_assignment::value ||\
      inner_allocator_type::propagate_on_container_copy_assignment::value\
   ...
   \
   template <class OuterA2>\
   scoped_allocator_adaptor_base(AUTOBOOST_FWD_REF(OuterA2) outerAlloc, AUTOBOOST_MOVE_CREF##N)\
      : outer_allocator_type(::autoboost::forward<OuterA2>(outerAlloc))\
      , m_inner(AUTOBOOST_MOVE_ARG##N)\
      {}\
   \
   scoped_allocator_adaptor_base(const scoped_allocator_adaptor_base& other)\
      : outer_allocator_type(other.outer_allocator())\
   ...
   template <class OuterA2>\
   scoped_allocator_adaptor_base\
      (const scoped_allocator_adaptor_base<OuterA2, true, AUTOBOOST_MOVE_TARG##N>& other)\
      : outer_allocator_type(other.outer_allocator())\
      , m_inner(other.inner_allocator())\
      {}\
   \
   template <class OuterA2>\
   scoped_allocator_adaptor_base\
      (AUTOBOOST_RV_REF_BEG scoped_allocator_adaptor_base<OuterA2, true, AUTOBOOST_MOVE_TARG##N> AUTOBOOST_RV_REF_END other)\
      : outer_allocator_type(other.outer_allocator())\
      , m_inner(other.inner_allocator())\
      {}\
   \
   ...
   template <class OuterA2>\
   scoped_allocator_adaptor_base\
      ( internal_type_t, AUTOBOOST_FWD_REF(OuterA2) outerAlloc, const inner_allocator_type &inner)\
      : outer_allocator_type(::autoboost::forward<OuterA2>(outerAlloc))\
      , m_inner(inner)\
   {}\
   \
...
//!
AUTOBOOST_MOVE_ITERATE_1TO9(AUTOBOOST_CONTAINER_SCOPED_ALLOCATOR_ADAPTOR_BASE_CODE)
#undef AUTOBOOST_CONTAINER_SCOPED_ALLOCATOR_ADAPTOR_BASE_CODE
   ...
   #define AUTOBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE      ,true
   #define AUTOBOOST_CONTAINER_SCOPEDALLOC_ALLINNER       AUTOBOOST_MOVE_TARG9
   #define AUTOBOOST_CONTAINER_SCOPEDALLOC_ALLINNERCLASS  AUTOBOOST_MOVE_CLASS9
#else
   #define AUTOBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE
   #define AUTOBOOST_CONTAINER_SCOPEDALLOC_ALLINNER       InnerAllocs...
   #define AUTOBOOST_CONTAINER_SCOPEDALLOC_ALLINNERCLASS  typename... InnerAllocs
#endif

//Specialization for adaptor without any InnerAlloc
template <typename OuterAlloc>
class scoped_allocator_adaptor_base< OuterAlloc AUTOBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE>
   : public OuterAlloc
{
   AUTOBOOST_COPYABLE_AND_MOVABLE(scoped_allocator_adaptor_base)
   public:
   ...
   struct rebind_base
   {
      typedef scoped_allocator_adaptor_base
         ...
         AUTOBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE > other;
   };
   ...
   template <class OuterA2>
   scoped_allocator_adaptor_base
      (const scoped_allocator_adaptor_base<OuterA2 AUTOBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE>& other)
      : outer_allocator_type(other.outer_allocator())
      {}

   template <class OuterA2>
   scoped_allocator_adaptor_base
      (AUTOBOOST_RV_REF_BEG scoped_allocator_adaptor_base<OuterA2 AUTOBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE> AUTOBOOST_RV_REF_END other)
      : outer_allocator_type(other.outer_allocator())
      {}
...
template <typename OuterAlloc, AUTOBOOST_MOVE_CLASS9>
class scoped_allocator_adaptor
#endif

   : public container_detail::scoped_allocator_adaptor_base
         <OuterAlloc AUTOBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE, AUTOBOOST_CONTAINER_SCOPEDALLOC_ALLINNER>
{
   ...
   typedef container_detail::scoped_allocator_adaptor_base
      <OuterAlloc AUTOBOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE, AUTOBOOST_CONTAINER_SCOPEDALLOC_ALLINNER> base_type;
   ...
   struct rebind
   {
      typedef scoped_allocator_adaptor
         < typename outer_traits_type::template portable_rebind_alloc<U>::type
         , AUTOBOOST_CONTAINER_SCOPEDALLOC_ALLINNER> other;
   };
   ...
   #define AUTOBOOST_CONTAINER_SCOPED_ALLOCATOR_ADAPTOR_RELATED_ALLOCATOR_CONSTRUCTOR_CODE(N)\
   template <class OuterA2>\
   scoped_allocator_adaptor(AUTOBOOST_FWD_REF(OuterA2) outerAlloc AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_CREF##N)\
      : base_type(::autoboost::forward<OuterA2>(outerAlloc) AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_ARG##N)\
      {}\
   //
   AUTOBOOST_MOVE_ITERATE_0TO9(AUTOBOOST_CONTAINER_SCOPED_ALLOCATOR_ADAPTOR_RELATED_ALLOCATOR_CONSTRUCTOR_CODE)
   #undef AUTOBOOST_CONTAINER_SCOPED_ALLOCATOR_ADAPTOR_RELATED_ALLOCATOR_CONSTRUCTOR_CODE
   ...
   template <class OuterA2>
   scoped_allocator_adaptor(const scoped_allocator_adaptor<OuterA2, AUTOBOOST_CONTAINER_SCOPEDALLOC_ALLINNER> &other)
      : base_type(other.base())
      {}
   ...
   //! rvalue from other.
   template <class OuterA2>
   scoped_allocator_adaptor(AUTOBOOST_RV_REF_BEG scoped_allocator_adaptor
      <OuterA2, AUTOBOOST_CONTAINER_SCOPEDALLOC_ALLINNER> AUTOBOOST_RV_REF_END other)
      : base_type(::autoboost::move(other.base()))
      {}
   ...
   {  return static_cast<scoped_allocator_adaptor&>(base_type::operator=(autoboost::move(other.base()))); }
   ...
   template <class T>
   void destroy(T* p) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   void construct(T* p, AUTOBOOST_FWD_REF(Args)...args)
   {
      container_detail::dispatch_uses_allocator
         ( (get_outermost_allocator)(this->outer_allocator())
         , this->inner_allocator(), p, ::autoboost::forward<Args>(args)...);
   }
   ...
   #define AUTOBOOST_CONTAINER_SCOPED_ALLOCATOR_CONSTRUCT_CODE(N) \
   template < typename T AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_CLASSQ##N >\
   void construct(T* p AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_UREFQ##N)\
   {\
      container_detail::dispatch_uses_allocator\
         ( (get_outermost_allocator)(this->outer_allocator())\
         , this->inner_allocator(), p AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_FWDQ##N);\
   }\
   //
   AUTOBOOST_MOVE_ITERATE_0TO9(AUTOBOOST_CONTAINER_SCOPED_ALLOCATOR_CONSTRUCT_CODE)
   #undef AUTOBOOST_CONTAINER_SCOPED_ALLOCATOR_CONSTRUCT_CODE
...
template <typename OuterA1, typename OuterA2, AUTOBOOST_CONTAINER_SCOPEDALLOC_ALLINNERCLASS>
inline bool operator==(const scoped_allocator_adaptor<OuterA1, AUTOBOOST_CONTAINER_SCOPEDALLOC_ALLINNER>& a
                      ,const scoped_allocator_adaptor<OuterA2, AUTOBOOST_CONTAINER_SCOPEDALLOC_ALLINNER>& b)
{
   #if !defined(AUTOBOOST_NO_CXX11_VARIADIC_TEMPLATES) || defined(AUTOBOOST_CONTAINER_DOXYGEN_INVOKED)
   const bool has_zero_inner = sizeof...(InnerAllocs) == 0u;
   #else
   const bool has_zero_inner = autoboost::container::container_detail::is_same<P0, void>::value;
   #endif
