...
#ifndef AUTOBOOST_CONTAINER_CONTAINER_VECTOR_HPP
#define AUTOBOOST_CONTAINER_CONTAINER_VECTOR_HPP
...
// container detail
#include <autoboost/container/detail/advanced_insert_int.hpp>
...
#include <autoboost/container/detail/next_capacity.hpp>
...
//#define AUTOBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER

namespace container_detail {

#ifndef AUTOBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER
...
class vec_iterator
{
   ...
   typedef typename autoboost::intrusive::pointer_traits<Pointer>::element_type         value_type;
   typedef typename autoboost::intrusive::pointer_traits<Pointer>::difference_type      difference_type;
   typedef typename if_c
      < IsConst
      , typename autoboost::intrusive::pointer_traits<Pointer>::template
                                 rebind_pointer<const value_type>::type
      , Pointer
      >::type                                                                       pointer;
   typedef typename autoboost::intrusive::pointer_traits<pointer>                       ptr_traits;
   ...
   public:
   AUTOBOOST_CONTAINER_FORCEINLINE const Pointer &get_ptr() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return   m_ptr;  }

   AUTOBOOST_CONTAINER_FORCEINLINE Pointer &get_ptr() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return   m_ptr;  }

   AUTOBOOST_CONTAINER_FORCEINLINE explicit vec_iterator(Pointer ptr) AUTOBOOST_NOEXCEPT_OR_NOTHROW
      : m_ptr(ptr)
   {}
   ...
   //Constructors
   AUTOBOOST_CONTAINER_FORCEINLINE vec_iterator() AUTOBOOST_NOEXCEPT_OR_NOTHROW
      : m_ptr()   //Value initialization to achieve "null iterators" (N3644)
   {}

   AUTOBOOST_CONTAINER_FORCEINLINE vec_iterator(vec_iterator<Pointer, false> const& other) AUTOBOOST_NOEXCEPT_OR_NOTHROW
      :  m_ptr(other.get_ptr())
   {}
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE reference operator[](difference_type off) const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return m_ptr[off];   }

   //Increment / Decrement
   AUTOBOOST_CONTAINER_FORCEINLINE vec_iterator& operator++() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   { ++m_ptr;  return *this; }

   AUTOBOOST_CONTAINER_FORCEINLINE vec_iterator operator++(int) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //Arithmetic
   AUTOBOOST_CONTAINER_FORCEINLINE vec_iterator& operator+=(difference_type off) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  m_ptr += off; return *this;   }

   AUTOBOOST_CONTAINER_FORCEINLINE vec_iterator& operator-=(difference_type off) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  m_ptr -= off; return *this;   }

   AUTOBOOST_CONTAINER_FORCEINLINE friend vec_iterator operator+(const vec_iterator &x, difference_type off) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return vec_iterator(x.m_ptr+off);  }

   AUTOBOOST_CONTAINER_FORCEINLINE friend vec_iterator operator+(difference_type off, vec_iterator right) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  right.m_ptr += off;  return right; }

   AUTOBOOST_CONTAINER_FORCEINLINE friend vec_iterator operator-(vec_iterator left, difference_type off) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  left.m_ptr -= off;  return left; }

   AUTOBOOST_CONTAINER_FORCEINLINE friend difference_type operator-(const vec_iterator &left, const vec_iterator& right) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return left.m_ptr - right.m_ptr;   }

   //Comparison operators
   AUTOBOOST_CONTAINER_FORCEINLINE friend bool operator==   (const vec_iterator& l, const vec_iterator& r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
...
struct vector_insert_ordered_cursor
{
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE vector_insert_ordered_cursor(BiDirPosConstIt posit, BiDirValueIt valueit)
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE size_type get_pos() const
   {  return *last_position_it;  }

   AUTOBOOST_CONTAINER_FORCEINLINE reference get_val()
...
struct vector_merge_cursor
{
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE vector_merge_cursor(T *pbeg, T *plast, BiDirValueIt valueit, Comp &cmp)
...
template<class Pointer, bool IsConst>
AUTOBOOST_CONTAINER_FORCEINLINE const Pointer &vector_iterator_get_ptr(const container_detail::vec_iterator<Pointer, IsConst> &it) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{  return   it.get_ptr();  }

template<class Pointer, bool IsConst>
AUTOBOOST_CONTAINER_FORCEINLINE Pointer &get_ptr(container_detail::vec_iterator<Pointer, IsConst> &it) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{  return  it.get_ptr();  }

namespace container_detail {

#else //ifndef AUTOBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER

template< class MaybeConstPointer
        , bool ElementTypeIsConst
            = is_const< typename autoboost::intrusive::pointer_traits<MaybeConstPointer>::element_type>::value >
struct vector_get_ptr_pointer_to_non_const
{
   typedef MaybeConstPointer                                         const_pointer;
   typedef autoboost::intrusive::pointer_traits<const_pointer>           pointer_traits_t;
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE static return_type get_ptr(const const_pointer &ptr) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return autoboost::intrusive::pointer_traits<return_type>::const_cast_from(ptr);  }
};
...
struct vector_get_ptr_pointer_to_non_const<Pointer, false>
{
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE static return_type get_ptr(const Pointer &ptr) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return ptr;  }
};
...
template<class MaybeConstPointer>
AUTOBOOST_CONTAINER_FORCEINLINE typename container_detail::vector_get_ptr_pointer_to_non_const<MaybeConstPointer>::return_type
   vector_iterator_get_ptr(const MaybeConstPointer &ptr) AUTOBOOST_NOEXCEPT_OR_NOTHROW
{
...
#endif   //#ifndef AUTOBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER
...
{
   private:
   AUTOBOOST_MOVABLE_BUT_NOT_COPYABLE(vector_alloc_holder)
   ...
   vector_alloc_holder()
      AUTOBOOST_NOEXCEPT_IF(container_detail::is_nothrow_default_constructible<Allocator>::value)
      : Allocator(), m_start(), m_size(), m_capacity()
   {}

   //Constructor, does not throw
   template<class AllocConvertible>
   explicit vector_alloc_holder(AUTOBOOST_FWD_REF(AllocConvertible) a) AUTOBOOST_NOEXCEPT_OR_NOTHROW
      : Allocator(autoboost::forward<AllocConvertible>(a)), m_start(), m_size(), m_capacity()
   {}

   //Constructor, does not throw
   template<class AllocConvertible>
   vector_alloc_holder(uninitialized_size_t, AUTOBOOST_FWD_REF(AllocConvertible) a, size_type initial_size)
      : Allocator(autoboost::forward<AllocConvertible>(a))
      , m_start()
   ...
   vector_alloc_holder(AUTOBOOST_RV_REF(vector_alloc_holder) holder) AUTOBOOST_NOEXCEPT_OR_NOTHROW
      : Allocator(AUTOBOOST_MOVE_BASE(Allocator, holder))
   ...
   vector_alloc_holder(pointer p, size_type capacity, AUTOBOOST_RV_REF(vector_alloc_holder) holder)
      : Allocator(AUTOBOOST_MOVE_BASE(Allocator, holder))
      , m_start(p)
      , m_size(holder.m_size)
      , m_capacity(capacity)
   {
      ...
      if(this->is_propagable_from(x_alloc, holder.start(), this_alloc, true)){
         ...
         #ifdef AUTOBOOST_CONTAINER_VECTOR_ALLOC_STATS
         this->num_alloc += n != 0;
         #endif
      }
   }
   ...
   vector_alloc_holder(pointer p, size_type n, AUTOBOOST_FWD_REF(AllocFwd) a)
      : Allocator(::autoboost::forward<AllocFwd>(a))
      , m_start(p)
      , m_size()
      , m_capacity(n)
   {}

   AUTOBOOST_CONTAINER_FORCEINLINE ~vector_alloc_holder() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      if(this->m_capacity){
         this->alloc().deallocate(this->m_start, this->m_capacity);
      }
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE pointer allocation_command(autoboost::container::allocation_type command,
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE size_type next_capacity(size_type additional_objects) const
   {
   ...
   void swap_resources(vector_alloc_holder &x) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      autoboost::adl_move_swap(this->m_start, x.m_start);
      autoboost::adl_move_swap(this->m_size, x.m_size);
      autoboost::adl_move_swap(this->m_capacity, x.m_capacity);
   }

   void steal_resources(vector_alloc_holder &x) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE Allocator &alloc() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return *this;  }

   AUTOBOOST_CONTAINER_FORCEINLINE const Allocator &alloc() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return *this;  }

   const pointer   &start() const     AUTOBOOST_NOEXCEPT_OR_NOTHROW {  return m_start;  }
   const size_type &capacity() const  AUTOBOOST_NOEXCEPT_OR_NOTHROW {  return m_capacity;  }
   void start(const pointer &p)       AUTOBOOST_NOEXCEPT_OR_NOTHROW {  m_start = p;  }
   void capacity(const size_type &c)  AUTOBOOST_NOEXCEPT_OR_NOTHROW {  m_capacity = c;  }
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE pointer priv_allocation_command(version_1, autoboost::container::allocation_type command,
                         size_type ,
                         size_type &prefer_in_recvd_out_size,
                         pointer &reuse)
   {
      (void)command;
      AUTOBOOST_ASSERT( (command & allocate_new));
      AUTOBOOST_ASSERT(!(command & nothrow_allocation));
      pointer const p = allocator_traits_type::allocate(this->alloc(), prefer_in_recvd_out_size, reuse);
      reuse = pointer();
      return p;
   }

   pointer priv_allocation_command(version_2, autoboost::container::allocation_type command,
   ...
   : public Allocator
{
   ...
   template<class AllocConvertible>
   explicit vector_alloc_holder(AUTOBOOST_FWD_REF(AllocConvertible) a) AUTOBOOST_NOEXCEPT_OR_NOTHROW
      : Allocator(autoboost::forward<AllocConvertible>(a)), m_size()
   {}
   ...
   vector_alloc_holder(AUTOBOOST_RV_REF(vector_alloc_holder) holder)
      : Allocator(AUTOBOOST_MOVE_BASE(Allocator, holder))
      , m_size(holder.m_size) //Size is initialized here so vector should only call uninitialized_xxx after this
   {
      ::autoboost::container::uninitialized_move_alloc_n
         (this->alloc(), container_detail::to_raw_pointer(holder.start()), m_size, container_detail::to_raw_pointer(this->start()));
   }

   template<class OtherAllocator, class OtherAllocatorVersion>
   vector_alloc_holder(AUTOBOOST_RV_REF_BEG vector_alloc_holder<OtherAllocator, OtherAllocatorVersion> AUTOBOOST_RV_REF_END holder)
      : Allocator()
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE void priv_first_allocation(size_type cap)
   {
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE void deep_swap(vector_alloc_holder &x)
   {
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE void swap_resources(vector_alloc_holder &) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  //Containers with version 0 allocators can't be moved without moving elements one by one
      throw_bad_alloc();
   }


   AUTOBOOST_CONTAINER_FORCEINLINE void steal_resources(vector_alloc_holder &)
   {  //Containers with version 0 allocators can't be moved without moving elements one by one
      throw_bad_alloc();
   }
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE bool try_expand_fwd(size_type at_least)
   {  return !at_least;  }

   AUTOBOOST_CONTAINER_FORCEINLINE pointer start() const       AUTOBOOST_NOEXCEPT_OR_NOTHROW {  return Allocator::internal_storage();  }
   AUTOBOOST_CONTAINER_FORCEINLINE size_type  capacity() const AUTOBOOST_NOEXCEPT_OR_NOTHROW {  return Allocator::internal_capacity;  }
   size_type   m_size;
   ...
   void priv_deep_swap(vector_alloc_holder<OtherAllocator, OtherAllocatorVersion> &x)
   {
      ...
      if(this->m_size < x.m_size){
         autoboost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_this, this->m_size, first_x, x.m_size);
      }
      else{
         autoboost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_x, x.m_size, first_this, this->m_size);
      }
      autoboost::adl_move_swap(this->m_size, x.m_size);
   }
};
...
template <class T, class Allocator AUTOBOOST_CONTAINER_DOCONLY(= new_allocator<T>) >
class vector
{
   #ifndef AUTOBOOST_CONTAINER_DOXYGEN_INVOKED
   ...
   typedef typename container_detail::version<Allocator>::type alloc_version;
   typedef autoboost::container::container_detail::vector_alloc_holder<Allocator> alloc_holder_t;
   ...
   #if defined AUTOBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER
   typedef AUTOBOOST_CONTAINER_IMPDEF(pointer)                                             iterator;
   typedef AUTOBOOST_CONTAINER_IMPDEF(const_pointer)                                       const_iterator;
   #else
   ...
   #endif
   typedef AUTOBOOST_CONTAINER_IMPDEF(autoboost::container::reverse_iterator<iterator>)        reverse_iterator;
   typedef AUTOBOOST_CONTAINER_IMPDEF(autoboost::container::reverse_iterator<const_iterator>)  const_reverse_iterator;

   #ifndef AUTOBOOST_CONTAINER_DOXYGEN_INVOKED
   private:
   AUTOBOOST_COPYABLE_AND_MOVABLE(vector)
   typedef container_detail::vector_value_traits<Allocator> value_traits;
   typedef constant_iterator<T, difference_type>            cvalue_iterator;

   protected:

   AUTOBOOST_CONTAINER_FORCEINLINE void steal_resources(vector &x)
   {  return this->m_holder.steal_resources(x.m_holder);   }

   struct initial_capacity_t{};
   template<class AllocFwd>
   AUTOBOOST_CONTAINER_FORCEINLINE vector(initial_capacity_t, pointer initial_memory, size_type capacity, AUTOBOOST_FWD_REF(AllocFwd) a)
      : m_holder(initial_memory, capacity, ::autoboost::forward<AllocFwd>(a))
   {}

   AUTOBOOST_CONTAINER_FORCEINLINE vector(initial_capacity_t, pointer initial_memory, size_type capacity)
   ...
   vector() AUTOBOOST_NOEXCEPT_IF(container_detail::is_nothrow_default_constructible<Allocator>::value)
      : m_holder()
   {}
   ...
   //!
   //! <b>Complexity</b>: Constant.
   explicit vector(const allocator_type& a) AUTOBOOST_NOEXCEPT_OR_NOTHROW
      : m_holder(a)
   {}
      ...
      :  m_holder(container_detail::uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      autoboost::container::uninitialized_value_init_alloc_n
      ...
      :  m_holder(container_detail::uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      autoboost::container::uninitialized_default_init_alloc_n
         (this->m_holder.alloc(), n, this->priv_raw_begin());
   }
      ...
      :  m_holder(container_detail::uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      autoboost::container::uninitialized_fill_alloc_n
   ...
   vector(InIt first, InIt last
      AUTOBOOST_CONTAINER_DOCIGN(AUTOBOOST_MOVE_I typename container_detail::disable_if_c
         < container_detail::is_convertible<InIt AUTOBOOST_MOVE_I size_type>::value
         AUTOBOOST_MOVE_I container_detail::nat >::type * = 0)
      )
      :  m_holder()
                 ...
                 , x.size())
   {
      ...
      #endif
      ::autoboost::container::uninitialized_copy_alloc_n
   ...
   //!
   //! <b>Complexity</b>: Constant.
   vector(AUTOBOOST_RV_REF(vector) x) AUTOBOOST_NOEXCEPT_OR_NOTHROW
      :  m_holder(autoboost::move(x.m_holder))
   {  AUTOBOOST_STATIC_ASSERT((!allocator_traits_type::is_partially_propagable::value));  }
   ...
   vector(AUTOBOOST_RV_REF_BEG vector<T, OtherAllocator> AUTOBOOST_RV_REF_END x
      ...
      :  m_holder(container_detail::uninitialized_size, a, x.size())
   {
      ...
      this->num_alloc += x.size() != 0;
      #endif
      ::autoboost::container::uninitialized_copy_alloc_n_source
         ( this->m_holder.alloc(), x.priv_raw_begin()
         , x.size(), this->priv_raw_begin());
   }
   ...
   vector(AUTOBOOST_RV_REF(vector) x, const allocator_type &a)
                 ...
                 )
   {
      if(is_propagable_from(x.get_stored_allocator(), x.m_holder.start(), a, true)){
         ...
         this->num_alloc += n != 0;
         #endif
         ::autoboost::container::uninitialized_move_alloc_n_source
            ( this->m_holder.alloc(), x.priv_raw_begin()
   ...
   ~vector() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      autoboost::container::destroy_alloc_n
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE vector& operator=(AUTOBOOST_COPY_ASSIGN_REF(vector) x)
   {
      if (&x != this){
   ...
   //!
   //! <b>Complexity</b>: Linear to the range [il.begin(), il.end()).
   AUTOBOOST_CONTAINER_FORCEINLINE vector& operator=(std::initializer_list<value_type> il)
   {
      this->assign(il.begin(), il.end());
      return *this;
   }
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE vector& operator=(AUTOBOOST_RV_REF(vector) x)
      AUTOBOOST_NOEXCEPT_IF(allocator_traits_type::propagate_on_container_move_assignment::value
                        || allocator_traits_type::is_always_equal::value)
   {
      AUTOBOOST_ASSERT(&x != this);
      this->priv_move_assign(autoboost::move(x));
      return *this;
   }
   ...
   //! <b>Note</b>: Non-standard extension to support static_vector
   template<class OtherAllocator>
   AUTOBOOST_CONTAINER_FORCEINLINE typename container_detail::enable_if_and
                           < vector&
                           , container_detail::is_version<OtherAllocator, 0>
                           , container_detail::is_different<OtherAllocator, allocator_type>
                           >::type
      operator=(AUTOBOOST_RV_REF_BEG vector<value_type, OtherAllocator> AUTOBOOST_RV_REF_END x)
   {
      this->priv_move_assign(autoboost::move(x));
      return *this;
   }
   ...
   void assign(InIt first, InIt last
      AUTOBOOST_CONTAINER_DOCIGN(AUTOBOOST_MOVE_I typename container_detail::disable_if_or
         < void
         AUTOBOOST_MOVE_I container_detail::is_convertible<InIt AUTOBOOST_MOVE_I size_type>
         AUTOBOOST_MOVE_I container_detail::and_
            < container_detail::is_different<alloc_version AUTOBOOST_MOVE_I version_0>
            AUTOBOOST_MOVE_I container_detail::is_not_input_iterator<InIt>
            >
         >::type * = 0)
      )
   {
   ...
   //!
   AUTOBOOST_CONTAINER_FORCEINLINE void assign(std::initializer_list<T> il)
   {
      this->assign(il.begin(), il.end());
   }
   #endif
   ...
   void assign(FwdIt first, FwdIt last
      AUTOBOOST_CONTAINER_DOCIGN(AUTOBOOST_MOVE_I typename container_detail::disable_if_or
         < void
         AUTOBOOST_MOVE_I container_detail::is_same<alloc_version AUTOBOOST_MOVE_I version_0>
         AUTOBOOST_MOVE_I container_detail::is_convertible<FwdIt AUTOBOOST_MOVE_I size_type>
         AUTOBOOST_MOVE_I container_detail::is_input_iterator<FwdIt>
         >::type * = 0)
      )
   {
      //For Fwd iterators the standard only requires EmplaceConstructible and assignable from *first
      //so we can't do any backwards allocation
      const size_type input_sz = static_cast<size_type>(autoboost::container::iterator_distance(first, last));
   ...
   //!
   //! <b>Complexity</b>: Linear to n.
   AUTOBOOST_CONTAINER_FORCEINLINE void assign(size_type n, const value_type& val)
   ...
   //!
   //! <b>Note</b>: Non-standard extension.
   AUTOBOOST_CONTAINER_FORCEINLINE stored_allocator_type &get_stored_allocator() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return this->m_holder.alloc(); }
   ...
   //!
   //! <b>Note</b>: Non-standard extension.
   AUTOBOOST_CONTAINER_FORCEINLINE const stored_allocator_type &get_stored_allocator() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return this->m_holder.alloc(); }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE iterator begin() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE const_iterator begin() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE iterator end() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE const_iterator end() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   { return this->cend(); }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE reverse_iterator rbegin() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE const_reverse_iterator rbegin() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   { return this->crbegin(); }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE reverse_iterator rend() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE const_reverse_iterator rend() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   { return this->crend(); }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE const_iterator cbegin() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   { return const_iterator(this->m_holder.start()); }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE const_iterator cend() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE const_reverse_iterator crbegin() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE const_reverse_iterator crend() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE bool empty() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE size_type size() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   { return this->m_holder.m_size; }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE size_type max_size() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!
   //! <b>Complexity</b>: Constant.
   AUTOBOOST_CONTAINER_FORCEINLINE size_type capacity() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE void reserve(size_type new_cap)
   {
   ...
   //!
   //! <b>Complexity</b>: Constant.
   reference         front() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_reference   front() const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      AUTOBOOST_ASSERT(!this->empty());
      return *this->m_holder.start();
   }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   reference         back() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      AUTOBOOST_ASSERT(!this->empty());
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_reference   back()  const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      AUTOBOOST_ASSERT(!this->empty());
      return this->m_holder.start()[this->m_holder.m_size - 1];
   }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   reference operator[](size_type n) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      AUTOBOOST_ASSERT(this->m_holder.m_size > n);
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_reference operator[](size_type n) const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      AUTOBOOST_ASSERT(this->m_holder.m_size > n);
      return this->m_holder.start()[n];
   }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   T* data() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const T * data()  const AUTOBOOST_NOEXCEPT_OR_NOTHROW
   { return this->priv_raw_begin(); }
   ...
   template<class ...Args>
   AUTOBOOST_CONTAINER_FORCEINLINE reference emplace_back(AUTOBOOST_FWD_REF(Args)...args)
   {
      if (AUTOBOOST_LIKELY(this->room_enough())){
         //There is more memory, just construct a new object at the end
         T* const p = this->priv_raw_end();
         allocator_traits_type::construct(this->m_holder.alloc(), p, ::autoboost::forward<Args>(args)...);
         ...
         return *this->priv_forward_range_insert_no_capacity
            (this->back_ptr(), 1, type(::autoboost::forward<Args>(args)...), alloc_version());
      }
   }
   ...
   //! <b>Note</b>: Non-standard extension.
   template<class ...Args>
   AUTOBOOST_CONTAINER_FORCEINLINE bool stable_emplace_back(AUTOBOOST_FWD_REF(Args)...args)
   {
      const bool is_room_enough = this->room_enough() || (alloc_version::value == 2 && this->m_holder.try_expand_fwd(1u));
      if (AUTOBOOST_LIKELY(is_room_enough)){
         //There is more memory, just construct a new object at the end
         allocator_traits_type::construct(this->m_holder.alloc(), this->priv_raw_end(), ::autoboost::forward<Args>(args)...);
         ++this->m_holder.m_size;
      }
   ...
   template<class ...Args>
   iterator emplace(const_iterator position, AUTOBOOST_FWD_REF(Args) ...args)
   {
      AUTOBOOST_ASSERT(this->priv_in_range_or_end(position));
      //Just call more general insert(pos, size, value) and return iterator
      typedef container_detail::insert_emplace_proxy<Allocator, T*, Args...> type;
      return this->priv_forward_range_insert( vector_iterator_get_ptr(position), 1
                                            , type(::autoboost::forward<Args>(args)...));
   }

   #else // !defined(AUTOBOOST_NO_CXX11_VARIADIC_TEMPLATES)

   #define AUTOBOOST_CONTAINER_VECTOR_EMPLACE_CODE(N) \
   AUTOBOOST_MOVE_TMPL_LT##N AUTOBOOST_MOVE_CLASS##N AUTOBOOST_MOVE_GT##N \
   AUTOBOOST_CONTAINER_FORCEINLINE reference emplace_back(AUTOBOOST_MOVE_UREF##N)\
   {\
      if (AUTOBOOST_LIKELY(this->room_enough())){\
         T* const p = this->priv_raw_end();\
         allocator_traits_type::construct (this->m_holder.alloc()\
            , this->priv_raw_end() AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_FWD##N);\
         ++this->m_holder.m_size;\
         return *p;\
      }\
      else{\
         typedef container_detail::insert_emplace_proxy_arg##N<Allocator, T* AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_TARG##N> type;\
         return *this->priv_forward_range_insert_no_capacity\
            ( this->back_ptr(), 1, type(AUTOBOOST_MOVE_FWD##N), alloc_version());\
      }\
   }\
   \
   AUTOBOOST_MOVE_TMPL_LT##N AUTOBOOST_MOVE_CLASS##N AUTOBOOST_MOVE_GT##N \
   AUTOBOOST_CONTAINER_FORCEINLINE bool stable_emplace_back(AUTOBOOST_MOVE_UREF##N)\
   {\
      const bool is_room_enough = this->room_enough() || (alloc_version::value == 2 && this->m_holder.try_expand_fwd(1u));\
      if (AUTOBOOST_LIKELY(is_room_enough)){\
         allocator_traits_type::construct (this->m_holder.alloc()\
   ...
   \
   AUTOBOOST_MOVE_TMPL_LT##N AUTOBOOST_MOVE_CLASS##N AUTOBOOST_MOVE_GT##N \
   iterator emplace(const_iterator pos AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_UREF##N)\
   {\
      AUTOBOOST_ASSERT(this->priv_in_range_or_end(pos));\
      typedef container_detail::insert_emplace_proxy_arg##N<Allocator, T* AUTOBOOST_MOVE_I##N AUTOBOOST_MOVE_TARG##N> type;\
      return this->priv_forward_range_insert(vector_iterator_get_ptr(pos), 1, type(AUTOBOOST_MOVE_FWD##N));\
   }\
   //
   AUTOBOOST_MOVE_ITERATE_0TO9(AUTOBOOST_CONTAINER_VECTOR_EMPLACE_CODE)
   #undef AUTOBOOST_CONTAINER_VECTOR_EMPLACE_CODE
   ...
   #else
   AUTOBOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(insert, T, iterator, priv_insert, const_iterator, const_iterator)
   #endif
   ...
   {
      AUTOBOOST_ASSERT(this->priv_in_range_or_end(p));
   ...
   //!
   //! <b>Complexity</b>: Linear to autoboost::container::iterator_distance [first, last).
   template <class InIt>
      ...
      )
   {
      ...
      return this->priv_forward_range_insert(vector_iterator_get_ptr(pos), autoboost::container::iterator_distance(first, last), proxy);
   }
   #endif

   //! <b>Requires</b>: p must be a valid iterator of *this. num, must
   //!   be equal to autoboost::container::iterator_distance(first, last)
   //!
   //! <b>Effects</b>: Insert a copy of the [first, last) range before pos.
   //!
   //! <b>Returns</b>: an iterator to the first inserted element or pos if first == last.
   ...
   //! <b>Complexity</b>: Linear to autoboost::container::iterator_distance [first, last).
   //!
   //! <b>Note</b>: This function avoids a linear operation to calculate autoboost::container::iterator_distance[first, last)
   ...
   {
      AUTOBOOST_ASSERT(this->priv_in_range_or_end(pos));
      AUTOBOOST_ASSERT(container_detail::is_input_iterator<InIt>::value ||
                   num == static_cast<size_type>(autoboost::container::iterator_distance(first, last)));
      (void)last;
   ...
   //!
   //! <b>Complexity</b>: Constant time.
   void pop_back() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      AUTOBOOST_ASSERT(!this->empty());
   ...
   {
      AUTOBOOST_ASSERT(this->priv_in_range(position));
      ...
      T *const new_end_ptr = ::autoboost::container::move(pos_ptr + 1, beg_ptr + this->m_holder.m_size, pos_ptr);
   ...
   iterator erase(const_iterator first, const_iterator last)
   {
      ...
      if (first != last){
         ...
         T* const ptr = container_detail::to_raw_pointer(autoboost::container::move(last_ptr, old_end_ptr, first_ptr));
   ...
   //! <b>Complexity</b>: Constant.
   void swap(vector& x)
      AUTOBOOST_NOEXCEPT_IF( ((allocator_traits_type::propagate_on_container_swap::value
                                    || allocator_traits_type::is_always_equal::value) &&
   ...
   void priv_insert_ordered_at(const size_type element_count, PositionValue position_value)
   {
      ...
      while(insertions_left){
         ...
         AUTOBOOST_ASSERT(pos != size_type(-1) && pos <= old_size_pos && pos <= prev_pos);
   ...
   {
      size_type const n = static_cast<size_type>(autoboost::container::iterator_distance(first, last));
      size_type const s = this->size();
      if(AUTOBOOST_LIKELY(s)){
         ...
         if(free_c < n){
            ...
            while(remaining){
               ...
               autoboost::uintptr_t const szt_align_mask = container_detail::alignment_of<size_type>::value - 1;
               autoboost::uintptr_t const addr = autoboost::uintptr_t(this->priv_raw_begin() + s + n);
               autoboost::uintptr_t const capaddr = autoboost::uintptr_t(this->priv_raw_begin() + c);
               autoboost::uintptr_t const aligned_addr = (addr + szt_align_mask) & ~szt_align_mask;
               ...
               BidirIt limit = first;
               autoboost::container::iterator_advance(limit, index_capacity);
         ...
         while(1){
            ...
            if(comp(*first, *pcur)) {
               *position = static_cast<size_type>(pcur - pbeg);
               AUTOBOOST_ASSERT((position == positions) || (*(position-1) == size_type(-1)) || (*(position-1) <= *position));
               ++position;
               ++added_in_middle;
               --remaining;
               if(++first == last)  break;
   ...
   {
      AUTOBOOST_ASSERT((new_cap >= this->size() ) && (new_cap - this->size()) >= n);
      ...
      while(1){
         if(!n) {
            ::autoboost::container::uninitialized_move_alloc(this->m_holder.alloc(), pbeg, pend, d_first);
            break;
         }
         else if(pbeg == pend) {
            ::autoboost::container::uninitialized_move_alloc_n(this->m_holder.alloc(), first, n, d_first);
            break;
         }
         //maintain stability moving external values only if they are strictly less
         else if(comp(*first, *pbeg)) {
            allocator_traits_type::construct( this->m_holder.alloc(), d_first, ::autoboost::move(*first) );
            ...
            allocator_traits_type::construct( this->m_holder.alloc(), d_first, ::autoboost::move(*pbeg) );
            new_values_destroyer.increment_size(1u);
            ++pbeg;
            ++d_first;
         }
      ...
      autoboost::container::destroy_alloc_n(a, container_detail::to_raw_pointer(old_p), old_size);
   ...
   {
      AUTOBOOST_ASSERT(this->m_holder.start() <= p);
      AUTOBOOST_ASSERT(p <= (this->m_holder.start()+this->size()));
      return static_cast<size_type>(p - this->m_holder.start());
   }

   template<class OtherAllocator>
   void priv_move_assign(AUTOBOOST_RV_REF_BEG vector<T, OtherAllocator> AUTOBOOST_RV_REF_END x
      , typename container_detail::enable_if_c
         < container_detail::is_version<OtherAllocator, 0>::value >::type * = 0)
   {
      ...
      autoboost::container::move_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
         ...
         < container_detail::is_version<OtherAllocator, 0>::value >::type * = 0)
   {
      ...
      const size_type this_sz  = m_holder.m_size;
      const size_type other_sz = static_cast<size_type>(x.m_holder.m_size);
      autoboost::container::copy_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
      this->m_holder.m_size = other_sz;
   }
   ...
   void priv_swap(Vector &x, container_detail::false_type)  //version_N
   {
      ...
      if(are_swap_propagable( this->get_stored_allocator(), this->m_holder.start()
         ...
         for(size_type i = 0; i != common_elements; ++i){
            autoboost::adl_move_swap(sml[i], big[i]);
         }
         //... and move-insert the remaining range
         sml.insert( sml.cend()
                   , autoboost::make_move_iterator(container_detail::iterator_to_raw_pointer(big.nth(common_elements)))
                   , autoboost::make_move_iterator(container_detail::iterator_to_raw_pointer(big.end()))
                   );
   ...
   container_detail::insert_range_proxy<Allocator, autoboost::move_iterator<T*>, T*> priv_dummy_empty_proxy()
   {
      return container_detail::insert_range_proxy<Allocator, autoboost::move_iterator<T*>, T*>
         (::autoboost::make_move_iterator((T *)0));
   }
   ...
   void priv_destroy_last(const bool moved = false) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      (void)moved;
   ...
   void priv_destroy_last_n(const size_type n) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      AUTOBOOST_ASSERT(n <= this->m_holder.m_size);
      if(!value_traits::trivial_dctr){
         T* const destroy_pos = this->priv_raw_begin() + (this->m_holder.m_size-n);
         autoboost::container::destroy_alloc_n(this->get_stored_allocator(), destroy_pos, n);
      }
   ...
   void priv_uninitialized_construct_at_end(InpIt first, InpIt last)
   {
      ...
      T* const new_end_pos = autoboost::container::uninitialized_copy_alloc(this->m_holder.alloc(), first, last, old_end_pos);
      this->m_holder.m_size += new_end_pos - old_end_pos;
   }

   void priv_destroy_all() AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      autoboost::container::destroy_alloc_n
         (this->get_stored_allocator(), this->priv_raw_begin(), this->m_holder.m_size);
      this->m_holder.m_size = 0;
   ...
   template<class U>
   iterator priv_insert(const const_iterator &p, AUTOBOOST_FWD_REF(U) x)
   {
      AUTOBOOST_ASSERT(this->priv_in_range_or_end(p));
      return this->priv_forward_range_insert
         ( vector_iterator_get_ptr(p), 1, container_detail::get_insert_value_proxy<T*, Allocator>(::autoboost::forward<U>(x)));
   }
   ...
   container_detail::insert_move_proxy<Allocator, T*> priv_single_insert_proxy(AUTOBOOST_RV_REF(T) x)
   {  return container_detail::insert_move_proxy<Allocator, T*> (x);  }

   template <class U>
   void priv_push_back(AUTOBOOST_FWD_REF(U) u)
   {
      if (AUTOBOOST_LIKELY(this->room_enough())){
         //There is more memory, just construct a new object at the end
         allocator_traits_type::construct
            ( this->m_holder.alloc(), this->priv_raw_end(), ::autoboost::forward<U>(u) );
         ++this->m_holder.m_size;
      }
      else{
         this->priv_forward_range_insert_no_capacity
            ( this->back_ptr(), 1
            , this->priv_single_insert_proxy(::autoboost::forward<U>(u)), alloc_version());
      }
   }
   ...
   void priv_shrink_to_fit(version_0) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {}
   ...
   void priv_shrink_to_fit(version_2) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {
      const size_type cp = this->m_holder.capacity();
      if(cp){
         const size_type sz = this->size();
   ...
   {
      AUTOBOOST_ASSERT(this->m_holder.capacity() >= this->m_holder.m_size);
      //Check if we have enough memory or try to expand current memory
   ...
   {
      AUTOBOOST_ASSERT(first_pos <= last_pos);
      AUTOBOOST_ASSERT(last_pos <= limit_pos);
      //
      T* const begin_ptr = this->priv_raw_begin();
      ...
      if((last_pos + shift_count) <= limit_pos){
         //All move assigned
         autoboost::container::move_backward(first_ptr, last_ptr, last_ptr + shift_count);
      }
      //Case B:
      ...
      //Case C:
         ...
         ::autoboost::container::uninitialized_move_alloc(this->m_holder.alloc(), boundary_ptr, last_ptr, limit_ptr);
         //The rest is move assigned
         autoboost::container::move_backward(first_ptr, boundary_ptr, limit_ptr);
      }
      return hole_size;
   }
   ...
   void priv_forward_range_insert_expand_forward(T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(AUTOBOOST_UNLIKELY(!n)) return;
      ...
      if (!elems_after){
         ...
         autoboost::container::move_backward(pos, old_finish - n, old_finish);
         ...
         ::autoboost::container::uninitialized_move_alloc(this->m_holder.alloc(), pos, old_finish, pos + n);
         AUTOBOOST_TRY{
         ...
         AUTOBOOST_CATCH(...){
            autoboost::container::destroy_alloc_n(this->get_stored_allocator(), pos + n, elems_after);
            AUTOBOOST_RETHROW
         }
         AUTOBOOST_CATCH_END
      }
      ...
      (T* const new_start, size_type new_cap, T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(old_buffer){
         new_finish = ::autoboost::container::uninitialized_move_alloc
      ...
      if(old_buffer){
         ...
         if(!value_traits::trivial_dctr_after_move)
            autoboost::container::destroy_alloc_n(this->get_stored_allocator(), old_buffer, this->m_holder.m_size);
          ...
          T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(s_before >= before_plus_new){
         ...
         T *const new_elem_pos =
            ::autoboost::container::uninitialized_move_alloc(this->m_holder.alloc(), old_start, pos, new_start);
         ...
         //s_before is so big that divides old_end
            ...
            if(!value_traits::trivial_dctr){
               ...
               if(remaining_pos != old_start){  //Make sure data has to be moved
                  ::autoboost::container::move(remaining_pos, old_finish, old_start);
               }
         ...
         if (s_before <= elemsbefore) {
            ...
            T *const next = ::autoboost::container::move(old_start + s_before, pos, old_start);
            ...
            if(!do_after && (n != s_before)){
               ...
               ::autoboost::container::move(pos, old_finish, next + new_1st_range);
            }
         }
         else {
            ...
            if(do_after){
               ...
               T* const move_end = move_start != pos ? ::autoboost::container::move(pos, old_finish, move_start)
                                                     : old_finish;
               //Destroy remaining moved elements from old_end except if they
               //have trivial destructor after being moved
               size_type n_destroy = s_before - n;
               if(!value_traits::trivial_dctr_after_move)
                  autoboost::container::destroy_alloc_n(this->get_stored_allocator(), move_end, n_destroy);
         ...
         if(do_after){
            ...
            if (elemsafter >= n_after){
               ...
               autoboost::container::move_backward(pos, finish_n, old_finish);
...
#endif //   #ifndef  AUTOBOOST_CONTAINER_CONTAINER_VECTOR_HPP
