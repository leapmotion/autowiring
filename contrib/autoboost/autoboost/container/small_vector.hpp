   ...
   : public Allocator
{
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE const Allocator &as_base() const
   {  return static_cast<const Allocator&>(*this);  }

   AUTOBOOST_CONTAINER_FORCEINLINE Allocator &as_base()
   ...
   struct rebind
   {
      ...
      template<class ...Args>
      AUTOBOOST_CONTAINER_FORCEINLINE explicit small_vector_allocator(AUTOBOOST_FWD_REF(Args) ...args)
      ...
      AUTOBOOST_CONTAINER_FORCEINLINE explicit small_vector_allocator(AUTOBOOST_MOVE_UREF##N)\
   ...
   //!Never throws
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector_allocator
      (const small_vector_allocator &other) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!Never throws
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector_allocator
      (AUTOBOOST_RV_REF(small_vector_allocator) other) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector_allocator
      (const small_vector_allocator<OtherAllocator> &other) AUTOBOOST_NOEXCEPT_OR_NOTHROW
      : Allocator(other.as_base())
   {}
   ...
   template<class OtherAllocator>
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector_allocator
      (AUTOBOOST_RV_REF(small_vector_allocator<OtherAllocator>) other) AUTOBOOST_NOEXCEPT_OR_NOTHROW
      : Allocator(::autoboost::move(other.as_base()))
   {}
   ...
   //!Never throws
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector_allocator &
      operator=(AUTOBOOST_COPY_ASSIGN_REF(small_vector_allocator) other) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   //!Never throws
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector_allocator &
      operator=(AUTOBOOST_RV_REF(small_vector_allocator) other) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   template<class OtherAllocator>
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector_allocator &
      operator=(AUTOBOOST_COPY_ASSIGN_REF(small_vector_allocator<OtherAllocator>) other) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return static_cast<small_vector_allocator&>(this->Allocator::operator=(other.as_base()));  }
   ...
   template<class OtherAllocator>
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector_allocator &
      operator=(AUTOBOOST_RV_REF(small_vector_allocator<OtherAllocator>) other) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   {  return static_cast<small_vector_allocator&>(this->Allocator::operator=(::autoboost::move(other.as_base())));  }

   //!Allocates storage from the standard-conforming allocator
   AUTOBOOST_CONTAINER_FORCEINLINE pointer allocate(size_type count, const_void_pointer hint = const_void_pointer())
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE friend void swap(small_vector_allocator &l, small_vector_allocator &r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE friend bool operator==(const small_vector_allocator &l, const small_vector_allocator &r) AUTOBOOST_NOEXCEPT_OR_NOTHROW
   ...
   */
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE bool is_internal_storage(pointer p) const
   ...
   : public vector<T, small_vector_allocator<SecondaryAllocator> >
{
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE explicit small_vector_base(initial_capacity_t, std::size_t initial_capacity)
      : base_type(initial_capacity_t(), this->internal_storage(), initial_capacity)
   {}

   template<class AllocFwd>
   AUTOBOOST_CONTAINER_FORCEINLINE explicit small_vector_base(initial_capacity_t, std::size_t capacity, AUTOBOOST_FWD_REF(AllocFwd) a)
   ...
   public:
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector_base& operator=(AUTOBOOST_COPY_ASSIGN_REF(small_vector_base) other)
   {  return static_cast<small_vector_base&>(this->base_type::operator=(static_cast<base_type const&>(other)));  }

   AUTOBOOST_CONTAINER_FORCEINLINE small_vector_base& operator=(AUTOBOOST_RV_REF(small_vector_base) other)
   {  return static_cast<small_vector_base&>(this->base_type::operator=(AUTOBOOST_MOVE_BASE(base_type, other))); }

   AUTOBOOST_CONTAINER_FORCEINLINE void swap(small_vector_base &other)
   ...
   #endif
{
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE static std::size_t internal_capacity()
   ...
   public:
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector()
      AUTOBOOST_NOEXCEPT_IF(container_detail::is_nothrow_default_constructible<Allocator>::value)
      : base_type(initial_capacity_t(), internal_capacity())
   {}

   AUTOBOOST_CONTAINER_FORCEINLINE explicit small_vector(const allocator_type &a)
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {}

   AUTOBOOST_CONTAINER_FORCEINLINE explicit small_vector(size_type n)
      : base_type(initial_capacity_t(), internal_capacity())
   {  this->resize(n); }

   AUTOBOOST_CONTAINER_FORCEINLINE small_vector(size_type n, const allocator_type &a)
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {  this->resize(n); }

   AUTOBOOST_CONTAINER_FORCEINLINE small_vector(size_type n, default_init_t)
      : base_type(initial_capacity_t(), internal_capacity())
   {  this->resize(n, default_init_t()); }

   AUTOBOOST_CONTAINER_FORCEINLINE small_vector(size_type n, default_init_t, const allocator_type &a)
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {  this->resize(n, default_init_t()); }

   AUTOBOOST_CONTAINER_FORCEINLINE small_vector(size_type n, const value_type &v)
      : base_type(initial_capacity_t(), internal_capacity())
   {  this->resize(n, v); }

   AUTOBOOST_CONTAINER_FORCEINLINE small_vector(size_type n, const value_type &v, const allocator_type &a)
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {  this->resize(n, v); }

   template <class InIt>
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector(InIt first, InIt last
   ...
   template <class InIt>
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector(InIt first, InIt last, const allocator_type& a
      AUTOBOOST_CONTAINER_DOCIGN(AUTOBOOST_MOVE_I typename container_detail::disable_if_c
         < container_detail::is_convertible<InIt AUTOBOOST_MOVE_I size_type>::value
         AUTOBOOST_MOVE_I container_detail::nat >::type * = 0)
      )
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector(const small_vector &other)
      : base_type( initial_capacity_t(), internal_capacity()
                 , allocator_traits_type::select_on_container_copy_construction(other.get_stored_allocator()))
   {  this->assign(other.cbegin(), other.cend());  }

   AUTOBOOST_CONTAINER_FORCEINLINE small_vector(const small_vector &other, const allocator_type &a)
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {  this->assign(other.cbegin(), other.cend());  }

   AUTOBOOST_CONTAINER_FORCEINLINE explicit small_vector(const base_type &other)
      : base_type( initial_capacity_t(), internal_capacity()
                 , allocator_traits_type::select_on_container_copy_construction(other.get_stored_allocator()))
   {  this->assign(other.cbegin(), other.cend());  }

   AUTOBOOST_CONTAINER_FORCEINLINE explicit small_vector(AUTOBOOST_RV_REF(base_type) other)
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector(AUTOBOOST_RV_REF(small_vector) other)
      : base_type(initial_capacity_t(), internal_capacity(), ::autoboost::move(other.get_stored_allocator()))
   {  this->move_construct_impl(other, other.get_stored_allocator());   }

   AUTOBOOST_CONTAINER_FORCEINLINE small_vector(AUTOBOOST_RV_REF(small_vector) other, const allocator_type &a)
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {  this->move_construct_impl(other, a);   }

   #if !defined(AUTOBOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector(std::initializer_list<value_type> il, const allocator_type& a = allocator_type())
      : base_type(initial_capacity_t(), internal_capacity(), a)
   {
   ...
   AUTOBOOST_CONTAINER_FORCEINLINE small_vector& operator=(AUTOBOOST_COPY_ASSIGN_REF(small_vector) other)
   {  return static_cast<small_vector&>(this->base_type::operator=(static_cast<base_type const&>(other)));  }

   AUTOBOOST_CONTAINER_FORCEINLINE small_vector& operator=(AUTOBOOST_RV_REF(small_vector) other)
   {  return static_cast<small_vector&>(this->base_type::operator=(AUTOBOOST_MOVE_BASE(base_type, other))); }

   AUTOBOOST_CONTAINER_FORCEINLINE small_vector& operator=(const base_type &other)
   {  return static_cast<small_vector&>(this->base_type::operator=(other));  }

   AUTOBOOST_CONTAINER_FORCEINLINE small_vector& operator=(AUTOBOOST_RV_REF(base_type) other)
   {  return static_cast<small_vector&>(this->base_type::operator=(autoboost::move(other))); }

   AUTOBOOST_CONTAINER_FORCEINLINE void swap(small_vector &other)
   {  return this->base_type::swap(other);  }
};
