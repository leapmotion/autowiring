...
#ifndef AUTOBOOST_CONTAINER_USES_ALLOCATOR_FWD_HPP
#define AUTOBOOST_CONTAINER_USES_ALLOCATOR_FWD_HPP

#include <autoboost/container/detail/workaround.hpp>
#include <autoboost/container/detail/std_fwd.hpp>

//! \file
//!   This header forward declares autoboost::container::constructible_with_allocator_prefix,
//!   autoboost::container::constructible_with_allocator_suffix and
//!   autoboost::container::uses_allocator. Also defines the following types:
...
//! A instance of type
//! allocator_arg_t
static allocator_arg_t allocator_arg = AUTOBOOST_CONTAINER_DOC1ST(unspecified, *std_allocator_arg_holder<>::dummy);
...
#endif   //AUTOBOOST_CONTAINER_USES_ALLOCATOR_HPP
