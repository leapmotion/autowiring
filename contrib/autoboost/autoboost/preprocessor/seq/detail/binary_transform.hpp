...
#		define AUTOBOOST_PP_SEQ_BINARY_TRANSFORM_GET_REM(...) \
			AUTOBOOST_PP_VARIADIC_IS_SINGLE_RETURN(AUTOBOOST_PP_REM_CAT,AUTOBOOST_PP_REM,__VA_ARGS__) \
		/**/
#	 else
#		define AUTOBOOST_PP_SEQ_BINARY_TRANSFORM_GET_REM(...) AUTOBOOST_PP_REM
#	 endif
#    define AUTOBOOST_PP_SEQ_BINARY_TRANSFORM_A(...) (AUTOBOOST_PP_SEQ_BINARY_TRANSFORM_GET_REM(__VA_ARGS__), __VA_ARGS__)() AUTOBOOST_PP_SEQ_BINARY_TRANSFORM_B
#    define AUTOBOOST_PP_SEQ_BINARY_TRANSFORM_B(...) (AUTOBOOST_PP_SEQ_BINARY_TRANSFORM_GET_REM(__VA_ARGS__), __VA_ARGS__)() AUTOBOOST_PP_SEQ_BINARY_TRANSFORM_A
# else
