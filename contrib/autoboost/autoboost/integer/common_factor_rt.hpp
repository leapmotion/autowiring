...
#ifndef AUTOBOOST_INTEGER_COMMON_FACTOR_RT_HPP
#define AUTOBOOST_INTEGER_COMMON_FACTOR_RT_HPP
...
};  // autoboost::integer::gcd_evaluator
...
};  // autoboost::integer::lcm_evaluator
...
#endif  // AUTOBOOST_INTEGER_COMMON_FACTOR_RT_HPP
