...
#ifndef AUTOBOOST_MATH_TOOLS_FRACTION_INCLUDED
#define AUTOBOOST_MATH_TOOLS_FRACTION_INCLUDED
...
namespace detail
{
   ...
   template <class T>
   struct is_pair : public autoboost::false_type{};

   template <class T, class U>
   struct is_pair<std::pair<T,U> > : public autoboost::true_type{};
   ...
   struct fraction_traits_simple
   {
       ...
       static result_type a(const value_type&) AUTOBOOST_MATH_NOEXCEPT(value_type)
       {
          return 1;
       }
       static result_type b(const value_type& v) AUTOBOOST_MATH_NOEXCEPT(value_type)
       {
          return v;
       }
   };
   ...
   struct fraction_traits_pair
   {
       ...
       static result_type a(const value_type& v) AUTOBOOST_MATH_NOEXCEPT(value_type)
       {
          return v.first;
       }
       static result_type b(const value_type& v) AUTOBOOST_MATH_NOEXCEPT(value_type)
...
inline typename detail::fraction_traits<Gen>::result_type continued_fraction_b(Gen& g, const U& factor, autoboost::uintmax_t& max_terms)
      AUTOBOOST_NOEXCEPT_IF(AUTOBOOST_MATH_IS_FLOAT(typename detail::fraction_traits<Gen>::result_type) && noexcept(std::declval<Gen>()()))
{
...
inline typename detail::fraction_traits<Gen>::result_type continued_fraction_b(Gen& g, const U& factor)
   AUTOBOOST_NOEXCEPT_IF(AUTOBOOST_MATH_IS_FLOAT(typename detail::fraction_traits<Gen>::result_type) && noexcept(std::declval<Gen>()()))
{
   autoboost::uintmax_t max_terms = (std::numeric_limits<autoboost::uintmax_t>::max)();
...
template <class Gen>
inline typename detail::fraction_traits<Gen>::result_type continued_fraction_b(Gen& g, int bits, autoboost::uintmax_t& max_terms)
   AUTOBOOST_NOEXCEPT_IF(AUTOBOOST_MATH_IS_FLOAT(typename detail::fraction_traits<Gen>::result_type) && noexcept(std::declval<Gen>()()))
{
   AUTOBOOST_MATH_STD_USING // ADL of std names
...
//
template <class Gen, class U>
inline typename detail::fraction_traits<Gen>::result_type continued_fraction_a(Gen& g, const U& factor, autoboost::uintmax_t& max_terms)
   AUTOBOOST_NOEXCEPT_IF(AUTOBOOST_MATH_IS_FLOAT(typename detail::fraction_traits<Gen>::result_type) && noexcept(std::declval<Gen>()()))
{
   AUTOBOOST_MATH_STD_USING // ADL of std names
...
inline typename detail::fraction_traits<Gen>::result_type continued_fraction_a(Gen& g, const U& factor)
   AUTOBOOST_NOEXCEPT_IF(AUTOBOOST_MATH_IS_FLOAT(typename detail::fraction_traits<Gen>::result_type) && noexcept(std::declval<Gen>()()))
{
   autoboost::uintmax_t max_iter = (std::numeric_limits<autoboost::uintmax_t>::max)();
...
template <class Gen>
inline typename detail::fraction_traits<Gen>::result_type continued_fraction_a(Gen& g, int bits, autoboost::uintmax_t& max_terms)
   AUTOBOOST_NOEXCEPT_IF(AUTOBOOST_MATH_IS_FLOAT(typename detail::fraction_traits<Gen>::result_type) && noexcept(std::declval<Gen>()()))
{
   AUTOBOOST_MATH_STD_USING // ADL of std names
...
#endif // AUTOBOOST_MATH_TOOLS_FRACTION_INCLUDED
