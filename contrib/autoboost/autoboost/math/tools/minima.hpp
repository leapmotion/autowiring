...
#ifndef AUTOBOOST_MATH_TOOLS_MINIMA_HPP
#define AUTOBOOST_MATH_TOOLS_MINIMA_HPP
...
std::pair<T, T> brent_find_minima(F f, T min, T max, int bits, autoboost::uintmax_t& max_iter)
   AUTOBOOST_NOEXCEPT_IF(AUTOBOOST_MATH_IS_FLOAT(T) && noexcept(std::declval<F>()(std::declval<T>())))
{
