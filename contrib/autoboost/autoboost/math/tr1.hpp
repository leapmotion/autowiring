...
{ return static_cast<typename tools::promote_args<T1, T2>::type>(autoboost::math::tr1::nexttoward AUTOBOOST_PREVENT_MACRO_SUBSTITUTION(static_cast<typename tools::promote_args<T1, T2>::type>(x), static_cast<long double>(y))); }
#if 0
