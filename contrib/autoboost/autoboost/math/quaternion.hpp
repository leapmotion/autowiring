//  autoboost quaternion.hpp header file
...
#ifndef AUTOBOOST_QUATERNION_HPP
#define AUTOBOOST_QUATERNION_HPP
...
#include <autoboost/config.hpp> // for AUTOBOOST_NO_STD_LOCALE
...
#include <autoboost/math/special_functions/sinc.hpp>    // for the Sinus cardinal
#include <autoboost/math/special_functions/sinhc.hpp>    // for the Hyperbolic Sinus cardinal
...
#define    AUTOBOOST_QUATERNION_ACCESSOR_GENERATOR(type)                    \
            type                    real() const                        \
            {                                                           \
                return(a);                                              \
            }                                                           \
...
#define    AUTOBOOST_QUATERNION_MEMBER_ASSIGNMENT_GENERATOR(type)                               \
            template<typename X>                                                            \
...
#define    AUTOBOOST_QUATERNION_MEMBER_DATA_GENERATOR(type)       \
            type    a;                                        \
            type    b;                                        \
            type    c;                                        \
            type    d;
        ...
        public:
            ...
            AUTOBOOST_QUATERNION_ACCESSOR_GENERATOR(T)

            // assignment operators

            AUTOBOOST_QUATERNION_MEMBER_ASSIGNMENT_GENERATOR(T)
        ...
        protected:
            ...
            AUTOBOOST_QUATERNION_MEMBER_DATA_GENERATOR(T)
...
#define    AUTOBOOST_QUATERNION_CONSTRUCTOR_GENERATOR(type)                                                 \
...
#define    AUTOBOOST_QUATERNION_MEMBER_ADD_GENERATOR_1(type)             \
...
#define    AUTOBOOST_QUATERNION_MEMBER_ADD_GENERATOR_2(type)                             \
...
#define    AUTOBOOST_QUATERNION_MEMBER_ADD_GENERATOR_3(type)                      \
            template<typename X>                                              \
...
#define    AUTOBOOST_QUATERNION_MEMBER_SUB_GENERATOR_1(type)             \
            quaternion<type> &        operator -= (type const & rhs) \
            {                                                        \
                a -= rhs;                                            \
                                                                     \
...
#define    AUTOBOOST_QUATERNION_MEMBER_SUB_GENERATOR_2(type)                             \
            quaternion<type> &        operator -= (::std::complex<type> const & rhs) \
            {                                                                        \
                a -= rhs.real();                                                     \
                b -= rhs.imag();                                                     \
...
#define    AUTOBOOST_QUATERNION_MEMBER_SUB_GENERATOR_3(type)                      \
            template<typename X>                                              \
            quaternion<type> &        operator -= (quaternion<X> const & rhs) \
            {                                                                 \
                a -= static_cast<type>(rhs.R_component_1());                  \
...
#define    AUTOBOOST_QUATERNION_MEMBER_MUL_GENERATOR_1(type)             \
            quaternion<type> &        operator *= (type const & rhs) \
            {                                                        \
                a *= rhs;                                            \
                b *= rhs;                                            \
...
#define    AUTOBOOST_QUATERNION_MEMBER_MUL_GENERATOR_2(type)                             \
            quaternion<type> &        operator *= (::std::complex<type> const & rhs) \
            {                                                                        \
                type    ar = rhs.real();                                             \
                type    br = rhs.imag();                                             \
...
#define    AUTOBOOST_QUATERNION_MEMBER_MUL_GENERATOR_3(type)                      \
            template<typename X>                                              \
            quaternion<type> &        operator *= (quaternion<X> const & rhs) \
            {                                                                 \
...
#define    AUTOBOOST_QUATERNION_MEMBER_DIV_GENERATOR_1(type)             \
            quaternion<type> &        operator /= (type const & rhs) \
            {                                                        \
                a /= rhs;                                            \
                b /= rhs;                                            \
    ...
    #define    AUTOBOOST_QUATERNION_MEMBER_DIV_GENERATOR_2(type)                         \
            quaternion<type> &        operator /= (::std::complex<type> const & rhs) \
            {                                                                        \
                using    ::std::valarray;                                            \
                using    ::std::abs;                                                 \
...
#if defined(AUTOBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP)
    #define    AUTOBOOST_QUATERNION_MEMBER_DIV_GENERATOR_3(type)                  \
            template<typename X>                                              \
            quaternion<type> &        operator /= (quaternion<X> const & rhs) \
            {                                                                 \
                using    ::std::valarray;                                     \
...
#define    AUTOBOOST_QUATERNION_MEMBER_ADD_GENERATOR(type)   \
        AUTOBOOST_QUATERNION_MEMBER_ADD_GENERATOR_1(type)    \
        AUTOBOOST_QUATERNION_MEMBER_ADD_GENERATOR_2(type)    \
        AUTOBOOST_QUATERNION_MEMBER_ADD_GENERATOR_3(type)

#define    AUTOBOOST_QUATERNION_MEMBER_SUB_GENERATOR(type)   \
        AUTOBOOST_QUATERNION_MEMBER_SUB_GENERATOR_1(type)    \
        AUTOBOOST_QUATERNION_MEMBER_SUB_GENERATOR_2(type)    \
        AUTOBOOST_QUATERNION_MEMBER_SUB_GENERATOR_3(type)

#define    AUTOBOOST_QUATERNION_MEMBER_MUL_GENERATOR(type)   \
        AUTOBOOST_QUATERNION_MEMBER_MUL_GENERATOR_1(type)    \
        AUTOBOOST_QUATERNION_MEMBER_MUL_GENERATOR_2(type)    \
        AUTOBOOST_QUATERNION_MEMBER_MUL_GENERATOR_3(type)

#define    AUTOBOOST_QUATERNION_MEMBER_DIV_GENERATOR(type)   \
        AUTOBOOST_QUATERNION_MEMBER_DIV_GENERATOR_1(type)    \
        AUTOBOOST_QUATERNION_MEMBER_DIV_GENERATOR_2(type)    \
        AUTOBOOST_QUATERNION_MEMBER_DIV_GENERATOR_3(type)

#define    AUTOBOOST_QUATERNION_MEMBER_ALGEBRAIC_GENERATOR(type)   \
        AUTOBOOST_QUATERNION_MEMBER_ADD_GENERATOR(type)            \
        AUTOBOOST_QUATERNION_MEMBER_SUB_GENERATOR(type)            \
        AUTOBOOST_QUATERNION_MEMBER_MUL_GENERATOR(type)            \
        AUTOBOOST_QUATERNION_MEMBER_DIV_GENERATOR(type)
        ...
        public:
            ...
            AUTOBOOST_QUATERNION_CONSTRUCTOR_GENERATOR(float)
            ...
            AUTOBOOST_QUATERNION_ACCESSOR_GENERATOR(float)

            // assignment operators

            AUTOBOOST_QUATERNION_MEMBER_ASSIGNMENT_GENERATOR(float)
            ...
            AUTOBOOST_QUATERNION_MEMBER_ALGEBRAIC_GENERATOR(float)


        protected:

            AUTOBOOST_QUATERNION_MEMBER_DATA_GENERATOR(float)
        ...
        public:
            ...
            AUTOBOOST_QUATERNION_CONSTRUCTOR_GENERATOR(double)
            ...
            AUTOBOOST_QUATERNION_ACCESSOR_GENERATOR(double)

            // assignment operators

            AUTOBOOST_QUATERNION_MEMBER_ASSIGNMENT_GENERATOR(double)
            ...
            AUTOBOOST_QUATERNION_MEMBER_ALGEBRAIC_GENERATOR(double)


        protected:

            AUTOBOOST_QUATERNION_MEMBER_DATA_GENERATOR(double)
        ...
        public:
            ...
            AUTOBOOST_QUATERNION_CONSTRUCTOR_GENERATOR(long double)
            ...
            AUTOBOOST_QUATERNION_ACCESSOR_GENERATOR(long double)

            // assignment operators

            AUTOBOOST_QUATERNION_MEMBER_ASSIGNMENT_GENERATOR(long double)
            ...
            AUTOBOOST_QUATERNION_MEMBER_ALGEBRAIC_GENERATOR(long double)


        protected:

            AUTOBOOST_QUATERNION_MEMBER_DATA_GENERATOR(long double)
...
#undef    AUTOBOOST_QUATERNION_MEMBER_ALGEBRAIC_GENERATOR
#undef    AUTOBOOST_QUATERNION_MEMBER_ADD_GENERATOR
#undef    AUTOBOOST_QUATERNION_MEMBER_SUB_GENERATOR
#undef    AUTOBOOST_QUATERNION_MEMBER_MUL_GENERATOR
#undef    AUTOBOOST_QUATERNION_MEMBER_DIV_GENERATOR
#undef    AUTOBOOST_QUATERNION_MEMBER_ADD_GENERATOR_1
#undef    AUTOBOOST_QUATERNION_MEMBER_ADD_GENERATOR_2
#undef    AUTOBOOST_QUATERNION_MEMBER_ADD_GENERATOR_3
#undef    AUTOBOOST_QUATERNION_MEMBER_SUB_GENERATOR_1
#undef    AUTOBOOST_QUATERNION_MEMBER_SUB_GENERATOR_2
#undef    AUTOBOOST_QUATERNION_MEMBER_SUB_GENERATOR_3
#undef    AUTOBOOST_QUATERNION_MEMBER_MUL_GENERATOR_1
#undef    AUTOBOOST_QUATERNION_MEMBER_MUL_GENERATOR_2
#undef    AUTOBOOST_QUATERNION_MEMBER_MUL_GENERATOR_3
#undef    AUTOBOOST_QUATERNION_MEMBER_DIV_GENERATOR_1
#undef    AUTOBOOST_QUATERNION_MEMBER_DIV_GENERATOR_2
#undef    AUTOBOOST_QUATERNION_MEMBER_DIV_GENERATOR_3

#undef    AUTOBOOST_QUATERNION_CONSTRUCTOR_GENERATOR


#undef    AUTOBOOST_QUATERNION_MEMBER_ASSIGNMENT_GENERATOR

#undef    AUTOBOOST_QUATERNION_MEMBER_DATA_GENERATOR

#undef    AUTOBOOST_QUATERNION_ACCESSOR_GENERATOR


        // operators

#define    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_BODY(op)      \
        {                                                    \
...
#define    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_1_L(op)                                                  \
        template<typename T>                                                                            \
        inline quaternion<T>    operator op (T const & lhs, quaternion<T> const & rhs)                  \
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_BODY(op)

#define    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_1_R(op)                                                  \
        template<typename T>                                                                            \
        inline quaternion<T>    operator op (quaternion<T> const & lhs, T const & rhs)                  \
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_BODY(op)

#define    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_2_L(op)                                                  \
        template<typename T>                                                                            \
        inline quaternion<T>    operator op (::std::complex<T> const & lhs, quaternion<T> const & rhs)  \
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_BODY(op)

#define    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_2_R(op)                                                  \
        template<typename T>                                                                            \
        inline quaternion<T>    operator op (quaternion<T> const & lhs, ::std::complex<T> const & rhs)  \
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_BODY(op)

#define    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_3(op)                                                    \
        template<typename T>                                                                            \
        inline quaternion<T>    operator op (quaternion<T> const & lhs, quaternion<T> const & rhs)      \
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_BODY(op)

#define    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR(op)     \
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_1_L(op)    \
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_1_R(op)    \
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_2_L(op)    \
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_2_R(op)    \
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_3(op)


        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR(+)
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR(-)
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR(*)
        AUTOBOOST_QUATERNION_OPERATOR_GENERATOR(/)


#undef    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR

#undef    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_1_L
#undef    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_1_R
#undef    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_2_L
#undef    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_2_R
#undef    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_3

#undef    AUTOBOOST_QUATERNION_OPERATOR_GENERATOR_BODY
...
#define    AUTOBOOST_QUATERNION_NOT_EQUAL_GENERATOR  \
        {                                        \
            return(!(lhs == rhs));               \
        }
        ...
        template<typename T>
        inline bool                                operator != (T const & lhs, quaternion<T> const & rhs)
        AUTOBOOST_QUATERNION_NOT_EQUAL_GENERATOR
...
#undef    AUTOBOOST_QUATERNION_NOT_EQUAL_GENERATOR
...
#define    AUTOBOOST_QUATERNION_VALARRAY_LOADER  \
            using    ::std::valarray;        \
                                             \
            valarray<T>    temp(4);          \
                                             \
        ...
        inline T                                sup(quaternion<T> const & q)
        {
            ...
            AUTOBOOST_QUATERNION_VALARRAY_LOADER
...
#undef    AUTOBOOST_QUATERNION_VALARRAY_LOADER
...
#endif /* AUTOBOOST_QUATERNION_HPP */
