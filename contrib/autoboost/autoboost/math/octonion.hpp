//    autoboost octonion.hpp header file
...
#ifndef AUTOBOOST_OCTONION_HPP
#define AUTOBOOST_OCTONION_HPP

#include <autoboost/math/quaternion.hpp>
...
#define    AUTOBOOST_OCTONION_ACCESSOR_GENERATOR(type)                      \
            type                        real() const                    \
            {                                                           \
                return(a);                                              \
            }                                                           \
            ...
            {                                                           \
                return(::std::complex<type>(g,h));                      \
                                                                        ...
                                                                        \
            ::autoboost::math::quaternion<type>    H_component_1() const    \
            {                                                           \
                return(::autoboost::math::quaternion<type>(a,b,c,d));       \
            }                                                           \
                                                                        \
            ::autoboost::math::quaternion<type>    H_component_2() const    \
            {                                                           \
                return(::autoboost::math::quaternion<type>(e,f,g,h));       \
            }


#define    AUTOBOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(type)                                         \
            template<typename X>                                                                    \
            ...
            {                                                                                       \
                ...
                return(*this);                                                                      \
                                                                                                    ...
                                                                                                    \
            octonion<type> &        operator = (::autoboost::math::quaternion<type> const & a_affecter) \
            {                                                                                       \
...
#define    AUTOBOOST_OCTONION_MEMBER_DATA_GENERATOR(type) \
            type    a;                                \
            type    b;                                \
            type    c;                                \
            type    d;                                \
        ...
        public:
            ...
            explicit                octonion(   ::autoboost::math::quaternion<T> const & q0,
                                                ::autoboost::math::quaternion<T> const & q1 = ::autoboost::math::quaternion<T>())
            :   a(q0.R_component_1()),
                b(q0.R_component_2()),
                c(q0.R_component_3()),
                d(q0.R_component_4()),
            ...
            AUTOBOOST_OCTONION_ACCESSOR_GENERATOR(T)

            // assignment operators

            AUTOBOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(T)
            ...
            octonion<T> &            operator += (::autoboost::math::quaternion<T> const & rhs)
            {
        ...
        protected:
            ...
            AUTOBOOST_OCTONION_MEMBER_DATA_GENERATOR(T)
...
#define    AUTOBOOST_OCTONION_CONSTRUCTOR_GENERATOR(type)                                                                               \
            ...
            {                                                                                                                       \
                                                                                                                                    ...
                                                                                                                                    \
            explicit                    octonion(   ::autoboost::math::quaternion<type> const & q0,                                     \
                                                    ::autoboost::math::quaternion<type> const & q1 = ::autoboost::math::quaternion<type>()) \
            :   a(q0.R_component_1()),                                                                                              \
                b(q0.R_component_2()),                                                                                              \
                c(q0.R_component_3()),                                                                                              \
                d(q0.R_component_4()),                                                                                              \
...
#define    AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR_1(type)                  \
...
#define    AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR_2(type)                                  \
...
#define    AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR_3(type)                                              \
            octonion<type> &            operator += (::autoboost::math::quaternion<type> const & rhs)   \
            {                                                                                       \
                a += rhs.R_component_1();                                                           \
                b += rhs.R_component_2();                                                           \
                c += rhs.R_component_3();                                                           \
...
#define    AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR_4(type)                          \
            template<typename X>                                                \
...
#define    AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR_1(type)                  \
            octonion<type> &            operator -= (type const & rhs)  \
            {                                                           \
                a -= rhs;                                               \
                                                                        \
...
#define    AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR_2(type)                                  \
            octonion<type> &            operator -= (::std::complex<type> const & rhs)  \
            {                                                                           \
                a -= rhs.real();                                                        \
                b -= rhs.imag();                                                        \
...
#define    AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR_3(type)                                              \
            octonion<type> &            operator -= (::autoboost::math::quaternion<type> const & rhs)   \
            {                                                                                       \
                a -= rhs.R_component_1();                                                           \
                b -= rhs.R_component_2();                                                           \
...
#define    AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR_4(type)                        \
            template<typename X>                                              \
            octonion<type> &            operator -= (octonion<X> const & rhs) \
            {                                                                 \
                a -= static_cast<type>(rhs.R_component_1());                  \
...
#define    AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR_1(type)                   \
            octonion<type> &            operator *= (type const & rhs)   \
            {                                                            \
                a *= rhs;                                                \
                b *= rhs;                                                \
...
#define    AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR_2(type)                                  \
            octonion<type> &            operator *= (::std::complex<type> const & rhs)  \
            {                                                                           \
                type    ar = rhs.real();                                                \
                type    br = rhs.imag();                                                \
...
#define    AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR_3(type)                                                    \
            octonion<type> &            operator *= (::autoboost::math::quaternion<type> const & rhs)   \
            {                                                                                       \
...
#define    AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR_4(type)                          \
            template<typename X>                                                \
            octonion<type> &            operator *= (octonion<X> const & rhs)   \
            {                                                                   \
...
#define    AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR_1(type)                  \
            octonion<type> &            operator /= (type const & rhs)  \
            {                                                           \
                a /= rhs;                                               \
                b /= rhs;                                               \
...
#if defined(AUTOBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP)
    #define    AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR_2(type)                              \
            octonion<type> &            operator /= (::std::complex<type> const & rhs)  \
            {                                                                           \
                using    ::std::valarray;                                               \
                using    ::std::abs;                                                    \
...
#endif /* AUTOBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP */

#if defined(AUTOBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP)
    #define    AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR_3(type)                                           \
            octonion<type> &            operator /= (::autoboost::math::quaternion<type> const & rhs)    \
            {                                                                                        \
                using    ::std::valarray;                                                            \
                using    ::std::abs;                                                                 \
...
#if defined(AUTOBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP)
    #define    AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR_4(type)                                           \
            template<typename X>                                                                     \
            octonion<type> &            operator /= (octonion<X> const & rhs)                        \
            {                                                                                        \
                using    ::std::valarray;                                                            \
...
#define    AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR(type)       \
        AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR_1(type)        \
        AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR_2(type)        \
        AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR_3(type)        \
        AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR_4(type)

#define    AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR(type)       \
        AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR_1(type)        \
        AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR_2(type)        \
        AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR_3(type)        \
        AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR_4(type)

#define    AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR(type)       \
        AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR_1(type)        \
        AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR_2(type)        \
        AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR_3(type)        \
        AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR_4(type)

#define    AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR(type)       \
        AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR_1(type)        \
        AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR_2(type)        \
        AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR_3(type)        \
        AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR_4(type)

#define    AUTOBOOST_OCTONION_MEMBER_ALGEBRAIC_GENERATOR(type) \
        AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR(type)          \
        AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR(type)          \
        AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR(type)          \
        AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR(type)
        ...
        public:
            ...
            AUTOBOOST_OCTONION_CONSTRUCTOR_GENERATOR(float)
            ...
            AUTOBOOST_OCTONION_ACCESSOR_GENERATOR(float)

            // assignment operators

            AUTOBOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(float)
            ...
            AUTOBOOST_OCTONION_MEMBER_ALGEBRAIC_GENERATOR(float)


        protected:

            AUTOBOOST_OCTONION_MEMBER_DATA_GENERATOR(float)
        ...
        public:
            ...
            AUTOBOOST_OCTONION_CONSTRUCTOR_GENERATOR(double)
            ...
            AUTOBOOST_OCTONION_ACCESSOR_GENERATOR(double)

            // assignment operators

            AUTOBOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(double)
            ...
            AUTOBOOST_OCTONION_MEMBER_ALGEBRAIC_GENERATOR(double)


        protected:

            AUTOBOOST_OCTONION_MEMBER_DATA_GENERATOR(double)
        ...
        public:
            ...
            AUTOBOOST_OCTONION_CONSTRUCTOR_GENERATOR(long double)
            ...
            AUTOBOOST_OCTONION_ACCESSOR_GENERATOR(long double)

            // assignment operators

            AUTOBOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(long double)
            ...
            AUTOBOOST_OCTONION_MEMBER_ALGEBRAIC_GENERATOR(long double)


        protected:

            AUTOBOOST_OCTONION_MEMBER_DATA_GENERATOR(long double)
...
#undef    AUTOBOOST_OCTONION_CONSTRUCTOR_GENERATOR

#undef    AUTOBOOST_OCTONION_MEMBER_ALGEBRAIC_GENERATOR

#undef    AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR
#undef    AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR
#undef    AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR
#undef    AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR

#undef    AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR_1
#undef    AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR_2
#undef    AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR_3
#undef    AUTOBOOST_OCTONION_MEMBER_ADD_GENERATOR_4
#undef    AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR_1
#undef    AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR_2
#undef    AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR_3
#undef    AUTOBOOST_OCTONION_MEMBER_SUB_GENERATOR_4
#undef    AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR_1
#undef    AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR_2
#undef    AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR_3
#undef    AUTOBOOST_OCTONION_MEMBER_MUL_GENERATOR_4
#undef    AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR_1
#undef    AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR_2
#undef    AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR_3
#undef    AUTOBOOST_OCTONION_MEMBER_DIV_GENERATOR_4


#undef    AUTOBOOST_OCTONION_MEMBER_DATA_GENERATOR

#undef    AUTOBOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR

#undef    AUTOBOOST_OCTONION_ACCESSOR_GENERATOR


        // operators

#define    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_BODY(op) \
        {                                             \
            octonion<T>    res(lhs);                  \
            res op##= rhs;                            \
            return(res);                              \
...
#define    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_1_L(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (T const & lhs, octonion<T> const & rhs)                            \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)

#define    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_1_R(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (octonion<T> const & lhs, T const & rhs)                            \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)

#define    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_2_L(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (::std::complex<T> const & lhs, octonion<T> const & rhs)            \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)

#define    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_2_R(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (octonion<T> const & lhs, ::std::complex<T> const & rhs)            \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)

#define    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_3_L(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (::autoboost::math::quaternion<T> const & lhs, octonion<T> const & rhs) \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)

#define    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_3_R(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (octonion<T> const & lhs, ::autoboost::math::quaternion<T> const & rhs) \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)

#define    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_4(op)                                                                                \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (octonion<T> const & lhs, octonion<T> const & rhs)                  \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)

#define    AUTOBOOST_OCTONION_OPERATOR_GENERATOR(op)     \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_1_L(op)    \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_1_R(op)    \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_2_L(op)    \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_2_R(op)    \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_3_L(op)    \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_3_R(op)    \
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR_4(op)


        AUTOBOOST_OCTONION_OPERATOR_GENERATOR(+)
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR(-)
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR(*)
        AUTOBOOST_OCTONION_OPERATOR_GENERATOR(/)


#undef    AUTOBOOST_OCTONION_OPERATOR_GENERATOR

#undef    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_1_L
#undef    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_1_R
#undef    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_2_L
#undef    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_2_R
#undef    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_3_L
#undef    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_3_R
#undef    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_4

#undef    AUTOBOOST_OCTONION_OPERATOR_GENERATOR_BODY
        ...
        template<typename T>
        inline bool                                operator == (::autoboost::math::quaternion<T> const & lhs, octonion<T> const & rhs)
        {
            return(
        ...
        template<typename T>
        inline bool                                operator == (octonion<T> const & lhs, ::autoboost::math::quaternion<T> const & rhs)
        {
            return(
...
#define    AUTOBOOST_OCTONION_NOT_EQUAL_GENERATOR \
        {                                     \
            return(!(lhs == rhs));            \
        }
        ...
        template<typename T>
        inline bool                                operator != (T const & lhs, octonion<T> const & rhs)
        AUTOBOOST_OCTONION_NOT_EQUAL_GENERATOR
    ...
    #undef    AUTOBOOST_OCTONION_NOT_EQUAL_GENERATOR
                                                                ...
                                                                octonion<T> & o)
        {
            ...
            ::autoboost::math::quaternion<T>    p = ::autoboost::math::quaternion<T>();
            ::autoboost::math::quaternion<T>    q = ::autoboost::math::quaternion<T>();
                ...
                if    (cc == '(')                                // read "(("
                {
                    ...
                    if    (cc == '(')                                // read "((("
                    {
                        ...
                        if        (cc == ')')                        // read "((u)"
                        {
                            ...
                            {
                                p = ::autoboost::math::quaternion<T>(u);
                        ...
                        else if    (cc ==',')                        // read "((u,"
                        {
                            ...
                            if        (cc == ')')                        // read "((u,v)"
                            {
                                p = ::autoboost::math::quaternion<T>(u,v);
                            ...
                            else if    (cc == ',')                            // read "((a),"
                            {
                                ...
                                if        (cc == '(')                            // read "((a),("
                                {
                                    ...
                                    if        (cc == '(')                            // read "((a),(("
                                    {
                                        ...
                                        if        (cc == ')')                            // read "((a),q)"
                                        {
                                            p = ::autoboost::math::quaternion<T>(a);
                                    ...
                                    else                                        // read "((a),(c" or "((a),(e"
                                    {
                                        ...
                                        else if    (cc == ',')                            // read "((a),(c," or "((a),(e,"
                                        {
                                            ...
                                            if        (cc == '(')                        // read "((a),(e,(" (ambiguity resolution)
                                            {
                                                ...
                                                if        (cc == ')')                        // read "((a),(e,y)"
                                                {
                                                    q = ::autoboost::math::quaternion<T>(x,y);
                                            ...
                                            else                                    // read "((a),(c,d" or "((a),(e,f"
                                            {
                                                ...
                                                else if    (cc == ',')                        // read "((a),(e,f," (ambiguity resolution)
                                                {
                                                    ...
                                                    if        (cc == ')')                        // read "((a),(e,f,g)"
                                                    {
                                                        q = ::autoboost::math::quaternion<T>(c,d,g);        // "c" was actually "e", and "d" was actually "f"
                                                    ...
                                                    else if    (cc == ',')                        // read "((a),(e,f,g,"
                                                    {
                                                        ...
                                                        {
                                                            q = ::autoboost::math::quaternion<T>(c,d,g,h);    // "c" was actually "e", and "d" was actually "f"
                            ...
                            else
                            {
                                ...
                                if        (cc == ')')                            // read "((a,b)"
                                {
                                    ...
                                    else if    (cc == ',')                            // read "((a,b),"
                                    {
                                        ...
                                        if        (cc == '(')                            // read "((a,b),("
                                        {
                                            ...
                                            if        (cc == '(')                            // read "((a,b),(("
                                            {
                                                p = ::autoboost::math::quaternion<T>(a,b);
                                            ...
                                            else                                        // read "((a,b),(c" or "((a,b),(e"
                                            {
                                                ...
                                                else if    (cc == ',')                            // read "((a,b),(c," or "((a,b),(e,"
                                                {
                                                    ...
                                                    else                                        // read "((a,b),(c,d" or "((a,b),(e,f"
                                                    {
                                                        ...
                                                        {
                                                            p = ::autoboost::math::quaternion<T>(a,b);                // too late to backtrack
                                                            ...
                                                            if        (cc == ')')                            // read "((a,b),(e,f,g)"
                                                            {
                                                                ...
                                                                if        (cc == ')')                            // read "((a,b),(e,f,g))"
                                                                {
                                                                    q = ::autoboost::math::quaternion<T>(c,d,g);            // "c" is actually "e" and "d" is actually "f"
                                                            ...
                                                            else if    (cc == ',')                            // read "((a,b),(e,f,g,"
                                                            {
                                                                ...
                                                                if        (cc == ')')                            // read "((a,b),(e,f,g,h)"
                                                                {
                                                                    ...
                                                                    if        (cc == ')')                            // read ((a,b),(e,f,g,h))"
                                                                    {
                                                                        q = ::autoboost::math::quaternion<T>(c,d,g,h);            // "c" is actually "e" and "d" is actually "f"
                                ...
                                else if    (cc == ',')                            // read "((a,b,"
                                {
                                    ...
                                    if        (cc == ')')                            // read "((a,b,c)"
                                    {
                                        ...
                                        {
                                            p = ::autoboost::math::quaternion<T>(a,b,c);
                                    ...
                                    else if    (cc == ',')                            // read "((a,b,c,"
                                    {
                                        ...
                                        if        (cc == ')')                            // read "((a,b,c,d)"
                                        {
                                            ...
                                            {
                                                p = ::autoboost::math::quaternion<T>(a,b,c,d);
...
#define    AUTOBOOST_OCTONION_VALARRAY_LOADER   \
            using    ::std::valarray;       \
                                            \
            valarray<T>    temp(8);         \
                                            \
        ...
        {
#ifdef    AUTOBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP
            using    ::std::abs;
#endif    /* AUTOBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP */

            AUTOBOOST_OCTONION_VALARRAY_LOADER
...
#undef    AUTOBOOST_OCTONION_VALARRAY_LOADER
