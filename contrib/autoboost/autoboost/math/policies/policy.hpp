...
#ifndef AUTOBOOST_MATH_POLICY_HPP
#define AUTOBOOST_MATH_POLICY_HPP
...
#endif
#ifndef AUTOBOOST_MATH_ROUNDING_ERROR_POLICY
#define AUTOBOOST_MATH_ROUNDING_ERROR_POLICY throw_on_error
#endif
#ifndef AUTOBOOST_MATH_UNDERFLOW_ERROR_POLICY
#define AUTOBOOST_MATH_UNDERFLOW_ERROR_POLICY ignore_error
#endif
#ifndef AUTOBOOST_MATH_DENORM_ERROR_POLICY
#define AUTOBOOST_MATH_DENORM_ERROR_POLICY ignore_error
#endif
#ifndef AUTOBOOST_MATH_INDETERMINATE_RESULT_ERROR_POLICY
#define AUTOBOOST_MATH_INDETERMINATE_RESULT_ERROR_POLICY ignore_error
#endif
#ifndef AUTOBOOST_MATH_DIGITS10_POLICY
#define AUTOBOOST_MATH_DIGITS10_POLICY 0
#endif
#ifndef AUTOBOOST_MATH_PROMOTE_FLOAT_POLICY
#define AUTOBOOST_MATH_PROMOTE_FLOAT_POLICY true
#endif
#ifndef AUTOBOOST_MATH_PROMOTE_DOUBLE_POLICY
#ifdef AUTOBOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS
#define AUTOBOOST_MATH_PROMOTE_DOUBLE_POLICY false
#else
#define AUTOBOOST_MATH_PROMOTE_DOUBLE_POLICY true
#endif
#endif
#ifndef AUTOBOOST_MATH_DISCRETE_QUANTILE_POLICY
#define AUTOBOOST_MATH_DISCRETE_QUANTILE_POLICY integer_round_outwards
#endif
#ifndef AUTOBOOST_MATH_ASSERT_UNDEFINED_POLICY
#define AUTOBOOST_MATH_ASSERT_UNDEFINED_POLICY true
#endif
#ifndef AUTOBOOST_MATH_MAX_SERIES_ITERATION_POLICY
#define AUTOBOOST_MATH_MAX_SERIES_ITERATION_POLICY 1000000
#endif
#ifndef AUTOBOOST_MATH_MAX_ROOT_ITERATION_POLICY
#define AUTOBOOST_MATH_MAX_ROOT_ITERATION_POLICY 200
#endif

#if !defined(__BORLANDC__)
#define AUTOBOOST_MATH_META_INT(type, name, Default)\
   template <type N = Default> struct name : public autoboost::mpl::int_<N>{};\
   namespace detail{\
   template <type N>\
   ...
   {\
      ...
      static double test(...);\
      AUTOBOOST_STATIC_CONSTANT(bool, value = sizeof(test(static_cast<T*>(0))) == 1);\
   };\
   }\
   template <class T> struct is_##name : public autoboost::mpl::bool_< ::autoboost::math::policies::detail::is_##name##_imp<T>::value>{};

#define AUTOBOOST_MATH_META_BOOL(name, Default)\
   template <bool N = Default> struct name : public autoboost::mpl::bool_<N>{};\
   namespace detail{\
   template <bool N>\
   char test_is_valid_arg(const name<N>*);\
   char test_is_default_arg(const name<Default>*);\
...
#define AUTOBOOST_MATH_META_INT(Type, name, Default)\
   ...
   {\
      static T inst;\
      AUTOBOOST_STATIC_CONSTANT(bool, value = sizeof( ::autoboost::math::policies::detail::is_##name##_tester<T>::test(inst)) == 1);\
   };\
   }\
   template <class T> struct is_##name : public autoboost::mpl::bool_< ::autoboost::math::policies::detail::is_##name##_imp<T>::value>\
   {\
...
AUTOBOOST_MATH_META_INT(error_policy_type, domain_error, AUTOBOOST_MATH_DOMAIN_ERROR_POLICY)
AUTOBOOST_MATH_META_INT(error_policy_type, pole_error, AUTOBOOST_MATH_POLE_ERROR_POLICY)
AUTOBOOST_MATH_META_INT(error_policy_type, overflow_error, AUTOBOOST_MATH_OVERFLOW_ERROR_POLICY)
AUTOBOOST_MATH_META_INT(error_policy_type, underflow_error, AUTOBOOST_MATH_UNDERFLOW_ERROR_POLICY)
AUTOBOOST_MATH_META_INT(error_policy_type, denorm_error, AUTOBOOST_MATH_DENORM_ERROR_POLICY)
AUTOBOOST_MATH_META_INT(error_policy_type, evaluation_error, AUTOBOOST_MATH_EVALUATION_ERROR_POLICY)
AUTOBOOST_MATH_META_INT(error_policy_type, rounding_error, AUTOBOOST_MATH_ROUNDING_ERROR_POLICY)
AUTOBOOST_MATH_META_INT(error_policy_type, indeterminate_result_error, AUTOBOOST_MATH_INDETERMINATE_RESULT_ERROR_POLICY)

//
// Policy types for internal promotion:
//
AUTOBOOST_MATH_META_BOOL(promote_float, AUTOBOOST_MATH_PROMOTE_FLOAT_POLICY)
AUTOBOOST_MATH_META_BOOL(promote_double, AUTOBOOST_MATH_PROMOTE_DOUBLE_POLICY)
AUTOBOOST_MATH_META_BOOL(assert_undefined, AUTOBOOST_MATH_ASSERT_UNDEFINED_POLICY)
//
...
AUTOBOOST_MATH_META_INT(discrete_quantile_policy_type, discrete_quantile, AUTOBOOST_MATH_DISCRETE_QUANTILE_POLICY)
//
// Precision:
//
AUTOBOOST_MATH_META_INT(int, digits10, AUTOBOOST_MATH_DIGITS10_POLICY)
AUTOBOOST_MATH_META_INT(int, digits2, 0)
//
// Iterations:
//
AUTOBOOST_MATH_META_INT(unsigned long, max_series_iterations, AUTOBOOST_MATH_MAX_SERIES_ITERATION_POLICY)
AUTOBOOST_MATH_META_INT(unsigned long, max_root_iterations, AUTOBOOST_MATH_MAX_ROOT_ITERATION_POLICY)
//
// Define the names for each possible policy:
//
#define AUTOBOOST_MATH_PARAMETER(name)\
   AUTOBOOST_PARAMETER_TEMPLATE_KEYWORD(name##_name)\
   AUTOBOOST_PARAMETER_NAME(name##_name)
...
#ifdef __BORLANDC__
   typedef typename mpl::if_c<
      (Digits2::value > ::autoboost::math::policies::detail::precision<Digits10,Digits2>::digits2_type::value),
...
public:
   typedef typename select_result<
      DefaultType, iter,
      ::autoboost::is_same<iter, end_type>::value>::type type;
};
...
{
   AUTOBOOST_STATIC_CONSTANT(bool, value = sizeof(::autoboost::math::policies::detail::test_is_valid_arg(static_cast<T*>(0))) == 1);
};

template <class T>
struct is_default_policy_imp
{
   AUTOBOOST_STATIC_CONSTANT(bool, value = sizeof(::autoboost::math::policies::detail::test_is_default_arg(static_cast<T*>(0))) == 1);
};

template <class T> struct is_valid_policy
: public mpl::bool_<
   ::autoboost::math::policies::detail::is_valid_policy_imp<T>::value>
{};

template <class T> struct is_default_policy
: public mpl::bool_<
   ::autoboost::math::policies::detail::is_default_policy_imp<T>::value>
{
   template <class U>
   struct apply
   {
...
typedef default_args<AUTOBOOST_MATH_PROMOTE_FLOAT_POLICY, AUTOBOOST_MATH_PROMOTE_DOUBLE_POLICY>::arg1 forwarding_arg1;
typedef default_args<AUTOBOOST_MATH_PROMOTE_FLOAT_POLICY, AUTOBOOST_MATH_PROMOTE_DOUBLE_POLICY>::arg2 forwarding_arg2;
...
private:
   ...
   //
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A1>::value);
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A2>::value);
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A3>::value);
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A4>::value);
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A5>::value);
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A6>::value);
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A7>::value);
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A8>::value);
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A9>::value);
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A10>::value);
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A11>::value);
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A12>::value);
   AUTOBOOST_STATIC_ASSERT(::autoboost::math::policies::detail::is_valid_policy<A13>::value);
   //
...
#if AUTOBOOST_MATH_DIGITS10_POLICY == 0
...
private:
   ...
   //
   typedef typename detail::append_N<reduced_list, default_policy, (14 - ::autoboost::mpl::size<reduced_list>::value)>::type result_type;
public:
   typedef policy<
...
struct precision
{
   AUTOBOOST_STATIC_ASSERT( ::std::numeric_limits<Real>::radix == 2);
...
struct precision
{
   AUTOBOOST_STATIC_ASSERT((::std::numeric_limits<Real>::radix == 2) || ((::std::numeric_limits<Real>::is_specialized == 0) || (::std::numeric_limits<Real>::digits == 0)));
#ifndef __BORLANDC__
   typedef typename Policy::precision_type precision_type;
   typedef typename mpl::if_c<
...
template <class Policy>
struct precision<AUTOBOOST_MATH_FLOAT128_TYPE, Policy>
{
...
#else
   AUTOBOOST_ASSERT(::std::numeric_limits<T>::is_specialized);
#endif
   typedef typename autoboost::math::policies::precision<T, Policy>::type p_t;
   return p_t::value;
}
...
{
   AUTOBOOST_STATIC_CONSTANT(autoboost::uintmax_t, v = static_cast<autoboost::uintmax_t>(1u) << (Digits::value - 1));
...
#ifndef AUTOBOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
   AUTOBOOST_STATIC_ASSERT( ::std::numeric_limits<T>::is_specialized);
   AUTOBOOST_STATIC_ASSERT( ::std::numeric_limits<T>::radix == 2);
#else
   AUTOBOOST_ASSERT(::std::numeric_limits<T>::is_specialized);
   AUTOBOOST_ASSERT(::std::numeric_limits<T>::radix == 2);
#endif
   typedef typename autoboost::math::policies::precision<T, Policy>::type p_t;
   typedef mpl::bool_<p_t::value <= std::numeric_limits<autoboost::uintmax_t>::digits> is_small_int;
...
{
   AUTOBOOST_STATIC_CONSTANT(bool, value = (sizeof(::autoboost::math::policies::detail::test_is_policy(static_cast<P*>(0))) == 1));
};

}

template <class P>
struct is_policy : public mpl::bool_< ::autoboost::math::policies::detail::is_policy_imp<P>::value> {};
