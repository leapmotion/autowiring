...
{
   typedef typename autoboost::math::policies::precision<T, autoboost::math::policies::policy<> >::type prec_type;
   std::stringstream ss;
   if(prec_type::value)
   {
...
#ifndef AUTOBOOST_NO_RTTI
  replace_all_in_string(function, "%1%", autoboost::math::policies::detail::name_of<T>());
#else
