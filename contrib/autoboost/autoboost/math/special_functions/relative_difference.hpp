...
#ifndef AUTOBOOST_MATH_RELATIVE_ERROR
#define AUTOBOOST_MATH_RELATIVE_ERROR
...
namespace autoboost{
   namespace math{
      ...
      typename autoboost::math::tools::promote_args<T,U>::type relative_difference(const T& arg_a, const U& arg_b)
      {
         typedef typename autoboost::math::tools::promote_args<T, U>::type result_type;
         result_type a = arg_a;
         result_type b = arg_b;
         ...
         if((autoboost::math::isnan)(a) || (autoboost::math::isnan)(b))
            return max_val;
      ...
      template <>
      inline autoboost::math::tools::promote_args<double, double>::type relative_difference(const double& arg_a, const double& arg_b)
      {
         AUTOBOOST_MATH_STD_USING
         double a = arg_a;
         double b = arg_b;
      ...
      template <class T, class U>
      inline typename autoboost::math::tools::promote_args<T, U>::type epsilon_difference(const T& arg_a, const U& arg_b)
      {
         typedef typename autoboost::math::tools::promote_args<T, U>::type result_type;
         result_type r = relative_difference(arg_a, arg_b);
         if(tools::max_value<result_type>() * autoboost::math::tools::epsilon<result_type>() < r)
            return tools::max_value<result_type>();
         return r / autoboost::math::tools::epsilon<result_type>();
      }
} // namespace math
} // namespace autoboost
