...
#ifndef AUTOBOOST_MATH_SPECIAL_LAGUERRE_HPP
#define AUTOBOOST_MATH_SPECIAL_LAGUERRE_HPP
...
laguerre(unsigned n, T x, const Policy&, const mpl::true_&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::laguerre_imp(n, static_cast<value_type>(x)), "autoboost::math::laguerre<%1%>(unsigned, %1%)");
}
...
{
   return autoboost::math::laguerre(n, m, x, policies::policy<>());
}
...
T laguerre_imp(unsigned n, unsigned m, T x, const Policy& pol)
{
   // Special cases:
   if(m == 0)
      return autoboost::math::laguerre(n, x, pol);
   ...
   laguerre(unsigned n, unsigned m, T x, const Policy& pol)
{
   typedef typename tools::promote_args<T>::type result_type;
   typedef typename policies::evaluation<result_type, Policy>::type value_type;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::laguerre_imp(n, m, static_cast<value_type>(x), pol), "autoboost::math::laguerre<%1%>(unsigned, unsigned, %1%)");
}
...
#endif // AUTOBOOST_MATH_SPECIAL_LAGUERRE_HPP
