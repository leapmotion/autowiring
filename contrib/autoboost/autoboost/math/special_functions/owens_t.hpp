...
#ifndef AUTOBOOST_OWENS_T_HPP
#define AUTOBOOST_OWENS_T_HPP
   ...
   namespace math
   {
      namespace detail
      {
         ...
         inline unsigned short owens_t_get_order_imp(const unsigned short icode, RealType, const mpl::int_<64>&)
        {
         ...
         inline RealType owens_t_T1(const RealType h, const RealType a, const unsigned short m, const Policy& pol)
         {
            ...
            RealType dj = autoboost::math::expm1( hs, pol);
            RealType gj = hs*dhs;
      ...
      const unsigned short m = 20;
        ...
        inline RealType owens_t_T3_imp(const RealType h, const RealType a, const RealType ah, const mpl::int_<64>&)
        {
          ...
          static const RealType c2[] =
          {
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.99999999999999999999999729978162447266851932041876728736094298092917625009873),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.99999999999999999999467056379678391810626533251885323416799874878563998732905968),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.99999999999999999824849349313270659391127814689133077036298754586814091034842536),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.9999999999999997703859616213643405880166422891953033591551179153879839440241685),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.99999999999998394883415238173334565554173013941245103172035286759201504179038147),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.9999999999993063616095509371081203145247992197457263066869044528823599399470977),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.9999999999797336340409464429599229870590160411238245275855903767652432017766116267),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.999999999574958412069046680119051639753412378037565521359444170241346845522403274),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.9999999933226234193375324943920160947158239076786103108097456617750134812033362048),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.9999999188923242461073033481053037468263536806742737922476636768006622772762168467),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.9999992195143483674402853783549420883055129680082932629160081128947764415749728967),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.999993935137206712830997921913316971472227199741857386575097250553105958772041501),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.99996135597690552745362392866517133091672395614263398912807169603795088421057688716),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.99979556366513946026406788969630293820987757758641211293079784585126692672425362469),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.999092789629617100153486251423850590051366661947344315423226082520411961968929483),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.996593837411918202119308620432614600338157335862888580671450938858935084316004769854),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.98910017138386127038463510314625339359073956513420458166238478926511821146316469589567),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.970078558040693314521331982203762771512160168582494513347846407314584943870399016019),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.92911438683263187495758525500033707204091967947532160289872782771388170647150321633673),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.8542058695956156057286980736842905011429254735181323743367879525470479126968822863),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.73796526033030091233118357742803709382964420335559408722681794195743240930748630755),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.58523469882837394570128599003785154144164680587615878645171632791404210655891158),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.415997776145676306165661663581868460503874205343014196580122174949645271353372263),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.2588210875241943574388730510317252236407805082485246378222935376279663808416534365),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.1375535825163892648504646951500265585055789019410617565727090346559210218472356689),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.0607952766325955730493900985022020434830339794955745989150270485056436844239206648),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.0216337683299871528059836483840390514275488679530797294557060229266785853764115),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -0.00593405693455186729876995814181203900550014220428843483927218267309209471516256),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 0.0011743414818332946510474576182739210553333860106811865963485870668929503649964142),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, -1.489155613350368934073453260689881330166342484405529981510694514036264969925132e-4),
             AUTOBOOST_MATH_BIG_CONSTANT(RealType, 260, 9.072354320794357587710929507988814669454281514268844884841547607134260303118208e-6)
          };
        ...
        inline RealType owens_t_T3(const RealType h, const RealType a, const RealType ah, const Policy&)
        {
         ...
         inline RealType owens_t_T5_imp(const RealType h, const RealType a, const mpl::int_<53>&)
         {
            ...
            const RealType as = a*a;
            const RealType hs = -h*h*autoboost::math::constants::half<RealType>();

            RealType val = 0;
            for(unsigned short i = 0; i < m; ++i)
            {
               AUTOBOOST_ASSERT(i < 13);
        ...
        inline RealType owens_t_T5_imp(const RealType h, const RealType a, const mpl::int_<64>&)
        {
          ...
          static const RealType pts[] = {
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.0016634282895983227941),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.014904509242697054183),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.04103478879005817919),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.079359853513391511008),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.1288612130237615133),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.18822336642448518856),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.25586876186122962384),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.32999972011807857222),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.40864620815774761438),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.48971819306044782365),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.57106118513245543894),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.6505134942981533829),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.72596367859928091618),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.79540665919549865924),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.85699701386308739244),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.90909804422384697594),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.95032536436570154409),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.97958418733152273717),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.99610366384229088321)
          };
          static const RealType wts[] = {
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.012975111395684900835),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.012888764187499150078),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.012716644398857307844),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.012459897461364705691),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.012120231988292330388),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.011699908404856841158),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.011201723906897224448),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.010628993848522759853),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.0099855296835573320047),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.0092756136096132857933),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.0085039700881139589055),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.0076757344408814561254),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.0067964187616556459109),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.005871875456524750363),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.0049082589542498110071),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.0039119870792519721409),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.0028897090921170700834),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.0018483371329504443947),
               AUTOBOOST_MATH_BIG_CONSTANT(RealType, 64, 0.00079623320100438873578)
          };
        ...
        inline RealType owens_t_T5(const RealType h, const RealType a, const Policy&)
        {
         ...
         std::pair<T, T> owens_t_T1_accelerated(T h, T a, const Policy& pol)
         {
            ...
            //
            AUTOBOOST_MATH_STD_USING
            static const char* function = "autoboost::math::owens_t<%1%>(%1%, %1%)";
            T half_h_h = h * h / 2;
            T a_pow = a;
            T aa = a * a;
            ...
            return std::pair<T, T>((sum / d) / autoboost::math::constants::two_pi<T>(), abs_err / sum);
         }
         ...
         inline std::pair<RealType, RealType> owens_t_T2_accelerated(const RealType h, const RealType a, const RealType ah, const Policy&)
         {
            ...
            RealType val = 0;
            RealType vi = a * exp( -ah*ah*half<RealType>() ) / root_two_pi<RealType>();
            RealType z = autoboost::math::detail::owens_t_znorm1(ah)/h;
            RealType last_z = fabs(z);
         ...
         inline RealType T4_mp(const RealType h, const RealType a, const Policy& pol)
         {
            ...
            RealType lim = autoboost::math::policies::get_epsilon<RealType, Policy>();
            ...
            while( true )
            {
               ...
               if(ii > (std::min)(1500, (int)policies::get_max_series_iterations<Policy>()))
                  policies::raise_evaluation_error("autoboost::math::owens_t<%1%>", 0, val, pol);
            } // while( true )
         ...
         inline RealType owens_t_dispatch(const RealType h, const RealType a, const RealType ah, const Policy& pol, mpl::int_<64> const&)
         {
            ...
            case 6: // T6
               ...
               break;
            default:
               AUTOBOOST_THROW_EXCEPTION(std::logic_error("selection routine in Owen's T function failed"));
            }
            return val;
         }
         ...
         inline RealType owens_t_dispatch(const RealType h, const RealType a, const RealType ah, const Policy& pol, const mpl::int_<65>&)
         {
            ...
            typedef typename autoboost::math::policies::normalise<Policy, autoboost::math::policies::evaluation_error<> >::type forwarding_policy;
            ...
            if(ah < 3)
            {
               ...
               catch(const autoboost::math::evaluation_error&){}  // T1 may fail and throw, that's OK
#endif
            }
            if(ah > 1)
            {
               ...
               catch(const autoboost::math::evaluation_error&){}  // T2 may fail and throw, that's OK
#endif
            }
            //
            ...
            catch(const autoboost::math::evaluation_error&){}  // T4 may fail and throw, that's OK
#endif
            //
         ...
         struct owens_t_initializer
         {
            struct init
            {
               ...
               {
                  autoboost::math::owens_t(static_cast<T>(7), static_cast<T>(0.96875), Policy());
                  autoboost::math::owens_t(static_cast<T>(2), static_cast<T>(0.5), Policy());
               }
      ...
      inline typename tools::promote_args<T1, T2>::type owens_t(T1 h, T2 a, const Policy& pol)
      {
         ...
         return policies::checked_narrowing_cast<result_type, Policy>(detail::owens_t(static_cast<value_type>(h), static_cast<value_type>(a), pol), "autoboost::math::owens_t<%1%>(%1%,%1%)");
      }
