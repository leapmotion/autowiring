...
#ifndef _AUTOBOOST_POLYGAMMA_2013_07_30_HPP_
  #define _AUTOBOOST_POLYGAMMA_2013_07_30_HPP_

#include <autoboost/math/special_functions/factorials.hpp>
#include <autoboost/math/special_functions/detail/polygamma.hpp>
#include <autoboost/math/special_functions/trigamma.hpp>
...
namespace autoboost { namespace math {
  ...
  inline typename tools::promote_args<T>::type polygamma(const int n, T x, const Policy& pol)
  {
     ...
     //
     if(n == 0)
        return autoboost::math::digamma(x, pol);
     if(n == 1)
        return autoboost::math::trigamma(x, pol);
     //
     ...
     return policies::checked_narrowing_cast<result_type, forwarding_policy>(
        ...
        "autoboost::math::polygamma<%1%>(int, %1%)");
  }

  template<class T>
  inline typename tools::promote_args<T>::type polygamma(const int n, T x)
  {
      return autoboost::math::polygamma(n, x, policies::policy<>());
  }

} } // namespace autoboost::math

#endif // _AUTOBOOST_BERNOULLI_2013_05_30_HPP_
