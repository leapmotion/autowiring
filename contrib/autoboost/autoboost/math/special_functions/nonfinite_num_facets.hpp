#ifndef AUTOBOOST_MATH_NONFINITE_NUM_FACETS_HPP
#define AUTOBOOST_MATH_NONFINITE_NUM_FACETS_HPP
    ...
    */
    ...
    private:
        ...
        CharType fill, ValType val) const
      {
        ...
        switch((autoboost::math::fpclassify)(val))
        {

        case FP_INFINITE:
          if(flags_ & trap_infinity)
          {
            AUTOBOOST_THROW_EXCEPTION(std::ios_base::failure("Infinity"));
          }
          else if((autoboost::math::signbit)(val))
          { // negative infinity.
        ...
        case FP_NAN:
          if(flags_ & trap_nan)
          {
            AUTOBOOST_THROW_EXCEPTION(std::ios_base::failure("NaN"));
          }
          else if((autoboost::math::signbit)(val))
          { // negative so "-nan".
        ...
        case FP_ZERO:
          if((flags_ & signed_zero) && ((autoboost::math::signbit)(val)))
    ...
    private:
      template<class ValType> static ValType positive_nan()
      {
        ...
        return (autoboost::math::copysign)(
      ...
      ) const
      {
        ...
        if(negative)
        {
          val = (autoboost::math::changesign)(val);
        }
      } // void get_signed
...
// https://svn.boost.org/trac/autoboost/ticket/5467
...
#endif // AUTOBOOST_MATH_NONFINITE_NUM_FACETS_HPP
