...
#ifndef AUTOBOOST_MATH_ELLINT_RD_HPP
#define AUTOBOOST_MATH_ELLINT_RD_HPP
...
T ellint_rd_imp(T x, T y, T z, const Policy& pol)
{
   ...
   static const char* function = "autoboost::math::ellint_rd<%1%>(%1%,%1%,%1%)";
   ...
   ellint_rd(T1 x, T2 y, T3 z, const Policy& pol)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(
      detail::ellint_rd_imp(
         ...
         static_cast<value_type>(z), pol), "autoboost::math::ellint_rd<%1%>(%1%,%1%,%1%)");
}
...
#endif // AUTOBOOST_MATH_ELLINT_RD_HPP
