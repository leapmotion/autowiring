...
#ifndef AUTOBOOST_ASINH_HPP
#define AUTOBOOST_ASINH_HPP
    ...
    namespace math
    {
       namespace detail{
        ...
        inline T    asinh_imp(const T x, const Policy& pol)
        {
            ...
            if((autoboost::math::isnan)(x))
            {
               return policies::raise_domain_error<T>(
                  "autoboost::math::asinh<%1%>(%1%)",
            ...
            if        (x >= tools::forth_root_epsilon<T>())
            {
               if        (x > 1 / tools::root_epsilon<T>())
                ...
                else if(x < 0.5f)
                {
                   ...
                   return autoboost::math::log1p(x + autoboost::math::sqrt1pm1(x * x, pol), pol);
                }
                else
                {
        ...
        {
           return autoboost::math::asinh(x, policies::policy<>());
        }
