...
#ifndef AUTOBOOST_MATH_SPECIAL_HERMITE_HPP
#define AUTOBOOST_MATH_SPECIAL_HERMITE_HPP
   ...
   hermite(unsigned n, T x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::hermite_imp(n, static_cast<value_type>(x)), "autoboost::math::hermite<%1%>(unsigned, %1%)");
}
...
{
   return autoboost::math::hermite(n, x, policies::policy<>());
}

} // namespace math
} // namespace autoboost

#endif // AUTOBOOST_MATH_SPECIAL_HERMITE_HPP
