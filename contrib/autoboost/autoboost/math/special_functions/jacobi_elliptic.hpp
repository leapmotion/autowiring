...
#ifndef AUTOBOOST_MATH_JACOBI_ELLIPTIC_HPP
#define AUTOBOOST_MATH_JACOBI_ELLIPTIC_HPP
...
inline typename tools::promote_args<T, U, V>::type jacobi_elliptic(T k, U theta, V* pcn, V* pdn, const Policy&)
{
   ...
   static const char* function = "autoboost::math::jacobi_elliptic<%1%>(%1%)";
...
#endif // AUTOBOOST_MATH_JACOBI_ELLIPTIC_HPP
