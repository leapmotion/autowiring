...
#ifndef AUTOBOOST_MATH_SF_BINOMIAL_HPP
#define AUTOBOOST_MATH_SF_BINOMIAL_HPP
...
T binomial_coefficient(unsigned n, unsigned k, const Policy& pol)
{
   ...
   static const char* function = "autoboost::math::binomial_coefficient<%1%>(unsigned, unsigned)";
   if(k > n)
...
{
   return policies::checked_narrowing_cast<float, policies::policy<> >(binomial_coefficient<double>(n, k, pol), "autoboost::math::binomial_coefficient<%1%>(unsigned,unsigned)");
}
...
#endif // AUTOBOOST_MATH_SF_BINOMIAL_HPP
