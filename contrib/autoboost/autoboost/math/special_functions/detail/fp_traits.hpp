...
#ifndef AUTOBOOST_MATH_FP_TRAITS_HPP
#define AUTOBOOST_MATH_FP_TRAITS_HPP
...
#   define AUTOBOOST_FPCLASSIFY_VAX_FORMAT
#endif
...
#     endif
#  else
#     undef AUTOBOOST_HAS_FPCLASSIFY
#     define AUTOBOOST_FPCLASSIFY_PREFIX
#  endif
...
#ifndef AUTOBOOST_FPCLASSIFY_VAX_FORMAT

template<> struct fp_traits_non_native<float, single_precision>
{
    typedef ieee_copy_all_bits_tag method;

    AUTOBOOST_STATIC_CONSTANT(uint32_t, sign        = 0x80000000u);
    AUTOBOOST_STATIC_CONSTANT(uint32_t, exponent    = 0x7f800000);
    AUTOBOOST_STATIC_CONSTANT(uint32_t, flag        = 0x00000000);
    AUTOBOOST_STATIC_CONSTANT(uint32_t, significand = 0x007fffff);
...
#if defined(AUTOBOOST_NO_INT64_T) || defined(AUTOBOOST_NO_INCLASS_MEMBER_INITIALIZATION) \
...
template<> struct fp_traits_non_native<double, double_precision>
{
    ...
    AUTOBOOST_STATIC_CONSTANT(uint32_t, sign        = 0x80000000u);
    AUTOBOOST_STATIC_CONSTANT(uint32_t, exponent    = 0x7ff00000);
    AUTOBOOST_STATIC_CONSTANT(uint32_t, flag        = 0);
    AUTOBOOST_STATIC_CONSTANT(uint32_t, significand = 0x000fffff);
...
#if defined(AUTOBOOST_BIG_ENDIAN)
    AUTOBOOST_STATIC_CONSTANT(int, offset_ = 0);
#elif defined(AUTOBOOST_LITTLE_ENDIAN)
    AUTOBOOST_STATIC_CONSTANT(int, offset_ = 4);
#else
    AUTOBOOST_STATIC_ASSERT(false);
#endif
};
...
#endif  // #ifndef AUTOBOOST_FPCLASSIFY_VAX_FORMAT
...
struct fp_traits_non_native<long double, extended_double_precision>
{
    ...
    AUTOBOOST_STATIC_CONSTANT(uint32_t, sign        = 0x80000000u);
    AUTOBOOST_STATIC_CONSTANT(uint32_t, exponent    = 0x7fff0000);
    AUTOBOOST_STATIC_CONSTANT(uint32_t, flag        = 0x00008000);
    AUTOBOOST_STATIC_CONSTANT(uint32_t, significand = 0x00007fff);
...
private:
    ...
    AUTOBOOST_STATIC_CONSTANT(int, offset_ = 0);
#elif defined(AUTOBOOST_LITTLE_ENDIAN)
    AUTOBOOST_STATIC_CONSTANT(int, offset_ = 12);
#else
    AUTOBOOST_STATIC_ASSERT(false);
#endif
};
...
struct fp_traits_non_native<long double, extended_double_precision>
{
    ...
    AUTOBOOST_STATIC_CONSTANT(uint32_t, exponent    = 0x7fff0000);
    AUTOBOOST_STATIC_CONSTANT(uint32_t, flag        = 0x00000000);
    AUTOBOOST_STATIC_CONSTANT(uint32_t, significand = 0x0000ffff);
...
{
    typedef AUTOBOOST_DEDUCED_TYPENAME size_to_precision<sizeof(T), ::autoboost::is_floating_point<T>::value>::type precision;
...
#if (defined(AUTOBOOST_MATH_USE_C99) && !(defined(__GNUC__) && (__GNUC__ < 4))) \
   && !defined(__hpux) \
   && !defined(__DECCXX)\
   && !defined(__osf__) \
...
{
    typedef AUTOBOOST_DEDUCED_TYPENAME size_to_precision<sizeof(T), ::autoboost::is_floating_point<T>::value>::type precision;
#if defined(AUTOBOOST_MATH_USE_STD_FPCLASSIFY) && !defined(AUTOBOOST_MATH_DISABLE_STD_FPCLASSIFY)
