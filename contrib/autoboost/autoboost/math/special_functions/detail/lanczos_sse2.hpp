...
#ifndef AUTOBOOST_MATH_SPECIAL_FUNCTIONS_LANCZOS_SSE2
#define AUTOBOOST_MATH_SPECIAL_FUNCTIONS_LANCZOS_SSE2
...
AUTOBOOST_STATIC_ASSERT(sizeof(double) == sizeof(long double));
