...
#ifndef AUTOBOOST_MATH_BESSEL_KN_HPP
#define AUTOBOOST_MATH_BESSEL_KN_HPP

#ifdef _MSC_VER
#pragma once
#endif

#include <autoboost/math/special_functions/detail/bessel_k0.hpp>
#include <autoboost/math/special_functions/detail/bessel_k1.hpp>
...
T bessel_kn(int n, T x, const Policy& pol)
{
    ...
    static const char* function = "autoboost::math::bessel_kn<%1%>(%1%,%1%)";
...
#endif // AUTOBOOST_MATH_BESSEL_KN_HPP
