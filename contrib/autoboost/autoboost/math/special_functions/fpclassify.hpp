...
#include "quadmath.h"
#define AUTOBOOST_MATH_HAS_QUADMATH_H
#endif
#endif
#endif
...
#if defined(AUTOBOOST_MATH_USE_FLOAT128)
#if defined(AUTOBOOST_MATH_HAS_QUADMATH_H)
...
#elif defined(AUTOBOOST_GNU_STDLIB) && AUTOBOOST_GNU_STDLIB && \
      _GLIBCXX_USE_C99_MATH && !_GLIBCXX_USE_C99_FP_MACROS_DYNAMIC
inline bool is_nan_helper(__float128 f, const autoboost::true_type&) { return std::isnan(static_cast<double>(f)); }
inline bool is_nan_helper(__float128 f, const autoboost::false_type&) { return std::isnan(static_cast<double>(f)); }
#else
inline bool is_nan_helper(__float128 f, const autoboost::true_type&) { return ::isnan(static_cast<double>(f)); }
inline bool is_nan_helper(__float128 f, const autoboost::false_type&) { return ::isnan(static_cast<double>(f)); }
#endif
#endif
}
...
#endif
#if defined(AUTOBOOST_MATH_USE_FLOAT128) && defined(AUTOBOOST_MATH_HAS_QUADMATH_H)
template<>
