...
#ifndef AUTOBOOST_MATH_TRUNC_HPP
#define AUTOBOOST_MATH_TRUNC_HPP
...
inline typename tools::promote_args<T>::type trunc(const T& v, const Policy& pol, const mpl::false_&)
{
   ...
   if(!(autoboost::math::isfinite)(v))
      return policies::raise_rounding_error("autoboost::math::trunc<%1%>(%1%)", 0, static_cast<result_type>(v), static_cast<result_type>(v), pol);
...
inline int itrunc(const T& v, const Policy& pol)
{
   AUTOBOOST_MATH_STD_USING
   typedef typename tools::promote_args<T>::type result_type;
   result_type r = autoboost::math::trunc(v, pol);
   if((r > (std::numeric_limits<int>::max)()) || (r < (std::numeric_limits<int>::min)()))
      return static_cast<int>(policies::raise_rounding_error("autoboost::math::itrunc<%1%>(%1%)", 0, static_cast<result_type>(v), 0, pol));
...
inline long ltrunc(const T& v, const Policy& pol)
{
   ...
   if((r > (std::numeric_limits<long>::max)()) || (r < (std::numeric_limits<long>::min)()))
      return static_cast<long>(policies::raise_rounding_error("autoboost::math::ltrunc<%1%>(%1%)", 0, static_cast<result_type>(v), 0L, pol));
...
template <class T, class Policy>
inline autoboost::long_long_type lltrunc(const T& v, const Policy& pol)
{
   AUTOBOOST_MATH_STD_USING
   typedef typename tools::promote_args<T>::type result_type;
   result_type r = autoboost::math::trunc(v, pol);
   if((r > (std::numeric_limits<autoboost::long_long_type>::max)()) || (r < (std::numeric_limits<autoboost::long_long_type>::min)()))
      return static_cast<autoboost::long_long_type>(policies::raise_rounding_error("autoboost::math::lltrunc<%1%>(%1%)", 0, v, static_cast<autoboost::long_long_type>(0), pol));
   return static_cast<autoboost::long_long_type>(r);
}
template <class T>
inline autoboost::long_long_type lltrunc(const T& v)
{
...
#endif // AUTOBOOST_MATH_TRUNC_HPP
