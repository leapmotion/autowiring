...
#ifndef AUTOBOOST_TUPLE_COMPARISON_HPP
#define AUTOBOOST_TUPLE_COMPARISON_HPP
...
inline bool operator==(const cons<T1, T2>& lhs, const cons<S1, S2>& rhs)
{
  ...
  AUTOBOOST_STATIC_ASSERT(length<T2>::value == length<S2>::value);
...
#endif // AUTOBOOST_TUPLE_COMPARISON_HPP
