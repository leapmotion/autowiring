...
#ifndef AUTOBOOST_TUPLE_IO_HPP
#define AUTOBOOST_TUPLE_IO_HPP
...
public:
   ...
   AUTOBOOST_STATIC_CONSTANT(int, number_of_manipulators = delimiter + 1);
private:
