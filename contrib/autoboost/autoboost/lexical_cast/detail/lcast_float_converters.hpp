...
#ifndef AUTOBOOST_LEXICAL_CAST_DETAIL_LCAST_FLOAT_CONVERTERS_HPP
#define AUTOBOOST_LEXICAL_CAST_DETAIL_LCAST_FLOAT_CONVERTERS_HPP
...
#  pragma warning(disable:4244)
        ...
        struct mantissa_holder_type<double>
        {
            ...
            typedef autoboost::ulong_long_type type;
        ...
        inline bool lcast_ret_float(T& value, const CharT* begin, const CharT* const end)
        {
            ...
            typedef AUTOBOOST_DEDUCED_TYPENAME mantissa_holder_type<T>::type mantissa_type;
             ...
             */
            typedef AUTOBOOST_DEDUCED_TYPENAME mantissa_holder_type<T>::wide_result_t wide_result_t;
            const wide_result_t result = std::pow(static_cast<wide_result_t>(10.0), pow_of_10) * mantissa;
            value = static_cast<T>( has_minus ? (autoboost::math::changesign)(result) : result);
...
#endif // AUTOBOOST_LEXICAL_CAST_DETAIL_LCAST_FLOAT_CONVERTERS_HPP
