...
#ifndef AUTOBOOST_UNORDERED_DETAIL_EQUIVALENT_HPP_INCLUDED
#define AUTOBOOST_UNORDERED_DETAIL_EQUIVALENT_HPP_INCLUDED
...
namespace autoboost { namespace unordered { namespace detail {
    ...
    {
        typedef autoboost::unordered::detail::grouped_node<A, T> node;
    ...
    struct pick_grouped_node2<A, T,
        autoboost::unordered::detail::grouped_ptr_node<T>*,
        autoboost::unordered::detail::ptr_bucket*>
    {
        typedef autoboost::unordered::detail::grouped_ptr_node<T> node;
    ...
    struct pick_grouped_node
    {
        typedef autoboost::unordered::detail::allocator_traits<
            typename autoboost::unordered::detail::rebind_wrap<A,
                autoboost::unordered::detail::grouped_ptr_node<T> >::type
    ...
    struct multiset
    {
        typedef autoboost::unordered::detail::multiset<A, T, H, P> types;
        ...
        typedef autoboost::unordered::detail::pick_grouped_node<allocator,
            value_type> pick;
        typedef typename pick::node node;
        typedef typename pick::bucket bucket;
        typedef typename pick::link_pointer link_pointer;

        typedef autoboost::unordered::detail::grouped_table_impl<types> table;
    ...
    struct multimap
    {
        typedef autoboost::unordered::detail::multimap<A, K, M, H, P> types;
    ...
    struct grouped_table_impl : autoboost::unordered::detail::table<Types>
    {
...
#   if defined(AUTOBOOST_NO_CXX11_VARIADIC_TEMPLATES)
        iterator emplace(autoboost::unordered::detail::emplace_args1<
...
#   endif
        ...
        iterator emplace(AUTOBOOST_UNORDERED_EMPLACE_ARGS)
        {
        ...
        template <class I>
        typename autoboost::unordered::detail::enable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            if(i == j) return;

            std::size_t distance = autoboost::unordered::detail::distance(i, j);
            if(distance == 1) {
                node_constructor a(this->node_alloc());
        ...
        template <class I>
        typename autoboost::unordered::detail::disable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            node_constructor a(this->node_alloc());
            for (; i != j; ++i) {
        ...
        static link_pointer split_groups(node_pointer i, node_pointer j)
        {
            ...
            if (j) {
                ...
                autoboost::swap(first->group_prev_, j->group_prev_);
            ...
            if (prev) {
                ...
                autoboost::swap(first->group_prev_, i->group_prev_);
            }
