...
#ifndef AUTOBOOST_UNORDERED_DETAIL_ALL_HPP_INCLUDED
#define AUTOBOOST_UNORDERED_DETAIL_ALL_HPP_INCLUDED
...
#include <autoboost/unordered/detail/buckets.hpp>
...
#if defined(AUTOBOOST_UNORDERED_DEPRECATED_EQUALITY)

#if defined(__EDG__)
#elif defined(_MSC_VER) || defined(__BORLANDC__) || defined(__DMC__)
#pragma message("Warning: AUTOBOOST_UNORDERED_DEPRECATED_EQUALITY is no longer supported.")
#elif defined(__GNUC__) || defined(__HP_aCC) || \
    defined(__SUNPRO_CC) || defined(__IBMCPP__)
#warning "AUTOBOOST_UNORDERED_DEPRECATED_EQUALITY is no longer supported."
#endif
...
namespace autoboost { namespace unordered { namespace detail {
    ...
    struct value_base
    {
        ...
        typename autoboost::aligned_storage<
            sizeof(value_type),
            autoboost::alignment_of<value_type>::value>::type data_;
    ...
    struct move_nodes
    {
        ...
        {
            constructor.construct_with_value2(autoboost::move(v));
            return constructor.release();
        }
    };
    ...
    struct table :
        autoboost::unordered::detail::functions<
    ...
    public:
        ...
        typedef autoboost::unordered::detail::functions<
            typename Types::hasher,
        ...
        typedef autoboost::unordered::detail::allocator_traits<node_allocator>
            node_allocator_traits;
        typedef autoboost::unordered::detail::allocator_traits<bucket_allocator>
        ...
        typedef typename bucket_allocator_traits::pointer
            bucket_pointer;
        typedef autoboost::unordered::detail::node_constructor<node_allocator>
            node_constructor;

        typedef autoboost::unordered::iterator_detail::
        ...
        autoboost::unordered::detail::compressed<bucket_allocator, node_allocator>
            allocators_;
        ...
        {
            AUTOBOOST_ASSERT(bucket_count_ != 0);
        ...
        std::size_t max_size() const
        {
            ...
            // size < mlf_ * count
            return autoboost::unordered::detail::double_to_size(ceil(
        ...
        void recalculate_max_load()
        {
            ...
            max_load_ = buckets_ ? autoboost::unordered::detail::double_to_size(ceil(
                    static_cast<double>(mlf_) *
        ...
        {
            AUTOBOOST_ASSERT(mlf_ >= minimum_max_load_factor);
            ...
            return policy::new_bucket_count(
                autoboost::unordered::detail::double_to_size(floor(
        ...
        table(table& x, autoboost::unordered::detail::move_tag m) :
            functions(x, m),
        ...
        {
            autoboost::unordered::detail::array_constructor<bucket_allocator>
        ...
        {
            autoboost::unordered::detail::func::ignore_unused_variable_warning(other);

            // According to 23.2.1.8, if propagate_on_container_swap is
            // false the behaviour is undefined unless the allocators
            // are equal.
            AUTOBOOST_ASSERT(node_alloc() == other.node_alloc());
        }
        ...
        void swap(table& x)
        {
            ...
            autoboost::swap(buckets_, x.buckets_);
            autoboost::swap(bucket_count_, x.bucket_count_);
            autoboost::swap(size_, x.size_);
        ...
        void delete_node(link_pointer prev)
        {
            ...
            autoboost::unordered::detail::func::destroy_value_impl(node_alloc(),
                n->value_ptr());
            autoboost::unordered::detail::func::destroy(autoboost::addressof(*n));
        ...
        {
            AUTOBOOST_ASSERT(prev->next_ != end);
