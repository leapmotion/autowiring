...
//           Andrew Lumsdaine
#ifndef AUTOBOOST_RELAXED_HEAP_HEADER
#define AUTOBOOST_RELAXED_HEAP_HEADER
...
#ifdef AUTOBOOST_RELAXED_HEAP_DEBUG
#  include <iostream>
#endif // AUTOBOOST_RELAXED_HEAP_DEBUG
...
private:
  ...
  struct group {
     ...
     *  element). Note that the use of autoboost::optional increases the
     ...
     */
    ::autoboost::optional<value_type> value;
...
private:
  ...
  {
#if defined(AUTOBOOST_RELAXED_HEAP_DEBUG) && AUTOBOOST_RELAXED_HEAP_DEBUG > 1
   ...
   *  smaller.
   */
  std::vector< ::autoboost::optional<value_type> > groups;
...
#endif // AUTOBOOST_RELAXED_HEAP_HEADER
