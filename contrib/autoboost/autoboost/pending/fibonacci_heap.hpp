...
#ifndef AUTOBOOST_FIBONACCI_HEAP_HPP
#define AUTOBOOST_FIBONACCI_HEAP_HPP
...
{
  typedef typename autoboost::property_traits<ID>::value_type size_type;
...
#if defined(AUTOBOOST_MSVC) || defined(__ICL) // need a new macro?
...
#endif // AUTOBOOST_FIBONACCI_HEAP_HPP
