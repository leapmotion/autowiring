...
#ifndef AUTOBOOST_FENCED_PRIORITY_QUEUE_HPP
#define AUTOBOOST_FENCED_PRIORITY_QUEUE_HPP

#include <vector>
#include <queue>
#include <functional>
#include <autoboost/pending/queue.hpp>
...
namespace autoboost {
  ...
  template<class T, class Compare = std::less<T>, bool implicit_fence = true,
           class Buffer = autoboost::queue<T> >
...
#endif /* AUTOBOOST_FENCED_PRIORITY_QUEUE_HPP */
