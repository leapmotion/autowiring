...
#ifndef AUTOBOOST_ASIO_SOCKET_ACCEPTOR_SERVICE_HPP
#define AUTOBOOST_ASIO_SOCKET_ACCEPTOR_SERVICE_HPP
...
# include <autoboost/asio/detail/null_socket_service.hpp>
...
#else
  : public autoboost::asio::detail::service_base<socket_acceptor_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit socket_acceptor_service(autoboost::asio::io_service& io_service)
  ...
  /// connections.
  autoboost::system::error_code listen(implementation_type& impl, int backlog,
      autoboost::system::error_code& ec)
  {
      ...
      typename enable_if<is_convertible<Protocol, Protocol1>::value>::type* = 0)
  {
    detail::async_result_init<
      AcceptHandler, void (autoboost::system::error_code)> init(
...
#endif // AUTOBOOST_ASIO_SOCKET_ACCEPTOR_SERVICE_HPP
