...
#ifndef AUTOBOOST_ASIO_BASIC_SIGNAL_SET_HPP
#define AUTOBOOST_ASIO_BASIC_SIGNAL_SET_HPP
 ...
 *
 * Most applications will use the autoboost::asio::signal_set typedef.
 *
 * @par Thread Safety
 ...
 * autoboost::asio::signal_set signals(io_service, SIGINT, SIGTERM);
 *
...
public:
   ...
   */
  explicit basic_signal_set(autoboost::asio::io_service& io_service)
   ...
   * @code autoboost::asio::signal_set signals(io_service);
   * signals.add(signal_number_1); @endcode
   */
  basic_signal_set(autoboost::asio::io_service& io_service, int signal_number_1)
    : basic_io_object<SignalSetService>(io_service)
  {
    autoboost::system::error_code ec;
    this->service.add(this->implementation, signal_number_1, ec);
    autoboost::asio::detail::throw_error(ec, "add");
  }
   ...
   */
  autoboost::system::error_code add(int signal_number,
      autoboost::system::error_code& ec)
  {
  ...
  void remove(int signal_number)
  {
    ...
    autoboost::asio::detail::throw_error(ec, "remove");
  }
   ...
   * signal number.
   */
  autoboost::system::error_code remove(int signal_number,
      autoboost::system::error_code& ec)
  {
  ...
  void clear()
  {
    ...
    autoboost::asio::detail::throw_error(ec, "clear");
  }
   ...
   * @note Removes all queued notifications.
   */
  autoboost::system::error_code clear(autoboost::system::error_code& ec)
  {
   ...
   * operation will be invoked with the autoboost::asio::error::operation_aborted
   * error code.
   *
   ...
   * error code autoboost::asio::error::operation_aborted.
   *
  ...
  AUTOBOOST_ASIO_INITFN_RESULT_TYPE(SignalHandler,
      void (autoboost::system::error_code, int))
  async_wait(AUTOBOOST_ASIO_MOVE_ARG(SignalHandler) handler)
  {
    // If you get an error on the following line it means that your handler does
    // not meet the documented type requirements for a SignalHandler.
    AUTOBOOST_ASIO_SIGNAL_HANDLER_CHECK(SignalHandler, handler) type_check;

    return this->service.async_wait(this->implementation,
        AUTOBOOST_ASIO_MOVE_CAST(SignalHandler)(handler));
  }
};
...
#endif // AUTOBOOST_ASIO_BASIC_SIGNAL_SET_HPP
