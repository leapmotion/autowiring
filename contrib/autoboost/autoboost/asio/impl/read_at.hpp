...
#ifndef AUTOBOOST_ASIO_IMPL_READ_AT_HPP
#define AUTOBOOST_ASIO_IMPL_READ_AT_HPP
    ...
    uint64_t offset, const MutableBufferSequence& buffers)
{
  ...
  autoboost::asio::detail::throw_error(ec, "read_at");
...
namespace detail
{
      ...
      switch (start_ = start)
      {
        ...
        for (;;)
        {
          device_.async_read_some_at(offset_ + total_transferred_,
              buffers_, AUTOBOOST_ASIO_MOVE_CAST(read_at_op)(*this));
          return; default:
  ...
  class read_at_op<AsyncRandomAccessReadDevice,
      autoboost::asio::mutable_buffers_1, CompletionCondition, ReadHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    read_at_op(AsyncRandomAccessReadDevice& device,
      ...
      switch (start_ = start)
      {
        ...
        for (;;)
        {
          device_.async_read_some_at(offset_ + total_transferred_,
              ...
              AUTOBOOST_ASIO_MOVE_CAST(read_at_op)(*this));
          return; default:
          total_transferred_ += bytes_transferred;
          if ((!ec && bytes_transferred == 0)
  ...
  template <typename AsyncRandomAccessReadDevice, typename Elem,
      typename CompletionCondition, typename ReadHandler>
  class read_at_op<AsyncRandomAccessReadDevice, autoboost::array<Elem, 2>,
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      switch (start_ = start)
      {
        ...
        for (;;)
        {
          ...
          device_.async_read_some_at(offset_ + total_transferred_,
              bufs, AUTOBOOST_ASIO_MOVE_CAST(read_at_op)(*this));
          return; default:
          total_transferred_ += bytes_transferred;
          if ((!ec && bytes_transferred == 0)
              || (n = this->check_for_completion(ec, total_transferred_)) == 0
    ...
    AUTOBOOST_ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_at_op<AsyncRandomAccessReadDevice, MutableBufferSequence,
    CompletionCondition, AUTOBOOST_ASIO_HANDLER_TYPE(ReadHandler,
      void (autoboost::system::error_code, std::size_t))>(
    ...
    AUTOBOOST_ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_at_op<AsyncRandomAccessReadDevice, MutableBufferSequence,
    detail::transfer_all_t, AUTOBOOST_ASIO_HANDLER_TYPE(ReadHandler,
      void (autoboost::system::error_code, std::size_t))>(
      ...
      switch (start_ = start)
      {
        ...
        for (;;)
        {
          device_.async_read_some_at(offset_ + total_transferred_,
              ...
              AUTOBOOST_ASIO_MOVE_CAST(read_at_streambuf_op)(*this));
          return; default:
          total_transferred_ += bytes_transferred;
...
#endif // AUTOBOOST_ASIO_IMPL_READ_AT_HPP
