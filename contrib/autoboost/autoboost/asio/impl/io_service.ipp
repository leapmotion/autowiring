...
#ifndef AUTOBOOST_ASIO_IMPL_IO_SERVICE_IPP
#define AUTOBOOST_ASIO_IMPL_IO_SERVICE_IPP
...
io_service::io_service()
  : service_registry_(new autoboost::asio::detail::service_registry(
...
std::size_t io_service::run(autoboost::system::error_code& ec)
{
  return impl_.run(ec);
}
...
std::size_t io_service::run_one(autoboost::system::error_code& ec)
{
...
std::size_t io_service::poll(autoboost::system::error_code& ec)
{
...
std::size_t io_service::poll_one(autoboost::system::error_code& ec)
{
...
void io_service::notify_fork(autoboost::asio::io_service::fork_event event)
{
  service_registry_->notify_fork(event);
}

io_service::service::service(autoboost::asio::io_service& owner)
  : owner_(owner),
    next_(0)
{
}
...
void io_service::service::fork_service(autoboost::asio::io_service::fork_event)
{
}
...
#endif // AUTOBOOST_ASIO_IMPL_IO_SERVICE_IPP
