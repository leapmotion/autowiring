...
#ifndef AUTOBOOST_ASIO_IMPL_READ_UNTIL_HPP
#define AUTOBOOST_ASIO_IMPL_READ_UNTIL_HPP
    ...
    autoboost::asio::basic_streambuf<Allocator>& b, char delim)
{
  ...
  autoboost::asio::detail::throw_error(ec, "read_until");
    ...
    autoboost::system::error_code& ec)
{
  ...
  for (;;)
  {
    ...
    typedef typename autoboost::asio::basic_streambuf<
      Allocator>::const_buffers_type const_buffers_type;
    typedef autoboost::asio::buffers_iterator<const_buffers_type> iterator;
    ...
    autoboost::system::error_code& ec)
{
  ...
  for (;;)
  {
    ...
    // Look for a match.
    autoboost::match_results<iterator,
      typename std::vector<autoboost::sub_match<iterator> >::allocator_type>
        match_results;
    if (regex_search(start_pos, end, match_results, expr,
          autoboost::match_default | autoboost::match_partial))
    {
...
namespace detail
{
  ...
  public:
    read_until_delim_op(AsyncReadStream& stream,
        autoboost::asio::basic_streambuf<Allocator>& streambuf,
      ...
      case 1:
        for (;;)
        {
          ...
          stream_.async_read_some(streambuf_.prepare(bytes_to_read),
              AUTOBOOST_ASIO_MOVE_CAST(read_until_delim_op)(*this));
          return; default:
    ...
    AUTOBOOST_ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_until_delim_op<AsyncReadStream,
    Allocator, AUTOBOOST_ASIO_HANDLER_TYPE(ReadHandler,
      void (autoboost::system::error_code, std::size_t))>(
...
namespace detail
{
  ...
  public:
    ...
    read_until_delim_string_op(read_until_delim_string_op&& other)
      : stream_(other.stream_),
        streambuf_(other.streambuf_),
        delim_(AUTOBOOST_ASIO_MOVE_CAST(std::string)(other.delim_)),
        start_(other.start_),
        search_position_(other.search_position_),
        handler_(AUTOBOOST_ASIO_MOVE_CAST(ReadHandler)(other.handler_))
    {
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      case 1:
        for (;;)
        {
          ...
          // Start a new asynchronous read operation to obtain more data.
          stream_.async_read_some(streambuf_.prepare(bytes_to_read),
              AUTOBOOST_ASIO_MOVE_CAST(read_until_delim_string_op)(*this));
          return; default:
          streambuf_.commit(bytes_transferred);
          if (ec || bytes_transferred == 0)
            break;
...
namespace detail
{
  ...
  public:
    read_until_expr_op(AsyncReadStream& stream,
        autoboost::asio::basic_streambuf<Allocator>& streambuf,
        const autoboost::regex& expr, ReadHandler& handler)
      : stream_(stream),
        streambuf_(streambuf),
        expr_(expr),
        start_(0),
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      case 1:
        for (;;)
        {
          ...
          // Start a new asynchronous read operation to obtain more data.
          stream_.async_read_some(streambuf_.prepare(bytes_to_read),
              AUTOBOOST_ASIO_MOVE_CAST(read_until_expr_op)(*this));
          return; default:
          streambuf_.commit(bytes_transferred);
          if (ec || bytes_transferred == 0)
            break;
    ...
    AUTOBOOST_ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_until_expr_op<AsyncReadStream, Allocator,
    autoboost::regex, AUTOBOOST_ASIO_HANDLER_TYPE(ReadHandler,
      void (autoboost::system::error_code, std::size_t))>(
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      case 1:
        for (;;)
        {
          ...
          // Start a new asynchronous read operation to obtain more data.
          stream_.async_read_some(streambuf_.prepare(bytes_to_read),
              AUTOBOOST_ASIO_MOVE_CAST(read_until_match_op)(*this));
          return; default:
          streambuf_.commit(bytes_transferred);
          if (ec || bytes_transferred == 0)
            break;
    ...
    typename enable_if<is_match_condition<MatchCondition>::value>::type*)
{
  ...
  detail::read_until_match_op<AsyncReadStream, Allocator,
    MatchCondition, AUTOBOOST_ASIO_HANDLER_TYPE(ReadHandler,
      void (autoboost::system::error_code, std::size_t))>(
...
#endif // AUTOBOOST_ASIO_IMPL_READ_UNTIL_HPP
