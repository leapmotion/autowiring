...
#ifndef AUTOBOOST_ASIO_IMPL_WRITE_AT_HPP
#define AUTOBOOST_ASIO_IMPL_WRITE_AT_HPP
    ...
    uint64_t offset, const ConstBufferSequence& buffers)
{
  ...
  autoboost::asio::detail::throw_error(ec, "write_at");
...
namespace detail
{
  ...
  public:
    write_at_op(AsyncRandomAccessWriteDevice& device,
      ...
      : detail::base_from_completion_cond<
        ...
        handler_(AUTOBOOST_ASIO_MOVE_CAST(WriteHandler)(handler))
    {
    }
    ...
    write_at_op(write_at_op&& other)
      : detail::base_from_completion_cond<CompletionCondition>(other),
        ...
        start_(other.start_),
        total_transferred_(other.total_transferred_),
        handler_(AUTOBOOST_ASIO_MOVE_CAST(WriteHandler)(other.handler_))
    {
    }
  ...
  class write_at_op<AsyncRandomAccessWriteDevice,
      autoboost::asio::mutable_buffers_1, CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_at_op(AsyncRandomAccessWriteDevice& device,
        uint64_t offset, const autoboost::asio::mutable_buffers_1& buffers,
        CompletionCondition completion_condition,
  ...
  template <typename AsyncRandomAccessWriteDevice,
      typename CompletionCondition, typename WriteHandler>
  class write_at_op<AsyncRandomAccessWriteDevice, autoboost::asio::const_buffers_1,
      CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_at_op(AsyncRandomAccessWriteDevice& device,
        uint64_t offset, const autoboost::asio::const_buffers_1& buffers,
        CompletionCondition completion_condition,
        WriteHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
  ...
  //private:
    AsyncRandomAccessWriteDevice& device_;
    uint64_t offset_;
    autoboost::asio::const_buffer buffer_;
    int start_;
    std::size_t total_transferred_;
    WriteHandler handler_;
  };
  ...
  template <typename AsyncRandomAccessWriteDevice, typename Elem,
      typename CompletionCondition, typename WriteHandler>
  class write_at_op<AsyncRandomAccessWriteDevice, autoboost::array<Elem, 2>,
      CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_at_op(AsyncRandomAccessWriteDevice& device,
        uint64_t offset, const autoboost::array<Elem, 2>& buffers,
        CompletionCondition completion_condition, WriteHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
        device_(device),
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      typename autoboost::asio::detail::dependent_type<Elem,
          autoboost::array<autoboost::asio::const_buffer, 2> >::type bufs = {{
        autoboost::asio::const_buffer(buffers_[0]),
        autoboost::asio::const_buffer(buffers_[1]) }};
      ...
      switch (start_ = start)
      {
        ...
        for (;;)
        {
          ...
          device_.async_write_some_at(offset_ + total_transferred_,
              bufs, AUTOBOOST_ASIO_MOVE_CAST(write_at_op)(*this));
          return; default:
          total_transferred_ += bytes_transferred;
          if ((!ec && bytes_transferred == 0)
              || (n = this->check_for_completion(ec, total_transferred_)) == 0
  ...
  public:
    ...
    {
      typename autoboost::asio::detail::dependent_type<Elem,
          std::array<autoboost::asio::const_buffer, 2> >::type bufs = {{
        autoboost::asio::const_buffer(buffers_[0]),
        autoboost::asio::const_buffer(buffers_[1]) }};
      std::size_t buffer_size0 = autoboost::asio::buffer_size(bufs[0]);
      std::size_t buffer_size1 = autoboost::asio::buffer_size(bufs[1]);
...
template <typename AsyncRandomAccessWriteDevice, typename ConstBufferSequence,
    typename CompletionCondition, typename WriteHandler>
inline AUTOBOOST_ASIO_INITFN_RESULT_TYPE(WriteHandler,
    ...
    AUTOBOOST_ASIO_MOVE_ARG(WriteHandler) handler)
{
  ...
  detail::write_at_op<AsyncRandomAccessWriteDevice, ConstBufferSequence,
    CompletionCondition, AUTOBOOST_ASIO_HANDLER_TYPE(
      WriteHandler, void (autoboost::system::error_code, std::size_t))>(
...
namespace detail
{
  ...
  make_write_at_streambuf_op(
      autoboost::asio::basic_streambuf<Allocator>& b, WriteHandler handler)
  {
    ...
    AUTOBOOST_ASIO_MOVE_ARG(WriteHandler) handler)
{
  ...
  async_write_at(d, offset, b.data(), completion_condition,
    detail::write_at_streambuf_op<Allocator, AUTOBOOST_ASIO_HANDLER_TYPE(
      WriteHandler, void (autoboost::system::error_code, std::size_t))>(
        b, init.handler));
...
#endif // AUTOBOOST_ASIO_IMPL_WRITE_AT_HPP
