...
#ifndef AUTOBOOST_ASIO_IMPL_SERIAL_PORT_BASE_IPP
#define AUTOBOOST_ASIO_IMPL_SERIAL_PORT_BASE_IPP
...
autoboost::system::error_code serial_port_base::baud_rate::store(
    AUTOBOOST_ASIO_OPTION_STORAGE& storage, autoboost::system::error_code& ec) const
{
...
autoboost::system::error_code serial_port_base::baud_rate::load(
    const AUTOBOOST_ASIO_OPTION_STORAGE& storage, autoboost::system::error_code& ec)
{
#if defined(AUTOBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
autoboost::system::error_code serial_port_base::flow_control::store(
    AUTOBOOST_ASIO_OPTION_STORAGE& storage, autoboost::system::error_code& ec) const
{
#if defined(AUTOBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
autoboost::system::error_code serial_port_base::flow_control::load(
    const AUTOBOOST_ASIO_OPTION_STORAGE& storage, autoboost::system::error_code& ec)
{
#if defined(AUTOBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
autoboost::system::error_code serial_port_base::parity::store(
    AUTOBOOST_ASIO_OPTION_STORAGE& storage, autoboost::system::error_code& ec) const
{
#if defined(AUTOBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
autoboost::system::error_code serial_port_base::parity::load(
    const AUTOBOOST_ASIO_OPTION_STORAGE& storage, autoboost::system::error_code& ec)
{
#if defined(AUTOBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
autoboost::system::error_code serial_port_base::stop_bits::store(
    AUTOBOOST_ASIO_OPTION_STORAGE& storage, autoboost::system::error_code& ec) const
{
#if defined(AUTOBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
autoboost::system::error_code serial_port_base::stop_bits::load(
    const AUTOBOOST_ASIO_OPTION_STORAGE& storage, autoboost::system::error_code& ec)
{
#if defined(AUTOBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
autoboost::system::error_code serial_port_base::character_size::store(
    AUTOBOOST_ASIO_OPTION_STORAGE& storage, autoboost::system::error_code& ec) const
{
#if defined(AUTOBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
autoboost::system::error_code serial_port_base::character_size::load(
    const AUTOBOOST_ASIO_OPTION_STORAGE& storage, autoboost::system::error_code& ec)
{
#if defined(AUTOBOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
#endif // AUTOBOOST_ASIO_IMPL_SERIAL_PORT_BASE_IPP
