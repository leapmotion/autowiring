...
#ifndef AUTOBOOST_ASIO_IMPL_ERROR_IPP
#define AUTOBOOST_ASIO_IMPL_ERROR_IPP
...
class netdb_category : public autoboost::system::error_category
{
public:
...
class addrinfo_category : public autoboost::system::error_category
{
public:
  const char* name() const AUTOBOOST_ASIO_ERROR_CATEGORY_NOEXCEPT
  {
...
class misc_category : public autoboost::system::error_category
{
public:
  const char* name() const AUTOBOOST_ASIO_ERROR_CATEGORY_NOEXCEPT
  {
...
#endif // AUTOBOOST_ASIO_IMPL_ERROR_IPP
