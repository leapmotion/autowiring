...
#ifndef AUTOBOOST_ASIO_POSIX_BASIC_DESCRIPTOR_HPP
#define AUTOBOOST_ASIO_POSIX_BASIC_DESCRIPTOR_HPP
...
public:
   ...
   * descriptor.
   */
  explicit basic_descriptor(autoboost::asio::io_service& io_service)
   ...
   */
  basic_descriptor(autoboost::asio::io_service& io_service,
  ...
  basic_descriptor(basic_descriptor&& other)
    : basic_io_object<DescriptorService>(
        AUTOBOOST_ASIO_MOVE_CAST(basic_descriptor)(other))
  {
  }
   ...
   */
  autoboost::system::error_code assign(const native_handle_type& native_descriptor,
      autoboost::system::error_code& ec)
  {
   ...
   * autoboost::asio::posix::descriptor_base::bytes_readable @n
   * autoboost::asio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   ...
   * ...
   * autoboost::asio::posix::stream_descriptor::bytes_readable command;
...
#endif // AUTOBOOST_ASIO_POSIX_BASIC_DESCRIPTOR_HPP
