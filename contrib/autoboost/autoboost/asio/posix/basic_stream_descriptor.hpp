...
#ifndef AUTOBOOST_ASIO_POSIX_BASIC_STREAM_DESCRIPTOR_HPP
#define AUTOBOOST_ASIO_POSIX_BASIC_STREAM_DESCRIPTOR_HPP
...
public:
   ...
   * descriptor.
   */
  explicit basic_stream_descriptor(autoboost::asio::io_service& io_service)
   ...
   */
  basic_stream_descriptor(autoboost::asio::io_service& io_service,
  ...
  basic_stream_descriptor(basic_stream_descriptor&& other)
    : basic_descriptor<StreamDescriptorService>(
        AUTOBOOST_ASIO_MOVE_CAST(basic_stream_descriptor)(other))
  {
  }
   ...
   * @code
   * descriptor.write_some(autoboost::asio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * descriptor.async_write_some(autoboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
   ...
   * @code
   * descriptor.read_some(autoboost::asio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * descriptor.async_read_some(autoboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
...
#endif // AUTOBOOST_ASIO_POSIX_BASIC_STREAM_DESCRIPTOR_HPP
