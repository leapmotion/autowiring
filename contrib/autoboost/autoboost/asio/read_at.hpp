...
#ifndef AUTOBOOST_ASIO_READ_AT_HPP
#define AUTOBOOST_ASIO_READ_AT_HPP
...
/**
 * @defgroup read_at autoboost::asio::read_at
 *
 ...
 * @code autoboost::asio::read_at(d, 42, autoboost::asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, autoboost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code autoboost::asio::read_at(
 *     d, 42, buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code autoboost::asio::read_at(d, 42,
 *     autoboost::asio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, autoboost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code autoboost::asio::read_at(d, 42, autoboost::asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_read_at autoboost::asio::async_read_at
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * autoboost::asio::async_read_at(d, 42, autoboost::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, autoboost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code autoboost::asio::async_read_at(
 *     d, 42, buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code autoboost::asio::async_read_at(d, 42,
...
AUTOBOOST_ASIO_INITFN_RESULT_TYPE(ReadHandler,
    void (autoboost::system::error_code, std::size_t))
async_read_at(AsyncRandomAccessReadDevice& d, uint64_t offset,
    basic_streambuf<Allocator>& b, AUTOBOOST_ASIO_MOVE_ARG(ReadHandler) handler);
...
#include <autoboost/asio/impl/read_at.hpp>

#endif // AUTOBOOST_ASIO_READ_AT_HPP
