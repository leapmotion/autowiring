...
#ifndef AUTOBOOST_ASIO_DATAGRAM_SOCKET_SERVICE_HPP
#define AUTOBOOST_ASIO_DATAGRAM_SOCKET_SERVICE_HPP
...
#else
  : public autoboost::asio::detail::service_base<datagram_socket_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit datagram_socket_service(autoboost::asio::io_service& io_service)
  ...
  {
    if (protocol.type() == AUTOBOOST_ASIO_OS_DEF(SOCK_DGRAM))
...
#endif // AUTOBOOST_ASIO_DATAGRAM_SOCKET_SERVICE_HPP
