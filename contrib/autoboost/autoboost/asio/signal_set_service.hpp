...
#ifndef AUTOBOOST_ASIO_SIGNAL_SET_SERVICE_HPP
#define AUTOBOOST_ASIO_SIGNAL_SET_SERVICE_HPP
...
#else
  : public autoboost::asio::detail::service_base<signal_set_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit signal_set_service(autoboost::asio::io_service& io_service)
    : autoboost::asio::detail::service_base<signal_set_service>(io_service),
  ...
  autoboost::system::error_code add(implementation_type& impl,
  ...
  autoboost::system::error_code remove(implementation_type& impl,
      int signal_number, autoboost::system::error_code& ec)
  {
  ...
  autoboost::system::error_code clear(implementation_type& impl,
  ...
  async_wait(implementation_type& impl,
      AUTOBOOST_ASIO_MOVE_ARG(SignalHandler) handler)
  {
    detail::async_result_init<
      SignalHandler, void (autoboost::system::error_code, int)> init(
...
#endif // AUTOBOOST_ASIO_SIGNAL_SET_SERVICE_HPP
