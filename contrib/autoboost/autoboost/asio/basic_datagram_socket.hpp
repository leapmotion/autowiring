...
#ifndef AUTOBOOST_ASIO_BASIC_DATAGRAM_SOCKET_HPP
#define AUTOBOOST_ASIO_BASIC_DATAGRAM_SOCKET_HPP
...
public:
   ...
   * socket.
   */
  explicit basic_datagram_socket(autoboost::asio::io_service& io_service)
   ...
   */
  basic_datagram_socket(autoboost::asio::io_service& io_service,
  ...
  basic_datagram_socket(basic_datagram_socket&& other)
    : basic_socket<Protocol, DatagramSocketService>(
        AUTOBOOST_ASIO_MOVE_CAST(basic_datagram_socket)(other))
  {
  }
  ...
  basic_datagram_socket(
    ...
    : basic_socket<Protocol, DatagramSocketService>(
        AUTOBOOST_ASIO_MOVE_CAST2(basic_datagram_socket<
   ...
   *     autoboost::asio::buffer(data, size), sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
   */
...
#endif // AUTOBOOST_ASIO_BASIC_DATAGRAM_SOCKET_HPP
