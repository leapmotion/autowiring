...
#ifndef AUTOBOOST_ASIO_BASIC_SEQ_PACKET_SOCKET_HPP
#define AUTOBOOST_ASIO_BASIC_SEQ_PACKET_SOCKET_HPP
...
public:
   ...
   * the socket.
   */
  explicit basic_seq_packet_socket(autoboost::asio::io_service& io_service)
   ...
   */
  basic_seq_packet_socket(autoboost::asio::io_service& io_service,
  ...
  basic_seq_packet_socket(basic_seq_packet_socket&& other)
    : basic_socket<Protocol, SeqPacketSocketService>(
        AUTOBOOST_ASIO_MOVE_CAST(basic_seq_packet_socket)(other))
  {
  }
  ...
  basic_seq_packet_socket(
    ...
    : basic_socket<Protocol, SeqPacketSocketService>(
        AUTOBOOST_ASIO_MOVE_CAST2(basic_seq_packet_socket<
   ...
   * follows:
   * @code
   * socket.receive(autoboost::asio::buffer(data, size), out_flags);
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(autoboost::asio::buffer(data, size), 0, out_flags);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(autoboost::asio::buffer(data, size), out_flags, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
...
#endif // AUTOBOOST_ASIO_BASIC_SEQ_PACKET_SOCKET_HPP
