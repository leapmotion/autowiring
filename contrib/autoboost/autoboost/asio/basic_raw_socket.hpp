...
#ifndef AUTOBOOST_ASIO_BASIC_RAW_SOCKET_HPP
#define AUTOBOOST_ASIO_BASIC_RAW_SOCKET_HPP
...
public:
   ...
   * socket.
   */
  explicit basic_raw_socket(autoboost::asio::io_service& io_service)
   ...
   */
  basic_raw_socket(autoboost::asio::io_service& io_service,
  ...
  basic_raw_socket(basic_raw_socket&& other)
    : basic_socket<Protocol, RawSocketService>(
        AUTOBOOST_ASIO_MOVE_CAST(basic_raw_socket)(other))
  {
  }
  ...
  basic_raw_socket(basic_raw_socket<Protocol1, RawSocketService1>&& other,
    ...
    : basic_socket<Protocol, RawSocketService>(
        AUTOBOOST_ASIO_MOVE_CAST2(basic_raw_socket<
   ...
   * @code socket.send(autoboost::asio::buffer(data, size)); @endcode
      ...
      AUTOBOOST_ASIO_MOVE_ARG(WriteHandler) handler)
  {
    ...
    return this->get_service().async_send(this->get_implementation(),
        buffers, flags, AUTOBOOST_ASIO_MOVE_CAST(WriteHandler)(handler));
  }
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * autoboost::asio::ip::udp::endpoint destination(
   *     autoboost::asio::ip::address::from_string("1.2.3.4"), 12345);
   * socket.send_to(autoboost::asio::buffer(data, size), destination);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
      ...
      const endpoint_type& destination)
  {
    ...
    autoboost::asio::detail::throw_error(ec, "send_to");
    return s;
  }
   ...
   *     autoboost::asio::buffer(data, size), destination, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
      ...
      AUTOBOOST_ASIO_MOVE_ARG(WriteHandler) handler)
  {
    ...
    return this->get_service().async_send_to(this->get_implementation(),
        buffers, destination, 0, AUTOBOOST_ASIO_MOVE_CAST(WriteHandler)(handler));
  }
   ...
   * follows:
   * @code socket.receive(autoboost::asio::buffer(data, size)); @endcode
   ...
   * follows:
   * @code
   * autoboost::asio::ip::udp::endpoint sender_endpoint;
   * socket.receive_from(
   *     autoboost::asio::buffer(data, size), sender_endpoint);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
      ...
      endpoint_type& sender_endpoint)
  {
    ...
    autoboost::asio::detail::throw_error(ec, "receive_from");
    return s;
  }
   ...
   *     autoboost::asio::buffer(data, size), 0, sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
   */
...
#endif // AUTOBOOST_ASIO_BASIC_RAW_SOCKET_HPP
