...
#ifndef AUTOBOOST_ASIO_BASIC_SERIAL_PORT_HPP
#define AUTOBOOST_ASIO_BASIC_SERIAL_PORT_HPP
...
public:
   ...
   */
  explicit basic_serial_port(autoboost::asio::io_service& io_service)
   ...
   */
  basic_serial_port(autoboost::asio::io_service& io_service,
  ...
  basic_serial_port(basic_serial_port&& other)
    : basic_io_object<SerialPortService>(
        AUTOBOOST_ASIO_MOVE_CAST(basic_serial_port)(other))
  {
  }
   ...
   */
  autoboost::system::error_code open(const std::string& device,
      autoboost::system::error_code& ec)
  {
   ...
   */
  autoboost::system::error_code assign(const native_handle_type& native_serial_port,
      autoboost::system::error_code& ec)
  {
  ...
  void send_break()
  {
    ...
    autoboost::asio::detail::throw_error(ec, "send_break");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  autoboost::system::error_code send_break(autoboost::system::error_code& ec)
  {
   ...
   * autoboost::asio::serial_port_base::baud_rate @n
   * autoboost::asio::serial_port_base::flow_control @n
   * autoboost::asio::serial_port_base::parity @n
   * autoboost::asio::serial_port_base::stop_bits @n
   * autoboost::asio::serial_port_base::character_size
   */
   ...
   */
  template <typename SettableSerialPortOption>
  autoboost::system::error_code set_option(const SettableSerialPortOption& option,
      autoboost::system::error_code& ec)
  {
   ...
   */
  template <typename GettableSerialPortOption>
  autoboost::system::error_code get_option(GettableSerialPortOption& option,
      autoboost::system::error_code& ec)
  {
   ...
   *
   * @throws autoboost::system::system_error Thrown on failure. An error code of
   * autoboost::asio::error::eof indicates that the connection was closed by the
   * peer.
   *
   ...
   * @code
   * serial_port.write_some(autoboost::asio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * serial_port.async_write_some(autoboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
      ...
      AUTOBOOST_ASIO_MOVE_ARG(WriteHandler) handler)
  {
    ...
    return this->get_service().async_write_some(this->get_implementation(),
        buffers, AUTOBOOST_ASIO_MOVE_CAST(WriteHandler)(handler));
  }
   ...
   * @code
   * serial_port.read_some(autoboost::asio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * serial_port.async_read_some(autoboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
      ...
      AUTOBOOST_ASIO_MOVE_ARG(ReadHandler) handler)
  {
    ...
    return this->get_service().async_read_some(this->get_implementation(),
        buffers, AUTOBOOST_ASIO_MOVE_CAST(ReadHandler)(handler));
  }
};
...
#endif // AUTOBOOST_ASIO_BASIC_SERIAL_PORT_HPP
