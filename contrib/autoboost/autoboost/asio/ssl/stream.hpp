...
#ifndef AUTOBOOST_ASIO_SSL_STREAM_HPP
#define AUTOBOOST_ASIO_SSL_STREAM_HPP
...
# include <autoboost/asio/ssl/old/stream.hpp>
...
# include <autoboost/asio/ssl/detail/buffered_handshake_op.hpp>
# include <autoboost/asio/ssl/detail/handshake_op.hpp>
# include <autoboost/asio/ssl/detail/io.hpp>
# include <autoboost/asio/ssl/detail/read_op.hpp>
# include <autoboost/asio/ssl/detail/shutdown_op.hpp>
# include <autoboost/asio/ssl/detail/stream_core.hpp>
# include <autoboost/asio/ssl/detail/write_op.hpp>
# include <autoboost/asio/ssl/stream_base.hpp>
...
using autoboost::asio::ssl::old::stream;
 ...
 * autoboost::asio::ssl::context ctx(autoboost::asio::ssl::context::sslv23);
 * autoboost::asio::ssl::stream<asio:ip::tcp::socket> sock(io_service, ctx);
 * @endcode
 *
 * @par Concepts:
...
public:
   ...
   * @note Calls @c SSL_set_verify.
   */
  autoboost::system::error_code set_verify_mode(
   ...
   * @note Calls @c SSL_set_verify_depth.
   */
  autoboost::system::error_code set_verify_depth(
  ...
  void handshake(handshake_type type)
  {
    autoboost::system::error_code ec;
    handshake(type, ec);
    autoboost::asio::detail::throw_error(ec, "handshake");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  autoboost::system::error_code handshake(handshake_type type,
      autoboost::system::error_code& ec)
  {
  ...
  AUTOBOOST_ASIO_INITFN_RESULT_TYPE(HandshakeHandler,
      void (autoboost::system::error_code))
  async_handshake(handshake_type type,
      AUTOBOOST_ASIO_MOVE_ARG(HandshakeHandler) handler)
  {
    // If you get an error on the following line it means that your handler does
    // not meet the documented type requirements for a HandshakeHandler.
    AUTOBOOST_ASIO_HANDSHAKE_HANDLER_CHECK(HandshakeHandler, handler) type_check;

    autoboost::asio::detail::async_result_init<
      HandshakeHandler, void (autoboost::system::error_code)> init(
        AUTOBOOST_ASIO_MOVE_CAST(HandshakeHandler)(handler));
  ...
  AUTOBOOST_ASIO_INITFN_RESULT_TYPE(BufferedHandshakeHandler,
      void (autoboost::system::error_code, std::size_t))
  async_handshake(handshake_type type, const ConstBufferSequence& buffers,
      AUTOBOOST_ASIO_MOVE_ARG(BufferedHandshakeHandler) handler)
  {
    // If you get an error on the following line it means that your handler does
    // not meet the documented type requirements for a BufferedHandshakeHandler.
    AUTOBOOST_ASIO_BUFFERED_HANDSHAKE_HANDLER_CHECK(
        BufferedHandshakeHandler, handler) type_check;

    autoboost::asio::detail::async_result_init<BufferedHandshakeHandler,
      void (autoboost::system::error_code, std::size_t)> init(
        AUTOBOOST_ASIO_MOVE_CAST(BufferedHandshakeHandler)(handler));
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  autoboost::system::error_code shutdown(autoboost::system::error_code& ec)
  {
  ...
  AUTOBOOST_ASIO_INITFN_RESULT_TYPE(ShutdownHandler,
      void (autoboost::system::error_code))
  async_shutdown(AUTOBOOST_ASIO_MOVE_ARG(ShutdownHandler) handler)
  {
    // If you get an error on the following line it means that your handler does
    // not meet the documented type requirements for a ShutdownHandler.
    AUTOBOOST_ASIO_SHUTDOWN_HANDLER_CHECK(ShutdownHandler, handler) type_check;

    autoboost::asio::detail::async_result_init<
      ShutdownHandler, void (autoboost::system::error_code)> init(
        AUTOBOOST_ASIO_MOVE_CAST(ShutdownHandler)(handler));
  ...
  std::size_t write_some(const ConstBufferSequence& buffers)
  {
    ...
    autoboost::asio::detail::throw_error(ec, "write_some");
    return n;
  }
      ...
      AUTOBOOST_ASIO_MOVE_ARG(WriteHandler) handler)
  {
    ...
    AUTOBOOST_ASIO_WRITE_HANDLER_CHECK(WriteHandler, handler) type_check;
  ...
  std::size_t read_some(const MutableBufferSequence& buffers)
  {
    ...
    autoboost::asio::detail::throw_error(ec, "read_some");
    return n;
  }
...
#endif // AUTOBOOST_ASIO_SSL_STREAM_HPP
