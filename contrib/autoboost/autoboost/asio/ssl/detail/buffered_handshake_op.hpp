...
#ifndef AUTOBOOST_ASIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
#define AUTOBOOST_ASIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
...
public:
  buffered_handshake_op(stream_base::handshake_type type,
    ...
    : type_(type),
      buffers_(buffers),
      total_buffer_size_(autoboost::asio::buffer_size(buffers_))
  {
  }
...
#endif // AUTOBOOST_ASIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
