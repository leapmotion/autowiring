...
#ifndef AUTOBOOST_ASIO_SSL_DETAIL_READ_OP_HPP
#define AUTOBOOST_ASIO_SSL_DETAIL_READ_OP_HPP
...
public:
      ...
      std::size_t& bytes_transferred) const
  {
    autoboost::asio::mutable_buffer buffer =
      autoboost::asio::detail::buffer_sequence_adapter<autoboost::asio::mutable_buffer,
...
#endif // AUTOBOOST_ASIO_SSL_DETAIL_READ_OP_HPP
