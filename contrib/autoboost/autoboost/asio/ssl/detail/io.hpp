...
#ifndef AUTOBOOST_ASIO_SSL_DETAIL_IO_HPP
#define AUTOBOOST_ASIO_SSL_DETAIL_IO_HPP
...
std::size_t io(Stream& next_layer, stream_core& core,
    const Operation& op, autoboost::system::error_code& ec)
{
  ...
  case engine::want_input_and_retry:
    ...
    if (autoboost::asio::buffer_size(core.input_) == 0)
      core.input_ = autoboost::asio::buffer(core.input_buffer_,
  ...
  case engine::want_output_and_retry:
    ...
    // transport.
    autoboost::asio::write(next_layer,
...
public:
  ...
  io_op(io_op&& other)
    : next_layer_(other.next_layer_),
      ...
      ec_(other.ec_),
      bytes_transferred_(other.bytes_transferred_),
      handler_(AUTOBOOST_ASIO_MOVE_CAST(Handler)(other.handler_))
  {
  }
    ...
    case 1: // Called after at least one async operation.
      do
      {
        ...
        case engine::want_input_and_retry:
          ...
          if (autoboost::asio::buffer_size(core_.input_) != 0)
          {
          ...
          if (core_.pending_read_.expires_at() == core_.neg_infin())
          {
            ...
            next_layer_.async_read_some(
                autoboost::asio::buffer(core_.input_buffer_),
                AUTOBOOST_ASIO_MOVE_CAST(io_op)(*this));
          }
          else
          {
            // Wait until the current read operation completes.
            core_.pending_read_.async_wait(AUTOBOOST_ASIO_MOVE_CAST(io_op)(*this));
          }
        ...
        case engine::want_output:
          ...
          if (core_.pending_write_.expires_at() == core_.neg_infin())
          {
            ...
            autoboost::asio::async_write(next_layer_,
          ...
          else
          {
            ...
            core_.pending_write_.async_wait(AUTOBOOST_ASIO_MOVE_CAST(io_op)(*this));
          }
        ...
        default:
          ...
          {
            next_layer_.async_read_some(
                autoboost::asio::buffer(core_.input_buffer_, 0),
                AUTOBOOST_ASIO_MOVE_CAST(io_op)(*this));
        ...
        case engine::want_input_and_retry:
          ...
          core_.input_ = autoboost::asio::buffer(
    ...
    io_op<Stream, Operation, Handler>* this_handler)
{
  return this_handler->start_ == 0 ? true
    : autoboost_asio_handler_cont_helpers::is_continuation(this_handler->handler_);
}
...
#endif // AUTOBOOST_ASIO_SSL_DETAIL_IO_HPP
