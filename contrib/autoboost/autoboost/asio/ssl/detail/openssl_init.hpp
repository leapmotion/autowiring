...
#ifndef AUTOBOOST_ASIO_SSL_DETAIL_OPENSSL_INIT_HPP
#define AUTOBOOST_ASIO_SSL_DETAIL_OPENSSL_INIT_HPP
...
protected:
  ...
  AUTOBOOST_ASIO_DECL static autoboost::asio::detail::shared_ptr<do_init> instance();

#if !defined(SSL_OP_NO_COMPRESSION) \
  && (OPENSSL_VERSION_NUMBER >= 0x00908000L)
  // Get an empty stack of compression methods, to be used when disabling
  // compression.
  AUTOBOOST_ASIO_DECL static STACK_OF(SSL_COMP)* get_null_compression_methods();
...
private:
  ...
  autoboost::asio::detail::shared_ptr<do_init> ref_;
};
...
#endif // AUTOBOOST_ASIO_SSL_DETAIL_OPENSSL_INIT_HPP
