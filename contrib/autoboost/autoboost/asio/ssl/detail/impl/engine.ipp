...
#ifndef AUTOBOOST_ASIO_SSL_DETAIL_IMPL_ENGINE_IPP
#define AUTOBOOST_ASIO_SSL_DETAIL_IMPL_ENGINE_IPP
  ...
  : ssl_(::SSL_new(context))
{
  if (!ssl_)
  {
    ...
    autoboost::asio::detail::throw_error(ec, "engine");
  }
...
autoboost::system::error_code engine::set_verify_mode(
...
autoboost::system::error_code engine::set_verify_depth(
...
autoboost::system::error_code engine::set_verify_callback(
    verify_callback_base* callback, autoboost::system::error_code& ec)
{
  if (SSL_get_app_data(ssl_))
    delete static_cast<verify_callback_base*>(SSL_get_app_data(ssl_));
...
{
  return perform((type == autoboost::asio::ssl::stream_base::client)
      ? &engine::do_connect : &engine::do_accept, 0, 0, ec, 0);
}

engine::want engine::shutdown(autoboost::system::error_code& ec)
{
  return perform(&engine::do_shutdown, 0, 0, ec, 0);
}

engine::want engine::write(const autoboost::asio::const_buffer& data,
    autoboost::system::error_code& ec, std::size_t& bytes_transferred)
{
  if (autoboost::asio::buffer_size(data) == 0)
  {
    ec = autoboost::system::error_code();
  ...
  return perform(&engine::do_write,
      const_cast<void*>(autoboost::asio::buffer_cast<const void*>(data)),
      autoboost::asio::buffer_size(data), ec, &bytes_transferred);
}

engine::want engine::read(const autoboost::asio::mutable_buffer& data,
    autoboost::system::error_code& ec, std::size_t& bytes_transferred)
{
  if (autoboost::asio::buffer_size(data) == 0)
  {
  ...
  return perform(&engine::do_read,
      autoboost::asio::buffer_cast<void*>(data),
      autoboost::asio::buffer_size(data), ec, &bytes_transferred);
}

autoboost::asio::mutable_buffers_1 engine::get_output(
    const autoboost::asio::mutable_buffer& data)
{
  int length = ::BIO_read(ext_bio_,
      autoboost::asio::buffer_cast<void*>(data),
      static_cast<int>(autoboost::asio::buffer_size(data)));

  return autoboost::asio::buffer(data,
      length > 0 ? static_cast<std::size_t>(length) : 0);
}

autoboost::asio::const_buffer engine::put_input(
    const autoboost::asio::const_buffer& data)
{
  int length = ::BIO_write(ext_bio_,
      autoboost::asio::buffer_cast<const void*>(data),
      static_cast<int>(autoboost::asio::buffer_size(data)));
...
const autoboost::system::error_code& engine::map_error_code(
    autoboost::system::error_code& ec) const
{
  ...
  {
    ec = autoboost::asio::ssl::error::stream_truncated;
    return ec;
  }
...
autoboost::asio::detail::static_mutex& engine::accept_mutex()
{
  static autoboost::asio::detail::static_mutex mutex = AUTOBOOST_ASIO_STATIC_MUTEX_INIT;
  return mutex;
}

engine::want engine::perform(int (engine::* op)(void*, std::size_t),
    void* data, std::size_t length, autoboost::system::error_code& ec,
    std::size_t* bytes_transferred)
{
  ...
  {
    ec = autoboost::system::error_code(sys_error,
        autoboost::asio::error::get_ssl_category());
    return want_nothing;
  }
...
{
  autoboost::asio::detail::static_mutex::scoped_lock lock(accept_mutex());
...
#endif // AUTOBOOST_ASIO_SSL_DETAIL_IMPL_ENGINE_IPP
