...
#ifndef AUTOBOOST_ASIO_SSL_OLD_BASIC_CONTEXT_HPP
#define AUTOBOOST_ASIO_SSL_OLD_BASIC_CONTEXT_HPP
...
public:
  ...
  /// Constructor.
  basic_context(autoboost::asio::io_service& io_service, method m)
    : service_(autoboost::asio::use_service<Service>(io_service)),
      impl_(service_.null())
  {
   ...
   */
  autoboost::system::error_code set_options(options o,
      autoboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  autoboost::system::error_code set_verify_mode(verify_mode v,
      autoboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  autoboost::system::error_code load_verify_file(const std::string& filename,
      autoboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  autoboost::system::error_code add_verify_path(const std::string& path,
      autoboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  autoboost::system::error_code use_certificate_file(const std::string& filename,
      file_format format, autoboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  autoboost::system::error_code use_certificate_chain_file(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  autoboost::system::error_code use_private_key_file(const std::string& filename,
      file_format format, autoboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  autoboost::system::error_code use_rsa_private_key_file(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  autoboost::system::error_code use_tmp_dh_file(const std::string& filename,
      autoboost::system::error_code& ec)
  {
...
#endif // AUTOBOOST_ASIO_SSL_OLD_BASIC_CONTEXT_HPP
