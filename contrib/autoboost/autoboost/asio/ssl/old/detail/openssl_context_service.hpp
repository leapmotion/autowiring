...
#ifndef AUTOBOOST_ASIO_SSL_OLD_DETAIL_OPENSSL_CONTEXT_SERVICE_HPP
#define AUTOBOOST_ASIO_SSL_OLD_DETAIL_OPENSSL_CONTEXT_SERVICE_HPP
...
class openssl_context_service
  : public autoboost::asio::detail::service_base<openssl_context_service>
{
public:
  ...
  typedef autoboost::function<std::string(std::size_t,
      context_base::password_purpose)> password_callback_type;

  // Constructor.
  openssl_context_service(autoboost::asio::io_service& io_service)
    : autoboost::asio::detail::service_base<openssl_context_service>(io_service)
  {
  }
  ...
  void create(impl_type& impl, context_base::method m)
  {
    ...
    case context_base::sslv2_server:
      autoboost::asio::detail::throw_error(autoboost::asio::error::invalid_argument);
      break;
  ...
  autoboost::system::error_code set_password_callback(impl_type& impl,
      Password_Callback callback, autoboost::system::error_code& ec)
  {
...
#endif // AUTOBOOST_ASIO_SSL_OLD_DETAIL_OPENSSL_CONTEXT_SERVICE_HPP
