...
#ifndef AUTOBOOST_ASIO_SSL_OLD_DETAIL_OPENSSL_STREAM_SERVICE_HPP
#define AUTOBOOST_ASIO_SSL_OLD_DETAIL_OPENSSL_STREAM_SERVICE_HPP
...
#include <autoboost/asio/ssl/old/detail/openssl_operation.hpp>
...
class openssl_stream_service
  : public autoboost::asio::detail::service_base<openssl_stream_service>
{
private:
  ...
  {
  public:
    typedef autoboost::function<
      void (const autoboost::system::error_code&, size_t)> func_t;

    base_handler(autoboost::asio::io_service& io_service)
      : op_(NULL)
  ...
  private:
    ...
    autoboost::asio::io_service::work work_;
  };  // class base_handler
  ...
  {
  public:
    io_handler(Handler handler, autoboost::asio::io_service& io_service)
  ...
  private:
    Handler handler_;
    void handler_impl(const autoboost::system::error_code& error, size_t size)
    {
  ...
  {
  public:
    handshake_handler(Handler handler, autoboost::asio::io_service& io_service)
      : base_handler<Stream>(io_service)
      , handler_(handler)
    {
      this->set_func(autoboost::bind(
  ...
  private:
    Handler handler_;
    void handler_impl(const autoboost::system::error_code& error, size_t)
    {
...
public:
  ...
  explicit openssl_stream_service(autoboost::asio::io_service& io_service)
    : autoboost::asio::detail::service_base<openssl_stream_service>(io_service),
      strand_(io_service)
  {
  }
  ...
  template <typename Stream>
  autoboost::system::error_code handshake(impl_type& impl, Stream& next_layer,
      stream_base::handshake_type type, autoboost::system::error_code& ec)
  {
    try
    {
    ...
    catch (autoboost::system::system_error& e)
    {
      ec = e.code();
      return ec;
    }
  ...
  template <typename Stream>
  autoboost::system::error_code shutdown(impl_type& impl, Stream& next_layer,
  ...
  std::size_t write_some(impl_type& impl, Stream& next_layer,
      const Const_Buffers& buffers, autoboost::system::error_code& ec)
  {
    size_t bytes_transferred = 0;
    try
    {
      autoboost::asio::const_buffer buffer =
        autoboost::asio::detail::buffer_sequence_adapter<
          autoboost::asio::const_buffer, Const_Buffers>::first(buffers);

      std::size_t buffer_size = autoboost::asio::buffer_size(buffer);
      ...
      const Const_Buffers& buffers, Handler handler)
  {
    ...
    {
      get_io_service().post(autoboost::asio::detail::bind_handler(
            handler, autoboost::system::error_code(), 0));
      return;
    }
  ...
  std::size_t read_some(impl_type& impl, Stream& next_layer,
      const Mutable_Buffers& buffers, autoboost::system::error_code& ec)
  {
    size_t bytes_transferred = 0;
    try
    {
      autoboost::asio::mutable_buffer buffer =
        autoboost::asio::detail::buffer_sequence_adapter<
          autoboost::asio::mutable_buffer, Mutable_Buffers>::first(buffers);
      ...
      autoboost::function<int (SSL*)> recv_func =
        autoboost::bind(autoboost::type<int>(), &::SSL_read, autoboost::arg<1>(),
            autoboost::asio::buffer_cast<void*>(buffer),
            static_cast<int>(buffer_size));
...
#endif // AUTOBOOST_ASIO_SSL_OLD_DETAIL_OPENSSL_STREAM_SERVICE_HPP
