...
#ifndef AUTOBOOST_ASIO_SSL_OLD_STREAM_SERVICE_HPP
#define AUTOBOOST_ASIO_SSL_OLD_STREAM_SERVICE_HPP
...
#include <autoboost/asio/ssl/old/detail/openssl_stream_service.hpp>
...
#else
  : public autoboost::asio::detail::service_base<stream_service>
#endif
{
private:
...
public:
  ...
  explicit stream_service(autoboost::asio::io_service& io_service)
    : autoboost::asio::detail::service_base<stream_service>(io_service),
...
#endif // AUTOBOOST_ASIO_SSL_OLD_STREAM_SERVICE_HPP
