...
#ifndef AUTOBOOST_ASIO_SSL_OLD_STREAM_HPP
#define AUTOBOOST_ASIO_SSL_OLD_STREAM_HPP
...
#include <autoboost/asio/ssl/stream_service.hpp>
 ...
 * autoboost::asio::ssl::context context(io_service, autoboost::asio::ssl::context::sslv23);
 * autoboost::asio::ssl::stream<autoboost::asio::ip::tcp::socket> sock(io_service, context);
 * @endcode
 *
 * @par Concepts:
...
public:
  ...
  explicit stream(Arg& arg, basic_context<Context_Service>& context)
    : next_layer_(arg),
      service_(autoboost::asio::use_service<Service>(next_layer_.get_io_service())),
      impl_(service_.null())
  {
...
#endif // AUTOBOOST_ASIO_SSL_OLD_STREAM_HPP
