...
#ifndef AUTOBOOST_ASIO_SSL_IMPL_CONTEXT_IPP
#define AUTOBOOST_ASIO_SSL_IMPL_CONTEXT_IPP
...
# include <autoboost/asio/ssl/context.hpp>
  ...
  : handle_(0)
{
  ...
  case context::sslv2_server:
    autoboost::asio::detail::throw_error(
        autoboost::asio::error::invalid_argument, "context");
    break;
  ...
  if (handle_ == 0)
  {
    ...
    autoboost::asio::detail::throw_error(ec, "context");
  }

  set_options(no_compression);
}

context::context(autoboost::asio::io_service&, context::method m)
  : handle_(0)
{
  context tmp(m);
  handle_ = tmp.handle_;
...
{
  context tmp(AUTOBOOST_ASIO_MOVE_CAST(context)(*this));
  handle_ = other.handle_;
  other.handle_ = 0;
  return *this;
}
...
void context::clear_options(context::options o)
{
  autoboost::system::error_code ec;
  clear_options(o, ec);
  autoboost::asio::detail::throw_error(ec, "clear_options");
}

autoboost::system::error_code context::clear_options(
    context::options o, autoboost::system::error_code& ec)
{
...
void context::set_options(context::options o)
{
  autoboost::system::error_code ec;
  set_options(o, ec);
  autoboost::asio::detail::throw_error(ec, "set_options");
}

autoboost::system::error_code context::set_options(
    context::options o, autoboost::system::error_code& ec)
{
#if !defined(SSL_OP_NO_COMPRESSION)
  if ((o & context::no_compression) != 0)
  {
    ...
    handle_->comp_methods =
      autoboost::asio::ssl::detail::openssl_init<>::get_null_compression_methods();
#endif // (OPENSSL_VERSION_NUMBER >= 0x00908000L)
    o ^= context::no_compression;
  }
#endif // !defined(SSL_OP_NO_COMPRESSION)
...
void context::set_verify_mode(verify_mode v)
{
  ...
  autoboost::asio::detail::throw_error(ec, "set_verify_mode");
}

autoboost::system::error_code context::set_verify_mode(
...
void context::set_verify_depth(int depth)
{
  ...
  autoboost::asio::detail::throw_error(ec, "set_verify_depth");
}

autoboost::system::error_code context::set_verify_depth(
...
void context::load_verify_file(const std::string& filename)
{
  ...
  autoboost::asio::detail::throw_error(ec, "load_verify_file");
}

autoboost::system::error_code context::load_verify_file(
...
void context::add_certificate_authority(const const_buffer& ca)
{
  ...
  autoboost::asio::detail::throw_error(ec, "add_certificate_authority");
}

autoboost::system::error_code context::add_certificate_authority(
...
void context::set_default_verify_paths()
{
  ...
  autoboost::asio::detail::throw_error(ec, "set_default_verify_paths");
}

autoboost::system::error_code context::set_default_verify_paths(
    autoboost::system::error_code& ec)
{
  ::ERR_clear_error();
...
void context::add_verify_path(const std::string& path)
{
  ...
  autoboost::asio::detail::throw_error(ec, "add_verify_path");
}

autoboost::system::error_code context::add_verify_path(
    ...
    const const_buffer& certificate, file_format format)
{
  ...
  autoboost::asio::detail::throw_error(ec, "use_certificate");
}

autoboost::system::error_code context::use_certificate(
    const const_buffer& certificate, file_format format,
    autoboost::system::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, file_format format)
{
  ...
  autoboost::asio::detail::throw_error(ec, "use_certificate_file");
}

autoboost::system::error_code context::use_certificate_file(
    const std::string& filename, file_format format,
    autoboost::system::error_code& ec)
{
  int file_type;
...
void context::use_certificate_chain(const const_buffer& chain)
{
  ...
  autoboost::asio::detail::throw_error(ec, "use_certificate_chain");
}

autoboost::system::error_code context::use_certificate_chain(
    const const_buffer& chain, autoboost::system::error_code& ec)
{
  ...
  if (bio.p)
  {
    ...
    if (!cert.p)
    {
      ec = autoboost::system::error_code(ERR_R_PEM_LIB,
          autoboost::asio::error::get_ssl_category());
      return ec;
    }
...
void context::use_certificate_chain_file(const std::string& filename)
{
  ...
  autoboost::asio::detail::throw_error(ec, "use_certificate_chain_file");
}

autoboost::system::error_code context::use_certificate_chain_file(
    const std::string& filename, autoboost::system::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  autoboost::asio::detail::throw_error(ec, "use_private_key");
}

autoboost::system::error_code context::use_private_key(
    const const_buffer& private_key, context::file_format format,
    autoboost::system::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, context::file_format format)
{
  ...
  autoboost::asio::detail::throw_error(ec, "use_private_key_file");
}
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  autoboost::asio::detail::throw_error(ec, "use_rsa_private_key");
}

autoboost::system::error_code context::use_rsa_private_key(
    const const_buffer& private_key, context::file_format format,
    autoboost::system::error_code& ec)
{
  ::ERR_clear_error();
...
autoboost::system::error_code context::use_private_key_file(
    const std::string& filename, context::file_format format,
    autoboost::system::error_code& ec)
{
  int file_type;
    ...
    const std::string& filename, context::file_format format)
{
  ...
  autoboost::asio::detail::throw_error(ec, "use_rsa_private_key_file");
}

autoboost::system::error_code context::use_rsa_private_key_file(
    const std::string& filename, context::file_format format,
    autoboost::system::error_code& ec)
{
  int file_type;
...
void context::use_tmp_dh(const const_buffer& dh)
{
  autoboost::system::error_code ec;
  use_tmp_dh(dh, ec);
  autoboost::asio::detail::throw_error(ec, "use_tmp_dh");
}

autoboost::system::error_code context::use_tmp_dh(
...
void context::use_tmp_dh_file(const std::string& filename)
{
  ...
  autoboost::asio::detail::throw_error(ec, "use_tmp_dh_file");
}

autoboost::system::error_code context::use_tmp_dh_file(
    const std::string& filename, autoboost::system::error_code& ec)
{
  ::ERR_clear_error();
...
autoboost::system::error_code context::do_use_tmp_dh(
...
autoboost::system::error_code context::do_set_verify_callback(
...
autoboost::system::error_code context::do_set_password_callback(
...
#endif // AUTOBOOST_ASIO_SSL_IMPL_CONTEXT_IPP
