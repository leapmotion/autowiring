...
#ifndef AUTOBOOST_ASIO_SEQ_PACKET_SOCKET_SERVICE_HPP
#define AUTOBOOST_ASIO_SEQ_PACKET_SOCKET_SERVICE_HPP
...
public:
  ...
  /// io_service.
  explicit seq_packet_socket_service(autoboost::asio::io_service& io_service)
  ...
  {
    if (protocol.type() == AUTOBOOST_ASIO_OS_DEF(SOCK_SEQPACKET))
...
#endif // AUTOBOOST_ASIO_SEQ_PACKET_SOCKET_SERVICE_HPP
