...
#ifndef AUTOBOOST_ASIO_BASIC_STREAMBUF_HPP
#define AUTOBOOST_ASIO_BASIC_STREAMBUF_HPP
 ...
 * autoboost::asio::streambuf::mutable_buffers_type bufs = b.prepare(512);
 *
...
public:
...
#else
  typedef autoboost::asio::const_buffers_1 const_buffers_type;
  typedef autoboost::asio::mutable_buffers_1 mutable_buffers_type;
#endif
  ...
  {
    return autoboost::asio::buffer(autoboost::asio::const_buffer(gptr(),
  ...
  {
    reserve(n);
    return autoboost::asio::buffer(autoboost::asio::mutable_buffer(
...
protected:
  ...
  void reserve(std::size_t n)
  {
    ...
    if (n > pend - pnext)
    {
      ...
      {
        std::length_error ex("autoboost::asio::streambuf too long");
...
#endif // AUTOBOOST_ASIO_BASIC_STREAMBUF_HPP
