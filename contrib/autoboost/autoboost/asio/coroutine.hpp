...
#ifndef AUTOBOOST_ASIO_COROUTINE_HPP
#define AUTOBOOST_ASIO_COROUTINE_HPP
 ...
 *
 * @code #include <autoboost/asio/yield.hpp>@endcode
 *
 * and may conversely be undefined as follows:
 *
 * @code #include <autoboost/asio/unyield.hpp>@endcode
 *
 * <b>reenter</b>
 *
 ...
 *
 * @li @c AUTOBOOST_ASIO_CORO_REENTER instead of @c reenter
 * @li @c AUTOBOOST_ASIO_CORO_YIELD instead of @c yield
 * @li @c AUTOBOOST_ASIO_CORO_FORK instead of @c fork
 */
class coroutine
{
public:
...
#define AUTOBOOST_ASIO_CORO_REENTER(c) \
  switch (::autoboost::asio::detail::coroutine_ref _coro_value = c) \
...
#define AUTOBOOST_ASIO_CORO_YIELD_IMPL(n) \
  for (_coro_value = (n);;) \
    if (_coro_value == 0) \
    { \
      case (n): ; \
...
#define AUTOBOOST_ASIO_CORO_FORK_IMPL(n) \
...
#if defined(_MSC_VER)
# define AUTOBOOST_ASIO_CORO_YIELD AUTOBOOST_ASIO_CORO_YIELD_IMPL(__COUNTER__ + 1)
# define AUTOBOOST_ASIO_CORO_FORK AUTOBOOST_ASIO_CORO_FORK_IMPL(__COUNTER__ + 1)
#else // defined(_MSC_VER)
# define AUTOBOOST_ASIO_CORO_YIELD AUTOBOOST_ASIO_CORO_YIELD_IMPL(__LINE__)
# define AUTOBOOST_ASIO_CORO_FORK AUTOBOOST_ASIO_CORO_FORK_IMPL(__LINE__)
#endif // defined(_MSC_VER)

#endif // AUTOBOOST_ASIO_COROUTINE_HPP
