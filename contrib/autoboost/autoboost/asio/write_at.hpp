...
#ifndef AUTOBOOST_ASIO_WRITE_AT_HPP
#define AUTOBOOST_ASIO_WRITE_AT_HPP
...
/**
 * @defgroup write_at autoboost::asio::write_at
 *
 ...
 * @code autoboost::asio::write_at(d, 42, autoboost::asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, autoboost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code autoboost::asio::write_at(
 *     d, offset, buffers,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code autoboost::asio::write_at(d, 42,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code autoboost::asio::write_at(d, 42, autoboost::asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write_at autoboost::asio::async_write_at
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * autoboost::asio::async_write_at(d, 42, autoboost::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, autoboost::array or
 * std::vector.
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code autoboost::asio::async_write_at(d, 42,
...
AUTOBOOST_ASIO_INITFN_RESULT_TYPE(WriteHandler,
    void (autoboost::system::error_code, std::size_t))
async_write_at(AsyncRandomAccessWriteDevice& d, uint64_t offset,
    basic_streambuf<Allocator>& b, AUTOBOOST_ASIO_MOVE_ARG(WriteHandler) handler);
...
#include <autoboost/asio/impl/write_at.hpp>

#endif // AUTOBOOST_ASIO_WRITE_AT_HPP
