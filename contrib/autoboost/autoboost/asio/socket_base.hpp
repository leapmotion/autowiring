...
#ifndef AUTOBOOST_ASIO_SOCKET_BASE_HPP
#define AUTOBOOST_ASIO_SOCKET_BASE_HPP
...
#include <autoboost/asio/detail/io_control.hpp>
...
public:
...
#else
    shutdown_receive = AUTOBOOST_ASIO_OS_DEF(SHUT_RD),
    shutdown_send = AUTOBOOST_ASIO_OS_DEF(SHUT_WR),
    shutdown_both = AUTOBOOST_ASIO_OS_DEF(SHUT_RDWR)
#endif
  };
...
#else
  AUTOBOOST_ASIO_STATIC_CONSTANT(int,
      message_peek = AUTOBOOST_ASIO_OS_DEF(MSG_PEEK));
  AUTOBOOST_ASIO_STATIC_CONSTANT(int,
      message_out_of_band = AUTOBOOST_ASIO_OS_DEF(MSG_OOB));
  AUTOBOOST_ASIO_STATIC_CONSTANT(int,
      message_do_not_route = AUTOBOOST_ASIO_OS_DEF(MSG_DONTROUTE));
  AUTOBOOST_ASIO_STATIC_CONSTANT(int,
      message_end_of_record = AUTOBOOST_ASIO_OS_DEF(MSG_EOR));
#endif
  ...
  typedef autoboost::asio::detail::socket_option::boolean<
    AUTOBOOST_ASIO_OS_DEF(SOL_SOCKET), AUTOBOOST_ASIO_OS_DEF(SO_BROADCAST)>
      broadcast;
#endif
...
#else
  typedef autoboost::asio::detail::socket_option::boolean<
    AUTOBOOST_ASIO_OS_DEF(SOL_SOCKET), AUTOBOOST_ASIO_OS_DEF(SO_DEBUG)> debug;
#endif
...
#else
  typedef autoboost::asio::detail::socket_option::boolean<
    AUTOBOOST_ASIO_OS_DEF(SOL_SOCKET), AUTOBOOST_ASIO_OS_DEF(SO_DONTROUTE)>
      do_not_route;
#endif
...
#else
  typedef autoboost::asio::detail::socket_option::boolean<
    AUTOBOOST_ASIO_OS_DEF(SOL_SOCKET), AUTOBOOST_ASIO_OS_DEF(SO_KEEPALIVE)> keep_alive;
#endif
...
#else
  typedef autoboost::asio::detail::socket_option::integer<
    AUTOBOOST_ASIO_OS_DEF(SOL_SOCKET), AUTOBOOST_ASIO_OS_DEF(SO_SNDBUF)>
      send_buffer_size;
#endif
...
#else
  typedef autoboost::asio::detail::socket_option::integer<
    AUTOBOOST_ASIO_OS_DEF(SOL_SOCKET), AUTOBOOST_ASIO_OS_DEF(SO_SNDLOWAT)>
      send_low_watermark;
#endif
...
#else
  typedef autoboost::asio::detail::socket_option::integer<
    AUTOBOOST_ASIO_OS_DEF(SOL_SOCKET), AUTOBOOST_ASIO_OS_DEF(SO_RCVBUF)>
      receive_buffer_size;
#endif
...
#else
  typedef autoboost::asio::detail::socket_option::integer<
    AUTOBOOST_ASIO_OS_DEF(SOL_SOCKET), AUTOBOOST_ASIO_OS_DEF(SO_RCVLOWAT)>
...
#else
  typedef autoboost::asio::detail::socket_option::boolean<
    AUTOBOOST_ASIO_OS_DEF(SOL_SOCKET), AUTOBOOST_ASIO_OS_DEF(SO_REUSEADDR)>
      reuse_address;
#endif
...
#else
  typedef autoboost::asio::detail::socket_option::linger<
    AUTOBOOST_ASIO_OS_DEF(SOL_SOCKET), AUTOBOOST_ASIO_OS_DEF(SO_LINGER)>
      linger;
#endif
   ...
   * operation is permitted to fail with autoboost::asio::error::connection_aborted.
  ...
  typedef autoboost::asio::detail::socket_option::boolean<
    ...
    autoboost::asio::detail::enable_connection_aborted_option>
...
#else
  typedef autoboost::asio::detail::io_control::non_blocking_io non_blocking_io;
#endif
...
#else
  typedef autoboost::asio::detail::io_control::bytes_readable bytes_readable;
#endif
...
#else
  AUTOBOOST_ASIO_STATIC_CONSTANT(int, max_connections
      = AUTOBOOST_ASIO_OS_DEF(SOMAXCONN));
#endif
...
#endif // AUTOBOOST_ASIO_SOCKET_BASE_HPP
