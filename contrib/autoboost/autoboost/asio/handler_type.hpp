...
#ifndef AUTOBOOST_ASIO_HANDLER_TYPE_HPP
#define AUTOBOOST_ASIO_HANDLER_TYPE_HPP
...
#define AUTOBOOST_ASIO_HANDLER_TYPE(h, sig) \
  typename handler_type<h, sig>::type

#endif // AUTOBOOST_ASIO_HANDLER_TYPE_HPP
