...
#ifndef AUTOBOOST_ASIO_DETAIL_WRAPPED_HANDLER_HPP
#define AUTOBOOST_ASIO_DETAIL_WRAPPED_HANDLER_HPP
...
struct is_continuation_delegated
{
  ...
  {
    return autoboost_asio_handler_cont_helpers::is_continuation(handler);
  }
};
...
public:
  ...
  void operator()()
  {
    dispatcher_.dispatch(AUTOBOOST_ASIO_MOVE_CAST(Handler)(handler_));
  }
...
public:
  ...
  rewrapped_handler(rewrapped_handler&& other)
    : context_(AUTOBOOST_ASIO_MOVE_CAST(Context)(other.context_)),
      handler_(AUTOBOOST_ASIO_MOVE_CAST(Handler)(other.handler_))
  {
  }
#endif // defined(AUTOBOOST_ASIO_HAS_MOVE)
...
#endif // AUTOBOOST_ASIO_DETAIL_WRAPPED_HANDLER_HPP
