...
#ifndef AUTOBOOST_ASIO_DETAIL_WIN_OBJECT_HANDLE_SERVICE_HPP
#define AUTOBOOST_ASIO_DETAIL_WIN_OBJECT_HANDLE_SERVICE_HPP
...
public:
  ...
  // Constructor.
  AUTOBOOST_ASIO_DECL win_object_handle_service(
  ...
  AUTOBOOST_ASIO_DECL void wait(implementation_type& impl,
      autoboost::system::error_code& ec);
  ...
  void async_wait(implementation_type& impl, Handler& handler)
  {
    ...
    AUTOBOOST_ASIO_HANDLER_CREATION((p.p, "object_handle", &impl, "async_wait"));
...
private:
  ...
  AUTOBOOST_ASIO_DECL void start_wait_op(implementation_type& impl, wait_op* op);

  // Helper function to register a wait operation.
  AUTOBOOST_ASIO_DECL void register_wait_callback(
      implementation_type& impl, mutex::scoped_lock& lock);

  // Callback function invoked when the registered wait completes.
  static AUTOBOOST_ASIO_DECL VOID CALLBACK wait_callback(
...
#endif // AUTOBOOST_ASIO_DETAIL_WIN_OBJECT_HANDLE_SERVICE_HPP
