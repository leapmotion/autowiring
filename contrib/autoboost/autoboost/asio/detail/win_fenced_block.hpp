...
#ifndef AUTOBOOST_ASIO_DETAIL_WIN_FENCED_BLOCK_HPP
#define AUTOBOOST_ASIO_DETAIL_WIN_FENCED_BLOCK_HPP
...
public:
  ...
  && ((AUTOBOOST_ASIO_MSVC < 1400) || !defined(MemoryBarrier))
# if defined(_M_IX86)
#  pragma warning(push)
...
#endif // AUTOBOOST_ASIO_DETAIL_WIN_FENCED_BLOCK_HPP
