...
#ifndef AUTOBOOST_ASIO_DETAIL_IMPL_SELECT_REACTOR_IPP
#define AUTOBOOST_ASIO_DETAIL_IMPL_SELECT_REACTOR_IPP
...
select_reactor::select_reactor(autoboost::asio::io_service& io_service)
  : autoboost::asio::detail::service_base<select_reactor>(io_service),
...
{
#if defined(AUTOBOOST_ASIO_HAS_IOCP)
  autoboost::asio::detail::signal_blocker sb;
  thread_ = new autoboost::asio::detail::thread(
...
void select_reactor::fork_service(autoboost::asio::io_service::fork_event fork_ev)
{
...
#endif // AUTOBOOST_ASIO_DETAIL_IMPL_SELECT_REACTOR_IPP
