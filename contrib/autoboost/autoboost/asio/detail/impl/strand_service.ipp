...
#ifndef AUTOBOOST_ASIO_DETAIL_IMPL_STRAND_SERVICE_IPP
#define AUTOBOOST_ASIO_DETAIL_IMPL_STRAND_SERVICE_IPP
...
strand_service::strand_service(autoboost::asio::io_service& io_service)
  : autoboost::asio::detail::service_base<strand_service>(io_service),
...
#if defined(AUTOBOOST_ASIO_ENABLE_SEQUENTIAL_STRAND_ALLOCATION)
  std::size_t index = salt;
#else // defined(AUTOBOOST_ASIO_ENABLE_SEQUENTIAL_STRAND_ALLOCATION)
  std::size_t index = reinterpret_cast<std::size_t>(&impl);
  index += (reinterpret_cast<std::size_t>(&impl) >> 3);
  index ^= salt + 0x9e3779b9 + (index << 6) + (index >> 2);
#endif // defined(AUTOBOOST_ASIO_ENABLE_SEQUENTIAL_STRAND_ALLOCATION)
...
#endif // AUTOBOOST_ASIO_DETAIL_IMPL_STRAND_SERVICE_IPP
