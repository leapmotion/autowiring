...
#ifndef AUTOBOOST_ASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
#define AUTOBOOST_ASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
    ...
    Handler& handler)
{
  ...
  AUTOBOOST_ASIO_HANDLER_CREATION((p.p, "strand", impl, "dispatch"));
  ...
  if (dispatch_immediately)
  {
    ...
    completion_handler<Handler>::do_complete(
        &io_service_, o, autoboost::system::error_code(), 0);
  }
}
    ...
    Handler& handler)
{
  ...
  AUTOBOOST_ASIO_HANDLER_CREATION((p.p, "strand", impl, "post"));
...
#endif // AUTOBOOST_ASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
