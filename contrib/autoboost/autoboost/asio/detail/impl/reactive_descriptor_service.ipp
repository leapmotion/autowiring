...
#ifndef AUTOBOOST_ASIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
#define AUTOBOOST_ASIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
    ...
    reactive_descriptor_service::implementation_type& impl)
{
  if (is_open(impl))
  {
    AUTOBOOST_ASIO_HANDLER_OPERATION(("descriptor", &impl, "close"));
...
autoboost::system::error_code reactive_descriptor_service::assign(
    reactive_descriptor_service::implementation_type& impl,
    const native_handle_type& native_descriptor, autoboost::system::error_code& ec)
{
  if (is_open(impl))
  {
...
autoboost::system::error_code reactive_descriptor_service::close(
    reactive_descriptor_service::implementation_type& impl,
    ...
    reactive_descriptor_service::implementation_type& impl)
{
  ...
  if (is_open(impl))
  {
    AUTOBOOST_ASIO_HANDLER_OPERATION(("descriptor", &impl, "release"));
...
autoboost::system::error_code reactive_descriptor_service::cancel(
    reactive_descriptor_service::implementation_type& impl,
    autoboost::system::error_code& ec)
{
  if (!is_open(impl))
  ...
  AUTOBOOST_ASIO_HANDLER_OPERATION(("descriptor", &impl, "cancel"));
...
#endif // AUTOBOOST_ASIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
