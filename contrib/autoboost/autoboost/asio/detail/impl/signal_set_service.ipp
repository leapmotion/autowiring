...
#ifndef AUTOBOOST_ASIO_DETAIL_IMPL_SIGNAL_SET_SERVICE_IPP
#define AUTOBOOST_ASIO_DETAIL_IMPL_SIGNAL_SET_SERVICE_IPP
...
#include <autoboost/asio/detail/signal_blocker.hpp>
#include <autoboost/asio/detail/signal_set_service.hpp>
...
signal_state* get_signal_state()
{
  static signal_state state = {
    AUTOBOOST_ASIO_STATIC_MUTEX_INIT, -1, -1, false, 0, { 0 } };
  return &state;
}
...
signal_set_service::signal_set_service(
  ...
  : io_service_(autoboost::asio::use_service<io_service_impl>(io_service)),
#if !defined(AUTOBOOST_ASIO_WINDOWS) \
  && !defined(AUTOBOOST_ASIO_WINDOWS_RUNTIME) \
  && !defined(__CYGWIN__)
    reactor_(autoboost::asio::use_service<reactor>(io_service)),
#endif // !defined(AUTOBOOST_ASIO_WINDOWS)
       //   && !defined(AUTOBOOST_ASIO_WINDOWS_RUNTIME)
       //   && !defined(__CYGWIN__)
    next_(0),
    ...
    autoboost::asio::io_service::fork_event fork_ev)
{
  ...
  switch (fork_ev)
  {
  case autoboost::asio::io_service::fork_prepare:
    {
    ...
    break;
  case autoboost::asio::io_service::fork_parent:
    ...
    break;
  case autoboost::asio::io_service::fork_child:
    if (state->fork_prepared_)
    {
      autoboost::asio::detail::signal_blocker blocker;
      close_descriptors();
      open_descriptors();
      int read_descriptor = state->read_descriptor_;
      state->fork_prepared_ = false;
...
autoboost::system::error_code signal_set_service::add(
    signal_set_service::implementation_type& impl,
    int signal_number, autoboost::system::error_code& ec)
{
...
autoboost::system::error_code signal_set_service::remove(
    signal_set_service::implementation_type& impl,
    int signal_number, autoboost::system::error_code& ec)
{
  // Check that the signal number is valid.
...
autoboost::system::error_code signal_set_service::clear(
    signal_set_service::implementation_type& impl,
...
autoboost::system::error_code signal_set_service::cancel(
    signal_set_service::implementation_type& impl,
    autoboost::system::error_code& ec)
{
  AUTOBOOST_ASIO_HANDLER_OPERATION(("signal_set", &impl, "cancel"));
...
void signal_set_service::open_descriptors()
{
  ...
  else
  {
    autoboost::system::error_code ec(errno,
        autoboost::asio::error::get_system_category());
    autoboost::asio::detail::throw_error(ec, "signal_set_service pipe");
  }
#endif // !defined(AUTOBOOST_ASIO_WINDOWS)
       //   && !defined(AUTOBOOST_ASIO_WINDOWS_RUNTIME)
       //   && !defined(__CYGWIN__)
...
#endif // AUTOBOOST_ASIO_DETAIL_IMPL_SIGNAL_SET_SERVICE_IPP
