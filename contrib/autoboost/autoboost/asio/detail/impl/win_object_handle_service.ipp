...
#ifndef AUTOBOOST_ASIO_DETAIL_IMPL_WIN_OBJECT_HANDLE_SERVICE_IPP
#define AUTOBOOST_ASIO_DETAIL_IMPL_WIN_OBJECT_HANDLE_SERVICE_IPP
    ...
    win_object_handle_service::implementation_type& impl)
{
  ...
  if (is_open(impl))
  {
    AUTOBOOST_ASIO_HANDLER_OPERATION(("object_handle", &impl, "close"));
...
autoboost::system::error_code win_object_handle_service::assign(
    win_object_handle_service::implementation_type& impl,
...
autoboost::system::error_code win_object_handle_service::close(
    win_object_handle_service::implementation_type& impl,
...
autoboost::system::error_code win_object_handle_service::cancel(
    win_object_handle_service::implementation_type& impl,
    autoboost::system::error_code& ec)
{
  if (is_open(impl))
  {
    AUTOBOOST_ASIO_HANDLER_OPERATION(("object_handle", &impl, "cancel"));
...
#endif // AUTOBOOST_ASIO_DETAIL_IMPL_WIN_OBJECT_HANDLE_SERVICE_IPP
