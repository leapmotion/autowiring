...
#ifndef AUTOBOOST_ASIO_DETAIL_IMPL_DEV_POLL_REACTOR_IPP
#define AUTOBOOST_ASIO_DETAIL_IMPL_DEV_POLL_REACTOR_IPP
...
dev_poll_reactor::dev_poll_reactor(autoboost::asio::io_service& io_service)
  : autoboost::asio::detail::service_base<dev_poll_reactor>(io_service),
...
void dev_poll_reactor::fork_service(autoboost::asio::io_service::fork_event fork_ev)
{
...
{
  autoboost::asio::detail::mutex::scoped_lock lock(mutex_);
  cancel_ops_unlocked(descriptor, autoboost::asio::error::operation_aborted);
}
...
void dev_poll_reactor::run(bool block, op_queue<operation>& ops)
{
  ...
  if (events_size > 0)
  {
    ...
    {
      autoboost::system::error_code ec = autoboost::system::error_code(
...
int dev_poll_reactor::do_dev_poll_create()
{
  ...
  if (fd == -1)
  {
    autoboost::system::error_code ec(errno,
        autoboost::asio::error::get_system_category());
    autoboost::asio::detail::throw_error(ec, "/dev/poll");
  }
  return fd;
}
...
#endif // AUTOBOOST_ASIO_DETAIL_IMPL_DEV_POLL_REACTOR_IPP
