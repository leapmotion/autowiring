...
#ifndef AUTOBOOST_ASIO_DETAIL_IMPL_WIN_THREAD_IPP
#define AUTOBOOST_ASIO_DETAIL_IMPL_WIN_THREAD_IPP
...
void win_thread::start_thread(func_base* arg, unsigned int stack_size)
{
  ...
  if (!exit_event_)
  {
    ...
    autoboost::system::error_code ec(last_error,
        autoboost::asio::error::get_system_category());
    autoboost::asio::detail::throw_error(ec, "thread.exit_event");
  }
