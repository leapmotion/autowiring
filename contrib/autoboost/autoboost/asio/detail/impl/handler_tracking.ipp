...
#ifndef AUTOBOOST_ASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
#define AUTOBOOST_ASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
...
# endif
# include <autoboost/asio/detail/chrono_time_traits.hpp>
...
struct handler_tracking_timestamp
{
  ...
  {
#if defined(AUTOBOOST_ASIO_HAS_AUTOBOOST_DATE_TIME)
    autoboost::posix_time::ptime epoch(autoboost::gregorian::date(1970, 1, 1));
    autoboost::posix_time::time_duration now =
      autoboost::posix_time::microsec_clock::universal_time() - epoch;
#elif defined(AUTOBOOST_ASIO_HAS_STD_CHRONO)
    typedef chrono_time_traits<std::chrono::system_clock,
        autoboost::asio::wait_traits<std::chrono::system_clock> > traits_helper;
    traits_helper::posix_time_duration now(
        std::chrono::system_clock::now().time_since_epoch());
#elif defined(AUTOBOOST_ASIO_HAS_AUTOBOOST_CHRONO)
    typedef chrono_time_traits<autoboost::chrono::system_clock,
        autoboost::asio::wait_traits<autoboost::chrono::system_clock> > traits_helper;
    traits_helper::posix_time_duration now(
        autoboost::chrono::system_clock::now().time_since_epoch());
#endif
...
{
  static tracking_state state = { AUTOBOOST_ASIO_STATIC_MUTEX_INIT, 1, 0 };
  return &state;
}
...
#endif // AUTOBOOST_ASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
