...
#ifndef AUTOBOOST_ASIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
#define AUTOBOOST_ASIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
...
#include <vector>
#include <autoboost/asio/detail/service_registry.hpp>
...
service_registry::~service_registry()
{
  ...
  autoboost::asio::io_service::service* service = first_service_;
  while (service)
  {
  ...
  {
    autoboost::asio::io_service::service* next_service = first_service_->next_;
    destroy(first_service_);
    first_service_ = next_service;
  }
}

void service_registry::notify_fork(autoboost::asio::io_service::fork_event fork_ev)
{
  // Make a copy of all of the services while holding the lock. We don't want
  // to hold the lock while calling into each service, as it may try to call
  // back into this class.
  std::vector<autoboost::asio::io_service::service*> services;
  {
  ...
  if (fork_ev == autoboost::asio::io_service::fork_prepare)
...
void service_registry::destroy(autoboost::asio::io_service::service* service)
{
  delete service;
}

autoboost::asio::io_service::service* service_registry::do_use_service(
    ...
    autoboost::asio::io_service::service* new_service)
{
  if (&owner_ != &new_service->get_io_service())
    autoboost::asio::detail::throw_exception(invalid_service_owner());
  ...
  {
    if (keys_match(service->key_, key))
      autoboost::asio::detail::throw_exception(service_already_exists());
    service = service->next_;
  }
...
#endif // AUTOBOOST_ASIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
