...
#ifndef AUTOBOOST_ASIO_DETAIL_IMPL_TASK_IO_SERVICE_IPP
#define AUTOBOOST_ASIO_DETAIL_IMPL_TASK_IO_SERVICE_IPP
...
struct task_io_service::task_cleanup
{
  ~task_cleanup()
  {
    ...
    {
      autoboost::asio::detail::increment(
...
task_io_service::task_io_service(
    autoboost::asio::io_service& io_service, std::size_t concurrency_hint)
  : autoboost::asio::detail::service_base<task_io_service>(io_service),
...
std::size_t task_io_service::run(autoboost::system::error_code& ec)
{
...
std::size_t task_io_service::run_one(autoboost::system::error_code& ec)
{
  ec = autoboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll(autoboost::system::error_code& ec)
{
  ec = autoboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll_one(autoboost::system::error_code& ec)
{
  ec = autoboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
#else // defined(AUTOBOOST_ASIO_HAS_THREADS)
...
#endif // AUTOBOOST_ASIO_DETAIL_IMPL_TASK_IO_SERVICE_IPP
