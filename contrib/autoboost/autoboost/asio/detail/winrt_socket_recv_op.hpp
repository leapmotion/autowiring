...
#ifndef AUTOBOOST_ASIO_DETAIL_WINRT_SOCKET_RECV_OP_HPP
#define AUTOBOOST_ASIO_DETAIL_WINRT_SOCKET_RECV_OP_HPP
...
{
public:
  AUTOBOOST_ASIO_DEFINE_HANDLER_PTR(winrt_socket_recv_op);
      ...
      const autoboost::system::error_code&, std::size_t)
  {
    ...
    {
      o->ec_ = autoboost::asio::error::eof;
    }
...
#endif // AUTOBOOST_ASIO_DETAIL_WINRT_SOCKET_RECV_OP_HPP
