...
#ifndef AUTOBOOST_ASIO_DETAIL_RESOLVE_OP_HPP
#define AUTOBOOST_ASIO_DETAIL_RESOLVE_OP_HPP
...
{
public:
  AUTOBOOST_ASIO_DEFINE_HANDLER_PTR(resolve_op);
...
private:
  ...
  autoboost::asio::detail::addrinfo_type* addrinfo_;
};
...
#endif // AUTOBOOST_ASIO_DETAIL_RESOLVE_OP_HPP
