...
#ifndef AUTOBOOST_ASIO_DETAIL_DESCRIPTOR_READ_OP_HPP
#define AUTOBOOST_ASIO_DETAIL_DESCRIPTOR_READ_OP_HPP
...
{
public:
  AUTOBOOST_ASIO_DEFINE_HANDLER_PTR(descriptor_read_op);
...
#endif // AUTOBOOST_ASIO_DETAIL_DESCRIPTOR_READ_OP_HPP
