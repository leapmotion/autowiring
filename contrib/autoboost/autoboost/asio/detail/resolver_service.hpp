...
#ifndef AUTOBOOST_ASIO_DETAIL_RESOLVER_SERVICE_HPP
#define AUTOBOOST_ASIO_DETAIL_RESOLVER_SERVICE_HPP
...
#include <autoboost/asio/detail/resolve_endpoint_op.hpp>
#include <autoboost/asio/detail/resolve_op.hpp>
...
public:
  ...
  // Constructor.
  resolver_service(autoboost::asio::io_service& io_service)
  ...
  {
    autoboost::asio::detail::addrinfo_type* address_info = 0;
...
#endif // AUTOBOOST_ASIO_DETAIL_RESOLVER_SERVICE_HPP
