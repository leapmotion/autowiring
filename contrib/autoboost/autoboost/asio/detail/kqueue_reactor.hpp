...
#ifndef AUTOBOOST_ASIO_DETAIL_KQUEUE_REACTOR_HPP
#define AUTOBOOST_ASIO_DETAIL_KQUEUE_REACTOR_HPP
...
class kqueue_reactor
  : public autoboost::asio::detail::service_base<kqueue_reactor>
{
public:
  ...
  // Constructor.
  AUTOBOOST_ASIO_DECL kqueue_reactor(autoboost::asio::io_service& io_service);

  // Destructor.
  AUTOBOOST_ASIO_DECL ~kqueue_reactor();
...
private:
  ...
  // cannot be created.
  AUTOBOOST_ASIO_DECL static int do_kqueue_create();
  ...
  AUTOBOOST_ASIO_DECL timespec* get_timeout(timespec& ts);
...
#include <autoboost/asio/detail/impl/kqueue_reactor.hpp>
...
#endif // AUTOBOOST_ASIO_DETAIL_KQUEUE_REACTOR_HPP
