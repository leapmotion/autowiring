...
#ifndef AUTOBOOST_ASIO_DETAIL_SIGNAL_HANDLER_HPP
#define AUTOBOOST_ASIO_DETAIL_SIGNAL_HANDLER_HPP
...
{
public:
  AUTOBOOST_ASIO_DEFINE_HANDLER_PTR(signal_handler);
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::binder2<Handler, autoboost::system::error_code, int>
...
#endif // AUTOBOOST_ASIO_DETAIL_SIGNAL_HANDLER_HPP
