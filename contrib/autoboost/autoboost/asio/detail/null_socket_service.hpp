...
#ifndef AUTOBOOST_ASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
#define AUTOBOOST_ASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
...
public:
  ...
  // Constructor.
  null_socket_service(autoboost::asio::io_service& io_service)
  ...
  autoboost::system::error_code open(implementation_type&,
      const protocol_type&, autoboost::system::error_code& ec)
  {
  ...
  autoboost::system::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, autoboost::system::error_code& ec)
  {
    ec = autoboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  autoboost::system::error_code close(implementation_type&,
  ...
  autoboost::system::error_code cancel(implementation_type&,
      autoboost::system::error_code& ec)
  {
    ec = autoboost::asio::error::operation_not_supported;
    return ec;
  ...
  autoboost::system::error_code listen(implementation_type&,
      int, autoboost::system::error_code& ec)
  {
    ec = autoboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  autoboost::system::error_code io_control(implementation_type&,
  ...
  autoboost::system::error_code non_blocking(implementation_type&,
  ...
  autoboost::system::error_code native_non_blocking(implementation_type&,
      bool, autoboost::system::error_code& ec)
  {
    ec = autoboost::asio::error::operation_not_supported;
    return ec;
  ...
  autoboost::system::error_code shutdown(implementation_type&,
  ...
  autoboost::system::error_code set_option(implementation_type&,
      const Option&, autoboost::system::error_code& ec)
  {
    ec = autoboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  autoboost::system::error_code get_option(const implementation_type&,
      Option&, autoboost::system::error_code& ec) const
  {
    ec = autoboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  autoboost::system::error_code accept(implementation_type&,
      Socket&, endpoint_type*, autoboost::system::error_code& ec)
  {
    ec = autoboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  autoboost::system::error_code connect(implementation_type&,
      const endpoint_type&, autoboost::system::error_code& ec)
  {
    ec = autoboost::asio::error::operation_not_supported;
    return ec;
...
#endif // AUTOBOOST_ASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
