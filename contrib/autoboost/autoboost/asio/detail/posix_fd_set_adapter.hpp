...
#ifndef AUTOBOOST_ASIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
#define AUTOBOOST_ASIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
...
public:
  ...
  void set(reactor_op_queue<socket_type>& operations, op_queue<operation>& ops)
  {
    ...
    while (i != operations.end())
    {
      ...
      {
        autoboost::system::error_code ec(error::fd_set_failure);
...
#endif // AUTOBOOST_ASIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
