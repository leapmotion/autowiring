...
#ifndef AUTOBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_HPP
#define AUTOBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_HPP
...
#include <autoboost/asio/detail/win_iocp_socket_accept_op.hpp>
#include <autoboost/asio/detail/win_iocp_socket_connect_op.hpp>
#include <autoboost/asio/detail/win_iocp_socket_recvfrom_op.hpp>
...
public:
  ...
  // Constructor.
  win_iocp_socket_service(autoboost::asio::io_service& io_service)
      ...
      socket_base::message_flags flags, Handler& handler)
  {
    ...
    AUTOBOOST_ASIO_HANDLER_CREATION((p.p, "socket", &impl, "async_send_to"));
      ...
      socket_base::message_flags flags, Handler& handler)
  {
    ...
    AUTOBOOST_ASIO_HANDLER_CREATION((p.p, "socket", &impl, "async_receive_from"));
  ...
  autoboost::system::error_code accept(implementation_type& impl, Socket& peer,
      ...
      endpoint_type* peer_endpoint, Handler& handler)
  {
    ...
    AUTOBOOST_ASIO_HANDLER_CREATION((p.p, "socket", &impl, "async_accept"));
...
#endif // AUTOBOOST_ASIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_HPP
