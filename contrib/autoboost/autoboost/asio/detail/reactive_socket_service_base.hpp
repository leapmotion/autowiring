...
#ifndef AUTOBOOST_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_BASE_HPP
#define AUTOBOOST_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_BASE_HPP
...
#include <autoboost/asio/detail/reactive_socket_recv_op.hpp>
#include <autoboost/asio/detail/reactive_socket_recvmsg_op.hpp>
#include <autoboost/asio/detail/reactive_socket_send_op.hpp>
...
public:
  ...
  // Constructor.
  AUTOBOOST_ASIO_DECL reactive_socket_service_base(
...
protected:
  ...
  AUTOBOOST_ASIO_DECL autoboost::system::error_code do_open(
      ...
      int type, int protocol, autoboost::system::error_code& ec);
  ...
  AUTOBOOST_ASIO_DECL void start_op(base_implementation_type& impl, int op_type,
...
#endif // AUTOBOOST_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_BASE_HPP
