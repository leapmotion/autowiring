...
#ifndef AUTOBOOST_ASIO_DETAIL_TIMER_QUEUE_HPP
#define AUTOBOOST_ASIO_DETAIL_TIMER_QUEUE_HPP
...
#include <autoboost/asio/detail/date_time_fwd.hpp>
...
private:
  ...
  static bool is_positive_infinity(
      const autoboost::date_time::base_time<T, TimeSystem>& time)
  {
...
#endif // AUTOBOOST_ASIO_DETAIL_TIMER_QUEUE_HPP
