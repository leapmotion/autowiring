...
#ifndef AUTOBOOST_ASIO_DETAIL_SOCKET_OPTION_HPP
#define AUTOBOOST_ASIO_DETAIL_SOCKET_OPTION_HPP
...
public:
  ...
  {
    enabled(e);
    timeout AUTOBOOST_ASIO_PREVENT_MACRO_SUBSTITUTION(t);
  }
  ...
  void timeout AUTOBOOST_ASIO_PREVENT_MACRO_SUBSTITUTION(int value)
  {
#if defined(WIN32)
  ...
  int timeout AUTOBOOST_ASIO_PREVENT_MACRO_SUBSTITUTION() const
  {
...
#endif // AUTOBOOST_ASIO_DETAIL_SOCKET_OPTION_HPP
