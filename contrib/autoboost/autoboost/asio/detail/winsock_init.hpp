...
#ifndef AUTOBOOST_ASIO_DETAIL_WINSOCK_INIT_HPP
#define AUTOBOOST_ASIO_DETAIL_WINSOCK_INIT_HPP
...
protected:
  ...
  AUTOBOOST_ASIO_DECL static void startup(data& d,
      unsigned char major, unsigned char minor);

  AUTOBOOST_ASIO_DECL static void manual_startup(data& d);

  AUTOBOOST_ASIO_DECL static void cleanup(data& d);

  AUTOBOOST_ASIO_DECL static void manual_cleanup(data& d);

  AUTOBOOST_ASIO_DECL static void throw_on_error(data& d);
};
...
public:
  ...
  //   #pragma init_seg(lib)
  //   autoboost::asio::detail::winsock_init<>::manual manual_winsock_init;
  //   #pragma warning(pop)
  class manual
  {
  public:
...
#endif // AUTOBOOST_ASIO_DETAIL_WINSOCK_INIT_HPP
