...
#ifndef AUTOBOOST_ASIO_DETAIL_CONSUMING_BUFFERS_HPP
#define AUTOBOOST_ASIO_DETAIL_CONSUMING_BUFFERS_HPP
...
class consuming_buffers<Buffer, autoboost::asio::null_buffers>
  : public autoboost::asio::null_buffers
{
public:
  consuming_buffers(const autoboost::asio::null_buffers&)
  {
    // No-op.
  }
...
#endif // AUTOBOOST_ASIO_DETAIL_CONSUMING_BUFFERS_HPP
