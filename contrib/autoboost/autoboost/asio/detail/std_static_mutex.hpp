...
#ifndef AUTOBOOST_ASIO_DETAIL_STD_STATIC_MUTEX_HPP
#define AUTOBOOST_ASIO_DETAIL_STD_STATIC_MUTEX_HPP
...
{
public:
  typedef autoboost::asio::detail::scoped_lock<std_static_mutex> scoped_lock;
...
#define AUTOBOOST_ASIO_STD_STATIC_MUTEX_INIT 0
...
#endif // AUTOBOOST_ASIO_DETAIL_STD_STATIC_MUTEX_HPP
