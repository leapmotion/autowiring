...
#ifndef AUTOBOOST_ASIO_DETAIL_WINRT_SOCKET_SEND_OP_HPP
#define AUTOBOOST_ASIO_DETAIL_WINRT_SOCKET_SEND_OP_HPP
...
{
public:
  AUTOBOOST_ASIO_DEFINE_HANDLER_PTR(winrt_socket_send_op);
...
#endif // AUTOBOOST_ASIO_DETAIL_WINRT_SOCKET_SEND_OP_HPP
