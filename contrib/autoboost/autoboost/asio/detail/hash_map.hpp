...
#ifndef AUTOBOOST_ASIO_DETAIL_HASH_MAP_HPP
#define AUTOBOOST_ASIO_DETAIL_HASH_MAP_HPP
...
public:
  ...
  {
    AUTOBOOST_ASIO_ASSERT(it != values_.end());
    AUTOBOOST_ASIO_ASSERT(num_buckets_ != 0);
...
private:
  ...
  static std::size_t hash_size(std::size_t num_elems)
  {
    ...
    {
#if defined(AUTOBOOST_ASIO_HASH_MAP_BUCKETS)
      AUTOBOOST_ASIO_HASH_MAP_BUCKETS
#else // AUTOBOOST_ASIO_HASH_MAP_BUCKETS
      3, 13, 23, 53, 97, 193, 389, 769, 1543, 3079, 6151, 12289, 24593,
      49157, 98317, 196613, 393241, 786433, 1572869, 3145739, 6291469,
      12582917, 25165843
#endif // AUTOBOOST_ASIO_HASH_MAP_BUCKETS
    };
  ...
  void rehash(std::size_t num_buckets)
  {
    if (num_buckets == num_buckets_)
      return;
    AUTOBOOST_ASIO_ASSERT(num_buckets != 0);
...
#endif // AUTOBOOST_ASIO_DETAIL_HASH_MAP_HPP
