...
#ifndef AUTOBOOST_ASIO_IP_RESOLVER_QUERY_BASE_HPP
#define AUTOBOOST_ASIO_IP_RESOLVER_QUERY_BASE_HPP
...
public:
  ...
  enum flags
  {
    canonical_name = AUTOBOOST_ASIO_OS_DEF(AI_CANONNAME),
    passive = AUTOBOOST_ASIO_OS_DEF(AI_PASSIVE),
    numeric_host = AUTOBOOST_ASIO_OS_DEF(AI_NUMERICHOST),
    numeric_service = AUTOBOOST_ASIO_OS_DEF(AI_NUMERICSERV),
    v4_mapped = AUTOBOOST_ASIO_OS_DEF(AI_V4MAPPED),
    all_matching = AUTOBOOST_ASIO_OS_DEF(AI_ALL),
    address_configured = AUTOBOOST_ASIO_OS_DEF(AI_ADDRCONFIG)
  };
...
#endif // AUTOBOOST_ASIO_IP_RESOLVER_QUERY_BASE_HPP
