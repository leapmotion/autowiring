...
#ifndef AUTOBOOST_ASIO_IP_BASIC_RESOLVER_HPP
#define AUTOBOOST_ASIO_IP_BASIC_RESOLVER_HPP
...
public:
   ...
   */
  explicit basic_resolver(autoboost::asio::io_service& io_service)
   ...
   * will be invoked with the autoboost::asio::error::operation_aborted error code.
   */
  void cancel()
  {
  ...
  iterator resolve(const query& q)
  {
    ...
    autoboost::asio::detail::throw_error(ec, "resolve");
    return i;
  }
   ...
   * entry.
   */
  iterator resolve(const query& q, autoboost::system::error_code& ec)
  {
      ...
      AUTOBOOST_ASIO_MOVE_ARG(ResolveHandler) handler)
  {
    ...
    AUTOBOOST_ASIO_RESOLVE_HANDLER_CHECK(
   ...
   * entry.
   */
  iterator resolve(const endpoint_type& e, autoboost::system::error_code& ec)
  {
...
#endif // AUTOBOOST_ASIO_IP_BASIC_RESOLVER_HPP
