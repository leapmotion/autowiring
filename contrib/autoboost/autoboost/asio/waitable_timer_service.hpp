...
#ifndef AUTOBOOST_ASIO_WAITABLE_TIMER_SERVICE_HPP
#define AUTOBOOST_ASIO_WAITABLE_TIMER_SERVICE_HPP
...
public:
  ...
  explicit waitable_timer_service(autoboost::asio::io_service& io_service)
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_point& expiry_time, autoboost::system::error_code& ec)
  {
  ...
  std::size_t expires_from_now(implementation_type& impl,
      const duration& expiry_time, autoboost::system::error_code& ec)
  {
...
#endif // AUTOBOOST_ASIO_WAITABLE_TIMER_SERVICE_HPP
