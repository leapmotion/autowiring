...
#ifndef AUTOBOOST_ASIO_GENERIC_SEQ_PACKET_PROTOCOL_HPP
#define AUTOBOOST_ASIO_GENERIC_SEQ_PACKET_PROTOCOL_HPP
...
/**
 * The autoboost::asio::generic::seq_packet_protocol class contains flags necessary
...
public:
  ...
  int type() const
  {
    return AUTOBOOST_ASIO_OS_DEF(SOCK_SEQPACKET);
  }
...
#endif // AUTOBOOST_ASIO_GENERIC_SEQ_PACKET_PROTOCOL_HPP
