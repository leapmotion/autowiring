...
#ifndef AUTOBOOST_ASIO_GENERIC_RAW_PROTOCOL_HPP
#define AUTOBOOST_ASIO_GENERIC_RAW_PROTOCOL_HPP
...
/**
 * The autoboost::asio::generic::raw_protocol class contains flags necessary for
 ...
 * @code raw_protocol p(autoboost::asio::ip::icmp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // AUTOBOOST_ASIO_GENERIC_RAW_PROTOCOL_HPP
