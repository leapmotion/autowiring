...
#ifndef AUTOBOOST_ASIO_GENERIC_STREAM_PROTOCOL_HPP
#define AUTOBOOST_ASIO_GENERIC_STREAM_PROTOCOL_HPP
...
/**
 * The autoboost::asio::generic::stream_protocol class contains flags necessary for
 ...
 * @code stream_protocol p(autoboost::asio::ip::tcp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // AUTOBOOST_ASIO_GENERIC_STREAM_PROTOCOL_HPP
