...
#ifndef AUTOBOOST_ASIO_GENERIC_DETAIL_IMPL_ENDPOINT_IPP
#define AUTOBOOST_ASIO_GENERIC_DETAIL_IMPL_ENDPOINT_IPP
...
void endpoint::init(const void* sock_addr,
    std::size_t sock_addr_size, int sock_protocol)
{
  if (sock_addr_size > sizeof(autoboost::asio::detail::sockaddr_storage_type))
  {
    autoboost::system::error_code ec(autoboost::asio::error::invalid_argument);
    autoboost::asio::detail::throw_error(ec);
  }
  ...
  memset(&data_.generic, 0, sizeof(autoboost::asio::detail::sockaddr_storage_type));
...
#endif // AUTOBOOST_ASIO_GENERIC_DETAIL_IMPL_ENDPOINT_IPP
