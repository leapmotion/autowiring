...
#ifndef AUTOBOOST_ASIO_LOCAL_DETAIL_IMPL_ENDPOINT_IPP
#define AUTOBOOST_ASIO_LOCAL_DETAIL_IMPL_ENDPOINT_IPP
...
{
  if (new_size > sizeof(autoboost::asio::detail::sockaddr_un_type))
  {
...
void endpoint::init(const char* path_name, std::size_t path_length)
{
  if (path_length > sizeof(data_.local.sun_path) - 1)
  {
    ...
    autoboost::system::error_code ec(autoboost::asio::error::name_too_long);
    autoboost::asio::detail::throw_error(ec);
  }

  using namespace std; // For memcpy.
  data_.local = autoboost::asio::detail::sockaddr_un_type();
...
#endif // AUTOBOOST_ASIO_LOCAL_DETAIL_IMPL_ENDPOINT_IPP
