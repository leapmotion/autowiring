...
#ifndef AUTOBOOST_ASIO_BASIC_IO_OBJECT_HPP
#define AUTOBOOST_ASIO_BASIC_IO_OBJECT_HPP
...
protected:
   ...
   */
  explicit basic_io_object(autoboost::asio::io_service& io_service)
    : service(autoboost::asio::use_service<IoObjectService>(io_service))
  {
...
protected:
  explicit basic_io_object(autoboost::asio::io_service& io_service)
    : service_(&autoboost::asio::use_service<IoObjectService>(io_service))
  {
  ...
  basic_io_object(IoObjectService1& other_service,
      typename IoObjectService1::implementation_type& other_implementation)
    : service_(&autoboost::asio::use_service<IoObjectService>(
...
#endif // AUTOBOOST_ASIO_BASIC_IO_OBJECT_HPP
