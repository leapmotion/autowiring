...
#ifndef AUTOBOOST_ASIO_BASIC_STREAM_SOCKET_HPP
#define AUTOBOOST_ASIO_BASIC_STREAM_SOCKET_HPP
...
public:
   ...
   */
  explicit basic_stream_socket(autoboost::asio::io_service& io_service)
   ...
   */
  basic_stream_socket(autoboost::asio::io_service& io_service,
  ...
  basic_stream_socket(basic_stream_socket&& other)
    : basic_socket<Protocol, StreamSocketService>(
        AUTOBOOST_ASIO_MOVE_CAST(basic_stream_socket)(other))
  {
  }
  ...
  basic_stream_socket(
    ...
    : basic_socket<Protocol, StreamSocketService>(
        AUTOBOOST_ASIO_MOVE_CAST2(basic_stream_socket<
   ...
   * @code
   * socket.send(autoboost::asio::buffer(data, size));
   * @endcode
  ...
  std::size_t send(const ConstBufferSequence& buffers)
  {
    ...
    autoboost::asio::detail::throw_error(ec, "send");
    return s;
  }
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.send(autoboost::asio::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(autoboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(autoboost::asio::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.receive(autoboost::asio::buffer(data, size));
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
   */
  ...
  std::size_t receive(const MutableBufferSequence& buffers)
  {
    ...
    std::size_t s = this->get_service().receive(
        this->get_implementation(), buffers, 0, ec);
    autoboost::asio::detail::throw_error(ec, "receive");
    return s;
  }
   ...
   * follows:
   * @code
   * socket.receive(autoboost::asio::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(autoboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
      ...
      AUTOBOOST_ASIO_MOVE_ARG(ReadHandler) handler)
  {
    ...
    return this->get_service().async_receive(this->get_implementation(),
        buffers, 0, AUTOBOOST_ASIO_MOVE_CAST(ReadHandler)(handler));
  }
   ...
   * follows:
   * @code
   * socket.async_receive(autoboost::asio::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
      ...
      AUTOBOOST_ASIO_MOVE_ARG(ReadHandler) handler)
  {
    ...
    return this->get_service().async_receive(this->get_implementation(),
        buffers, flags, AUTOBOOST_ASIO_MOVE_CAST(ReadHandler)(handler));
  }
   ...
   * @code
   * socket.write_some(autoboost::asio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_write_some(autoboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
      ...
      AUTOBOOST_ASIO_MOVE_ARG(WriteHandler) handler)
  {
    ...
    return this->get_service().async_send(this->get_implementation(),
        buffers, 0, AUTOBOOST_ASIO_MOVE_CAST(WriteHandler)(handler));
  }
   ...
   * @code
   * socket.read_some(autoboost::asio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_read_some(autoboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, autoboost::array or
   * std::vector.
...
#endif // AUTOBOOST_ASIO_BASIC_STREAM_SOCKET_HPP
