...
#ifndef AUTOBOOST_ASIO_SPAWN_HPP
#define AUTOBOOST_ASIO_SPAWN_HPP
...
#include <autoboost/coroutine/all.hpp>
...
public:
...
#elif defined(AUTOBOOST_COROUTINES_UNIDIRECT) || defined(AUTOBOOST_COROUTINES_V2)
  typedef autoboost::coroutines::push_coroutine<void> callee_type;
#else
  typedef autoboost::coroutines::coroutine<void()> callee_type;
#endif
...
#elif defined(AUTOBOOST_COROUTINES_UNIDIRECT) || defined(AUTOBOOST_COROUTINES_V2)
  typedef autoboost::coroutines::pull_coroutine<void> caller_type;
#else
  typedef autoboost::coroutines::coroutine<void()>::caller_type caller_type;
#endif
   ...
   * } @endcode
   */
  basic_yield_context operator[](autoboost::system::error_code& ec) const
  {
...
/**
 * @defgroup spawn autoboost::asio::spawn
 *
 ...
 *
 * @code autoboost::asio::spawn(my_strand, do_echo);
 *
 * // ...
 *
 * void do_echo(autoboost::asio::yield_context yield)
 * {
 *   try
 *   {
 *     char data[128];
 ...
 *           autoboost::asio::buffer(data), yield);
 *
 *       autoboost::asio::async_write(my_socket,
 *           autoboost::asio::buffer(data, length), yield);
 *     }
 *   }
...
void spawn(AUTOBOOST_ASIO_MOVE_ARG(Handler) handler,
    ...
    const autoboost::coroutines::attributes& attributes
      = autoboost::coroutines::attributes());
...
#include <autoboost/asio/impl/spawn.hpp>

#endif // AUTOBOOST_ASIO_SPAWN_HPP
