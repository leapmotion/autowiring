...
#ifndef AUTOBOOST_ASIO_READ_UNTIL_HPP
#define AUTOBOOST_ASIO_READ_UNTIL_HPP
...
#include <autoboost/asio/detail/regex_fwd.hpp>
...
struct is_match_condition
{
  ...
  enum
  {
    value = autoboost::asio::is_function<
        typename autoboost::asio::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until autoboost::asio::read_until
 *
 ...
 * @code autoboost::asio::streambuf b;
 * autoboost::asio::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
std::size_t read_until(SyncReadStream& s,
    autoboost::asio::basic_streambuf<Allocator>& b, char delim);
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    autoboost::asio::basic_streambuf<Allocator>& b, const std::string& delim);
 ...
 * @code autoboost::asio::streambuf b;
 * autoboost::asio::read_until(s, b, autoboost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    autoboost::asio::basic_streambuf<Allocator>& b, const autoboost::regex& expr);
 ...
 * @code typedef autoboost::asio::buffers_iterator<
 *     autoboost::asio::streambuf::const_buffers_type> iterator;
 *
 ...
 * }
 * ...
 * autoboost::asio::streambuf b;
 * autoboost::asio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 *     : public autoboost::true_type {};
 * } // namespace asio
 * ...
 * autoboost::asio::streambuf b;
 * autoboost::asio::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    autoboost::asio::basic_streambuf<Allocator>& b, MatchCondition match_condition,
...
std::size_t read_until(SyncReadStream& s,
    ...
    MatchCondition match_condition, autoboost::system::error_code& ec,
    typename enable_if<is_match_condition<MatchCondition>::value>::type* = 0);

/*@}*/
/**
 * @defgroup async_read_until autoboost::asio::async_read_until
 *
 ...
 * @code autoboost::asio::streambuf b;
 * ...
 * void handler(const autoboost::system::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::istream is(&b);
 ...
 * }
 * ...
 * autoboost::asio::async_read_until(s, b, '\n', handler); @endcode
...
async_read_until(AsyncReadStream& s,
    autoboost::asio::basic_streambuf<Allocator>& b,
    char delim, AUTOBOOST_ASIO_MOVE_ARG(ReadHandler) handler);
 ...
 * }
 * ...
 * autoboost::asio::async_read_until(s, b, autoboost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * autoboost::asio::streambuf b;
 * autoboost::asio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * autoboost::asio::streambuf b;
 * autoboost::asio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 */
...
async_read_until(AsyncReadStream& s,
    autoboost::asio::basic_streambuf<Allocator>& b,
    MatchCondition match_condition, AUTOBOOST_ASIO_MOVE_ARG(ReadHandler) handler,
    typename enable_if<is_match_condition<MatchCondition>::value>::type* = 0);
...
#include <autoboost/asio/impl/read_until.hpp>

#endif // !defined(AUTOBOOST_ASIO_NO_IOSTREAM)

#endif // AUTOBOOST_ASIO_READ_UNTIL_HPP
