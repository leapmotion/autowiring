...
#ifndef AUTOBOOST_ASIO_BUFFERED_STREAM_HPP
#define AUTOBOOST_ASIO_BUFFERED_STREAM_HPP
...
public:
  ...
  {
    return stream_impl_.async_fill(AUTOBOOST_ASIO_MOVE_CAST(ReadHandler)(handler));
  }
...
#endif // AUTOBOOST_ASIO_BUFFERED_STREAM_HPP
