...
#ifndef AUTOBOOST_ASIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
#define AUTOBOOST_ASIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
...
public:
   ...
   */
  explicit basic_object_handle(autoboost::asio::io_service& io_service)
   ...
   */
  basic_object_handle(autoboost::asio::io_service& io_service,
  ...
  basic_object_handle(basic_object_handle&& other)
    : basic_handle<ObjectHandleService>(
        AUTOBOOST_ASIO_MOVE_CAST(basic_object_handle)(other))
  {
  }
...
#endif // AUTOBOOST_ASIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
