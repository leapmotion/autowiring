...
#ifndef AUTOBOOST_ASIO_WINDOWS_STREAM_HANDLE_SERVICE_HPP
#define AUTOBOOST_ASIO_WINDOWS_STREAM_HANDLE_SERVICE_HPP
...
#else
  : public autoboost::asio::detail::service_base<stream_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_handle_service(autoboost::asio::io_service& io_service)
    : autoboost::asio::detail::service_base<stream_handle_service>(io_service),
...
#endif // AUTOBOOST_ASIO_WINDOWS_STREAM_HANDLE_SERVICE_HPP
