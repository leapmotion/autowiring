...
//
#ifndef AUTOBOOST_NUMERIC_CONVERSION_CAST_25OCT2001_HPP
#define AUTOBOOST_NUMERIC_CONVERSION_CAST_25OCT2001_HPP

#include <autoboost/detail/workaround.hpp>

#if AUTOBOOST_WORKAROUND(AUTOBOOST_MSVC, < 1300) || AUTOBOOST_WORKAROUND(__BORLANDC__, AUTOBOOST_TESTED_AT(0x582))

#  include<autoboost/numeric/conversion/detail/old_numeric_cast.hpp>

#else

#include <autoboost/type.hpp>
#include <autoboost/numeric/conversion/converter.hpp>
#include <autoboost/numeric/conversion/numeric_cast_traits.hpp>
