...
//
#ifndef AUTOBOOST_NUMERIC_CONVERSION_DETAIL_CONVERTER_FLC_12NOV2002_HPP
#define AUTOBOOST_NUMERIC_CONVERSION_DETAIL_CONVERTER_FLC_12NOV2002_HPP

#include <functional>

#include "autoboost/numeric/conversion/detail/meta.hpp"
#include "autoboost/numeric/conversion/detail/conversion_traits.hpp"
#include "autoboost/numeric/conversion/bounds.hpp"

#include "autoboost/type_traits/is_same.hpp"

#include "autoboost/mpl/integral_c.hpp"

namespace autoboost { namespace numeric { namespace convdetail
{
...
//--------------------------------------------------------------------------
  ...
  //
  template<class Traits>
  struct trivial_converter_impl : public std::unary_function<  AUTOBOOST_DEDUCED_TYPENAME Traits::argument_type
                                                              ,AUTOBOOST_DEDUCED_TYPENAME Traits::result_type
                                                            >
  ...
  struct rounding_converter : public std::unary_function<  AUTOBOOST_DEDUCED_TYPENAME Traits::argument_type
                                                          ,AUTOBOOST_DEDUCED_TYPENAME Traits::result_type
                                                        >
                             ,public RangeChecker
  ...
  struct non_rounding_converter : public std::unary_function< AUTOBOOST_DEDUCED_TYPENAME Traits::argument_type
                                                             ,AUTOBOOST_DEDUCED_TYPENAME Traits::result_type
                                                           >
                                 ,public RangeChecker
                                 ,public RawConverter
...
//--------------------------------------------------------------------------
  ...
  {
#if AUTOBOOST_WORKAROUND(__BORLANDC__, AUTOBOOST_TESTED_AT( 0x0561 ) )
...
} } } // namespace autoboost::numeric::convdetail
