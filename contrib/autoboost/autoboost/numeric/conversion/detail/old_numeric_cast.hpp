...
//             actually compile when AUTOBOOST_NO_LIMITS was defined in
...
#ifndef AUTOBOOST_OLD_NUMERIC_CAST_HPP
#define AUTOBOOST_OLD_NUMERIC_CAST_HPP
...
# else
#  define AUTOBOOST_EXPLICIT_DEFAULT_TARGET
# endif
...
//  numeric_cast  ------------------------------------------------------------//
...
#if !defined(AUTOBOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS) || defined(AUTOBOOST_SGI_CPP_LIMITS)
    ...
    namespace detail
    {
      ...
      {
             static inline T min AUTOBOOST_PREVENT_MACRO_SUBSTITUTION ()
         {
      ...
      // Move to namespace autoboost in utility.hpp?
      template <class T, bool specialized>
      struct fixed_numeric_limits_base
          : public if_true< std::numeric_limits<T>::is_signed >
           ::AUTOBOOST_NESTED_TEMPLATE then< signed_numeric_limits<T>,
...
# ifdef AUTOBOOST_HAS_LONG_LONG
      ...
      template <>
      struct fixed_numeric_limits_base< ::autoboost::long_long_type, false>
      {
          AUTOBOOST_STATIC_CONSTANT(bool, is_specialized = true);
          AUTOBOOST_STATIC_CONSTANT(bool, is_signed = true);
          static  ::autoboost::long_long_type max AUTOBOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MAX
              return LONGLONG_MAX;
#  else
...
#  endif
          ...
          static  ::autoboost::long_long_type min AUTOBOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MIN
              return LONGLONG_MIN;
#  else
...
#  endif
      ...
      template <>
      struct fixed_numeric_limits_base< ::autoboost::ulong_long_type, false>
      {
          AUTOBOOST_STATIC_CONSTANT(bool, is_specialized = true);
          AUTOBOOST_STATIC_CONSTANT(bool, is_signed = false);
          static  ::autoboost::ulong_long_type max AUTOBOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef ULONGLONG_MAX
...
#  endif
          ...
          static  ::autoboost::ulong_long_type min AUTOBOOST_PREVENT_MACRO_SUBSTITUTION () { return 0; }
      };
# endif
    } // namespace detail
...
#  define AUTOBOOST_UINT64_CAST(src_type)                                   \
        ...
        AUTOBOOST_UINT64_CAST(long double);
        AUTOBOOST_UINT64_CAST(double);
        AUTOBOOST_UINT64_CAST(float);
#  undef AUTOBOOST_UINT64_CAST
# endif
    };
...
# endif
    ...
    inline Target numeric_cast(Source arg AUTOBOOST_EXPLICIT_DEFAULT_TARGET)
    {
...
#  undef AUTOBOOST_EXPLICIT_DEFAULT_TARGET

} // namespace autoboost

#endif  // AUTOBOOST_OLD_NUMERIC_CAST_HPP
