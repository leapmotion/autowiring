...
#ifndef AUTOBOOST_PARAMETER_PYTHON_060209_HPP
# define AUTOBOOST_PARAMETER_PYTHON_060209_HPP

# include <autoboost/mpl/vector.hpp>
# include <autoboost/mpl/fold.hpp>
# include <autoboost/mpl/prior.hpp>
# include <autoboost/mpl/shift_right.hpp>
# include <autoboost/mpl/shift_left.hpp>
# include <autoboost/mpl/bitand.hpp>
...
# include <autoboost/mpl/front.hpp>
...
# include <autoboost/python/def.hpp>
# include <autoboost/python/make_constructor.hpp>
# include <autoboost/python/init.hpp>
# include <autoboost/python/to_python_converter.hpp>
# include <autoboost/parameter/aux_/maybe.hpp>
# include <autoboost/parameter/aux_/python/invoker.hpp>

namespace autoboost { namespace parameter { namespace python
{
  namespace python_ = autoboost::python;
}}}

namespace autoboost { namespace parameter { namespace python { namespace aux
{
...
}}}} // namespace autoboost::parameter::python::aux

namespace autoboost { namespace python
{
...
namespace aux
{
      ...
      Def def, F f, Iter, End, Keywords const& keywords, mpl::false_)
  {
      ...
      def_combination_aux(
        ...
        , (
              keywords, autoboost::python::arg(kw::keyword_name())
          )
      );
  }
      ...
      Def def, F f, Iter, End, Keywords const& keywords, mpl::true_)
  {
      ...
      def_combination_aux(
          def, f, typename mpl::next<Iter>::type(), End()
        , (
              keywords, autoboost::python::arg(kw::keyword_name()) = empty_tag()
          )
      );
  }
  ...
  template <class Class, class CallPolicies = autoboost::python::default_call_policies>
  struct def_init
  {
      ...
      void operator()(F f) const
      {
          cl.def(
              "__init__"
            , autoboost::python::make_constructor(f, call_policies)
          );
      }
      ...
      void operator()(F f, Keywords const& keywords) const
      {
          cl.def(
              "__init__"
            , autoboost::python::make_constructor(f, call_policies, keywords)
          );
      }
  ...
  struct def_function
  {
      ...
      void operator()(F f) const
      {
          autoboost::python::def(name, f);
      }

      template <class F, class Keywords>
      void operator()(F f, Keywords const& keywords) const
      {
          autoboost::python::def(name, f, keywords);
      }
...
template <class ParameterSpecs, class CallPolicies = autoboost::python::default_call_policies>
struct init
  : autoboost::python::def_visitor<init<ParameterSpecs, CallPolicies> >
{
    ...
    {
        cl.def(autoboost::python::init<>()[call_policies]);
    }
...
template <class ParameterSpecs, class CallPolicies = autoboost::python::default_call_policies>
struct call
  : autoboost::python::def_visitor<call<ParameterSpecs, CallPolicies> >
{
...
struct function
  : autoboost::python::def_visitor<function<Fwd, ParameterSpecs> >
{
...
}}} // namespace autoboost::parameter::python

#endif // AUTOBOOST_PARAMETER_PYTHON_060209_HPP
