...
#ifndef AUTOBOOST_PARAMETER_CAST_060902_HPP
# define AUTOBOOST_PARAMETER_CAST_060902_HPP
...
#  define AUTOBOOST_PARAMETER_FUNCTION_CAST(value, predicate) value
...
struct cast<void(T), Args>
{
    ...
    typedef typename autoboost::add_reference<
        typename autoboost::remove_const<type0>::type
    >::type reference;
...
#  define AUTOBOOST_PARAMETER_FUNCTION_CAST(value, predicate, args) \
    autoboost::parameter::aux::cast<void predicate, args>::remove_const( \
        autoboost::parameter::aux::cast<void predicate, args>::execute(value) \
    )
...
#endif // AUTOBOOST_PARAMETER_CAST_060902_HPP
