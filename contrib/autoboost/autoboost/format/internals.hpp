...
#ifndef AUTOBOOST_FORMAT_INTERNALS_HPP
#define AUTOBOOST_FORMAT_INTERNALS_HPP
...
#include <autoboost/format/alt_sstream.hpp> // used as a dummy stream
...
//   set of params that define the format state of a stream
    ...
    {
        typedef AUTOBOOST_IO_STD basic_ios<Ch, Tr>   basic_ios;
...
//        stream_format_state(const basic_ios& os)     { set_by_stream(os); }
        ...
        void apply_on(basic_ios & os,            //- applies format_state to the stream
                      autoboost::io::detail::locale_t * loc_default = 0) const;
        template<class T>
        ...
        autoboost::optional<autoboost::io::detail::locale_t>  loc_;
    };
...
// -   stream_format_state:: -------------------------------------------------
    ...
    void stream_format_state<Ch,Tr>:: apply_on (basic_ios & os,
                      autoboost::io::detail::locale_t * loc_default) const {
    ...
    compute_states() {
        ...
        if(pad_scheme_ & zeropad) {
            ...
            if(fmtstate_.flags_ & std::ios_base::left) {
              AUTOBOOST_ASSERT(!(fmtstate_.flags_ &(std::ios_base::adjustfield ^std::ios_base::left)));
...
} } } // namespaces autoboost :: io :: detail


#endif // AUTOBOOST_FORMAT_INTERNALS_HPP
