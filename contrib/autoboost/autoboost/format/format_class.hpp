...
#ifndef AUTOBOOST_FORMAT_CLASS_HPP
#define AUTOBOOST_FORMAT_CLASS_HPP


#include <vector>
#include <string>

#include <autoboost/optional.hpp> // to store locale when needed

#include <autoboost/format/format_fwd.hpp>
#include <autoboost/format/internals_fwd.hpp>
#include <autoboost/format/internals.hpp>
#include <autoboost/format/alt_sstream.hpp>
...
namespace autoboost {
    ...
    && !AUTOBOOST_WORKAROUND(__BORLANDC__, <= 0x570) \
    && !AUTOBOOST_WORKAROUND( _CRAYC, != 0) \
    ...
    private:
        ...
        autoboost::optional<io::detail::locale_t>     loc_;
    }; // class basic_format

} // namespace autoboost


#endif // AUTOBOOST_FORMAT_CLASS_HPP
