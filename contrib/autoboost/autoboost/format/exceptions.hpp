...
#ifndef AUTOBOOST_FORMAT_EXCEPTIONS_HPP
#define AUTOBOOST_FORMAT_EXCEPTIONS_HPP
...
// **** exceptions -----------------------------------------------
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "autoboost::bad_format_string: format-string is ill-formed";
            }
        };
        ...
        public:
            ...
            std::size_t get_expected() const { return expected_; }
            virtual const char *what() const throw() {
                return "autoboost::too_many_args: "
...
#endif // AUTOBOOST_FORMAT_EXCEPTIONS_HPP
