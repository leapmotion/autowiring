...
#ifndef AUTOBOOST_FORMAT_GROUP_HPP
#define AUTOBOOST_FORMAT_GROUP_HPP
...
inline
AUTOBOOST_IO_STD basic_ostream<Ch, Tr>&
operator << ( AUTOBOOST_IO_STD basic_ostream<Ch, Tr>& os,
             const group0& )
{
   return os;
}
...
#endif  // - AUTOBOOST_NO_OVERLOAD_FOR_NON_CONST
...
#endif   // AUTOBOOST_FORMAT_GROUP_HPP
