// ----------------------------------------------------------------------------
// free_funcs.hpp :  implementation of the free functions of autoboost::format
// ----------------------------------------------------------------------------
...
#ifndef AUTOBOOST_FORMAT_FUNCS_HPP
#define AUTOBOOST_FORMAT_FUNCS_HPP
...
namespace autoboost {
    ...
    namespace io {
         using ::autoboost::str; // keep compatibility with when it was defined in this N.S.
    }   // - namespace io
...
#endif // AUTOBOOST_FORMAT_FUNCS_HPP
