...
#ifndef AUTOBOOST_INTRUSIVE_POINTER_TRAITS_HPP
#define AUTOBOOST_INTRUSIVE_POINTER_TRAITS_HPP
...
struct pointer_traits
{
      ...
      typedef Ptr                                                             pointer;
      //
      typedef AUTOBOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT
         ( autoboost::intrusive::detail::, Ptr, element_type
         , autoboost::intrusive::detail::first_param<Ptr>)                        element_type;
      //
      typedef AUTOBOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
         (autoboost::intrusive::detail::, Ptr, difference_type, std::ptrdiff_t)   difference_type;

      typedef AUTOBOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
         (autoboost::intrusive::detail::, Ptr, reference, typename autoboost::intrusive::detail::unvoid_ref<element_type>::type)   reference;
      //
      template <class U> struct rebind_pointer
      {
         typedef typename autoboost::intrusive::pointer_rebind<Ptr, U>::type  type;
      };

      #if !defined(AUTOBOOST_NO_CXX11_TEMPLATE_ALIASES)
         template <class U> using rebind = typename autoboost::intrusive::pointer_rebind<Ptr, U>::type;
      #endif
   ...
   static pointer pointer_to(reference r)
   {
      ...
      const bool value = autoboost::intrusive::detail::
         has_member_function_callable_with_pointer_to
            <Ptr, reference>::value;
      autoboost::intrusive::detail::bool_<value> flag;
   ...
   //priv_pointer_to
   static pointer priv_pointer_to(autoboost::intrusive::detail::true_, reference r)
   { return Ptr::pointer_to(r); }

   static pointer priv_pointer_to(autoboost::intrusive::detail::false_, reference r)
   { return pointer(autoboost::intrusive::detail::addressof(r)); }

   //priv_static_cast_from
   template<class UPtr>
   static pointer priv_static_cast_from(autoboost::intrusive::detail::true_, const UPtr &uptr)
   { return Ptr::static_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_static_cast_from(autoboost::intrusive::detail::false_, const UPtr &uptr)
   {  return pointer_to(*static_cast<element_type*>(to_raw_pointer(uptr)));  }

   //priv_const_cast_from
   template<class UPtr>
   static pointer priv_const_cast_from(autoboost::intrusive::detail::true_, const UPtr &uptr)
   { return Ptr::const_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_const_cast_from(autoboost::intrusive::detail::false_, const UPtr &uptr)
   {  return pointer_to(const_cast<element_type&>(*uptr));  }

   //priv_dynamic_cast_from
   template<class UPtr>
   static pointer priv_dynamic_cast_from(autoboost::intrusive::detail::true_, const UPtr &uptr)
   { return Ptr::dynamic_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_dynamic_cast_from(autoboost::intrusive::detail::false_, const UPtr &uptr)
   {
...
struct pointer_traits<T*>
{
   ...
   #else
      typedef typename autoboost::intrusive::detail::unvoid_ref<element_type>::type reference;
      #if !defined(AUTOBOOST_NO_CXX11_TEMPLATE_ALIASES)
         template <class U> using rebind = U*;
      #endif
   #endif
   ...
   //!
   static pointer pointer_to(reference r)
   { return autoboost::intrusive::detail::addressof(r); }
...
#endif // ! defined(AUTOBOOST_INTRUSIVE_POINTER_TRAITS_HPP)
