...
#ifndef AUTOBOOST_INTRUSIVE_DETAIL_POINTER_ELEMENT_HPP
#define AUTOBOOST_INTRUSIVE_DETAIL_POINTER_ELEMENT_HPP
...
{
   typedef typename autoboost::intrusive::detail::first_param<Ptr>::type type;
};
...
{
   typedef typename ::autoboost::intrusive::detail::pointer_element_impl<Ptr>::type type;
};
...
#endif // defined(AUTOBOOST_INTRUSIVE_DETAIL_POINTER_ELEMENT_HPP)
