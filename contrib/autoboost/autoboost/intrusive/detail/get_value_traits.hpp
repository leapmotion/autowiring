...
#include <autoboost/intrusive/detail/hook_traits.hpp>
...
AUTOBOOST_INTRUSIVE_INTERNAL_STATIC_BOOL_IS_TRUE(internal_any_hook, is_any_hook)
AUTOBOOST_INTRUSIVE_INTERNAL_STATIC_BOOL_IS_TRUE(internal_base_hook, hooktags::is_base_hook)
...
#endif   //AUTOBOOST_INTRUSIVE_DOXYGEN_INVOKED
...
#endif   //#ifndef AUTOBOOST_INTRUSIVE_DETAIL_GET_VALUE_TRAITS_HPP
