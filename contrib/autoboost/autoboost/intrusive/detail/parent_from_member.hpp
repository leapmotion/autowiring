...
//
/////////////////////////////////////////////////////////////////////////////
#ifndef AUTOBOOST_INTRUSIVE_DETAIL_PARENT_FROM_MEMBER_HPP
#define AUTOBOOST_INTRUSIVE_DETAIL_PARENT_FROM_MEMBER_HPP
...
#if defined(AUTOBOOST_MSVC) || ((defined(_WIN32) || defined(__WIN32__) || defined(WIN32)) && defined(AUTOBOOST_INTEL))
   #define AUTOBOOST_INTRUSIVE_MSVC_ABI_PTR_TO_MEMBER
...
inline std::ptrdiff_t offset_from_pointer_to_member(const Member Parent::* ptr_to_member)
{
   ...
   #if defined(AUTOBOOST_INTRUSIVE_MSVC_ABI_PTR_TO_MEMBER)
   ...
   AUTOBOOST_STATIC_ASSERT( sizeof(caster) == sizeof(int) );
   ...
   #elif defined(__GNUC__)   || defined(__HP_aCC) || defined(AUTOBOOST_INTEL) || \
...
#ifdef AUTOBOOST_INTRUSIVE_MSVC_ABI_PTR_TO_MEMBER
#undef AUTOBOOST_INTRUSIVE_MSVC_ABI_PTR_TO_MEMBER
#endif

#include <autoboost/intrusive/detail/config_end.hpp>

#endif   //#ifndef AUTOBOOST_INTRUSIVE_DETAIL_PARENT_FROM_MEMBER_HPP
