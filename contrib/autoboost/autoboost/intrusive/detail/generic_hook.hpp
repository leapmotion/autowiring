...
#ifndef AUTOBOOST_INTRUSIVE_GENERIC_HOOK_HPP
#define AUTOBOOST_INTRUSIVE_GENERIC_HOOK_HPP
...
{  //If this assertion raises, you might have destroyed an object
   ...
   (void)hook; AUTOBOOST_INTRUSIVE_SAFE_HOOK_DESTRUCTOR_ASSERT(!hook.is_linked());
}
   ...
   /// @endcond
{
   ...
   bool is_linked() const
   {
      ...
      AUTOBOOST_STATIC_ASSERT(( hooktags::safemode_or_autounlink ));
      return !node_algorithms::unique(this->this_ptr());
   }

   void unlink()
   {
      AUTOBOOST_STATIC_ASSERT(( (int)hooktags::link_mode == (int)auto_unlink ));
...
#endif //AUTOBOOST_INTRUSIVE_GENERIC_HOOK_HPP
