...
#ifndef AUTOBOOST_INTRUSIVE_COMMON_SLIST_ALGORITHMS_HPP
#define AUTOBOOST_INTRUSIVE_COMMON_SLIST_ALGORITHMS_HPP
...
class common_slist_algorithms
{
   ...
   static node_ptr get_previous_node(node_ptr p, const node_ptr & this_node)
   {
      for( node_ptr p_next
         ...
         AUTOBOOST_INTRUSIVE_INVARIANT_ASSERT(p);
      }
      return p;
   }
...
#endif //AUTOBOOST_INTRUSIVE_COMMON_SLIST_ALGORITHMS_HPP
