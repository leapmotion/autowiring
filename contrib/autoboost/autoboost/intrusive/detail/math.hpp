...
#ifndef AUTOBOOST_INTRUSIVE_DETAIL_MATH_HPP
#define AUTOBOOST_INTRUSIVE_DETAIL_MATH_HPP
...
////////////////////////////
   ...
   //Use _BitScanReverseXX intrinsics
      ...
      #define AUTOBOOST_INTRUSIVE_BSR_INTRINSIC_64_BIT
   #endif
      ...
      #if defined(AUTOBOOST_INTRUSIVE_BSR_INTRINSIC_64_BIT)   //64 bit target
   ...
   #ifdef AUTOBOOST_INTRUSIVE_BSR_INTRINSIC_64_BIT
      #define AUTOBOOST_INTRUSIVE_BSR_INTRINSIC _BitScanReverse64
      #undef AUTOBOOST_INTRUSIVE_BSR_INTRINSIC_64_BIT
   #else
      #define AUTOBOOST_INTRUSIVE_BSR_INTRINSIC _BitScanReverse
   #endif
   ...
   {
      unsigned long log2;
      AUTOBOOST_INTRUSIVE_BSR_INTRINSIC( &log2, (unsigned long)x );
      return log2;
   }

   #undef AUTOBOOST_INTRUSIVE_BSR_INTRINSIC
...
#endif //AUTOBOOST_INTRUSIVE_DETAIL_MATH_HPP
