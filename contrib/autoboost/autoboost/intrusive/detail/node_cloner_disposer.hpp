...
#ifndef AUTOBOOST_INTRUSIVE_DETAIL_NODE_CLONER_DISPOSER_HPP
#define AUTOBOOST_INTRUSIVE_DETAIL_NODE_CLONER_DISPOSER_HPP
   ...
   :  private ebo_functor_holder<F>
{
   ...
   node_ptr operator()(const node_ptr & p)
   {
      ...
      if(safemode_or_autounlink)
         AUTOBOOST_INTRUSIVE_SAFE_HOOK_DEFAULT_ASSERT(node_algorithms::unique(n));
      return n;
   }
...
#endif //AUTOBOOST_INTRUSIVE_DETAIL_NODE_CLONER_DISPOSER_HPP
