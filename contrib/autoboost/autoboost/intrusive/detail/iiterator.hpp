...
#ifndef AUTOBOOST_INTRUSIVE_DETAIL_IITERATOR_HPP
#define AUTOBOOST_INTRUSIVE_DETAIL_IITERATOR_HPP
...
#include <autoboost/intrusive/detail/std_fwd.hpp>
...
struct iiterator
{
   ...
   typedef ::autoboost::intrusive::pointer_traits<node_ptr>        nodepointer_traits_t;
...
{	// increment iterator by offset, arbitrary iterators
   autoboost::intrusive::detail::advance_impl(it, n, autoboost::intrusive::iterator_traits<InputIt>::iterator_category());
}
...
typename iterator_traits<InputIt>::difference_type iterator_distance(InputIt first, InputIt last)
{
   ...
   autoboost::intrusive::detail::distance_impl(first, last, off, autoboost::intrusive::iterator_traits<InputIt>::iterator_category());
   return off;
}
...
#endif //AUTOBOOST_INTRUSIVE_DETAIL_IITERATOR_HPP
