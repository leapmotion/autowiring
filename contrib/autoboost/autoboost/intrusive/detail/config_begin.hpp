...
#include <autoboost/config.hpp>
   ...
   #pragma warning (disable : 4541) //'typeid' used on polymorphic type 'autoboost::exception' with /GR-
   #pragma warning (disable : 4512) //'typeid' used on polymorphic type 'autoboost::exception' with /GR-
#endif

//#define AUTOBOOST_INTRUSIVE_USE_ITERATOR_FACADE
