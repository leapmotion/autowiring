...
//
/////////////////////////////////////////////////////////////////////////////
#ifndef AUTOBOOST_INTRUSIVE_RBTREE_HPP
#define AUTOBOOST_INTRUSIVE_RBTREE_HPP
...
#include <autoboost/intrusive/set_hook.hpp>
#include <autoboost/intrusive/detail/rbtree_node.hpp>
...
#include <autoboost/intrusive/rbtree_algorithms.hpp>
   ...
   /// @endcond
{
   ...
   //noncopyable
   AUTOBOOST_MOVABLE_BUT_NOT_COPYABLE(rbtree_impl)
   ...
   rbtree_impl(AUTOBOOST_RV_REF(rbtree_impl) x)
      :  tree_type(::autoboost::move(static_cast<tree_type&>(x)))
   {}

   //! @copydoc ::autoboost::intrusive::bstree::operator=(bstree &&)
   rbtree_impl& operator=(AUTOBOOST_RV_REF(rbtree_impl) x)
   {  return static_cast<rbtree_impl&>(tree_type::operator=(::autoboost::move(static_cast<tree_type&>(x)))); }
      ...
      >::type
{
   typedef typename make_rbtree
      ...
      #endif
      >::type   Base;
   AUTOBOOST_MOVABLE_BUT_NOT_COPYABLE(rbtree)
   ...
   rbtree(AUTOBOOST_RV_REF(rbtree) x)
      :  Base(::autoboost::move(static_cast<Base&>(x)))
   {}

   rbtree& operator=(AUTOBOOST_RV_REF(rbtree) x)
   {  return static_cast<rbtree &>(this->Base::operator=(::autoboost::move(static_cast<Base&>(x))));  }
...
#endif //AUTOBOOST_INTRUSIVE_RBTREE_HPP
