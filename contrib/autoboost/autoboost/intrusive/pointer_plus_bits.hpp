...
#ifndef AUTOBOOST_INTRUSIVE_POINTER_PLUS_BITS_HPP
#define AUTOBOOST_INTRUSIVE_POINTER_PLUS_BITS_HPP
...
#include <autoboost/intrusive/detail/mpl.hpp> //ls_zeros
#include <autoboost/intrusive/detail/assert.hpp> //AUTOBOOST_INTRUSIVE_INVARIANT_ASSERT
...
struct pointer_plus_bits<T*, NumBits>
{
   ...
   {
      AUTOBOOST_INTRUSIVE_INVARIANT_ASSERT(0 == (std::size_t(p) & Mask));
   ...
   {
      AUTOBOOST_INTRUSIVE_INVARIANT_ASSERT(c <= Mask);
...
#endif //AUTOBOOST_INTRUSIVE_POINTER_PLUS_BITS_HPP
