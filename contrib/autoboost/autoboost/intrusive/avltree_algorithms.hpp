...
#define AUTOBOOST_INTRUSIVE_AVLTREE_ALGORITHMS_HPP
      ...
      for ( node_ptr root = NodeTraits::get_parent(header)
         ...
         if(x_parent_balance == NodeTraits::zero()){
            ...
            if (x == x_parent_left) {  ////x is left child or x and sibling are null
               ...
               AUTOBOOST_INTRUSIVE_INVARIANT_ASSERT(x_parent_left);
               if (NodeTraits::get_balance(x_parent_left) == NodeTraits::positive()) {
                  // x_parent_left MUST have a right child
                  AUTOBOOST_INTRUSIVE_INVARIANT_ASSERT(NodeTraits::get_right(x_parent_left));
            ...
            if (x == x_parent_right) { //x is right child or x and sibling are null
               ...
               AUTOBOOST_INTRUSIVE_INVARIANT_ASSERT(x_parent_right);
               if (NodeTraits::get_balance(x_parent_right) == NodeTraits::negative()) {
                  // x_parent_right MUST have then a left child
                  AUTOBOOST_INTRUSIVE_INVARIANT_ASSERT(NodeTraits::get_left(x_parent_right));
            ...
            AUTOBOOST_INTRUSIVE_INVARIANT_ASSERT(false);  // never reached
         }
      }
   }
...
#endif //AUTOBOOST_INTRUSIVE_AVLTREE_ALGORITHMS_HPP
