...
#ifndef AUTOBOOST_INTRUSIVE_PACK_OPTIONS_HPP
#define AUTOBOOST_INTRUSIVE_PACK_OPTIONS_HPP
...
#endif   //!defined(AUTOBOOST_INTRUSIVE_VARIADIC_TEMPLATES)

#define AUTOBOOST_INTRUSIVE_OPTION_TYPE(OPTION_NAME, TYPE, TYPEDEF_EXPR, TYPEDEF_NAME) \
template< class TYPE> \
struct OPTION_NAME \
{ \
   template<class Base> \
...
#define AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(OPTION_NAME, TYPE, VALUE, CONSTANT_NAME) \
template< TYPE VALUE> \
struct OPTION_NAME \
{ \
   template<class Base> \
...
#else    //#ifndef AUTOBOOST_INTRUSIVE_DOXYGEN_INVOKED

//! This class is a utility that takes:
//!   - a default options class defining initial static constant
//!   and typedefs
//!   - several options defined with AUTOBOOST_INTRUSIVE_OPTION_CONSTANT and
...
//!
//! \code
//!   AUTOBOOST_INTRUSIVE_OPTION_TYPE(my_pointer, VoidPointer, VoidPointer, my_pointer_type)
//!   AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(incremental, bool, Enabled, is_incremental)
//! \endcode
//!
...
//! <code>autoboost::intrusive::pack_options</code>,
...
//!   //    struct my_pointer
//!   //    { unspecified_content };
//!   AUTOBOOST_INTRUSIVE_OPTION_TYPE(my_pointer, VoidPointer, autoboost::remove_pointer<VoidPointer>::type, my_pointer_type)
//!
//!   struct empty_default{};
//!
//!   typedef pack_options< empty_default, typename my_pointer<void*> >::type::my_pointer_type type;
//!
//!   AUTOBOOST_STATIC_ASSERT(( autoboost::is_same<type, void>::value ));
//!
//! \endcode
#define AUTOBOOST_INTRUSIVE_OPTION_TYPE(OPTION_NAME, TYPE, TYPEDEF_EXPR, TYPEDEF_NAME)
...
//!
//!   AUTOBOOST_STATIC_ASSERT(( is_incremental == true ));
//!
//! \endcode
#define AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(OPTION_NAME, TYPE, VALUE, CONSTANT_NAME)
...
#endif   //#ifndef AUTOBOOST_INTRUSIVE_PACK_OPTIONS_HPP
