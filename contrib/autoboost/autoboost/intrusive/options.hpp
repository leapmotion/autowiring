...
#ifndef AUTOBOOST_INTRUSIVE_OPTIONS_HPP
#define AUTOBOOST_INTRUSIVE_OPTIONS_HPP
...
AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(constant_time_size, bool, Enabled, constant_time_size)

//!This option setter specifies a container header holder type
AUTOBOOST_INTRUSIVE_OPTION_TYPE(header_holder_type, HeaderHolder, HeaderHolder, header_holder_type)

//!This option setter specifies the type that
//!the container will use to store its size.
AUTOBOOST_INTRUSIVE_OPTION_TYPE(size_type, SizeType, SizeType, size_type)

//!This option setter specifies the strict weak ordering
//!comparison functor for the value type
AUTOBOOST_INTRUSIVE_OPTION_TYPE(compare, Compare, Compare, compare)
...
AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(floating_point, bool, Enabled, floating_point)

//!This option setter specifies the equality
//!functor for the value type
AUTOBOOST_INTRUSIVE_OPTION_TYPE(equal, Equal, Equal, equal)

//!This option setter specifies the equality
//!functor for the value type
AUTOBOOST_INTRUSIVE_OPTION_TYPE(priority, Priority, Priority, priority)

//!This option setter specifies the hash
//!functor for the value type
AUTOBOOST_INTRUSIVE_OPTION_TYPE(hash, Hash, Hash, hash)
...
AUTOBOOST_INTRUSIVE_OPTION_TYPE(value_traits, ValueTraits, ValueTraits, proto_value_traits)

//#define AUTOBOOST_INTRUSIVE_COMMA ,
//#define AUTOBOOST_INTRUSIVE_LESS <
//#define AUTOBOOST_INTRUSIVE_MORE >
//AUTOBOOST_INTRUSIVE_OPTION_TYPE (member_hook, Parent AUTOBOOST_INTRUSIVE_COMMA class MemberHook AUTOBOOST_INTRUSIVE_COMMA MemberHook Parent::* PtrToMember , mhtraits AUTOBOOST_INTRUSIVE_LESS Parent AUTOBOOST_INTRUSIVE_COMMA MemberHook AUTOBOOST_INTRUSIVE_COMMA PtrToMember AUTOBOOST_INTRUSIVE_MORE , proto_value_traits)
...
//};
//
//#undef AUTOBOOST_INTRUSIVE_COMMA
//#undef AUTOBOOST_INTRUSIVE_LESS
//#undef AUTOBOOST_INTRUSIVE_MORE
...
AUTOBOOST_INTRUSIVE_OPTION_TYPE(function_hook, Functor, fhtraits<Functor>, proto_value_traits)

//!This option setter specifies that the container
//!must use the specified base hook
AUTOBOOST_INTRUSIVE_OPTION_TYPE(base_hook, BaseHook, BaseHook, proto_value_traits)

//!This option setter specifies the type of
//!a void pointer. This will instruct the hook
//!to use this type of pointer instead of the
//!default one
AUTOBOOST_INTRUSIVE_OPTION_TYPE(void_pointer, VoidPointer, VoidPointer, void_pointer)

//!This option setter specifies the type of
//!the tag of a base hook. A type cannot have two
//!base hooks of the same type, so a tag can be used
//!to differentiate two base hooks with otherwise same type
AUTOBOOST_INTRUSIVE_OPTION_TYPE(tag, Tag, Tag, tag)

//!This option setter specifies the link mode
//!(normal_link, safe_link or auto_unlink)
AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(link_mode, link_mode_type, LinkType, link_mode)
...
AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(linear, bool, Enabled, linear)
...
AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(cache_last, bool, Enabled, cache_last)
...
AUTOBOOST_INTRUSIVE_OPTION_TYPE(bucket_traits, BucketTraits, BucketTraits, bucket_traits)
...
AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(store_hash, bool, Enabled, store_hash)
...
//!with the same key.
AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(optimize_multikey, bool, Enabled, optimize_multikey)
...
AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(power_2_buckets, bool, Enabled, power_2_buckets)
...
AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(cache_begin, bool, Enabled, cache_begin)
...
//!stored hash values.
AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(compare_hash, bool, Enabled, compare_hash)
...
AUTOBOOST_INTRUSIVE_OPTION_CONSTANT(incremental, bool, Enabled, incremental)
...
#endif   //#ifndef AUTOBOOST_INTRUSIVE_OPTIONS_HPP
