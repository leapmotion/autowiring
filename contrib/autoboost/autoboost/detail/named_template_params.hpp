...
#ifndef AUTOBOOST_DETAIL_NAMED_TEMPLATE_PARAMS_HPP
#define AUTOBOOST_DETAIL_NAMED_TEMPLATE_PARAMS_HPP

#include <autoboost/type_traits/conversion_traits.hpp>
#include <autoboost/type_traits/composite_traits.hpp> // for is_reference
...
#define AUTOBOOST_NAMED_TEMPLATE_PARAM(TYPE) \
...
#endif // AUTOBOOST_DETAIL_NAMED_TEMPLATE_PARAMS_HPP
