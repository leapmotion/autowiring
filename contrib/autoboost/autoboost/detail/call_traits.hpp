...
#ifndef AUTOBOOST_DETAIL_CALL_TRAITS_HPP
#define AUTOBOOST_DETAIL_CALL_TRAITS_HPP
...
public:
   ...
   typedef typename autoboost::detail::ct_imp<
      T,
...
#endif // AUTOBOOST_DETAIL_CALL_TRAITS_HPP
