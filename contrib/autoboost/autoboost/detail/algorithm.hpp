...
#ifndef AUTOBOOST_ALGORITHM_HPP
# define AUTOBOOST_ALGORITHM_HPP
...
namespace autoboost {
  ...
  {
    return any_if(autoboost::begin(c), autoboost::end(c), p);
  }
  ...
  {
    return container_contains(autoboost::begin(c), autoboost::end(c), value);
  }

} // namespace autoboost

#endif // AUTOBOOST_ALGORITHM_HPP
