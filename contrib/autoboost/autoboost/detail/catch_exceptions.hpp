...
#include <autoboost/cstdlib.hpp>  // for exit codes
...
# ifndef AUTOBOOST_BUILT_IN_EXCEPTIONS_MISSING_WHAT
...
# endif
    ...
    if ( exception_thrown ) result = autoboost::exit_exception_failure;
...
#if !defined(AUTOBOOST_NO_CPP_MAIN_SUCCESS_MESSAGE)
