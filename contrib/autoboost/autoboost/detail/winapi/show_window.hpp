...
#ifndef AUTOBOOST_DETAIL_WINAPI_SHOW_WINDOW_HPP_
#define AUTOBOOST_DETAIL_WINAPI_SHOW_WINDOW_HPP_
...
extern "C" {
AUTOBOOST_DETAIL_WINAPI_DECLARE_HANDLE(HWND);

AUTOBOOST_SYMBOL_IMPORT autoboost::detail::winapi::BOOL_ WINAPI ShowWindow(
        HWND hWnd,
        int nCmdShow);

AUTOBOOST_SYMBOL_IMPORT autoboost::detail::winapi::BOOL_ WINAPI ShowWindowAsync(
        HWND hWnd,
        int nCmdShow);
}
#endif // AUTOBOOST_USE_WINDOWS_H
...
#if defined( AUTOBOOST_USE_WINDOWS_H ) && !defined( NOSHOWWINDOW )
...
#endif // AUTOBOOST_DETAIL_WINAPI_SHOW_WINDOW_HPP_
