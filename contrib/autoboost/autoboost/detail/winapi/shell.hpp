...
#ifndef AUTOBOOST_DETAIL_WINAPI_SHELL_HPP_
#define AUTOBOOST_DETAIL_WINAPI_SHELL_HPP_
...
AUTOBOOST_DETAIL_WINAPI_DECLARE_HANDLE(HICON);
...
#if !defined( AUTOBOOST_NO_ANSI_APIS )
AUTOBOOST_SYMBOL_IMPORT autoboost::detail::winapi::DWORD_PTR_ WINAPI SHGetFileInfoA(
    autoboost::detail::winapi::LPCSTR_ pszPath,
    autoboost::detail::winapi::DWORD_ dwFileAttributes,
    ::_SHFILEINFOA *psfinsigned,
    autoboost::detail::winapi::UINT_ cbFileInfons,
    autoboost::detail::winapi::UINT_ uFlags);
#endif

AUTOBOOST_SYMBOL_IMPORT autoboost::detail::winapi::DWORD_PTR_ WINAPI SHGetFileInfoW(
    autoboost::detail::winapi::LPCWSTR_ pszPath,
    autoboost::detail::winapi::DWORD_ dwFileAttributes,
...
typedef struct AUTOBOOST_DETAIL_WINAPI_MAY_ALIAS _SHFILEINFOA {
    HICON_ hIcon;
    int iIcon;
    DWORD_ dwAttributes;
...
typedef struct AUTOBOOST_DETAIL_WINAPI_MAY_ALIAS _SHFILEINFOW {
    HICON_ hIcon;
    int iIcon;
    DWORD_ dwAttributes;
...
AUTOBOOST_FORCEINLINE DWORD_PTR_ SHGetFileInfoA(LPCSTR_ pszPath, DWORD_ dwFileAttributes, SHFILEINFOA_* psfinsigned, UINT_ cbFileInfons, UINT_ uFlags)
{
    return ::SHGetFileInfoA(pszPath, dwFileAttributes, reinterpret_cast< ::_SHFILEINFOA* >(psfinsigned), cbFileInfons, uFlags);
}

AUTOBOOST_FORCEINLINE DWORD_PTR_ sh_get_file_info(LPCSTR_ pszPath, DWORD_ dwFileAttributes, SHFILEINFOA_* psfinsigned, UINT_ cbFileInfons, UINT_ uFlags)
{
    return ::SHGetFileInfoA(pszPath, dwFileAttributes, reinterpret_cast< ::_SHFILEINFOA* >(psfinsigned), cbFileInfons, uFlags);
}
...
AUTOBOOST_FORCEINLINE DWORD_PTR_ SHGetFileInfoW(LPCWSTR_ pszPath, DWORD_ dwFileAttributes, SHFILEINFOW_* psfinsigned, UINT_ cbFileInfons, UINT_ uFlags)
{
    return ::SHGetFileInfoW(pszPath, dwFileAttributes, reinterpret_cast< ::_SHFILEINFOW* >(psfinsigned), cbFileInfons, uFlags);
}

AUTOBOOST_FORCEINLINE DWORD_PTR_ sh_get_file_info(LPCWSTR_ pszPath, DWORD_ dwFileAttributes, SHFILEINFOW_* psfinsigned, UINT_ cbFileInfons, UINT_ uFlags)
{
    return ::SHGetFileInfoW(pszPath, dwFileAttributes, reinterpret_cast< ::_SHFILEINFOW* >(psfinsigned), cbFileInfons, uFlags);
}
...
#endif // AUTOBOOST_DETAIL_WINAPI_SHELL_HPP_
