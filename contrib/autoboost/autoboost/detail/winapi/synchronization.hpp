...
#ifndef AUTOBOOST_DETAIL_WINAPI_SYNCHRONIZATION_HPP
#define AUTOBOOST_DETAIL_WINAPI_SYNCHRONIZATION_HPP
...
extern "C" {
    ...
    * PCONDITION_VARIABLE_;
    #define AUTOBOOST_DETAIL_WINAPI_CONDITION_VARIABLE_INIT {0}
...
AUTOBOOST_FORCEINLINE HANDLE_ create_anonymous_mutex(_SECURITY_ATTRIBUTES* lpAttributes, BOOL_ bInitialOwner)
{
#ifdef AUTOBOOST_NO_ANSI_APIS
...
AUTOBOOST_FORCEINLINE HANDLE_ create_anonymous_semaphore(_SECURITY_ATTRIBUTES* lpAttributes, LONG_ lInitialCount, LONG_ lMaximumCount)
{
#ifdef AUTOBOOST_NO_ANSI_APIS
...
AUTOBOOST_FORCEINLINE HANDLE_ create_anonymous_event(_SECURITY_ATTRIBUTES* lpAttributes, BOOL_ bManualReset, BOOL_ bInitialState)
{
#ifdef AUTOBOOST_NO_ANSI_APIS
...
#endif // AUTOBOOST_DETAIL_WINAPI_SYNCHRONIZATION_HPP
