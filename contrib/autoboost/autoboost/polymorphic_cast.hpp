//  autoboost polymorphic_cast.hpp header file  ----------------------------------------------//
...
#ifndef AUTOBOOST_POLYMORPHIC_CAST_HPP
#define AUTOBOOST_POLYMORPHIC_CAST_HPP
...
//  polymorphic_cast  --------------------------------------------------------//
    ...
    inline Target polymorphic_cast(Source* x)
    {
        ...
        if ( tmp == 0 ) autoboost::throw_exception( std::bad_cast() );
        return tmp;
    }
...
//  polymorphic_downcast  ----------------------------------------------------//
    ...
    {
        AUTOBOOST_ASSERT( dynamic_cast<Target>(x) == x );  // detect logic error
        return static_cast<Target>(x);
    }

} // namespace autoboost

#endif  // AUTOBOOST_POLYMORPHIC_CAST_HPP
