...
#ifndef AUTOBOOST_CONCEPT_ARCHETYPES_HPP
#define AUTOBOOST_CONCEPT_ARCHETYPES_HPP
...
#define AUTOBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(OP, NAME)                       \
  ...
  AUTOBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(==, equal_op)
  AUTOBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(!=, not_equal_op)
  AUTOBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(<, less_than_op)
  AUTOBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(<=, less_equal_op)
  AUTOBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(>, greater_than_op)
  AUTOBOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(>=, greater_equal_op)

#define AUTOBOOST_DEFINE_OPERATOR_ARCHETYPE(OP, NAME) \
  template <class Base = null_archetype<> > \
  ...
  AUTOBOOST_DEFINE_OPERATOR_ARCHETYPE(+, addable)
  AUTOBOOST_DEFINE_OPERATOR_ARCHETYPE(-, subtractable)
  AUTOBOOST_DEFINE_OPERATOR_ARCHETYPE(*, multipliable)
  AUTOBOOST_DEFINE_OPERATOR_ARCHETYPE(/, dividable)
  AUTOBOOST_DEFINE_OPERATOR_ARCHETYPE(%, modable)

  // As is, these are useless because of the return type.
  // Need to invent a better way...
#define AUTOBOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(OP, NAME) \
  ...
  AUTOBOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(+, plus_op)
  AUTOBOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(*, time_op)
  AUTOBOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(/, divide_op)
  AUTOBOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(-, subtract_op)
  AUTOBOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(%, mod_op)
...
#endif // AUTOBOOST_CONCEPT_ARCHETYPES_H
