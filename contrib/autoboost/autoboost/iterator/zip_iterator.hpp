...
#ifndef AUTOBOOST_ZIP_ITERATOR_TMB_07_13_2003_HPP_
# define AUTOBOOST_ZIP_ITERATOR_TMB_07_13_2003_HPP_
...
#include <autoboost/iterator/iterator_adaptor.hpp> // for enable_if_convertible
#include <autoboost/iterator/iterator_categories.hpp>

#include <autoboost/iterator/minimum_category.hpp>

#include <utility> // for std::pair
#include <autoboost/fusion/adapted/autoboost_tuple.hpp> // for backward compatibility
...
#include <autoboost/fusion/algorithm/iteration/for_each.hpp>
#include <autoboost/fusion/algorithm/transformation/transform.hpp>
#include <autoboost/fusion/sequence/convert.hpp>
#include <autoboost/fusion/sequence/intrinsic/at_c.hpp>
#include <autoboost/fusion/sequence/comparison/equal_to.hpp>
...
namespace iterators {
  ...
  private:
    ...
    void advance(typename super_t::difference_type n)
    {
        fusion::for_each(
          m_iterator_tuple,
          detail::advance_iterator<AUTOBOOST_DEDUCED_TYPENAME super_t::difference_type>(n));
    }
