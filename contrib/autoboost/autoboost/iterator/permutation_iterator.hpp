...
#ifndef AUTOBOOST_PERMUTATION_ITERATOR_HPP
#define AUTOBOOST_PERMUTATION_ITERATOR_HPP
...
class permutation_iterator
  : public iterator_adaptor<
           ...
           , IndexIterator, typename autoboost::detail::iterator_traits<ElementIterator>::value_type
           , use_default, typename autoboost::detail::iterator_traits<ElementIterator>::reference>
{
  typedef iterator_adaptor<
            permutation_iterator<ElementIterator, IndexIterator>
          , IndexIterator, typename autoboost::detail::iterator_traits<ElementIterator>::value_type
          , use_default, typename autoboost::detail::iterator_traits<ElementIterator>::reference> super_t;
