...
#ifndef AUTOBOOST_TRANSFORM_ITERATOR_23022003THW_HPP
#define AUTOBOOST_TRANSFORM_ITERATOR_23022003THW_HPP
...
#if AUTOBOOST_WORKAROUND(AUTOBOOST_MSVC, AUTOBOOST_TESTED_AT(1310))
...
namespace iterators {
  ...
  template <class UnaryFunc, class Iterator, class Reference, class Value>
  class transform_iterator
    : public autoboost::iterators::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
  {
    typedef typename
    autoboost::iterators::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
    super_t;
...
#if !AUTOBOOST_WORKAROUND(__MWERKS__, AUTOBOOST_TESTED_AT(0x3003))
        // don't provide this constructor if UnaryFunc is a
        // function pointer type, since it will be 0.  Too dangerous.
        AUTOBOOST_STATIC_ASSERT(is_class<UnaryFunc>::value);
#endif
    }
...
#endif // AUTOBOOST_TRANSFORM_ITERATOR_23022003THW_HPP
