...
#ifndef AUTOBOOST_ITERATOR_ARCHETYPES_HPP
#define AUTOBOOST_ITERATOR_ARCHETYPES_HPP
...
>
{
    ...
    struct archetype
    {
        AUTOBOOST_STATIC_ASSERT(!is_const<Value>::value);
...
struct iterator_archetype
  : public detail::iterator_archetype_base<Value, AccessCategory, TraversalCategory>
    ...
    // iterator operations
# if AUTOBOOST_WORKAROUND(AUTOBOOST_DINKUMWARE_STDLIB, < 310)           \
    || AUTOBOOST_WORKAROUND(_RWSTD_VER, AUTOBOOST_TESTED_AT(0x20101))
...
#endif // AUTOBOOST_ITERATOR_ARCHETYPES_HPP
