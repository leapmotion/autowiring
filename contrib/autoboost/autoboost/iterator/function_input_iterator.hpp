...
#ifndef AUTOBOOST_FUNCTION_INPUT_ITERATOR
#define AUTOBOOST_FUNCTION_INPUT_ITERATOR

#include <autoboost/config.hpp>
#include <autoboost/assert.hpp>
#include <autoboost/mpl/if.hpp>
#include <autoboost/function_types/is_function_pointer.hpp>
#include <autoboost/function_types/is_function_reference.hpp>
#include <autoboost/function_types/result_type.hpp>
...
namespace iterators {
    ...
    namespace impl {
        ...
        class function_input_iterator
            ...
            AUTOBOOST_DEDUCED_TYPENAME result_of<Function ()>::type,
            single_pass_traversal_tag,
            AUTOBOOST_DEDUCED_TYPENAME result_of<Function ()>::type const &
            >
        {
        public:
        ...
        private:
            Function * f;
            Input state;
            mutable optional<AUTOBOOST_DEDUCED_TYPENAME result_of<Function ()>::type> value;
        };
