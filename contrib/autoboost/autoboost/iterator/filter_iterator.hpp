...
#ifndef AUTOBOOST_FILTER_ITERATOR_23022003THW_HPP
#define AUTOBOOST_FILTER_ITERATOR_23022003THW_HPP
   ...
   public:
        ...
        : super_t(x), m_predicate(), m_end(end_)
      {
        ...
        // body of this function.
          ...
          AUTOBOOST_STATIC_ASSERT(is_class<Predicate>::value);
#endif
          satisfy_predicate();
      }
...
#endif // AUTOBOOST_FILTER_ITERATOR_23022003THW_HPP
