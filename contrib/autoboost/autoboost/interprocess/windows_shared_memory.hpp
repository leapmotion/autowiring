...
#ifndef AUTOBOOST_INTERPROCESS_WINDOWS_SHARED_MEMORY_HPP
#define AUTOBOOST_INTERPROCESS_WINDOWS_SHARED_MEMORY_HPP
...
class windows_shared_memory
{
   ...
   AUTOBOOST_MOVABLE_BUT_NOT_COPYABLE(windows_shared_memory)
   ...
   //!Does not throw
   windows_shared_memory(AUTOBOOST_RV_REF(windows_shared_memory) moved)
      : m_handle(0)
   {  this->swap(moved);   }
   ...
   //!Does not throw
   windows_shared_memory &operator=(AUTOBOOST_RV_REF(windows_shared_memory) moved)
   {
      windows_shared_memory tmp(autoboost::move(moved));
      this->swap(tmp);
      return *this;
   }
...
#endif   //AUTOBOOST_INTERPROCESS_WINDOWS_SHARED_MEMORY_HPP
