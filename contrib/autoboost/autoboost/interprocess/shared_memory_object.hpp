...
#  if defined(AUTOBOOST_INTERPROCESS_RUNTIME_FILESYSTEM_BASED_POSIX_SHARED_MEMORY)
...
class shared_memory_object
{
   ...
   AUTOBOOST_MOVABLE_BUT_NOT_COPYABLE(shared_memory_object)
   ...
   //!Does not throw
   shared_memory_object(AUTOBOOST_RV_REF(shared_memory_object) moved)
   ...
   //!Does not throw
   shared_memory_object &operator=(AUTOBOOST_RV_REF(shared_memory_object) moved)
   {
      shared_memory_object tmp(autoboost::move(moved));
      this->swap(tmp);
      return *this;
   }
...
#else //!defined(AUTOBOOST_INTERPROCESS_POSIX_SHARED_MEMORY_OBJECTS)

namespace shared_memory_object_detail {

#ifdef AUTOBOOST_INTERPROCESS_RUNTIME_FILESYSTEM_BASED_POSIX_SHARED_MEMORY
...
#else
#error "Not supported platform for AUTOBOOST_INTERPROCESS_RUNTIME_FILESYSTEM_BASED_POSIX_SHARED_MEMORY"
#endif
...
{
   #if defined(AUTOBOOST_INTERPROCESS_FILESYSTEM_BASED_POSIX_SHARED_MEMORY)
   const bool add_leading_slash = false;
   #elif defined(AUTOBOOST_INTERPROCESS_RUNTIME_FILESYSTEM_BASED_POSIX_SHARED_MEMORY)
...
#endif   //AUTOBOOST_INTERPROCESS_SHARED_MEMORY_OBJECT_HPP
