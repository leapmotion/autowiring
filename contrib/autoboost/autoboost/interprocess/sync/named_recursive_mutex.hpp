...
#ifndef AUTOBOOST_INTERPROCESS_NAMED_RECURSIVE_MUTEX_HPP
#define AUTOBOOST_INTERPROCESS_NAMED_RECURSIVE_MUTEX_HPP
...
#include <autoboost/interprocess/permissions.hpp>
   ...
   #include <autoboost/interprocess/sync/windows/named_recursive_mutex.hpp>
   #define AUTOBOOST_INTERPROCESS_USE_WINDOWS
#else
   #include <autoboost/interprocess/sync/shm/named_recursive_mutex.hpp>
#endif
...
inline bool named_recursive_mutex::timed_lock(const autoboost::posix_time::ptime &abs_time)
...
#endif   //AUTOBOOST_INTERPROCESS_NAMED_RECURSIVE_MUTEX_HPP
