...
#ifndef AUTOBOOST_INTERPROCESS_RECURSIVE_MUTEX_HPP
#define AUTOBOOST_INTERPROCESS_RECURSIVE_MUTEX_HPP
...
#include <autoboost/assert.hpp>
   ...
   (defined(AUTOBOOST_INTERPROCESS_POSIX_PROCESS_SHARED) && defined (AUTOBOOST_INTERPROCESS_POSIX_RECURSIVE_MUTEXES))
   #include <autoboost/interprocess/sync/posix/recursive_mutex.hpp>
...
//Experimental...
   ...
   #include <autoboost/interprocess/sync/windows/recursive_mutex.hpp>
...
inline bool interprocess_recursive_mutex::timed_lock(const autoboost::posix_time::ptime &abs_time)
...
#endif   //AUTOBOOST_INTERPROCESS_RECURSIVE_MUTEX_HPP
