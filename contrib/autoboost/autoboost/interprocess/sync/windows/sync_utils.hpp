...
#ifndef AUTOBOOST_INTERPROCESS_DETAIL_SYNC_UTILS_HPP
#define AUTOBOOST_INTERPROCESS_DETAIL_SYNC_UTILS_HPP
...
#include <autoboost/interprocess/detail/config_external_begin.hpp>
   #include <autoboost/unordered/unordered_map.hpp>
#include <autoboost/interprocess/detail/config_external_end.hpp>
...
class sync_id
{
   ...
   {  return autoboost::hash_value(m.rand_);  }
...
class sync_handles
{
   ...
   typedef autoboost::unordered_map<sync_id, void*> umap_type;
   typedef autoboost::container::map<const sync_id*, umap_type::iterator, address_less> map_type;
...
#endif   //AUTOBOOST_INTERPROCESS_DETAIL_SYNC_UTILS_HPP
