...
#ifndef AUTOBOOST_INTERPROCESS_DETAIL_WINAPI_WRAPPER_COMMON_HPP
#define AUTOBOOST_INTERPROCESS_DETAIL_WINAPI_WRAPPER_COMMON_HPP
...
inline bool winapi_wrapper_timed_wait_for_single_object(void *handle, const autoboost::posix_time::ptime &abs_time)
{
   ...
   const autoboost::posix_time::ptime cur_time = microsec_clock::universal_time();
