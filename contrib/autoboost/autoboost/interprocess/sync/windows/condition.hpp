...
#ifndef AUTOBOOST_INTERPROCESS_DETAIL_WINDOWS_CONDITION_HPP
#define AUTOBOOST_INTERPROCESS_DETAIL_WINDOWS_CONDITION_HPP
...
#include <autoboost/interprocess/sync/detail/condition_algorithm_8a.hpp>
...
class windows_condition
{
   ...
   {
      typedef autoboost::int32_t     integer_type;
      ...
      autoboost::int32_t    m_nwaiters_blocked;
      autoboost::int32_t    m_nwaiters_gone;
      autoboost::int32_t    m_nwaiters_to_unblock;
...
#endif   //AUTOBOOST_INTERPROCESS_DETAIL_WINDOWS_CONDITION_HPP
