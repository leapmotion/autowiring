...
#ifndef AUTOBOOST_INTERPROCESS_WINDOWS_NAMED_SYNC_HPP
#define AUTOBOOST_INTERPROCESS_WINDOWS_NAMED_SYNC_HPP
         ...
         if(winapi::lock_file_ex
            ...
            if(winapi::get_file_size(m_file_hnd, filesize)){
               ...
               if(static_cast<std::size_t>(filesize) != sizeof_file_info){
                  ...
                  AUTOBOOST_ASSERT(std::size_t(filesize) == sizeof_file_info);
               }
               else{
...
#endif   //AUTOBOOST_INTERPROCESS_WINDOWS_NAMED_SYNC_HPP
