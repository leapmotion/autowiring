...
#ifndef AUTOBOOST_INTERPROCESS_WINDOWS_NAMED_SEMAPHORE_HPP
#define AUTOBOOST_INTERPROCESS_WINDOWS_NAMED_SEMAPHORE_HPP
...
inline bool windows_named_semaphore::timed_wait(const autoboost::posix_time::ptime &abs_time)
{
...
#endif   //AUTOBOOST_INTERPROCESS_WINDOWS_NAMED_SEMAPHORE_HPP
