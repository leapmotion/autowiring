...
#ifndef AUTOBOOST_INTERPROCESS_DETAIL_WINDOWS_MUTEX_HPP
#define AUTOBOOST_INTERPROCESS_DETAIL_WINDOWS_MUTEX_HPP
...
inline bool windows_mutex::timed_lock(const autoboost::posix_time::ptime &abs_time)
{
   sync_handles &handles =
      windows_intermodule_singleton<sync_handles>::get();
   //This can throw
...
#endif   //AUTOBOOST_INTERPROCESS_DETAIL_WINDOWS_MUTEX_HPP
