...
//#define AUTOBOOST_INTERPROCESS_SPIN_WAIT_DEBUG
#ifdef AUTOBOOST_INTERPROCESS_SPIN_WAIT_DEBUG
#include <iostream>
#endif

// AUTOBOOST_INTERPROCESS_SMT_PAUSE
...
#define AUTOBOOST_INTERPROCESS_SMT_PAUSE _mm_pause();

#elif defined(__GNUC__) && ( defined(__i386__) || defined(__x86_64__) ) && !defined(_CRAYC)

#define AUTOBOOST_INTERPROCESS_SMT_PAUSE __asm__ __volatile__( "rep; nop" : : : "memory" );
...
class spin_wait
{
   ...
   void yield()
   {
      ...
      #if defined(AUTOBOOST_INTERPROCESS_SMT_PAUSE)
...
#endif // #ifndef AUTOBOOST_INTERPROCESS_SYNC_WAIT_HPP_INCLUDED
