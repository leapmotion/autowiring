...
#ifndef AUTOBOOST_INTERPROCESS_NAMED_CONDITION_HPP
#define AUTOBOOST_INTERPROCESS_NAMED_CONDITION_HPP
...
#include <autoboost/interprocess/sync/detail/locks.hpp>
   ...
   #include <autoboost/interprocess/sync/windows/named_condition.hpp>
   #define AUTOBOOST_INTERPROCESS_USE_WINDOWS
#else
   #include <autoboost/interprocess/sync/shm/named_condition.hpp>
#endif
...
inline bool named_condition::timed_wait
   (L& lock, const autoboost::posix_time::ptime &abs_time)
{
   ipcdetail::internal_mutex_lock<L> internal_lock(lock);
...
template <typename L, typename Pr>
inline bool named_condition::timed_wait
   (L& lock, const autoboost::posix_time::ptime &abs_time, Pr pred)
{
   ipcdetail::internal_mutex_lock<L> internal_lock(lock);
...
#endif // AUTOBOOST_INTERPROCESS_NAMED_CONDITION_HPP
