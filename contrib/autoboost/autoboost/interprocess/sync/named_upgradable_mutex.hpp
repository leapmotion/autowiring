...
#ifndef AUTOBOOST_INTERPROCESS_named_upgradable_mutex_HPP
#define AUTOBOOST_INTERPROCESS_named_upgradable_mutex_HPP
...
#include <autoboost/interprocess/sync/interprocess_upgradable_mutex.hpp>
#include <autoboost/interprocess/detail/posix_time_types_wrk.hpp>
#include <autoboost/interprocess/sync/shm/named_creation_functor.hpp>
...
class named_upgradable_mutex
{
   ...
   //!Throws: interprocess_exception on error.
   bool timed_lock_sharable(const autoboost::posix_time::ptime &abs_time);
   ...
   //!Throws: interprocess_exception on error.
   bool timed_lock_upgradable(const autoboost::posix_time::ptime &abs_time);
   ...
   //!Returns: If acquires exclusive ownership, returns true. Otherwise returns false.
   //!Throws: An exception derived from interprocess_exception on error.
   bool timed_unlock_upgradable_and_lock(const autoboost::posix_time::ptime &abs_time);
...
#endif   //AUTOBOOST_INTERPROCESS_named_upgradable_mutex_HPP
