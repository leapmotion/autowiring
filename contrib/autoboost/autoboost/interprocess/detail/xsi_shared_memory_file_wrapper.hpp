...
#ifndef AUTOBOOST_INTERPROCESS_XSI_SHARED_MEMORY_FILE_WRAPPER_HPP
#define AUTOBOOST_INTERPROCESS_XSI_SHARED_MEMORY_FILE_WRAPPER_HPP
...
#include <autoboost/interprocess/xsi_shared_memory.hpp>
   ...
   : public xsi_shared_memory
{
   ...
   AUTOBOOST_MOVABLE_BUT_NOT_COPYABLE(xsi_shared_memory_file_wrapper)
   ...
   xsi_shared_memory_file_wrapper(AUTOBOOST_RV_REF(xsi_shared_memory_file_wrapper) moved)
   {  this->swap(moved);   }

   xsi_shared_memory_file_wrapper &operator=(AUTOBOOST_RV_REF(xsi_shared_memory_file_wrapper) moved)
   {
      xsi_shared_memory_file_wrapper tmp(autoboost::move(moved));
      this->swap(tmp);
      return *this;
   }
...
#endif   //AUTOBOOST_INTERPROCESS_XSI_SHARED_MEMORY_FILE_WRAPPER_HPP
