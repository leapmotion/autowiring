...
#ifndef AUTOBOOST_INTERPROCESS_DETAIL_TRANSFORM_ITERATORS_HPP
#define AUTOBOOST_INTERPROCESS_DETAIL_TRANSFORM_ITERATORS_HPP
...
{
   public:
   typedef typename ::autoboost::container::iterator_traits<Iterator>::iterator_category         iterator_category;
   typedef typename ipcdetail::remove_reference<typename UnaryFunction::result_type>::type   value_type;
   typedef typename ::autoboost::container::iterator_traits<Iterator>::difference_type           difference_type;
...
#endif   //#ifndef AUTOBOOST_INTERPROCESS_DETAIL_TRANSFORM_ITERATORS_HPP
