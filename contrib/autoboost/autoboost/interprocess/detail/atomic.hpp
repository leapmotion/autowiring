...
#ifndef AUTOBOOST_INTERPROCESS_DETAIL_ATOMIC_HPP
#define AUTOBOOST_INTERPROCESS_DETAIL_ATOMIC_HPP
...
//! Atomically increment an autoboost::uint32_t by 1
//! "mem": pointer to the object
//! Returns the old value pointed to by mem
inline autoboost::uint32_t atomic_inc32(volatile autoboost::uint32_t *mem);

//! Atomically read an autoboost::uint32_t from memory
inline autoboost::uint32_t atomic_read32(volatile autoboost::uint32_t *mem);

//! Atomically set an autoboost::uint32_t in memory
//! "mem": pointer to the object
//! "param": val value that the object will assume
inline void atomic_write32(volatile autoboost::uint32_t *mem, autoboost::uint32_t val);

//! Compare an autoboost::uint32_t's value with "cmp".
//! If they are the same swap the value with "with"
//! "mem": pointer to the value
//! "with": what to swap it with
//! "cmp": the value to compare it to
//! Returns the old value of *mem
inline autoboost::uint32_t atomic_cas32
   (volatile autoboost::uint32_t *mem, autoboost::uint32_t with, autoboost::uint32_t cmp);
...
#include <autoboost/interprocess/detail/win32_api.hpp>
   ...
   #define AUTOBOOST_INTERPROCESS_READ_WRITE_BARRIER _ReadWriteBarrier()
#elif defined(__GNUC__)
   #if (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__) > 40100
      #define AUTOBOOST_INTERPROCESS_READ_WRITE_BARRIER __sync_synchronize()
   #else
      #define AUTOBOOST_INTERPROCESS_READ_WRITE_BARRIER __asm__ __volatile__("" : : : "memory")
   #endif
#endif
...
//! Atomically decrement an autoboost::uint32_t by 1
//! "mem": pointer to the atomic value
//! Returns the old value pointed to by mem
inline autoboost::uint32_t atomic_dec32(volatile autoboost::uint32_t *mem)
...
inline autoboost::uint32_t atomic_read32(volatile autoboost::uint32_t *mem)
{
    const autoboost::uint32_t val = *mem;
...
//! Atomically add 'val' to an autoboost::uint32_t
//! "mem": pointer to the object
//! "val": amount to add
//! Returns the old value pointed to by mem
inline autoboost::uint32_t atomic_add32
   (volatile autoboost::uint32_t *mem, autoboost::uint32_t val)
{
   // int r = *pw;
   // *mem += val;
   // return r;
...
//! Returns the old value pointed to by mem
inline autoboost::uint32_t atomic_dec32(volatile autoboost::uint32_t *mem)
{  return atomic_add32(mem, (autoboost::uint32_t)-1);  }
...
//! "val": amount to add
//! Returns the old value pointed to by mem
inline autoboost::uint32_t atomic_add32(volatile autoboost::uint32_t *mem, autoboost::uint32_t val)
{
   autoboost::uint32_t prev, temp;
...
//! Returns the old value pointed to by mem
inline autoboost::uint32_t atomic_dec32(volatile autoboost::uint32_t *mem)
{  return atomic_add32(mem, autoboost::uint32_t(-1u));  }
...
//! Returns the old value pointed to by mem
inline autoboost::uint32_t atomic_dec32(volatile autoboost::uint32_t *mem)
{  return atomic_add_32_nv(reinterpret_cast<volatile ::uint32_t*>(mem), (autoboost::uint32_t)-1) + 1; }
...
inline autoboost::uint32_t atomic_dec32(volatile autoboost::uint32_t *mem)
{  autoboost::uint32_t old_val = __ATOMIC_DECREMENT_LONG(mem); __MB(); return old_val; }
...
inline autoboost::uint32_t atomic_read32(volatile autoboost::uint32_t *mem)
{  autoboost::uint32_t old_val = *mem; __MB(); return old_val;  }
...
//first define autoboost::uint32_t versions of __lwarx and __stwcx to avoid poluting
...
inline autoboost::uint32_t lwarxu(volatile autoboost::uint32_t *mem)
{
   return static_cast<autoboost::uint32_t>(__lwarx(reinterpret_cast<volatile int*>(mem)));
}
...
//!unsuccessful
inline bool stwcxu(volatile autoboost::uint32_t* mem, autoboost::uint32_t val)
{
...
{
   autoboost::uint32_t oldValue;
   autoboost::uint32_t valueToStore;
   do
   {
      oldValue = lwarxu(mem);
...
inline autoboost::uint32_t atomic_add32
   (volatile autoboost::uint32_t *mem, autoboost::uint32_t val)
{  return __sync_fetch_and_add(const_cast<autoboost::uint32_t *>(mem), val);   }
...
//! Atomically read an autoboost::uint32_t from memory
inline autoboost::uint32_t atomic_read32(volatile autoboost::uint32_t *mem)
{  autoboost::uint32_t old_val = *mem; __sync_synchronize(); return old_val;  }
...
inline autoboost::uint32_t atomic_cas32
   (volatile autoboost::uint32_t *mem, autoboost::uint32_t with, autoboost::uint32_t cmp)
{  return __sync_val_compare_and_swap(const_cast<autoboost::uint32_t *>(mem), cmp, with);   }
...
inline bool atomic_add_unless32
   (volatile autoboost::uint32_t *mem, autoboost::uint32_t value, autoboost::uint32_t unless_this)
{
   autoboost::uint32_t old, c(atomic_read32(mem));
...
#endif   //AUTOBOOST_INTERPROCESS_DETAIL_ATOMIC_HPP
