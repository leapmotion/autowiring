...
#ifndef AUTOBOOST_INTERPROCESS_SEGMENT_MANAGER_BASE_HPP
#define AUTOBOOST_INTERPROCESS_SEGMENT_MANAGER_BASE_HPP
...
// container/detail
#include <autoboost/container/detail/type_traits.hpp> //alignment_of
...
struct block_header
{
   ...
   size_type total_size_with_header() const
   {
      return get_rounded_size
            ...
            , size_type(::autoboost::container::container_detail::alignment_of<block_header<size_type> >::value))
           + total_size();
   }
   ...
   {  return block_header_from_value(value, sizeof(T), ::autoboost::container::container_detail::alignment_of<T>::value);  }
   ...
   static block_header<size_type> *block_header_from_value(const void *value, std::size_t sz, std::size_t algn)
   {
      ...
      (void)sz;
      //Some sanity checks
      AUTOBOOST_ASSERT(hdr->m_value_alignment == algn);
      AUTOBOOST_ASSERT(hdr->m_value_bytes % sz == 0);
      return hdr;
   }
   ...
   :  public Hook
{
   ...
   enum  {  BlockHdrAlignment = ::autoboost::container::container_detail::alignment_of<block_header<size_type> >::value  };
...
struct index_key
{
   ...
   typedef CharT                                         char_type;
   typedef typename autoboost::intrusive::pointer_traits<const_char_ptr_t>::difference_type difference_type;
...
#endif //#ifndef AUTOBOOST_INTERPROCESS_SEGMENT_MANAGER_BASE_HPP
