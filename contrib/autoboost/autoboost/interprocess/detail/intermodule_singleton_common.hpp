...
class intermodule_singleton_common
{
   ...
   static const ::autoboost::uint32_t Uninitialized       = 0u;
   static const ::autoboost::uint32_t Initializing        = 1u;
   static const ::autoboost::uint32_t Initialized         = 2u;
   static const ::autoboost::uint32_t Broken              = 3u;
   static const ::autoboost::uint32_t Destroyed           = 4u;
   ...
   static void initialize_singleton_logic
      (void *&ptr, volatile autoboost::uint32_t &this_module_singleton_initialized, singleton_constructor_t constructor, bool phoenix)
   {
      ...
      if(atomic_read32(&this_module_singleton_initialized) != Initialized){
         ...
         ::autoboost::uint32_t previous_module_singleton_initialized = atomic_cas32
         ...
         //trying to initialize the singleton.
            ...
            throw interprocess_exception("autoboost::interprocess::intermodule_singleton initialization failed");
         }
      }
      AUTOBOOST_ASSERT(ptr != 0);
   }

   static void finalize_singleton_logic(void *&ptr, volatile autoboost::uint32_t &this_module_singleton_initialized, singleton_destructor_t destructor)
   {
   ...
   static void initialize_global_map_handle()
   {
      ...
      while(1){
         ...
         ::autoboost::uint32_t tmp = atomic_cas32(&this_module_map_initialized, Initializing, Uninitialized);
   ...
   static volatile autoboost::uint32_t this_module_singleton_count;
   ...
   static volatile autoboost::uint32_t this_module_map_initialized;

   //Raw memory to construct the global map manager
   static union mem_holder_t
   {
      unsigned char map_mem [sizeof(ThreadSafeGlobalMap)];
      ::autoboost::container::container_detail::max_align_t aligner;
   } mem_holder;
};

template<class ThreadSafeGlobalMap>
volatile autoboost::uint32_t intermodule_singleton_common<ThreadSafeGlobalMap>::this_module_singleton_count;

template<class ThreadSafeGlobalMap>
volatile autoboost::uint32_t intermodule_singleton_common<ThreadSafeGlobalMap>::this_module_map_initialized;
...
class intermodule_singleton_impl
{
   ...
   //singleton.
   static volatile autoboost::uint32_t   this_module_singleton_initialized;
   ...
   struct fini_atomic_func
   {
      ...
      void operator()()
      {
         ...
         AUTOBOOST_ASSERT(rcount);
         AUTOBOOST_ASSERT(rcount->singleton_ref_count > 0);
         //Check if last reference
         if(atomic_dec32(&rcount->singleton_ref_count) == 1){
            //If last, destroy the object
            AUTOBOOST_ASSERT(rcount->ptr != 0);
            ...
            bool destroyed = intermodule_singleton_helpers::thread_safe_global_map_dependant
                        <ThreadSafeGlobalMap>::erase(m_map, typeid(C).name());
            (void)destroyed;  AUTOBOOST_ASSERT(destroyed == true);
            delete pc;
         }
      }
...
template <typename C, bool L, bool P, class ThreadSafeGlobalMap>
volatile autoboost::uint32_t intermodule_singleton_impl<C, L, P, ThreadSafeGlobalMap>::this_module_singleton_initialized = 0;
...
#endif   //#ifndef AUTOBOOST_INTERPROCESS_INTERMODULE_SINGLETON_COMMON_HPP
