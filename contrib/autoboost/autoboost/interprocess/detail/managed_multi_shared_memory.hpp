...
#ifndef AUTOBOOST_INTERPROCESS_MANAGED_MULTI_SHARED_MEMORY_HPP
#define AUTOBOOST_INTERPROCESS_MANAGED_MULTI_SHARED_MEMORY_HPP
...
#include <autoboost/interprocess/shared_memory_object.hpp>
#include <autoboost/interprocess/containers/list.hpp>//list
#include <autoboost/interprocess/mapped_region.hpp> //mapped_region
#include <autoboost/interprocess/shared_memory_object.hpp>
#include <autoboost/interprocess/permissions.hpp>
#include <autoboost/interprocess/detail/managed_open_or_create_impl.hpp> //managed_open_or_create_impl
#include <autoboost/interprocess/containers/string.hpp>
#include <autoboost/interprocess/streams/vectorstream.hpp>
...
//   };
 ...
 public:
                             ...
                             const permissions &perm)
   {
      ...
      AUTOBOOST_CATCH(const std::bad_alloc&){
      }
      AUTOBOOST_CATCH_END
      if(group){
                          ...
                          const permissions &perm)
   {
      AUTOBOOST_TRY{
         ...
         autoboost::interprocess::basic_ovectorstream<autoboost::interprocess::string> formatter;
         ...
         //This can throw.
         m_shmem_list.push_back(autoboost::move(mshm));
         return true;
      }
      AUTOBOOST_CATCH(const std::bad_alloc&){
      }
...
#endif   //AUTOBOOST_INTERPROCESS_MANAGED_MULTI_SHARED_MEMORY_HPP
