...
//#define AUTOBOOST_INTERPROCESS_DISABLE_FORCEINLINE

#if defined(AUTOBOOST_INTERPROCESS_DISABLE_FORCEINLINE)
   #define AUTOBOOST_INTERPROCESS_FORCEINLINE inline
#elif defined(AUTOBOOST_INTERPROCESS_FORCEINLINE_IS_AUTOBOOST_FORCELINE)
   #define AUTOBOOST_INTERPROCESS_FORCEINLINE AUTOBOOST_FORCEINLINE
