...
#ifndef AUTOBOOST_INTERPROCESS_MANAGED_MAPPED_FILE_HPP
#define AUTOBOOST_INTERPROCESS_MANAGED_MAPPED_FILE_HPP
...
#include <autoboost/interprocess/detail/file_wrapper.hpp>
#include <autoboost/move/utility_core.hpp>
#include <autoboost/interprocess/file_mapping.hpp>
   ...
   #endif   //#ifndef AUTOBOOST_INTERPROCESS_DOXYGEN_INVOKED
{
   ...
   AUTOBOOST_MOVABLE_BUT_NOT_COPYABLE(basic_managed_mapped_file)
   #endif   //#ifndef AUTOBOOST_INTERPROCESS_DOXYGEN_INVOKED
   ...
   typedef typename AUTOBOOST_INTERPROCESS_IMPDEF(base_t::size_type) size_type;
   ...
   //!Does not throw
   basic_managed_mapped_file(AUTOBOOST_RV_REF(basic_managed_mapped_file) moved)
   {
      this->swap(moved);
   }
   ...
   //!Moves the ownership of "moved"'s managed memory to *this.
   //!Does not throw
   basic_managed_mapped_file &operator=(AUTOBOOST_RV_REF(basic_managed_mapped_file) moved)
   {
      basic_managed_mapped_file tmp(autoboost::move(moved));
      this->swap(tmp);
      return *this;
   }
...
#endif   //AUTOBOOST_INTERPROCESS_MANAGED_MAPPED_FILE_HPP
