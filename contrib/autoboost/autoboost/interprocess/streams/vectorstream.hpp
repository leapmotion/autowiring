...
#ifndef AUTOBOOST_INTERPROCESS_VECTORSTREAM_HPP
#define AUTOBOOST_INTERPROCESS_VECTORSTREAM_HPP
...
//!std::vector, autoboost::interprocess::vector or autoboost::interprocess::basic_string
   ...
   : public std::basic_streambuf<typename CharVector::value_type, CharTraits>
{
   ...
   void initialize_pointers()
   {
      ...
      if(m_mode & std::ios_base::out){
         ...
         AUTOBOOST_ASSERT(m_vect.size() == m_vect.capacity());
...
//!contiguous storage, like std::vector, autoboost::interprocess::vector or
//!autoboost::interprocess::basic_string
template <class CharVector, class CharTraits>
...
#endif /* AUTOBOOST_INTERPROCESS_VECTORSTREAM_HPP */
