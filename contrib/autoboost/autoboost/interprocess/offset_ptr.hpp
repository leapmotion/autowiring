...
namespace ipcdetail {
   ...
   union offset_ptr_internal
   {
      ...
      AUTOBOOST_STATIC_ASSERT(autoboost::is_integral<OffsetType>::value && autoboost::is_unsigned<OffsetType>::value);
   ...
   AUTOBOOST_INTERPROCESS_FORCEINLINE void * offset_ptr_to_raw_pointer(const volatile void *this_ptr, OffsetType offset)
   {
   ...
   template<class OffsetType>
   AUTOBOOST_INTERPROCESS_FORCEINLINE OffsetType offset_ptr_to_offset(const volatile void *ptr, const volatile void *this_ptr)
   {
      typedef pointer_offset_caster<void*, OffsetType> caster_t;
   ...
   template<class OffsetType>
   AUTOBOOST_INTERPROCESS_FORCEINLINE OffsetType offset_ptr_to_offset_from_other
   ...
   struct enable_if_convertible_equal_address
      : enable_if_c< ::autoboost::is_convertible<From*, To*>::value
...
class offset_ptr
{
   ...
   //!Never throws.
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr() AUTOBOOST_NOEXCEPT
      : internal(1)
   {}

   //!Constructor from raw pointer (allows "0" pointer conversion).
   //!Never throws.
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr(pointer ptr) AUTOBOOST_NOEXCEPT
   ...
   //!Never throws.
   template <class T>
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr( T *ptr
             , typename ipcdetail::enable_if< ::autoboost::is_convertible<T*, PointedType*> >::type * = 0) AUTOBOOST_NOEXCEPT
      : internal(ipcdetail::offset_ptr_to_offset<OffsetType>(static_cast<PointedType*>(ptr), this))
   {}

   //!Constructor from other offset_ptr
   //!Never throws.
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr(const offset_ptr& ptr) AUTOBOOST_NOEXCEPT
   ...
   template<class T2>
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr( const offset_ptr<T2, DifferenceType, OffsetType, OffsetAlignment> &ptr
   ...
   template<class T2>
   AUTOBOOST_INTERPROCESS_FORCEINLINE explicit offset_ptr(const offset_ptr<T2, DifferenceType, OffsetType, OffsetAlignment> &ptr
             #ifndef AUTOBOOST_INTERPROCESS_DOXYGEN_INVOKED
             , typename ipcdetail::enable_if_c<
                !::autoboost::is_convertible<T2*, PointedType*>::value && ::autoboost::is_constructible<T2*, PointedType*>::value
             >::type * = 0
             #endif
             ) AUTOBOOST_NOEXCEPT
      : internal(ipcdetail::offset_ptr_to_offset<OffsetType>(static_cast<PointedType*>(ptr.get()), this))
   ...
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr(const offset_ptr<T2, P2, O2, A2> & r, ipcdetail::static_cast_tag) AUTOBOOST_NOEXCEPT
   ...
   //!Never throws.
   template<class T2, class P2, class O2, std::size_t A2>
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr(const offset_ptr<T2, P2, O2, A2> & r, ipcdetail::const_cast_tag) AUTOBOOST_NOEXCEPT
   ...
   //!Never throws.
   template<class T2, class P2, class O2, std::size_t A2>
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr(const offset_ptr<T2, P2, O2, A2> & r, ipcdetail::dynamic_cast_tag) AUTOBOOST_NOEXCEPT
   ...
   //!Never throws.
   template<class T2, class P2, class O2, std::size_t A2>
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr(const offset_ptr<T2, P2, O2, A2> & r, ipcdetail::reinterpret_cast_tag) AUTOBOOST_NOEXCEPT
      : internal(ipcdetail::offset_ptr_to_offset<OffsetType>(reinterpret_cast<PointedType*>(r.get()), this))
   {}

   //!Obtains raw pointer from offset.
   //!Never throws.
   AUTOBOOST_INTERPROCESS_FORCEINLINE pointer get() const AUTOBOOST_NOEXCEPT
   {  return static_cast<pointer>(ipcdetail::offset_ptr_to_raw_pointer(this, this->internal.m_offset));   }

   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_type get_offset() const AUTOBOOST_NOEXCEPT
   {  return this->internal.m_offset;  }

   //!Pointer-like -> operator. It can return 0 pointer.
   //!Never throws.
   AUTOBOOST_INTERPROCESS_FORCEINLINE pointer operator->() const AUTOBOOST_NOEXCEPT
   {  return this->get(); }

   //!Dereferencing operator, if it is a null offset_ptr behavior
   //!   is undefined. Never throws.
   AUTOBOOST_INTERPROCESS_FORCEINLINE reference operator* () const AUTOBOOST_NOEXCEPT
   {
      pointer p = this->get();
      reference r = *p;
      return r;
   ...
   //!Indexing operator.
   //!Never throws.
   AUTOBOOST_INTERPROCESS_FORCEINLINE reference operator[](difference_type idx) const AUTOBOOST_NOEXCEPT
   {  return this->get()[idx];  }

   //!Assignment from pointer (saves extra conversion).
   //!Never throws.
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr& operator= (pointer from) AUTOBOOST_NOEXCEPT
   {
   ...
   //!Never throws.
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr& operator= (const offset_ptr & ptr) AUTOBOOST_NOEXCEPT
   {
   ...
   template<class T2> AUTOBOOST_INTERPROCESS_FORCEINLINE
   #ifndef AUTOBOOST_INTERPROCESS_DOXYGEN_INVOKED
   typename ipcdetail::enable_if_c
      < ::autoboost::is_convertible<T2*, PointedType*>::value, offset_ptr&>::type
   #else
   offset_ptr&
   #endif
   ...
   //!Never throws.
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr &operator+= (difference_type offset) AUTOBOOST_NOEXCEPT
   ...
   //!++offset_ptr.
   //!Never throws.
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr& operator++ (void) AUTOBOOST_NOEXCEPT
   {  this->inc_offset(sizeof (PointedType));   return *this;  }

   //!offset_ptr++.
   //!Never throws.
   AUTOBOOST_INTERPROCESS_FORCEINLINE offset_ptr operator++ (int) AUTOBOOST_NOEXCEPT
   {
      offset_ptr tmp(*this);
   ...
   AUTOBOOST_INTERPROCESS_FORCEINLINE operator unspecified_bool_type() const AUTOBOOST_NOEXCEPT
   ...
   //!Never throws
   AUTOBOOST_INTERPROCESS_FORCEINLINE bool operator! () const AUTOBOOST_NOEXCEPT
   {  return this->internal.m_offset == 1;   }
   ...
   #endif //AUTOBOOST_INTERPROCESS_DOXYGEN_INVOKED
   #endif

   //!Compatibility with pointer_traits
   //!
   AUTOBOOST_INTERPROCESS_FORCEINLINE static offset_ptr pointer_to(reference r) AUTOBOOST_NOEXCEPT
   { return offset_ptr(&r); }

   //!difference_type + offset_ptr
   //!operation
   AUTOBOOST_INTERPROCESS_FORCEINLINE friend offset_ptr operator+(difference_type diff, offset_ptr right) AUTOBOOST_NOEXCEPT
   {  right += diff;  return right;  }

   //!offset_ptr + difference_type
   //!operation
   AUTOBOOST_INTERPROCESS_FORCEINLINE friend offset_ptr operator+(offset_ptr left, difference_type diff) AUTOBOOST_NOEXCEPT
   ...
   //!operation
   AUTOBOOST_INTERPROCESS_FORCEINLINE friend difference_type operator-(const offset_ptr &pt, const offset_ptr &pt2) AUTOBOOST_NOEXCEPT
   {  return difference_type(pt.get()- pt2.get());   }

   //Comparison
   AUTOBOOST_INTERPROCESS_FORCEINLINE friend bool operator== (const offset_ptr &pt1, const offset_ptr &pt2) AUTOBOOST_NOEXCEPT
   ...
   AUTOBOOST_INTERPROCESS_FORCEINLINE friend bool operator== (pointer pt1, const offset_ptr &pt2) AUTOBOOST_NOEXCEPT
   {  return pt1 == pt2.get();  }
   ...
   //Comparison
   AUTOBOOST_INTERPROCESS_FORCEINLINE friend bool operator== (const offset_ptr &pt1, pointer pt2) AUTOBOOST_NOEXCEPT
   {  return pt1.get() == pt2;  }
   ...
   AUTOBOOST_INTERPROCESS_FORCEINLINE friend void swap(offset_ptr &left, offset_ptr &right) AUTOBOOST_NOEXCEPT
   {
   ...
   private:
   template<class T2>
   AUTOBOOST_INTERPROCESS_FORCEINLINE void assign(const offset_ptr<T2, DifferenceType, OffsetType, OffsetAlignment> &ptr, ipcdetail::bool_<true>) AUTOBOOST_NOEXCEPT
   ...
   template<class T2>
   AUTOBOOST_INTERPROCESS_FORCEINLINE void assign(const offset_ptr<T2, DifferenceType, OffsetType, OffsetAlignment> &ptr, ipcdetail::bool_<false>) AUTOBOOST_NOEXCEPT
   ...
   #if !defined(AUTOBOOST_INTERPROCESS_DOXYGEN_INVOKED)
   AUTOBOOST_INTERPROCESS_FORCEINLINE void inc_offset(DifferenceType bytes) AUTOBOOST_NOEXCEPT
   {  internal.m_offset += bytes;   }

   AUTOBOOST_INTERPROCESS_FORCEINLINE void dec_offset(DifferenceType bytes) AUTOBOOST_NOEXCEPT
   {  internal.m_offset -= bytes;   }

   ipcdetail::offset_ptr_internal<OffsetType, OffsetAlignment> internal;

   public:
   AUTOBOOST_INTERPROCESS_FORCEINLINE const OffsetType &priv_offset() const AUTOBOOST_NOEXCEPT
   {  return internal.m_offset;   }

   AUTOBOOST_INTERPROCESS_FORCEINLINE       OffsetType &priv_offset() AUTOBOOST_NOEXCEPT
   {  return internal.m_offset;   }
...
AUTOBOOST_INTERPROCESS_FORCEINLINE autoboost::interprocess::offset_ptr<T1, P1, O1, A1>
...
//!Never throws.
template <class T, class P, class O, std::size_t A>
AUTOBOOST_INTERPROCESS_FORCEINLINE T * to_raw_pointer(autoboost::interprocess::offset_ptr<T, P, O, A> const & p) AUTOBOOST_NOEXCEPT
...
struct pointer_plus_bits<autoboost::interprocess::offset_ptr<T, P, O, A>, NumBits>
{
   ...
   AUTOBOOST_INTERPROCESS_FORCEINLINE static pointer get_pointer(const pointer &n) AUTOBOOST_NOEXCEPT
   {
      pointer p;
   ...
   AUTOBOOST_INTERPROCESS_FORCEINLINE static void set_pointer(pointer &n, const pointer &p) AUTOBOOST_NOEXCEPT
   {
   ...
   AUTOBOOST_INTERPROCESS_FORCEINLINE static std::size_t get_bits(const pointer &n) AUTOBOOST_NOEXCEPT
   {
      return std::size_t((n.priv_offset() & Mask) >> 1u);
   }

   AUTOBOOST_INTERPROCESS_FORCEINLINE static void set_bits(pointer &n, std::size_t const b) AUTOBOOST_NOEXCEPT
   {
