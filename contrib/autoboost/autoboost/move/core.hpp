...
// @endcond
   ...
   #define AUTOBOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      public:\
      AUTOBOOST_MOVE_FORCEINLINE operator ::autoboost::rv<TYPE>&() \
      {  return *AUTOBOOST_MOVE_TO_RV_CAST(::autoboost::rv<TYPE>*, this);  }\
      AUTOBOOST_MOVE_FORCEINLINE operator const ::autoboost::rv<TYPE>&() const \
   ...
   #define AUTOBOOST_COPYABLE_AND_MOVABLE(TYPE)\
      public:\
      AUTOBOOST_MOVE_FORCEINLINE TYPE& operator=(TYPE &t)\
