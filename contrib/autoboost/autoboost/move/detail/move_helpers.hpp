...
////////////////////////////////////////
   ...
   template<class RETURN_VALUE, class AUTOBOOST_MOVE_TEMPL_PARAM, class TYPE>
   struct autoboost_move_conversion_aware_catch_1
      : public ::autoboost::move_detail::enable_if_and
                        < RETURN_VALUE
   ...
   template<class RETURN_VALUE, class AUTOBOOST_MOVE_TEMPL_PARAM, class TYPE>
   struct autoboost_move_conversion_aware_catch_2
      : public ::autoboost::move_detail::disable_if_or
                        < RETURN_VALUE
                        , ::autoboost::move_detail::is_same<TYPE, AUTOBOOST_MOVE_TEMPL_PARAM>
                        , ::autoboost::move_detail::is_rv_impl<AUTOBOOST_MOVE_TEMPL_PARAM>
   ...
   #define AUTOBOOST_MOVE_CONVERSION_AWARE_CATCH_COMMON(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
      AUTOBOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(AUTOBOOST_MOVE_CATCH_CONST(TYPE) x)\
      {  return FWD_FUNCTION(static_cast<const TYPE&>(x)); }\
      \
      AUTOBOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(AUTOBOOST_MOVE_CATCH_RVALUE(TYPE) x) \
      {  return FWD_FUNCTION(::autoboost::move(x));  }\
      \
      AUTOBOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(TYPE &x)\
   ...
   //
      ...
      #define AUTOBOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
         ...
         AUTOBOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(const AUTOBOOST_MOVE_TEMPL_PARAM &u,\
            typename autoboost_move_conversion_aware_catch_1< ::autoboost::move_detail::nat, AUTOBOOST_MOVE_TEMPL_PARAM, TYPE>::type* = 0)\
         { return FWD_FUNCTION(u); }\
         \
         template<class AUTOBOOST_MOVE_TEMPL_PARAM>\
         AUTOBOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(const AUTOBOOST_MOVE_TEMPL_PARAM &u,\
            typename autoboost_move_conversion_aware_catch_2< ::autoboost::move_detail::nat, AUTOBOOST_MOVE_TEMPL_PARAM, TYPE>::type* = 0)\
         {\
            TYPE t((u));\
      ...
      #define AUTOBOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
         ...
         \
         template<class AUTOBOOST_MOVE_TEMPL_PARAM>\
         AUTOBOOST_MOVE_FORCEINLINE typename autoboost_move_conversion_aware_catch_1<RETURN_VALUE, AUTOBOOST_MOVE_TEMPL_PARAM, TYPE>::type\
            PUB_FUNCTION(const AUTOBOOST_MOVE_TEMPL_PARAM &u)\
         { return FWD_FUNCTION(u); }\
         \
         template<class AUTOBOOST_MOVE_TEMPL_PARAM>\
         AUTOBOOST_MOVE_FORCEINLINE typename autoboost_move_conversion_aware_catch_2<RETURN_VALUE, AUTOBOOST_MOVE_TEMPL_PARAM, TYPE>::type\
            PUB_FUNCTION(const AUTOBOOST_MOVE_TEMPL_PARAM &u)\
         {\
            TYPE t((u));\
            return FWD_FUNCTION(::autoboost::move(t));\
...
////////////////////////////////////////
   ...
   template<class RETURN_VALUE, class AUTOBOOST_MOVE_TEMPL_PARAM, class UNLESS_CONVERTIBLE_TO, class TYPE>
   struct autoboost_move_conversion_aware_catch_1arg_1
      : public ::autoboost::move_detail::enable_if_and
                        < RETURN_VALUE
                        , ::autoboost::move_detail::not_< ::autoboost::move_detail::is_same_or_convertible<AUTOBOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO> >
                        , ::autoboost::move_detail::is_same<TYPE, AUTOBOOST_MOVE_TEMPL_PARAM>
                        , ::autoboost::has_move_emulation_disabled<AUTOBOOST_MOVE_TEMPL_PARAM>
                        >
   {};
   ...
   template<class RETURN_VALUE, class AUTOBOOST_MOVE_TEMPL_PARAM, class UNLESS_CONVERTIBLE_TO, class TYPE>
   struct autoboost_move_conversion_aware_catch_1arg_2
      : public ::autoboost::move_detail::disable_if_or
                        < RETURN_VALUE
                        , ::autoboost::move_detail::is_same_or_convertible< AUTOBOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO>
                        , ::autoboost::move_detail::is_rv_impl<AUTOBOOST_MOVE_TEMPL_PARAM>
                        , ::autoboost::move_detail::is_same<TYPE, AUTOBOOST_MOVE_TEMPL_PARAM>
                        >
   {};
   ...
   #define AUTOBOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG_COMMON(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1, UNLESS_CONVERTIBLE_TO)\
      AUTOBOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(ARG1 arg1, AUTOBOOST_MOVE_CATCH_CONST(TYPE) x)\
      {  return FWD_FUNCTION(arg1, static_cast<const TYPE&>(x)); }\
      \
      AUTOBOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(ARG1 arg1, AUTOBOOST_MOVE_CATCH_RVALUE(TYPE) x) \
      {  return FWD_FUNCTION(arg1, ::autoboost::move(x));  }\
      \
      AUTOBOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(ARG1 arg1, TYPE &x)\
   ...
   //
      ...
      #define AUTOBOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1, UNLESS_CONVERTIBLE_TO)\
         ...
         \
         template<class AUTOBOOST_MOVE_TEMPL_PARAM>\
         AUTOBOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(ARG1 arg1, const AUTOBOOST_MOVE_TEMPL_PARAM &u,\
            typename autoboost_move_conversion_aware_catch_1arg_1<void, AUTOBOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO, TYPE>::type* = 0)\
         { return FWD_FUNCTION(arg1, u); }\
         \
         template<class AUTOBOOST_MOVE_TEMPL_PARAM>\
         AUTOBOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(ARG1 arg1, const AUTOBOOST_MOVE_TEMPL_PARAM &u,\
            typename autoboost_move_conversion_aware_catch_1arg_2<void, AUTOBOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO, TYPE>::type* = 0)\
         {\
            TYPE t((u));\
      ...
      #define AUTOBOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1, UNLESS_CONVERTIBLE_TO)\
         ...
         \
         template<class AUTOBOOST_MOVE_TEMPL_PARAM>\
         AUTOBOOST_MOVE_FORCEINLINE typename autoboost_move_conversion_aware_catch_1arg_1<RETURN_VALUE, AUTOBOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO, TYPE>::type\
            PUB_FUNCTION(ARG1 arg1, const AUTOBOOST_MOVE_TEMPL_PARAM &u)\
         { return FWD_FUNCTION(arg1, u); }\
         \
         template<class AUTOBOOST_MOVE_TEMPL_PARAM>\
         AUTOBOOST_MOVE_FORCEINLINE typename autoboost_move_conversion_aware_catch_1arg_2<RETURN_VALUE, AUTOBOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO, TYPE>::type\
            PUB_FUNCTION(ARG1 arg1, const AUTOBOOST_MOVE_TEMPL_PARAM &u)\
         {\
            TYPE t((u));\
            return FWD_FUNCTION(arg1, ::autoboost::move(t));\
   ...
   #define AUTOBOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1, UNLESS_CONVERTIBLE_TO)\
      ...
      \
      template<class AUTOBOOST_MOVE_TEMPL_PARAM>\
      AUTOBOOST_MOVE_FORCEINLINE typename ::autoboost::move_detail::disable_if_or\
                        < RETURN_VALUE \
                        , ::autoboost::move_detail::is_same<TYPE, AUTOBOOST_MOVE_TEMPL_PARAM> \
                        , ::autoboost::move_detail::is_same_or_convertible<AUTOBOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO> \
                        >::type\
