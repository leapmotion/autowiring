...
#if defined(AUTOBOOST_MOVE_DISABLE_FORCEINLINE)
   #define AUTOBOOST_MOVE_FORCEINLINE inline
#elif defined(AUTOBOOST_MOVE_FORCEINLINE_IS_AUTOBOOST_FORCELINE)
   #define AUTOBOOST_MOVE_FORCEINLINE AUTOBOOST_FORCEINLINE
