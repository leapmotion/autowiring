...
//       is_unary_function
//////////////////////////////////////
#if defined(AUTOBOOST_MSVC) || defined(__BORLANDC_)
#define AUTOBOOST_MOVE_TT_DECL __cdecl
#else
#define AUTOBOOST_MOVE_TT_DECL
#endif

#if defined(_MSC_EXTENSIONS) && !defined(__BORLAND__) && !defined(_WIN64) && !defined(_M_ARM) && !defined(UNDER_CE)
#define AUTOBOOST_MOVE_TT_TEST_MSC_FUNC_SIGS
#endif
...
#ifndef AUTOBOOST_MOVE_TT_TEST_MSC_FUNC_SIGS
...
#else // AUTOBOOST_MOVE_TT_TEST_MSC_FUNC_SIGS
...
#  define AUTOBOOST_MOVEUP_HAS_VIRTUAL_DESTRUCTOR(T) __has_virtual_destructor(T)
#elif defined(AUTOBOOST_CLANG) && defined(__has_feature)
#  if __has_feature(has_virtual_destructor)
#     define AUTOBOOST_MOVEUP_HAS_VIRTUAL_DESTRUCTOR(T) __has_virtual_destructor(T)
#  endif
#elif defined(__GNUC__) && ((__GNUC__ > 4) || ((__GNUC__ == 4) && (__GNUC_MINOR__ >= 3) && !defined(__GCCXML__))) && !defined(AUTOBOOST_CLANG)
#  define AUTOBOOST_MOVEUP_HAS_VIRTUAL_DESTRUCTOR(T) __has_virtual_destructor(T)
...
#ifdef AUTOBOOST_MOVEUP_HAS_VIRTUAL_DESTRUCTOR
   template<class T>
   struct has_virtual_destructor{   static const bool value = AUTOBOOST_MOVEUP_HAS_VIRTUAL_DESTRUCTOR(T);  };
#else
...
template<class T, class U>
struct missing_virtual_destructor< ::autoboost::movelib::default_delete<T>, U >
...
#endif //#ifndef AUTOBOOST_MOVE_UNIQUE_PTR_DETAIL_META_UTILS_HPP
