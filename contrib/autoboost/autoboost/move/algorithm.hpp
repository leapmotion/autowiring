...
//////////////////////////////////////////////////////////////////////////////
   ...
   //!   performs *(result + n) = ::autoboost::move (*(first + n)).
   //!
   ...
   //!   performs *(result - n) = ::autoboost::move(*(last - n)).
   //!
   //! <b>Requires</b>: result shall not be in the range [first,last).
   //!
...
#endif   //!defined(AUTOBOOST_MOVE_USE_STANDARD_LIBRARY_MOVE)
...
//!         typename iterator_traits<ForwardIterator>::value_type(autoboost::move(*first));
//!   \endcode
//!
//! <b>Returns</b>: result
template
...
F uninitialized_move(I f, I l, F r
   /// @cond
//   ,typename ::autoboost::move_detail::enable_if<has_move_emulation_enabled<typename std::iterator_traits<I>::value_type> >::type* = 0
   /// @endcond
   )
{
   ...
   AUTOBOOST_TRY{
      while (f != l) {
         void * const addr = static_cast<void*>(::autoboost::move_detail::addressof(*r));
         ::new(addr) input_value_type(::autoboost::move(*f));
         ++f; ++r;
      }
   }
   AUTOBOOST_CATCH(...){
...
template
   <typename I,   // I models InputIterator
    typename F>   // F models ForwardIterator
F uninitialized_move(I f, I l, F r,
   typename ::autoboost::move_detail::disable_if<has_move_emulation_enabled<typename std::iterator_traits<I>::value_type> >::type* = 0)
{
