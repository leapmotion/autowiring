 ...
 * 29 Jan 2004 - c_array() added, AUTOBOOST_NO_PRIVATE_IN_AGGREGATE removed (Nico Josuttis)
 ...
 * Jan 29, 2004
 */
#ifndef AUTOBOOST_ARRAY_HPP
#define AUTOBOOST_ARRAY_HPP
      ...
      public:
        ...
        void swap (array<T,N>& y) {
            for (size_type i = 0; i < N; ++i)
                autoboost::swap(elems[i],y.elems[i]);
        }
    ...
    class array< T, 0 > {
      ...
      public:
        ...
        static reference failed_rangecheck () {
                ...
                autoboost::throw_exception(e);
#if defined(AUTOBOOST_NO_EXCEPTIONS) || (!defined(AUTOBOOST_MSVC) && !defined(__PATHSCALE__))
                //
...
// Specific for autoboost::array: simply returns its elems data member.
    template <typename T, std::size_t N>
    T(&get_c_array(autoboost::array<T,N>& arg))[N]
    {
        return arg.elems;
    }
