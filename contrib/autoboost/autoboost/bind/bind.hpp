#ifndef AUTOBOOST_BIND_BIND_HPP_INCLUDED
#define AUTOBOOST_BIND_BIND_HPP_INCLUDED
...
#  define AUTOBOOST_BIND_VISIT_EACH autoboost::visit_each
#else
#  define AUTOBOOST_BIND_VISIT_EACH visit_each
#endif

#include <autoboost/bind/storage.hpp>
...
#if !defined(AUTOBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION) && !defined(AUTOBOOST_NO_FUNCTION_TEMPLATE_ORDERING)
...
public:
    ...
    A1 operator[] (autoboost::arg<1>) const { return base_type::a1_; }
...
public:
    ...
    A1 operator[] (autoboost::arg<1>) const { return base_type::a1_; }
    A2 operator[] (autoboost::arg<2>) const { return base_type::a2_; }
...
public:
    ...
    A1 operator[] (autoboost::arg<1>) const { return base_type::a1_; }
    A2 operator[] (autoboost::arg<2>) const { return base_type::a2_; }
    A3 operator[] (autoboost::arg<3>) const { return base_type::a3_; }
...
public:
    ...
    A2 operator[] (autoboost::arg<2>) const { return base_type::a2_; }
    A3 operator[] (autoboost::arg<3>) const { return base_type::a3_; }
    A4 operator[] (autoboost::arg<4>) const { return base_type::a4_; }
...
public:
    ...
    A3 operator[] (autoboost::arg<3>) const { return base_type::a3_; }
    A4 operator[] (autoboost::arg<4>) const { return base_type::a4_; }
    A5 operator[] (autoboost::arg<5>) const { return base_type::a5_; }
...
public:
    ...
    A4 operator[] (autoboost::arg<4>) const { return base_type::a4_; }
    A5 operator[] (autoboost::arg<5>) const { return base_type::a5_; }
    A6 operator[] (autoboost::arg<6>) const { return base_type::a6_; }
...
public:
    ...
    A5 operator[] (autoboost::arg<5>) const { return base_type::a5_; }
    A6 operator[] (autoboost::arg<6>) const { return base_type::a6_; }
    A7 operator[] (autoboost::arg<7>) const { return base_type::a7_; }
...
public:
    ...
    A6 operator[] (autoboost::arg<6>) const { return base_type::a6_; }
    A7 operator[] (autoboost::arg<7>) const { return base_type::a7_; }
    A8 operator[] (autoboost::arg<8>) const { return base_type::a8_; }
...
public:
    ...
    A7 operator[] (autoboost::arg<7>) const { return base_type::a7_; }
    A8 operator[] (autoboost::arg<8>) const { return base_type::a8_; }
    A9 operator[] (autoboost::arg<9>) const { return base_type::a9_; }
...
public:
    ...
    A1 && operator[] (autoboost::arg<1>) const { return std::forward<A1>( a1_ ); } // not static_cast because of g++ 4.9

    A1 && operator[] (autoboost::arg<1> (*) ()) const { return std::forward<A1>( a1_ ); }
...
public:
    ...
    A1 && operator[] (autoboost::arg<1>) const { return std::forward<A1>( a1_ ); }
    A2 && operator[] (autoboost::arg<2>) const { return std::forward<A2>( a2_ ); }
...
public:
    ...
    A1 && operator[] (autoboost::arg<1>) const { return std::forward<A1>( a1_ ); }
    A2 && operator[] (autoboost::arg<2>) const { return std::forward<A2>( a2_ ); }
    A3 && operator[] (autoboost::arg<3>) const { return std::forward<A3>( a3_ ); }
...
public:
    ...
    A2 && operator[] (autoboost::arg<2>) const { return std::forward<A2>( a2_ ); }
    A3 && operator[] (autoboost::arg<3>) const { return std::forward<A3>( a3_ ); }
    A4 && operator[] (autoboost::arg<4>) const { return std::forward<A4>( a4_ ); }
...
public:
    ...
    A3 && operator[] (autoboost::arg<3>) const { return std::forward<A3>( a3_ ); }
    A4 && operator[] (autoboost::arg<4>) const { return std::forward<A4>( a4_ ); }
    A5 && operator[] (autoboost::arg<5>) const { return std::forward<A5>( a5_ ); }
...
public:
    ...
    A4 && operator[] (autoboost::arg<4>) const { return std::forward<A4>( a4_ ); }
    A5 && operator[] (autoboost::arg<5>) const { return std::forward<A5>( a5_ ); }
    A6 && operator[] (autoboost::arg<6>) const { return std::forward<A6>( a6_ ); }
...
public:
    ...
    A5 && operator[] (autoboost::arg<5>) const { return std::forward<A5>( a5_ ); }
    A6 && operator[] (autoboost::arg<6>) const { return std::forward<A6>( a6_ ); }
    A7 && operator[] (autoboost::arg<7>) const { return std::forward<A7>( a7_ ); }
...
public:
    ...
    A6 && operator[] (autoboost::arg<6>) const { return std::forward<A6>( a6_ ); }
    A7 && operator[] (autoboost::arg<7>) const { return std::forward<A7>( a7_ ); }
    A8 && operator[] (autoboost::arg<8>) const { return std::forward<A8>( a8_ ); }
...
public:
    ...
    A7 && operator[] (autoboost::arg<7>) const { return std::forward<A7>( a7_ ); }
    A8 && operator[] (autoboost::arg<8>) const { return std::forward<A8>( a8_ ); }
    A9 && operator[] (autoboost::arg<9>) const { return std::forward<A9>( a9_ ); }
...
public:
    ...
    template<class V> void accept( V & v ) const
    {
#if !defined( AUTOBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP ) && !defined( __BORLANDC__ )
        using autoboost::visit_each;
#endif

        AUTOBOOST_BIND_VISIT_EACH( v, f_, 0 );
        l_.accept( v );
    }
...
#elif !defined( AUTOBOOST_NO_VOID_RETURNS )
...
#define AUTOBOOST_BIND_RETURN return
#include <autoboost/bind/bind_template.hpp>
#undef AUTOBOOST_BIND_RETURN
...
template<class R2, class F, class L> class bind_t: public bind_t_generator<R2>::AUTOBOOST_NESTED_TEMPLATE implementation<F, L>
{
public:

    bind_t(F f, L const & l): bind_t_generator<R2>::AUTOBOOST_NESTED_TEMPLATE implementation<F, L>(f, l) {}
...
#ifndef AUTOBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP
...
# endif // #ifndef AUTOBOOST_NO_FUNCTION_TEMPLATE_ORDERING

#else // AUTOBOOST_NO_ARGUMENT_DEPENDENT_LOOKUP

// put overloads in autoboost
...
#if !defined(AUTOBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION) || (__SUNPRO_CC >= 0x530)

#if defined( __BORLANDC__ ) && AUTOBOOST_WORKAROUND( __BORLANDC__, AUTOBOOST_TESTED_AT(0x582) )
...
template<class T> struct add_value
{
    typedef typename add_value_2< T, autoboost::is_placeholder< T >::value >::type type;
};
...
#define AUTOBOOST_BIND_OPERATOR( op, name ) \
\
struct name \
{ \
...
AUTOBOOST_BIND_OPERATOR( ==, equal )
AUTOBOOST_BIND_OPERATOR( !=, not_equal )

AUTOBOOST_BIND_OPERATOR( <, less )
AUTOBOOST_BIND_OPERATOR( <=, less_equal )

AUTOBOOST_BIND_OPERATOR( >, greater )
AUTOBOOST_BIND_OPERATOR( >=, greater_equal )

AUTOBOOST_BIND_OPERATOR( &&, logical_and )
AUTOBOOST_BIND_OPERATOR( ||, logical_or )

#undef AUTOBOOST_BIND_OPERATOR
...
{
    using autoboost::visit_each;
    AUTOBOOST_BIND_VISIT_EACH( v, t.get(), 0 );
}
...
#ifndef AUTOBOOST_BIND
#define AUTOBOOST_BIND bind
#endif
...
template<class R, class F, class A1, class A2>
    ...
    AUTOBOOST_BIND(F f, A1 a1, A2 a2)
{
...
template<class R, class F, class A1, class A2, class A3>
    ...
    AUTOBOOST_BIND(F f, A1 a1, A2 a2, A3 a3)
{
...
template<class R, class F, class A1, class A2, class A3, class A4>
    ...
    AUTOBOOST_BIND(F f, A1 a1, A2 a2, A3 a3, A4 a4)
{
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5>
    ...
    AUTOBOOST_BIND(F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5)
{
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5, class A6>
    ...
    AUTOBOOST_BIND(F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6)
{
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5, class A6, class A7>
    ...
    AUTOBOOST_BIND(F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7)
{
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8>
    ...
    AUTOBOOST_BIND(F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8)
{
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8, class A9>
    ...
    AUTOBOOST_BIND(F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9)
{
...
template<class R, class F>
    _bi::bind_t<R, F, _bi::list0>
    AUTOBOOST_BIND(autoboost::type<R>, F f)
{
    typedef _bi::list0 list_type;
    return _bi::bind_t<R, F, list_type> (f, list_type());
}
...
template<class R, class F, class A1>
    _bi::bind_t<R, F, typename _bi::list_av_1<A1>::type>
    AUTOBOOST_BIND(autoboost::type<R>, F f, A1 a1)
{
    typedef typename _bi::list_av_1<A1>::type list_type;
    return _bi::bind_t<R, F, list_type> (f, list_type(a1));
}
...
template<class R, class F, class A1, class A2>
    _bi::bind_t<R, F, typename _bi::list_av_2<A1, A2>::type>
    AUTOBOOST_BIND(autoboost::type<R>, F f, A1 a1, A2 a2)
{
    typedef typename _bi::list_av_2<A1, A2>::type list_type;
    return _bi::bind_t<R, F, list_type> (f, list_type(a1, a2));
}
...
template<class R, class F, class A1, class A2, class A3>
    _bi::bind_t<R, F, typename _bi::list_av_3<A1, A2, A3>::type>
    AUTOBOOST_BIND(autoboost::type<R>, F f, A1 a1, A2 a2, A3 a3)
{
    typedef typename _bi::list_av_3<A1, A2, A3>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3));
}
...
template<class R, class F, class A1, class A2, class A3, class A4>
    _bi::bind_t<R, F, typename _bi::list_av_4<A1, A2, A3, A4>::type>
    AUTOBOOST_BIND(autoboost::type<R>, F f, A1 a1, A2 a2, A3 a3, A4 a4)
{
    typedef typename _bi::list_av_4<A1, A2, A3, A4>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3, a4));
}
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5>
    _bi::bind_t<R, F, typename _bi::list_av_5<A1, A2, A3, A4, A5>::type>
    AUTOBOOST_BIND(autoboost::type<R>, F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5)
{
    typedef typename _bi::list_av_5<A1, A2, A3, A4, A5>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3, a4, a5));
}
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5, class A6>
    _bi::bind_t<R, F, typename _bi::list_av_6<A1, A2, A3, A4, A5, A6>::type>
    AUTOBOOST_BIND(autoboost::type<R>, F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6)
{
    typedef typename _bi::list_av_6<A1, A2, A3, A4, A5, A6>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3, a4, a5, a6));
}
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5, class A6, class A7>
    _bi::bind_t<R, F, typename _bi::list_av_7<A1, A2, A3, A4, A5, A6, A7>::type>
    AUTOBOOST_BIND(autoboost::type<R>, F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7)
{
    typedef typename _bi::list_av_7<A1, A2, A3, A4, A5, A6, A7>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3, a4, a5, a6, a7));
}
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8>
    _bi::bind_t<R, F, typename _bi::list_av_8<A1, A2, A3, A4, A5, A6, A7, A8>::type>
    AUTOBOOST_BIND(autoboost::type<R>, F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8)
{
    typedef typename _bi::list_av_8<A1, A2, A3, A4, A5, A6, A7, A8>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3, a4, a5, a6, a7, a8));
}
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8, class A9>
    _bi::bind_t<R, F, typename _bi::list_av_9<A1, A2, A3, A4, A5, A6, A7, A8, A9>::type>
    AUTOBOOST_BIND(autoboost::type<R>, F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9)
{
    typedef typename _bi::list_av_9<A1, A2, A3, A4, A5, A6, A7, A8, A9>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3, a4, a5, a6, a7, a8, a9));
}
...
#endif // !defined(AUTOBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION) && !defined(AUTOBOOST_NO_FUNCTION_TEMPLATE_ORDERING)

// function pointers

#define AUTOBOOST_BIND_CC
#define AUTOBOOST_BIND_ST

#include <autoboost/bind/bind_cc.hpp>

#undef AUTOBOOST_BIND_CC
#undef AUTOBOOST_BIND_ST

#ifdef AUTOBOOST_BIND_ENABLE_STDCALL

#define AUTOBOOST_BIND_CC __stdcall
#define AUTOBOOST_BIND_ST
...
#ifdef AUTOBOOST_BIND_ENABLE_FASTCALL

#define AUTOBOOST_BIND_CC __fastcall
#define AUTOBOOST_BIND_ST
...
#ifdef AUTOBOOST_BIND_ENABLE_PASCAL

#define AUTOBOOST_BIND_ST pascal
#define AUTOBOOST_BIND_CC
...
#define AUTOBOOST_BIND_MF_NAME(X) X
#define AUTOBOOST_BIND_MF_CC

#include <autoboost/bind/bind_mf_cc.hpp>
#include <autoboost/bind/bind_mf2_cc.hpp>

#undef AUTOBOOST_BIND_MF_NAME
#undef AUTOBOOST_BIND_MF_CC

#ifdef AUTOBOOST_MEM_FN_ENABLE_CDECL

#define AUTOBOOST_BIND_MF_NAME(X) X##_cdecl
#define AUTOBOOST_BIND_MF_CC __cdecl
...
#define AUTOBOOST_BIND_MF_NAME(X) X##_stdcall
#define AUTOBOOST_BIND_MF_CC __stdcall
...
#define AUTOBOOST_BIND_MF_NAME(X) X##_fastcall
#define AUTOBOOST_BIND_MF_CC __fastcall
...
#if defined(AUTOBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION) || defined(AUTOBOOST_NO_FUNCTION_TEMPLATE_ORDERING) \
    || ( defined(__BORLANDC__) && AUTOBOOST_WORKAROUND( __BORLANDC__, AUTOBOOST_TESTED_AT( 0x620 ) ) )

template<class R, class T, class A1>
_bi::bind_t< R, _mfi::dm<R, T>, typename _bi::list_av_1<A1>::type >
    AUTOBOOST_BIND(R T::*f, A1 a1)
{
...
#ifndef AUTOBOOST_BIND_NO_PLACEHOLDERS

# include <autoboost/bind/placeholders.hpp>
...
#endif // #ifndef AUTOBOOST_BIND_BIND_HPP_INCLUDED
