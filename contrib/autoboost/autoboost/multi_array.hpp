...
#ifndef AUTOBOOST_MULTI_ARRAY_RG071801_HPP
#define AUTOBOOST_MULTI_ARRAY_RG071801_HPP
...
#include "autoboost/multi_array/base.hpp"
#include "autoboost/multi_array/collection_concept.hpp"
#include "autoboost/multi_array/copy_array.hpp"
#include "autoboost/multi_array/iterator.hpp"
#include "autoboost/multi_array/subarray.hpp"
#include "autoboost/multi_array/multi_array_ref.hpp"
#include "autoboost/multi_array/algorithm.hpp"
...
{
    static T x;
    AUTOBOOST_STATIC_CONSTANT(bool, value = sizeof((is_multi_array_impl_help)(x)) == 1);
...
public:
  ...
  struct const_array_view {
    typedef autoboost::detail::multi_array::const_multi_array_view<T,NDims> type;
  };

  template <std::size_t NDims>
  struct array_view {
    typedef autoboost::detail::multi_array::multi_array_view<T,NDims> type;
  };
  ...
  super_type(rhs), allocator_(rhs.allocator_) {
    allocate_space();
    autoboost::detail::multi_array::copy_n(rhs.base_,rhs.num_elements(),base_);
  }
  ...
  multi_array& resize(const detail::multi_array
    ...
    autoboost::array<size_type,NumDims> min_extents;
    ...
    // typedef autoboost::array<index,NumDims> index_list;
    ...
    typename
      multi_array::AUTOBOOST_NESTED_TEMPLATE array_view<NumDims>::type view_old = (*this)[old_idxes];
    typename
      multi_array::AUTOBOOST_NESTED_TEMPLATE array_view<NumDims>::type view_new = new_array[new_idxes];
...
private:
  ...
  typedef autoboost::array<size_type,NumDims> size_list;
  typedef autoboost::array<index,NumDims> index_list;
...
#endif // AUTOBOOST_MULTI_ARRAY_RG071801_HPP
