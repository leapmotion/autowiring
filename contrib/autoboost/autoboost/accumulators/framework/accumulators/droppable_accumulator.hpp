...
#ifndef AUTOBOOST_ACCUMULATORS_FRAMEWORK_ACCUMULATORS_DROPPABLE_ACCUMULATOR_HPP_EAN_13_12_2005
...
#include <autoboost/accumulators/framework/depends_on.hpp> // for feature_of
#include <autoboost/accumulators/framework/parameters/accumulator.hpp> // for accumulator
...
namespace autoboost { namespace accumulators
{
      ...
      : Accumulator
    {
        ...
        {
            AUTOBOOST_ASSERT(0 < this->ref_count_);
      ...
      : Accumulator
    {
        ...
        void on_drop(Args const &args)
        {
            ...
            AUTOBOOST_ASSERT(!this->has_result());
