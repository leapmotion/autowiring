...
#ifndef AUTOBOOST_ACCUMULATORS_FRAMEWORK_ACCUMULATORS_EXTERNAL_ACCUMULATOR_HPP_EAN_01_12_2005
...
#include <autoboost/accumulators/framework/accumulators/reference_accumulator.hpp>

namespace autoboost { namespace accumulators { namespace impl
{
