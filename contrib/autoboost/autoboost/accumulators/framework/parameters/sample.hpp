...
#ifndef AUTOBOOST_ACCUMULATORS_FRAMEWORK_PARAMETERS_SAMPLE_HPP_EAN_31_10_2005
...
AUTOBOOST_PARAMETER_KEYWORD(tag, sample)
AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(sample)
