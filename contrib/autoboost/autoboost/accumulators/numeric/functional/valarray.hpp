...
#ifndef AUTOBOOST_NUMERIC_FUNCTIONAL_VALARRAY_HPP_EAN_12_12_2005
...
#include <autoboost/typeof/std/valarray.hpp>
...
namespace autoboost { namespace numeric
{
    ...
    #define AUTOBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(Name, Op)                   \
        template<typename Left, typename Right>                                         \
        ...
        AUTOBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(plus, +)
        AUTOBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(minus, -)
        AUTOBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(multiplies, *)
        AUTOBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(divides, /)
        AUTOBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(modulus, %)

    #undef AUTOBOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP
          ...
          : std::binary_function<Left, Right, void>
        {
            ...
            {
                AUTOBOOST_ASSERT(left.size() == right.size());
          ...
          : std::unary_function<From, bool>
        {
            ...
            {
                AUTOBOOST_MPL_ASSERT((is_same<bool, typename From::value_type>));
                for(std::size_t i = 0, size = arr.size(); i != size; ++i)
                {
                    if(!arr[i])
                    {
