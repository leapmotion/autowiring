...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_COVARIANCE_HPP_DE_01_01_2006
#define AUTOBOOST_ACCUMULATORS_STATISTICS_COVARIANCE_HPP_DE_01_01_2006
...
namespace autoboost { namespace numeric
{
    ...
    {
        struct outer_product
          : autoboost::detail::function2<functional::outer_product<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};
    }

    namespace
    {
        op::outer_product const &outer_product = autoboost::detail::pod_singleton<op::outer_product>::instance;
    }
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(covariance)
}
