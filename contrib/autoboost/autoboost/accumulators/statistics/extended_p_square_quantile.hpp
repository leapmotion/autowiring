...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_EXTENDED_SINGLE_QUANTILE_HPP_DE_01_01_2006
#define AUTOBOOST_ACCUMULATORS_STATISTICS_EXTENDED_SINGLE_QUANTILE_HPP_DE_01_01_2006
...
#include <autoboost/accumulators/statistics/extended_p_square.hpp>
#include <autoboost/accumulators/statistics/weighted_extended_p_square.hpp>
#include <autoboost/accumulators/statistics/times2_iterator.hpp>
    ...
    */
      ...
      : accumulator_base
    {
        ...
        extended_p_square_quantile_impl(Args const &args)
          : probabilities(
                autoboost::begin(args[extended_p_square_probabilities])
              , autoboost::end(args[extended_p_square_probabilities])
            )
        {
        }
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(extended_p_square_quantile)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(extended_p_square_quantile_quadratic)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(weighted_extended_p_square_quantile)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(weighted_extended_p_square_quantile_quadratic)
}
