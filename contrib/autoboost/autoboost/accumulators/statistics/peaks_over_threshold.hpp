...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_PEAKS_OVER_THRESHOLD_HPP_DE_01_01_2006
#define AUTOBOOST_ACCUMULATORS_STATISTICS_PEAKS_OVER_THRESHOLD_HPP_DE_01_01_2006

#include <vector>
#include <limits>
#include <numeric>
#include <functional>
#include <autoboost/config/no_tr1/cmath.hpp> // pow
...
//
AUTOBOOST_PARAMETER_NESTED_KEYWORD(tag, pot_threshold_value, threshold_value)
AUTOBOOST_PARAMETER_NESTED_KEYWORD(tag, pot_threshold_probability, threshold_probability)

AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(pot_threshold_value)
AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(pot_threshold_probability)
...
namespace impl
{
    ...
    */
      ...
      : accumulator_base
    {
        ...
        typedef autoboost::tuple<float_type, float_type, float_type> result_type;
        ...
        peaks_over_threshold_impl(Args const &args)
          ...
          , fit_parameters_(autoboost::make_tuple(0., 0., 0.))
          , is_dirty_(true)
        {
        }
        ...
        result_type result(Args const &args) const
        {
            if (this->is_dirty_)
            {
                ...
                this->fit_parameters_ = autoboost::make_tuple(u_bar, beta_bar, xi_hat);
            }
    ...
    private:
        ...
        mutable result_type fit_parameters_; // autoboost::tuple that stores fit parameters
            ...
            if (this->is_dirty_)
            {
                ...
                if ( n >= static_cast<std::size_t>(tail(args).size()))
                {
                    ...
                    else
                    {
                        ...
                        return autoboost::make_tuple(Sample(0), Sample(0), Sample(0));
                    }
                }
                else
                {
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(peaks_over_threshold)
}
