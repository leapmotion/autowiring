...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_ROLLING_MEAN_HPP_EAN_26_12_2008
#define AUTOBOOST_ACCUMULATORS_STATISTICS_ROLLING_MEAN_HPP_EAN_26_12_2008
...
#include <autoboost/accumulators/statistics/rolling_sum.hpp>
...
namespace autoboost { namespace accumulators
{
   ...
   namespace extract
   {
      ...
      AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(lazy_rolling_mean)
         AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(immediate_rolling_mean)
         AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(rolling_mean)
   }
