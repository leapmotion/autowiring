...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_ROLLING_VARIANCE_HPP_EAN_15_11_2011
#define AUTOBOOST_ACCUMULATORS_STATISTICS_ROLLING_VARIANCE_HPP_EAN_15_11_2011

#include <autoboost/accumulators/accumulators.hpp>
#include <autoboost/accumulators/statistics/stats.hpp>
...
#include <autoboost/accumulators/statistics/rolling_mean.hpp>
#include <autoboost/accumulators/statistics/rolling_moment.hpp>
...
namespace impl
{
    ...
    */
    ...
    private:
        ...
        template<typename T>
        void prevent_underflow(T &non_negative_number,typename autoboost::enable_if<autoboost::is_arithmetic<T>,T>::type* = 0)
        {
            if (non_negative_number < T(0)) non_negative_number = T(0);
        }
        template<typename T>
        void prevent_underflow(T &non_arithmetic_quantity,typename autoboost::disable_if<autoboost::is_arithmetic<T>,T>::type* = 0)
        {
        }
    };
} // namespace impl
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(lazy_rolling_variance)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(immediate_rolling_variance)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(rolling_variance)
}
