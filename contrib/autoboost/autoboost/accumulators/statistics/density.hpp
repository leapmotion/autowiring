...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_DENSITY_HPP_DE_01_01_2006
#define AUTOBOOST_ACCUMULATORS_STATISTICS_DENSITY_HPP_DE_01_01_2006
...
#include <autoboost/accumulators/statistics/max.hpp>
#include <autoboost/accumulators/statistics/min.hpp>
...
//
AUTOBOOST_PARAMETER_NESTED_KEYWORD(tag, density_cache_size, cache_size)
AUTOBOOST_PARAMETER_NESTED_KEYWORD(tag, density_num_bins, num_bins)

AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(density_cache_size)
AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(density_num_bins)
...
namespace tag
{
      ...
      , density_num_bins
    {
        ...
        static autoboost::parameter::keyword<density_cache_size> const cache_size;
        static autoboost::parameter::keyword<density_num_bins> const num_bins;
        #endif
    };
}
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(density)
}
