...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_MEAN_HPP_EAN_28_10_2005
#define AUTOBOOST_ACCUMULATORS_STATISTICS_MEAN_HPP_EAN_28_10_2005
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_DEFINE_EXTRACTOR(tag, mean_of_variates, (typename)(typename))

    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(mean)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(mean_of_weights)
}
