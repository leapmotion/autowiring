...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_WEIGHTED_MEAN_HPP_EAN_03_11_2005
#define AUTOBOOST_ACCUMULATORS_STATISTICS_WEIGHTED_MEAN_HPP_EAN_03_11_2005
...
#include <autoboost/accumulators/framework/parameters/weights.hpp>
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_DEFINE_EXTRACTOR(tag, weighted_mean_of_variates, (typename)(typename))

    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(weighted_mean)
}
