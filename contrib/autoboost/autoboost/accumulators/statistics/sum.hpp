...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_SUM_HPP_EAN_28_10_2005
#define AUTOBOOST_ACCUMULATORS_STATISTICS_SUM_HPP_EAN_28_10_2005
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(sum)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(sum_of_weights)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(sum_of_variates)
}
