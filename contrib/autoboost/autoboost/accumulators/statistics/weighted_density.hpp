...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_WEIGHTED_DENSITY_HPP_DE_01_01_2006
#define AUTOBOOST_ACCUMULATORS_STATISTICS_WEIGHTED_DENSITY_HPP_DE_01_01_2006
...
#include <autoboost/accumulators/statistics/density.hpp> // for named parameters density_cache_size and density_num_bins
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(weighted_density)
}
