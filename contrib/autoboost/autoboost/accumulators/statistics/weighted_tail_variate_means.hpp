...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_WEIGHTED_TAIL_VARIATE_MEANS_HPP_DE_01_01_2006
#define AUTOBOOST_ACCUMULATORS_STATISTICS_WEIGHTED_TAIL_VARIATE_MEANS_HPP_DE_01_01_2006
...
#include <autoboost/accumulators/statistics/tail_variate_means.hpp>
#include <autoboost/accumulators/statistics/weighted_tail_mean.hpp>
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(weighted_tail_variate_means)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(relative_weighted_tail_variate_means)
}
