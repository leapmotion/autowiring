...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_EXTENDED_SINGLE_HPP_DE_01_01_2006
#define AUTOBOOST_ACCUMULATORS_STATISTICS_EXTENDED_SINGLE_HPP_DE_01_01_2006
...
//
AUTOBOOST_PARAMETER_NESTED_KEYWORD(tag, extended_p_square_probabilities, probabilities)

AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(extended_p_square_probabilities)
...
namespace tag
{
      ...
      , extended_p_square_probabilities
    {
        ...
        static autoboost::parameter::keyword<tag::probabilities> const probabilities;
        #endif
    };
}
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(extended_p_square)
}
