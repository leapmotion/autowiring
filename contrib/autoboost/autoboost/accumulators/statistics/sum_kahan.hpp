...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_SUM_KAHAN_HPP_EAN_26_07_2010
#define AUTOBOOST_ACCUMULATORS_STATISTICS_SUM_KAHAN_HPP_EAN_26_07_2010
...
#include <autoboost/accumulators/statistics/weighted_sum_kahan.hpp>
    ...
    */
    ...
    sum_kahan_impl(Args const & args)
      : sum(args[parameter::keyword<Tag>::get() | Sample()]),
        compensation(autoboost::numeric_cast<Sample>(0.0))
    {
    }
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(sum_kahan)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(sum_of_weights_kahan)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(sum_of_variates_kahan)
} // namespace extract
