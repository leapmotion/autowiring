...
#ifndef AUTOBOOST_ACCUMULATORS_STATISTICS_MEDIAN_HPP_EAN_28_10_2005
#define AUTOBOOST_ACCUMULATORS_STATISTICS_MEDIAN_HPP_EAN_28_10_2005
...
#include <autoboost/accumulators/statistics/p_square_quantile.hpp>
#include <autoboost/accumulators/statistics/density.hpp>
#include <autoboost/accumulators/statistics/p_square_cumul_dist.hpp>
...
namespace extract
{
    ...
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(median)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(with_density_median)
    AUTOBOOST_ACCUMULATORS_IGNORE_GLOBAL(with_p_square_cumulative_distribution_median)
}
