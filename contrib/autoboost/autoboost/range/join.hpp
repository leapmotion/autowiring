...
//
#ifndef AUTOBOOST_RANGE_JOIN_HPP_INCLUDED
#define AUTOBOOST_RANGE_JOIN_HPP_INCLUDED

#include <autoboost/config.hpp>
#include <autoboost/range/detail/join_iterator.hpp>
...
public:
    typedef iterator_range<
        range_detail::join_iterator<
            ...
            AUTOBOOST_DEDUCED_TYPENAME range_value<SinglePassRange1>::type
        >
    > type;
};
    ...
    : public range_detail::joined_type<SinglePassRange1, SinglePassRange2>::type
{
    ...
    typedef AUTOBOOST_DEDUCED_TYPENAME range_detail::joined_type<
...
using ::autoboost::range::joined_range;
using ::autoboost::range::join;
