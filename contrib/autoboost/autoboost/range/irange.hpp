...
//
#ifndef AUTOBOOST_RANGE_IRANGE_HPP_INCLUDED
#define AUTOBOOST_RANGE_IRANGE_HPP_INCLUDED
...
namespace autoboost
{
    namespace range_detail
    {
        ...
        class integer_iterator
            : public autoboost::iterator_facade<
                    ...
                    >
        {
            typedef autoboost::iterator_facade<
                        integer_iterator<Integer>,
                        Integer,
                        autoboost::random_access_traversal_tag,
                        Integer,
    ...
    {
        AUTOBOOST_ASSERT( step_size != 0 );
        AUTOBOOST_ASSERT( (step_size > 0) ? (last >= first) : (last <= first) );
