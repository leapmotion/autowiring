...
//
#ifndef AUTOBOOST_RANGE_ALGORITHM_EXT_PUSH_BACK_HPP_INCLUDED
#define AUTOBOOST_RANGE_ALGORITHM_EXT_PUSH_BACK_HPP_INCLUDED
...
inline Container& push_back( Container& on, const Range& from )
{
    ...
    on.insert( on.end(), autoboost::begin(from), autoboost::end(from) );
    return on;
}
