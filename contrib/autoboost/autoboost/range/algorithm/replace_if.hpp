...
//
#ifndef AUTOBOOST_RANGE_ALGORITHM_REPLACE_IF_HPP_INCLUDED
#define AUTOBOOST_RANGE_ALGORITHM_REPLACE_IF_HPP_INCLUDED
               ...
               const Value& val)
{
    ...
    std::replace_if(autoboost::begin(rng), autoboost::end(rng), pred, val);
    return rng;
}
