...
//
#ifndef AUTOBOOST_RANGE_ALGORITHM_GENERATE_HPP_INCLUDED
#define AUTOBOOST_RANGE_ALGORITHM_GENERATE_HPP_INCLUDED
...
inline ForwardRange& generate( ForwardRange& rng, Generator gen )
{
    ...
    std::generate(autoboost::begin(rng), autoboost::end(rng), gen);
    return rng;
}
