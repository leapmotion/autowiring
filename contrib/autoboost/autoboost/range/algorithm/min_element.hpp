...
//
#ifndef AUTOBOOST_RANGE_ALGORITHM_MIN_ELEMENT_HPP_INCLUDED
#define AUTOBOOST_RANGE_ALGORITHM_MIN_ELEMENT_HPP_INCLUDED
...
min_element(ForwardRange& rng)
{
    ...
    return std::min_element(autoboost::begin(rng), autoboost::end(rng));
}
...
{
    AUTOBOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return std::min_element(autoboost::begin(rng), autoboost::end(rng), pred);
}
...
min_element(ForwardRange& rng)
{
    ...
    return range_return<ForwardRange,re>::pack(
        std::min_element(autoboost::begin(rng), autoboost::end(rng)),
        rng);
}
...
min_element(ForwardRange& rng, BinaryPredicate pred)
{
    AUTOBOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return range_return<ForwardRange,re>::pack(
        std::min_element(autoboost::begin(rng), autoboost::end(rng), pred),
        rng);
}
