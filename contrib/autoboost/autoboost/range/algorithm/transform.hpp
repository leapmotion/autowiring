...
//
#ifndef AUTOBOOST_RANGE_ALGORITHM_TRANSFORM_HPP_INCLUDED
#define AUTOBOOST_RANGE_ALGORITHM_TRANSFORM_HPP_INCLUDED
...
namespace autoboost
{
    namespace range
    {
                  ...
                  UnaryOperation          fun)
        {
            ...
            return std::transform(autoboost::begin(rng),autoboost::end(rng),out,fun);
        }
    ...
    namespace range
    {
                  ...
                  BinaryOperation         fun)
        {
            ...
            return autoboost::range_detail::transform_impl(
