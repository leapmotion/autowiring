...
//
#ifndef AUTOBOOST_RANGE_ALGORITHM_ADJACENT_FIND_HPP_INCLUDED
#define AUTOBOOST_RANGE_ALGORITHM_ADJACENT_FIND_HPP_INCLUDED
...
adjacent_find(ForwardRange & rng)
{
    ...
    return std::adjacent_find(autoboost::begin(rng),autoboost::end(rng));
}
...
adjacent_find(ForwardRange & rng, BinaryPredicate pred)
{
    ...
    AUTOBOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        ...
        typename range_value<ForwardRange>::type>));
    return std::adjacent_find(autoboost::begin(rng),autoboost::end(rng),pred);
}
...
adjacent_find(ForwardRange & rng)
{
    ...
    return range_return<ForwardRange,re>::
        pack(std::adjacent_find(autoboost::begin(rng),autoboost::end(rng)),
             rng);
}
...
adjacent_find(ForwardRange& rng, BinaryPredicate pred)
{
    ...
    AUTOBOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        ...
        typename range_value<ForwardRange>::type>));
    return range_return<ForwardRange,re>::
        pack(std::adjacent_find(autoboost::begin(rng),autoboost::end(rng),pred),
             rng);
}
