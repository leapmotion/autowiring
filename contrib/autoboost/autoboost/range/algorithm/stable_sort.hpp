...
//
#ifndef AUTOBOOST_RANGE_ALGORITHM_STABLE_SORT_HPP_INCLUDED
#define AUTOBOOST_RANGE_ALGORITHM_STABLE_SORT_HPP_INCLUDED
...
{
    AUTOBOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::stable_sort(autoboost::begin(rng), autoboost::end(rng), sort_pred);
    return rng;
}
