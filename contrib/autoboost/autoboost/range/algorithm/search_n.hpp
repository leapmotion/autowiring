...
//
#ifndef AUTOBOOST_RANGE_ALGORITHM_SEARCH_N_HPP_INCLUDED
#define AUTOBOOST_RANGE_ALGORITHM_SEARCH_N_HPP_INCLUDED
...
namespace range_detail
{
    ...
    search_n_impl(ForwardIterator first, ForwardIterator last,
                  Integer count, const Value& value)
    {
        AUTOBOOST_RANGE_CONCEPT_ASSERT((ForwardIteratorConcept<ForwardIterator>));
        AUTOBOOST_RANGE_CONCEPT_ASSERT((EqualityComparableConcept<Value>));
        AUTOBOOST_RANGE_CONCEPT_ASSERT((EqualityComparableConcept<typename std::iterator_traits<ForwardIterator>::value_type>));
        //AUTOBOOST_RANGE_CONCEPT_ASSERT((EqualityComparableConcept2<typename std::iterator_traits<ForwardIterator>::value_type, Value>));
...
search_n(ForwardRange& rng, Integer count, const Value& value)
{
    ...
    return range_detail::search_n_impl(autoboost::begin(rng),autoboost::end(rng), count, value);
}
         ...
         BinaryPredicate binary_pred)
{
    ...
    AUTOBOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        AUTOBOOST_DEDUCED_TYPENAME range_value<ForwardRange>::type, const Value&>));
    return range_detail::search_n_pred_impl(autoboost::begin(rng), autoboost::end(rng),
         ...
         BinaryPredicate binary_pred)
{
    AUTOBOOST_RANGE_CONCEPT_ASSERT((ForwardRangeConcept<const ForwardRange>));
    AUTOBOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        AUTOBOOST_DEDUCED_TYPENAME range_value<const ForwardRange>::type, const Value&>));
    return range_detail::search_n_pred_impl(autoboost::begin(rng), autoboost::end(rng),
        count, value, binary_pred);
}
...
search_n(ForwardRange& rng, Integer count, const Value& value)
{
    ...
    return range_return<ForwardRange,re>::
        pack(range_detail::search_n_impl(autoboost::begin(rng),autoboost::end(rng),
                           count, value),
             rng);
}
         ...
         BinaryPredicate pred)
{
    AUTOBOOST_RANGE_CONCEPT_ASSERT((ForwardRangeConcept<ForwardRange>));
    AUTOBOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        AUTOBOOST_DEDUCED_TYPENAME range_value<ForwardRange>::type,
        const Value&>));
    return range_return<ForwardRange,re>::
        pack(range_detail::search_n_pred_impl(autoboost::begin(rng),
                                              autoboost::end(rng),
                           count, value, pred),
             rng);
}
         ...
         BinaryPredicate pred)
{
    AUTOBOOST_RANGE_CONCEPT_ASSERT((ForwardRangeConcept<const ForwardRange>));
    AUTOBOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        AUTOBOOST_DEDUCED_TYPENAME range_value<const ForwardRange>::type,
        const Value&>));
    return range_return<const ForwardRange,re>::
        pack(range_detail::search_n_pred_impl(autoboost::begin(rng),
                                              autoboost::end(rng),
