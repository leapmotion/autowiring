...
//
#ifndef AUTOBOOST_RANGE_ALGORITHM_PARTIAL_SORT_HPP_INCLUDED
#define AUTOBOOST_RANGE_ALGORITHM_PARTIAL_SORT_HPP_INCLUDED
...
inline RandomAccessRange& partial_sort(RandomAccessRange& rng,
    AUTOBOOST_DEDUCED_TYPENAME range_iterator<RandomAccessRange>::type middle)
{
    AUTOBOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::partial_sort(autoboost::begin(rng), middle, autoboost::end(rng));
    return rng;
}
...
inline const RandomAccessRange& partial_sort(const RandomAccessRange& rng,
    AUTOBOOST_DEDUCED_TYPENAME range_iterator<const RandomAccessRange>::type middle)
{
