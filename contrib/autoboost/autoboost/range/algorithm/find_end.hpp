...
//
#ifndef AUTOBOOST_RANGE_ALGORITHM_FIND_END_HPP_INCLUDED
#define AUTOBOOST_RANGE_ALGORITHM_FIND_END_HPP_INCLUDED
...
inline AUTOBOOST_DEDUCED_TYPENAME disable_if<
    ...
    AUTOBOOST_DEDUCED_TYPENAME range_iterator< ForwardRange1 >::type
>::type
find_end(ForwardRange1 & rng1, const ForwardRange2& rng2)
{
    ...
    return std::find_end(autoboost::begin(rng1),autoboost::end(rng1),
...
inline AUTOBOOST_DEDUCED_TYPENAME disable_if<
    is_const<ForwardRange1>,
    AUTOBOOST_DEDUCED_TYPENAME range_return<ForwardRange1,re>::type
>::type
find_end(ForwardRange1& rng1, const ForwardRange2& rng2)
{
    AUTOBOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange1> ));
    ...
    return range_return<ForwardRange1,re>::
        pack(std::find_end(autoboost::begin(rng1), autoboost::end(rng1),
                           autoboost::begin(rng2), autoboost::end(rng2)),
             rng1);
}
