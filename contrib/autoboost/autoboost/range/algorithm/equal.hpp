...
//
#ifndef AUTOBOOST_RANGE_ALGORITHM_EQUAL_HPP_INCLUDED
#define AUTOBOOST_RANGE_ALGORITHM_EQUAL_HPP_INCLUDED
...
namespace autoboost
{
    namespace range_detail
    {
        ...
        inline bool equal( SinglePassTraversalReadableIterator1 first1,
                           ...
                           SinglePassTraversalReadableIterator2 last2 )
        {
            AUTOBOOST_DEDUCED_TYPENAME std::iterator_traits< SinglePassTraversalReadableIterator1 >::iterator_category tag1;
            AUTOBOOST_DEDUCED_TYPENAME std::iterator_traits< SinglePassTraversalReadableIterator2 >::iterator_category tag2;
    ...
    namespace range
    {
        ...
        inline bool equal( const SinglePassRange1& rng1, const SinglePassRange2& rng2 )
        {
            ...
            return ::autoboost::range_detail::equal(
