...
//
#ifndef AUTOBOOST_RANGE_ALGORITHM_FIND_FIRST_OF_HPP_INCLUDED
#define AUTOBOOST_RANGE_ALGORITHM_FIND_FIRST_OF_HPP_INCLUDED
...
find_first_of(SinglePassRange1 & rng1, ForwardRange2 const & rng2)
{
    ...
    return std::find_first_of(autoboost::begin(rng1),autoboost::end(rng1),
                              autoboost::begin(rng2),autoboost::end(rng2));
}

/// \overload
template< class SinglePassRange1, class ForwardRange2 >
inline AUTOBOOST_DEDUCED_TYPENAME range_iterator<const SinglePassRange1>::type
...
inline AUTOBOOST_DEDUCED_TYPENAME disable_if<
    is_const<SinglePassRange1>,
    AUTOBOOST_DEDUCED_TYPENAME range_return<SinglePassRange1,re>::type
>::type
find_first_of(SinglePassRange1& rng1, const ForwardRange2& rng2)
{
    ...
    return range_return<SinglePassRange1,re>::
        pack(std::find_first_of(autoboost::begin(rng1), autoboost::end(rng1),
                                autoboost::begin(rng2), autoboost::end(rng2)),
             rng1);
}
...
/// \overload
template< range_return_value re, class SinglePassRange1, class ForwardRange2 >
inline AUTOBOOST_DEDUCED_TYPENAME range_return<const SinglePassRange1,re>::type
find_first_of(const SinglePassRange1& rng1, const ForwardRange2& rng2)
{
    AUTOBOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    AUTOBOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<const ForwardRange2> ));
