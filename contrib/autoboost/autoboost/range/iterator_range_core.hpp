...
// to function types.
//
#ifndef AUTOBOOST_RANGE_ITERATOR_RANGE_CORE_HPP_INCLUDED
#define AUTOBOOST_RANGE_ITERATOR_RANGE_CORE_HPP_INCLUDED

#include <autoboost/config.hpp> // Define __STL_CONFIG_H, if appropriate.
...
#include <autoboost/range/functions.hpp>
...
#include <autoboost/range/detail/safe_bool.hpp>
...
namespace autoboost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return static_cast<IteratorT>( autoboost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return static_cast<IteratorT>( autoboost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( autoboost::begin(l),
                                                 autoboost::end(l),
                                                 autoboost::begin(r),
                                                 autoboost::end(r) );
        }
...
incrementable_t test_traversal_tag(autoboost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(autoboost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(autoboost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef autoboost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef autoboost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef autoboost::random_access_traversal_tag type;
};
...
{
    typedef
        AUTOBOOST_DEDUCED_TYPENAME iterator_traversal<IteratorT>::type
    traversal_t;
    ...
    typedef
        AUTOBOOST_DEDUCED_TYPENAME pure_iterator_traversal_impl<traversal_i>::type
    type;
};
...
public:
    typedef AUTOBOOST_DEDUCED_TYPENAME base_type::difference_type difference_type;
    typedef AUTOBOOST_DEDUCED_TYPENAME base_type::reference reference;

    reference back() const
    {
        AUTOBOOST_ASSERT(!this->empty());
        return *autoboost::prior(this->m_End);
    }
...
public:
    typedef AUTOBOOST_DEDUCED_TYPENAME
        autoboost::mpl::if_<
            autoboost::mpl::or_<
                autoboost::is_abstract<
                    AUTOBOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                autoboost::is_array<
                    AUTOBOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                autoboost::is_function<
                    AUTOBOOST_DEDUCED_TYPENAME base_type::value_type
                >
            >,
            AUTOBOOST_DEDUCED_TYPENAME base_type::reference,
            AUTOBOOST_DEDUCED_TYPENAME base_type::value_type
    ...
    // type.
    typedef AUTOBOOST_DEDUCED_TYPENAME base_type::difference_type difference_type;
    typedef AUTOBOOST_DEDUCED_TYPENAME base_type::size_type size_type;
    typedef AUTOBOOST_DEDUCED_TYPENAME base_type::reference reference;
...
public:
    ...
    {
        AUTOBOOST_ASSERT(at >= 0);
        AUTOBOOST_ASSERT(static_cast<typename base_type::size_type>(at) < size());
    ...
    AUTOBOOST_DEDUCED_TYPENAME base_type::size_type size() const
    {
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                autoboost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        class iterator_range
            : public iterator_range_detail::iterator_range_base<
                    IteratorT,
                    AUTOBOOST_DEDUCED_TYPENAME iterator_range_detail::pure_iterator_traversal<IteratorT>::type
                >
        {
            ...
            struct is_compatible_range
                : is_convertible<
                    AUTOBOOST_DEDUCED_TYPENAME mpl::eval_if<
                        ...
                        mpl::identity<void>
                    >::type,
                    AUTOBOOST_DEDUCED_TYPENAME base_type::iterator
                >
            {
            };
        ...
        public:
            ...
            iterator_range& advance_begin(
                AUTOBOOST_DEDUCED_TYPENAME base_type::difference_type n)
            {
                std::advance(this->m_Begin, n);
                return *this;
            }
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, autoboost::next(first, n));
        }
        ...
        {
            return iterator_range< AUTOBOOST_DEDUCED_TYPENAME range_iterator<Range>::type >
                ( autoboost::begin( r ), autoboost::end( r ) );
        }
        ...
        */
        template< class ForwardRange >
        inline iterator_range< AUTOBOOST_DEDUCED_TYPENAME range_iterator<ForwardRange>::type >
        make_iterator_range( ForwardRange& r )
        {
           return iterator_range< AUTOBOOST_DEDUCED_TYPENAME range_iterator<ForwardRange>::type >
                ( r, iterator_range_detail::range_tag() );
        }

        template< class ForwardRange >
        inline iterator_range< AUTOBOOST_DEDUCED_TYPENAME range_iterator<const ForwardRange>::type >
        make_iterator_range( const ForwardRange& r )
        {
           return iterator_range< AUTOBOOST_DEDUCED_TYPENAME range_iterator<const ForwardRange>::type >
        ...
        namespace iterator_range_detail
        {
            ...
            make_range_impl( Range& r,
                             AUTOBOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_begin,
                             AUTOBOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                //
                ...
                AUTOBOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = autoboost::begin( r ),
                    new_end   = autoboost::end( r );
        ...
        template< class Range >
        inline iterator_range< AUTOBOOST_DEDUCED_TYPENAME range_iterator<const Range>::type >
