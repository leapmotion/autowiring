#ifndef AUTOBOOST_RANGE_ATL_HPP
#define AUTOBOOST_RANGE_ATL_HPP
...
#if !defined(AUTOBOOST_RANGE_ATL_NO_COLLECTIONS)
    #if (_ATL_VER < 0x0700)
        #define AUTOBOOST_RANGE_ATL_NO_COLLECTIONS
    #endif
#endif


#if !defined(AUTOBOOST_RANGE_ATL_HAS_OLD_CSIMPLE_XXX)
    #if (_ATL_VER < 0x0700) // dubious
        #define AUTOBOOST_RANGE_ATL_HAS_OLD_CSIMPLE_XXX
    #endif
#endif
...
namespace ATL {
    ...
    // strings
    //
#if !defined(AUTOBOOST_RANGE_ATL_HAS_OLD_CSIMPLESTRING)
...
#endif // !defined(AUTOBOOST_RANGE_ATL_NO_COLLECTIONS)
...
#endif // !defined(AUTOBOOST_RANGE_ATL_HAS_OLD_CSIMPLE_XXX)
...
#include <autoboost/iterator/indirect_iterator.hpp>
...
namespace autoboost { namespace range_detail_microsoft {
...
#endif
    {
        ...
        Iterator begin(X& x)
        {
            return Iterator(autoboost::make_tuple(x.m_aKey, x.m_aVal));
        }

        template< class Iterator, class X >
        Iterator end(X& x)
        {
            return Iterator(autoboost::make_tuple(x.m_aKey + x.GetSize(), x.m_aVal + x.GetSize()));
        }
    };
...
//
    ...
    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        ...
        (ATL, AUTOBOOST_PP_NIL), CAtlArray, 2
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CAutoPtrArray, 1
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CInterfaceArray, (class)(const IID *)
    )
    ...
    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CAtlList, 2
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CAutoPtrList, 1
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CHeapPtrList, 2
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CInterfaceList, (class)(const IID *)
    )
    ...
    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CAtlMap, 4
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::atl_rb_tree_tag,
        (ATL, AUTOBOOST_PP_NIL), CRBTree, 4
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::atl_rb_tree_tag,
        (ATL, AUTOBOOST_PP_NIL), CRBMap, 4
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::atl_rb_tree_tag,
        (ATL, AUTOBOOST_PP_NIL), CRBMultiMap, 4
    )
    ...
    #if !defined(AUTOBOOST_RANGE_ATL_HAS_OLD_CSIMPLESTRING)
        AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
            autoboost::range_detail_microsoft::atl_string_tag,
            (ATL, AUTOBOOST_PP_NIL), CSimpleStringT, (class)(bool)
        )
    #else
        AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
            autoboost::range_detail_microsoft::atl_string_tag,
            (ATL, AUTOBOOST_PP_NIL), CSimpleStringT, 1
        )
    #endif

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::atl_string_tag,
        (ATL, AUTOBOOST_PP_NIL), CStringT, 2
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::atl_string_tag,
        (ATL, AUTOBOOST_PP_NIL), CFixedStringT, (class)(int)
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CStaticString, (class)(const int)
    )
...
//
    ...
    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CSimpleArray, 2
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CSimpleMap, 3
    )
    ...
    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CSimpleArray, 1
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CSimpleMap, 2
    )

    AUTOBOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        autoboost::range_detail_microsoft::using_type_as_tag,
        (ATL, AUTOBOOST_PP_NIL), CSimpleValArray, 1
    )
