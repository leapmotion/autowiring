...
//
#ifndef AUTOBOOST_RANGE_ANY_RANGE_HPP_INCLUDED
#define AUTOBOOST_RANGE_ANY_RANGE_HPP_INCLUDED
...
#include <autoboost/range/detail/any_iterator.hpp>
...
namespace autoboost
{
    namespace range_detail
    {
        ...
        // values when the user specified autoboost::use_default as a template
        // parameter.
        template<
            class T,
            class Default
...
# endif
        ...
        public:
            ...
            : base_type(autoboost::begin(wrapped_range),
                        autoboost::end(wrapped_range))
            {
            }
            ...
            any_range(const any_range<
                              ...
                              , Buffer
                            >& other)
            : base_type(autoboost::begin(other), autoboost::end(other))
            {
            }
        ...
        {
            AUTOBOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<WrappedRange> ));
            typedef any_range<
