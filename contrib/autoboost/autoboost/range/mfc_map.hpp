...
#ifndef AUTOBOOST_RANGE_ADAPTOR_MFC_MAP_HPP
#define AUTOBOOST_RANGE_ADAPTOR_MFC_MAP_HPP

#if !defined(AUTOBOOST_RANGE_MFC_NO_CPAIR)

#include <autoboost/range/mfc.hpp>
#include <autoboost/range/adaptor/map.hpp>
...
namespace autoboost
{
    namespace range_detail
    {
        ...
        {
            typedef AUTOBOOST_DEDUCED_TYPENAME CMap<KEY, ARG_KEY, VALUE, ARG_VALUE> map_type;
            typedef AUTOBOOST_DEDUCED_TYPENAME range_reference<const map_type>::type argument_type;
            typedef AUTOBOOST_DEDUCED_TYPENAME const KEY& result_type;
        ...
        {
            typedef AUTOBOOST_DEDUCED_TYPENAME CMap<KEY, ARG_KEY, VALUE, ARG_VALUE> map_type;
            typedef AUTOBOOST_DEDUCED_TYPENAME range_reference<map_type>::type argument_type;
            typedef AUTOBOOST_DEDUCED_TYPENAME VALUE& result_type;
        ...
        struct select_second_const< CMap<KEY, ARG_KEY, VALUE, ARG_VALUE> >
        {
            typedef AUTOBOOST_DEDUCED_TYPENAME CMap<KEY, ARG_KEY, VALUE, ARG_VALUE> map_type;
            typedef AUTOBOOST_DEDUCED_TYPENAME range_reference<const map_type>::type argument_type;
            typedef AUTOBOOST_DEDUCED_TYPENAME const VALUE& result_type;
