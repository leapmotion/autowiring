...
#ifndef AUTOBOOST_RANGE_AS_LITERAL_HPP
#define AUTOBOOST_RANGE_AS_LITERAL_HPP
...
#include <autoboost/range/detail/as_literal.hpp>
#else
...
namespace autoboost
{
    namespace range_detail
    {
        ...
        template< class T >
        inline iterator_range<AUTOBOOST_DEDUCED_TYPENAME range_iterator<T>::type>
        make_range( T& r, long )
        {
