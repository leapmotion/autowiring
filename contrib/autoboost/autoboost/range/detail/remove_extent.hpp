...
#ifndef AUTOBOOST_RANGE_DETAIL_REMOVE_BOUNDS_HPP
#define AUTOBOOST_RANGE_DETAIL_REMOVE_BOUNDS_HPP

#include <autoboost/config.hpp>  // MSVC, NO_INTRINSIC_WCHAR_T, put size_t in std.
#include <cstddef>
...
namespace autoboost
{
    namespace range_detail
    {
        ...
        struct remove_extent {
            static T* ar;
            AUTOBOOST_STATIC_CONSTANT(std::size_t, size = sizeof(*ar) / sizeof((*ar)[0]));
