...
#ifndef AUTOBOOST_RANGE_STRING_COLLECTION_TRAITS_HPP
#define AUTOBOOST_RANGE_STRING_COLLECTION_TRAITS_HPP
...
// Implementation
#include <autoboost/range/detail/collection_traits_detail.hpp>
...
//  collection_traits template class -----------------------------------------//
        ...
        */
        ...
        {
        private:
            typedef typename ::autoboost::mpl::eval_if<
                    ::autoboost::algorithm::detail::is_pair<T>,
                        detail::pair_container_traits_selector<T>,
                        typename ::autoboost::mpl::eval_if<
                        ::autoboost::is_array<T>,
                            detail::array_container_traits_selector<T>,
                            typename ::autoboost::mpl::eval_if<
                            ::autoboost::is_pointer<T>,
...
#endif // AUTOBOOST_STRING_COLLECTION_TRAITS_HPP
