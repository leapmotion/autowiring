...
#ifndef AUTOBOOST_RANGE_DETAIL_DETAIL_STR_HPP
#define AUTOBOOST_RANGE_DETAIL_DETAIL_STR_HPP
...
#include <autoboost/range/detail/size_type.hpp>
...
namespace autoboost
{
    ...
    namespace range_detail
    {
        ...
        struct range_end<char_ptr_>
        {
            static char* fun( char* s )
            {
                return autoboost::range_detail::str_end( s );
            }
        };
