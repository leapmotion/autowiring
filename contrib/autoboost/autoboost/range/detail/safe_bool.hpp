...
// <autoboost/smart_ptr/operator_bool.hpp>
#ifndef AUTOBOOST_RANGE_SAFE_BOOL_INCLUDED_HPP
#define AUTOBOOST_RANGE_SAFE_BOOL_INCLUDED_HPP
...
#if (defined(__SUNPRO_CC) && AUTOBOOST_WORKAROUND(__SUNPRO_CC, < 0x570)) || defined(__CINT_)
