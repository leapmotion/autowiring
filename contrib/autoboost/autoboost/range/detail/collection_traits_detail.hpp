...
#ifndef AUTOBOOST_RANGE_STRING_DETAIL_COLLECTION_TRAITS_HPP
#define AUTOBOOST_RANGE_STRING_DETAIL_COLLECTION_TRAITS_HPP
...
// Default collection traits -----------------------------------------------------------------
            ...
            */
            ...
            struct default_container_traits
            {
                ...
                typedef typename
                    ::autoboost::mpl::if_< ::autoboost::is_const<ContainerT>,
                        const_iterator,
                        iterator
...
// Pair container traits ---------------------------------------------------------------------
            ...
            struct pair_container_traits
            {
                ...
                typedef typename ::autoboost::detail::
...
// Array container traits ---------------------------------------------------------------
            ...
            struct array_traits<T[sz]>
            {
                ...
                AUTOBOOST_STATIC_CONSTANT( size_type, array_size = sz );
            };
            ...
            */
            ...
            public:
                ...
                typedef typename
                    ::autoboost::mpl::if_< ::autoboost::is_const<T>,
                        const_iterator,
                        iterator
                    >::type result_iterator;
            ...
            private:
                // resolve array size
                typedef typename
                    ::autoboost::remove_cv<value_type>::type char_type;
                typedef typename
                    array_length_selector<char_type>::
                        AUTOBOOST_NESTED_TEMPLATE array_length<traits_type> array_length_type;

            public:
                AUTOBOOST_STATIC_CONSTANT( size_type, array_size = traits_type::array_size );
...
// Pointer container traits ---------------------------------------------------------------
            ...
            {
                typedef typename
                    ::autoboost::remove_pointer<T>::type value_type;
...
#endif  // AUTOBOOST_STRING_DETAIL_COLLECTION_HPP
