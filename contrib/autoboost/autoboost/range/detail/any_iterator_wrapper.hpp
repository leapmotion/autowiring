...
//
#ifndef AUTOBOOST_RANGE_DETAIL_ANY_ITERATOR_WRAPPER_HPP_INCLUDED
#define AUTOBOOST_RANGE_DETAIL_ANY_ITERATOR_WRAPPER_HPP_INCLUDED

#include <autoboost/cast.hpp>
#include <autoboost/range/config.hpp>
#include <autoboost/range/detail/any_iterator_interface.hpp>
    ...
    namespace range_detail
    {
...
#else
            return *autoboost::polymorphic_downcast<TargetT*>(&source);
#endif
        }
        ...
        class any_incrementable_iterator_wrapper
            : public any_incrementable_iterator_interface<
                    ...
                    >
        {
            AUTOBOOST_RANGE_CONCEPT_ASSERT(( IncrementableIteratorConcept<WrappedIterator> ));
        public:
            typedef WrappedIterator wrapped_type;

            AUTOBOOST_STATIC_ASSERT(( is_convertible<
        ...
        {
            struct disabler {};
            AUTOBOOST_RANGE_CONCEPT_ASSERT(( SinglePassIteratorConcept<WrappedIterator> ));
        ...
        class any_forward_iterator_wrapper
            : public any_forward_iterator_interface<
                    ...
                    >
        {
            AUTOBOOST_RANGE_CONCEPT_ASSERT(( ForwardIteratorConcept<WrappedIterator> ));
        ...
        class any_bidirectional_iterator_wrapper
            : public any_bidirectional_iterator_interface<
                    ...
                    >
        {
            AUTOBOOST_RANGE_CONCEPT_ASSERT(( BidirectionalIteratorConcept<WrappedIterator> ));
        ...
        class any_random_access_iterator_wrapper
            : public any_random_access_iterator_interface<
                        ...
                        >
        {
            AUTOBOOST_RANGE_CONCEPT_ASSERT(( RandomAccessIteratorConcept<WrappedIterator> ));
