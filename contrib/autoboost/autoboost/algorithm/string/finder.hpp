...
#ifndef AUTOBOOST_STRING_FINDER_HPP
#define AUTOBOOST_STRING_FINDER_HPP
...
#include <autoboost/algorithm/string/detail/finder.hpp>
            ...
            return
                detail::first_finderF<
                    AUTOBOOST_STRING_TYPENAME
                        ...
                        is_equal>( ::autoboost::as_literal(Search), is_equal() ) ;
        }
            ...
            const RangeT& Search, PredicateT Comp )
        {
            return
                detail::first_finderF<
                    AUTOBOOST_STRING_TYPENAME
                        range_const_iterator<RangeT>::type,
                    PredicateT>( ::autoboost::as_literal(Search), Comp );
        }
            ...
            int Nth)
        {
            return
                detail::nth_finderF<
                    AUTOBOOST_STRING_TYPENAME
                        range_const_iterator<RangeT>::type,
                    is_equal>( ::autoboost::as_literal(Search), Nth, is_equal() ) ;
        }
        //! "Nth" finder
        /*!
            \overload
            ...
            PredicateT Comp )
        {
            return
                detail::nth_finderF<
                    AUTOBOOST_STRING_TYPENAME
                        range_const_iterator<RangeT>::type,
                    PredicateT>( ::autoboost::as_literal(Search), Nth, Comp );
        }
...
#endif  // AUTOBOOST_STRING_FINDER_HPP
