...
// find_format_all_copy (iterator variant) implementation ---------------------------//
           ...
           template<
                ...
                const FormatResultT& FormatResult )
            {
                ...
                input_iterator_type LastMatch=::autoboost::begin(Input);
                ...
                while( M )
                {
                    ...
                    LastMatch=M.end();
                    M=Finder( LastMatch, ::autoboost::end(Input) );
                }

                // Copy the rest of the sequence
                Output = std::copy( LastMatch, ::autoboost::end(Input), Output );
 ...
 // find_format_all_copy implementation ----------------------------------------------//
           ...
           template<
                ...
                const FormatResultT& FormatResult)
            {
                ...
                {
                    // Copy the beginning of the sequence
                    autoboost::algorithm::detail::insert( Output, ::autoboost::end(Output), LastMatch, M.begin() );
                    // Copy formatted result
                ...
                // Copy the rest of the sequence
                ::autoboost::algorithm::detail::insert( Output, ::autoboost::end(Output), LastMatch, ::autoboost::end(Input) );
 ...
 // find_format_all implementation ------------------------------------------------//
                ...
                FormatResultT FormatResult)
            {
                ...
                while( M )
                {
                    ...
                    ::autoboost::algorithm::detail::copy_to_storage( Storage, M.format_result() );

                    // Find range for a next match
                    M=Finder( SearchIt, ::autoboost::end(Input) );
                }
                ...
                {
                    // Truncate input
                    ::autoboost::algorithm::detail::erase( Input, InsertIt, ::autoboost::end(Input) );
                }
                else
                {
                    // Copy remaining data to the end of input
                    ::autoboost::algorithm::detail::insert( Input, ::autoboost::end(Input), Storage.begin(), Storage.end() );
                }
            }
            ...
            {
                if( ::autoboost::algorithm::detail::check_find_result(Input, FindResult) ) {
                    ::autoboost::algorithm::detail::find_format_all_impl2(
                        Input,
                        Finder,
                        Formatter,
                        FindResult,
...
#endif  // AUTOBOOST_STRING_FIND_FORMAT_ALL_DETAIL_HPP
