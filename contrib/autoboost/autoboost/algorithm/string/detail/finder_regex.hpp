...
#ifndef AUTOBOOST_STRING_FINDER_REGEX_DETAIL_HPP
#define AUTOBOOST_STRING_FINDER_REGEX_DETAIL_HPP
...
//  regex find functor -----------------------------------------------//
                ...
                public iterator_range<IteratorT>
            {
                ...
                typedef AUTOBOOST_STRING_TYPENAME base_type::value_type value_type;
                typedef AUTOBOOST_STRING_TYPENAME base_type::difference_type difference_type;
                typedef AUTOBOOST_STRING_TYPENAME base_type::const_iterator const_iterator;
                typedef AUTOBOOST_STRING_TYPENAME base_type::iterator iterator;
                typedef autoboost::match_results<iterator> match_results_type;
            ...
            */
            ...
            struct find_regexF
            {
                    ...
                    ForwardIteratorT End ) const
                {
                    ...
                    // search for a match
                    if ( ::autoboost::regex_search( Begin, End, result, m_Rx, m_MatchFlags ) )
                    {
                        // construct a result
...
#endif  // AUTOBOOST_STRING_FIND_DETAIL_HPP
