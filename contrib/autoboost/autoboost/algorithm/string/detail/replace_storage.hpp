...
#ifndef AUTOBOOST_STRING_REPLACE_STORAGE_DETAIL_HPP
#define AUTOBOOST_STRING_REPLACE_STORAGE_DETAIL_HPP
...
//  storage handling routines -----------------------------------------------//
            ...
            inline void copy_to_storage(
                ...
                const WhatT& What )
            {
                Storage.insert( Storage.end(), ::autoboost::begin(What), ::autoboost::end(What) );
            }
...
//  process segment routine -----------------------------------------------//
            ...
            struct process_segment_helper
            {
                    ...
                    ForwardIteratorT SegmentEnd )
                {
                    ...
                    ForwardIteratorT It=::autoboost::algorithm::detail::move_from_storage( Storage, InsertIt, SegmentBegin );
            ...
            struct process_segment_helper< true >
            {
...

                {
                    ...
                    ::autoboost::algorithm::detail::replace( Input, InsertIt, SegmentBegin, Storage );
                    // Empty the storage
                    Storage.clear();
...
#endif  // AUTOBOOST_STRING_REPLACE_STORAGE_DETAIL_HPP
