...
#ifndef AUTOBOOST_STRING_PREDICATE_DETAIL_HPP
#define AUTOBOOST_STRING_PREDICATE_DETAIL_HPP
...
//  ends_with predicate implementation ----------------------------------//
                ...
                std::forward_iterator_tag)
            {
                ...
                iterator_range<ForwardIterator1T> Result
                    =last_finder(
                        ::autoboost::make_iterator_range(SubBegin, SubEnd),
                        Comp)(Begin, End);
...
#endif  // AUTOBOOST_STRING_PREDICATE_DETAIL_HPP
