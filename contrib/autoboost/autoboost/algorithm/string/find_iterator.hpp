...
#ifndef AUTOBOOST_STRING_FIND_ITERATOR_HPP
#define AUTOBOOST_STRING_FIND_ITERATOR_HPP
...
#include <autoboost/algorithm/string/detail/find_iterator.hpp>
...
//  find_iterator -----------------------------------------------//
        ...
        */
        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<AUTOBOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::autoboost::as_literal(Col));
                m_Match=::autoboost::make_iterator_range(::autoboost::begin(lit_col), ::autoboost::begin(lit_col));
                m_End=::autoboost::end(lit_col);
        ...
        make_find_iterator(
            ...
            FinderT Finder)
        {
            return find_iterator<AUTOBOOST_STRING_TYPENAME range_iterator<RangeT>::type>(
                Collection, Finder);
        }
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<AUTOBOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::autoboost::as_literal(Col));
                m_Match=make_iterator_range(::autoboost::begin(lit_col), ::autoboost::begin(lit_col));
                m_Next=::autoboost::begin(lit_col);
                m_End=::autoboost::end(lit_col);
        ...
        make_split_iterator(
            ...
            FinderT Finder)
        {
            return split_iterator<AUTOBOOST_STRING_TYPENAME range_iterator<RangeT>::type>(
                Collection, Finder);
        }
...
#endif  // AUTOBOOST_STRING_FIND_ITERATOR_HPP
