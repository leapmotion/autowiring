...
#ifndef AUTOBOOST_STRING_FIND_HPP
#define AUTOBOOST_STRING_FIND_HPP
...
#include <autoboost/algorithm/string/constants.hpp>
...
//  Generic find -----------------------------------------------//
        ...
        */
            ...
            const FinderT& Finder)
        {
            ...
            return Finder(::autoboost::begin(lit_input),::autoboost::end(lit_input));
        }
...
//  find_first  -----------------------------------------------//
        ...
        */
        ...
        inline iterator_range<
            AUTOBOOST_STRING_TYPENAME range_iterator<Range1T>::type>
        find_first(
            Range1T& Input,
            const Range2T& Search)
        {
            return ::autoboost::algorithm::find(Input, ::autoboost::algorithm::first_finder(Search));
        }
        ...
        */
        ...
        {
            return ::autoboost::algorithm::find(Input, ::autoboost::algorithm::first_finder(Search,is_iequal(Loc)));
        }
...
//  find_last  -----------------------------------------------//
        ...
        */
        ...
        find_last(
            ...
            const Range2T& Search)
        {
            return ::autoboost::algorithm::find(Input, ::autoboost::algorithm::last_finder(Search));
        }
        ...
        */
        ...
        ifind_last(
            ...
            const std::locale& Loc=std::locale())
        {
            return ::autoboost::algorithm::find(Input, ::autoboost::algorithm::last_finder(Search, is_iequal(Loc)));
        }
...
//  find_nth ----------------------------------------------------------------------//
        ...
        */
        ...
        find_nth(
            ...
            int Nth)
        {
            return ::autoboost::algorithm::find(Input, ::autoboost::algorithm::nth_finder(Search,Nth));
        }
        ...
        */
        ...
        ifind_nth(
            ...
            const std::locale& Loc=std::locale())
        {
            return ::autoboost::algorithm::find(Input, ::autoboost::algorithm::nth_finder(Search,Nth,is_iequal(Loc)));
        }
...
//  find_head ----------------------------------------------------------------------//
        ...
        */
        ...
        find_head(
            ...
            int N)
        {
            return ::autoboost::algorithm::find(Input, ::autoboost::algorithm::head_finder(N));
        }
...
//  find_tail ----------------------------------------------------------------------//
        ...
        */
        ...
        find_tail(
            ...
            int N)
        {
            return ::autoboost::algorithm::find(Input, ::autoboost::algorithm::tail_finder(N));
        }
...
//  find_token --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::autoboost::algorithm::find(Input, ::autoboost::algorithm::token_finder(Pred, eCompress));
        }
...
#endif  // AUTOBOOST_STRING_FIND_HPP
