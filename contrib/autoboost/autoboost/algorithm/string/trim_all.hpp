...
#ifndef AUTOBOOST_STRING_TRIM_ALL_HPP
#define AUTOBOOST_STRING_TRIM_ALL_HPP
...
namespace autoboost {
    namespace algorithm {
        ...
        */
        ...
        {
            return
                ::autoboost::find_format_all_copy(
                    ::autoboost::trim_copy_if(Input, IsSpace),
                    ::autoboost::token_finder(IsSpace, ::autoboost::token_compress_on),
                    ::autoboost::dissect_formatter(::autoboost::head_finder(1)));
        }
        ...
        */
        ...
        {
            ::autoboost::trim_if(Input, IsSpace);
            ::autoboost::find_format_all(
                Input,
                ::autoboost::token_finder(IsSpace, ::autoboost::token_compress_on),
                ::autoboost::dissect_formatter(::autoboost::head_finder(1)));
        }
        ...
        */
        ...
        {
            return trim_all_copy_if(Input, ::autoboost::is_space(Loc));
        }
        ...
        */
        ...
        {
            trim_all_if(Input, ::autoboost::is_space(Loc));
        }
        ...
        inline SequenceT trim_fill_copy_if(const SequenceT& Input, const RangeT& Fill, PredicateT IsSpace)
        {
            return
                ::autoboost::find_format_all_copy(
                    ::autoboost::trim_copy_if(Input, IsSpace),
                    ::autoboost::token_finder(IsSpace, ::autoboost::token_compress_on),
                    ::autoboost::const_formatter(::autoboost::as_literal(Fill)));
        }
        ...
        */
        ...
        {
            return trim_fill_copy_if(Input, Fill, ::autoboost::is_space(Loc));
        }
        ...
        */
        ...
        {
            trim_fill_if(Input, Fill, ::autoboost::is_space(Loc));
        }
...
#endif  // AUTOBOOST_STRING_TRIM_ALL_HPP
