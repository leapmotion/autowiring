...
#ifndef AUTOBOOST_STRING_FORMATTER_HPP
#define AUTOBOOST_STRING_FORMATTER_HPP
...
#include <autoboost/algorithm/string/detail/formatter.hpp>
        ...
        */
        ...
        const_formatter(const RangeT& Format)
        {
            return detail::const_formatF<
                iterator_range<
                    AUTOBOOST_STRING_TYPENAME range_const_iterator<RangeT>::type> >(::autoboost::as_literal(Format));
        }
