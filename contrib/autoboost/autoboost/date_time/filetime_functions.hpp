 ...
 * AUTOBOOST_HAS_FTIME defined.
 */

#include <autoboost/date_time/compiler_config.hpp>

#if defined(AUTOBOOST_HAS_FTIME) // skip this file if no FILETIME
...
namespace winapi {
    ...
    extern "C" {
        ...
        struct FILETIME
        {
            autoboost::uint32_t dwLowDateTime;
            autoboost::uint32_t dwHighDateTime;
        };
        struct SYSTEMTIME
        {
            autoboost::uint16_t wYear;
            autoboost::uint16_t wMonth;
            autoboost::uint16_t wDayOfWeek;
            autoboost::uint16_t wDay;
            autoboost::uint16_t wHour;
            autoboost::uint16_t wMinute;
            autoboost::uint16_t wSecond;
            autoboost::uint16_t wMilliseconds;
        };
...
#elif defined(AUTOBOOST_HAS_GETSYSTEMTIMEASFILETIME)
    ...
    inline autoboost::uint64_t file_time_to_microseconds(FileTimeT const& ft)
    {
...
#if !defined(AUTOBOOST_DATE_TIME_POSIX_TIME_STD_CONFIG)
