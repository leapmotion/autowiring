...
#include <autoboost/date_time/time_duration.hpp>
#include <autoboost/date_time/time_resolution_traits.hpp>
#include <autoboost/date_time/gregorian/gregorian_types.hpp>
#include <autoboost/date_time/wrapping_int.hpp>
...
#ifdef AUTOBOOST_DATE_TIME_POSIX_TIME_STD_CONFIG
  // set up conditional test compilations
#define AUTOBOOST_DATE_TIME_HAS_MILLISECONDS
#define AUTOBOOST_DATE_TIME_HAS_MICROSECONDS
#define AUTOBOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<autoboost::date_time::time_resolution_traits_adapted64_impl, autoboost::date_time::nano,
    1000000000, 9 > time_res_traits;
#else
  // set up conditional test compilations
#define AUTOBOOST_DATE_TIME_HAS_MILLISECONDS
#define AUTOBOOST_DATE_TIME_HAS_MICROSECONDS
#undef  AUTOBOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<
    autoboost::date_time::time_resolution_traits_adapted64_impl, autoboost::date_time::micro,
                                            1000000, 6 > time_res_traits;


// #undef AUTOBOOST_DATE_TIME_HAS_MILLISECONDS
// #undef AUTOBOOST_DATE_TIME_HAS_MICROSECONDS
// #undef AUTOBOOST_DATE_TIME_HAS_NANOSECONDS
//   typedef date_time::time_resolution_traits<autoboost::int64_t, autoboost::date_time::tenth,
//                                              10, 0 > time_res_traits;
  ...
  /*! \ingroup time_basics
   */
  class AUTOBOOST_SYMBOL_VISIBLE time_duration :
  ...
  public:
    ...
    time_duration(autoboost::date_time::special_values sv) :
  ...
  class AUTOBOOST_SYMBOL_VISIBLE posix_time_system_config
  {
   public:
...
#if (defined(AUTOBOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    AUTOBOOST_STATIC_CONSTANT(autoboost::int64_t, tick_per_second = 1000000000);
#endif
  };
  ...
  {
   public:
    typedef autoboost::int64_t time_rep_type;
...
#if (defined(AUTOBOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    AUTOBOOST_STATIC_CONSTANT(autoboost::int64_t, tick_per_second = 1000000);
#endif
  };
