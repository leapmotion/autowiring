...
#include <autoboost/date_time/posix_time/conversion.hpp> // to_tm will be needed in the facets
...
namespace posix_time {
  ...
  //typedef autoboost::date_time::time_facet<ptime, wchar_t> wptime_facet;
  //! ptime_facet is depricated and will be phased out. use time_facet instead
  //typedef autoboost::date_time::time_facet<ptime, char>     ptime_facet;

  //! wptime_input_facet is depricated and will be phased out. use wtime_input_facet instead
  //typedef autoboost::date_time::time_input_facet<ptime,wchar_t> wptime_input_facet;
  //! ptime_input_facet is depricated and will be phased out. use time_input_facet instead
  //typedef autoboost::date_time::time_input_facet<ptime,char>     ptime_input_facet;

  typedef autoboost::date_time::time_facet<ptime, wchar_t>     wtime_facet;
  typedef autoboost::date_time::time_facet<ptime, char>         time_facet;

  typedef autoboost::date_time::time_input_facet<ptime, wchar_t>     wtime_input_facet;
  typedef autoboost::date_time::time_input_facet<ptime, char>         time_input_facet;
  ...
  operator<<(std::basic_ostream<CharT, TraitsT>& os,
    ...
    typedef autoboost::date_time::time_facet<ptime, CharT> custom_ptime_facet;
