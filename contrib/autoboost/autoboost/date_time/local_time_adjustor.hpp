...
#include <autoboost/date_time/time_defs.hpp> // autoboost::date_time::dst_flags
#include <autoboost/date_time/special_defs.hpp> // not_a_date_time
  ...
  namespace date_time {
    ...
    public:
      ...
      static time_duration_type utc_to_local_offset(const time_type& t)
      {
        ...
        autoboost::throw_exception(std::out_of_range("Unreachable case"));
        AUTOBOOST_DATE_TIME_UNREACHABLE_EXPRESSION(return time_duration_type(not_a_date_time)); // should never reach
      }
                                                    ...
                                                    date_time::dst_flags dst=date_time::calculate)
      {
        ...
        autoboost::throw_exception(std::out_of_range("Time label invalid"));
        AUTOBOOST_DATE_TIME_UNREACHABLE_EXPRESSION(return time_duration_type(not_a_date_time)); // should never reach
      }
