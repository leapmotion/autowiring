#ifndef AB_DATE_TIME_TIME_FORMATTING_STREAMS_HPP___
#define AB_DATE_TIME_TIME_FORMATTING_STREAMS_HPP___
...
#include <iomanip>
#include <iostream>
#include <autoboost/date_time/date_formatting_locales.hpp>
