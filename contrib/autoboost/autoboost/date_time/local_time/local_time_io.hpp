#ifndef AUTOBOOST_DATE_TIME_LOCAL_TIME_IO_HPP__
#define AUTOBOOST_DATE_TIME_LOCAL_TIME_IO_HPP__
...
#include <autoboost/date_time/time_facet.hpp>
#include <autoboost/date_time/string_convert.hpp>
#include <autoboost/date_time/local_time/local_date_time.hpp>
#include <autoboost/date_time/local_time/posix_time_zone.hpp>
#include <autoboost/date_time/local_time/conversion.hpp> // to_tm will be needed in the facets

namespace autoboost {
namespace local_time {

  typedef autoboost::date_time::time_facet<local_date_time, wchar_t> wlocal_time_facet;
  typedef autoboost::date_time::time_facet<local_date_time, char>     local_time_facet;

  typedef autoboost::date_time::time_input_facet<local_date_time::utc_time_type,wchar_t> wlocal_time_input_facet;
  typedef autoboost::date_time::time_input_facet<local_date_time::utc_time_type,char>     local_time_input_facet;
  ...
  operator<<(std::basic_ostream<CharT, TraitsT>& os,
             const autoboost::local_time::local_time_period& p) {
    autoboost::io::ios_flags_saver iflags(os);
    typedef autoboost::date_time::time_facet<local_date_time, CharT> custom_facet;
    std::ostreambuf_iterator<CharT> oitr(os);
  ...
  inline
  std::basic_istream<CharT, Traits>&
  operator>>(std::basic_istream<CharT, Traits>& is, autoboost::local_time::local_time_period& tp)
  {
    autoboost::io::ios_flags_saver iflags(is);
    typename std::basic_istream<CharT, Traits>::sentry strm_sentry(is, false);
    if (strm_sentry) {
...
#endif // AUTOBOOST_DATE_TIME_LOCAL_TIME_IO_HPP__
