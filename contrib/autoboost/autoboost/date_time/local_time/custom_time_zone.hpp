...
namespace local_time {
  ...
  //typedef autoboost::date_time::time_zone_names time_zone_names;
  typedef autoboost::date_time::dst_adjustment_offsets<autoboost::posix_time::time_duration> dst_adjustment_offsets;
  //typedef autoboost::date_time::time_zone_base<autoboost::posix_time::ptime> time_zone;
  typedef autoboost::shared_ptr<dst_calc_rule> dst_calc_rule_ptr;
  ...
  public:
    ...
    custom_time_zone_base(const time_zone_names& zone_names,
                     ...
                     autoboost::shared_ptr<dst_calc_rule> calc_rule) :
