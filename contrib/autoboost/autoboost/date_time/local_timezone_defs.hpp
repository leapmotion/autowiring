...
namespace autoboost {
  namespace date_time {
    ...
    /*! This class is used to configure dst_calc_engine template typically
        as follows:
        @code
          using namespace autoboost::gregorian;
          using namespace autoboost::posix_time;
          typedef us_dst_trait<date> us_dst_traits;
          typedef autoboost::date_time::dst_calc_engine<date, time_duration,
                                                    us_dst_traits>
                                                    us_dst_calc;
          ...
          if (us_dst::local_is_dst(t.date(), t.time_of_day())
              == autoboost::date_time::is_not_in_dst)
          {
