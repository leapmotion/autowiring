  ...
  public:
    ...
    static time_type utc_to_local(const time_type& t)
    {
      ...
      if (t < time_t_start_time) {
        autoboost::throw_exception(std::out_of_range("Cannot convert dates prior to Jan 1, 1970"));
        AUTOBOOST_DATE_TIME_UNREACHABLE_EXPRESSION(return time_t_start_time); // should never reach
      }
