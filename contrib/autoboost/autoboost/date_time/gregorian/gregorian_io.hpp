...
#include <autoboost/date_time/date_facet.hpp>
#include <autoboost/date_time/period_parser.hpp>
#include <autoboost/date_time/period_formatter.hpp>
#include <autoboost/date_time/special_values_parser.hpp>
#include <autoboost/date_time/special_values_formatter.hpp>
#include <autoboost/date_time/gregorian/gregorian_types.hpp>
#include <autoboost/date_time/gregorian/conversion.hpp> // to_tm will be needed in the facets

namespace autoboost {
namespace gregorian {


  typedef autoboost::date_time::period_formatter<wchar_t> wperiod_formatter;
  typedef autoboost::date_time::period_formatter<char>    period_formatter;

  typedef autoboost::date_time::date_facet<date,wchar_t> wdate_facet;
  typedef autoboost::date_time::date_facet<date,char>    date_facet;

  typedef autoboost::date_time::period_parser<date,char>       period_parser;
  typedef autoboost::date_time::period_parser<date,wchar_t>    wperiod_parser;

  typedef autoboost::date_time::special_values_formatter<char> special_values_formatter;
  typedef autoboost::date_time::special_values_formatter<wchar_t> wspecial_values_formatter;

  typedef autoboost::date_time::special_values_parser<date,char> special_values_parser;
  typedef autoboost::date_time::special_values_parser<date,wchar_t> wspecial_values_parser;

  typedef autoboost::date_time::date_input_facet<date,char>    date_input_facet;
  typedef autoboost::date_time::date_input_facet<date,wchar_t> wdate_input_facet;

  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const autoboost::gregorian::date& d) {
    autoboost::io::ios_flags_saver iflags(os);
    typedef autoboost::date_time::date_facet<date, CharT> custom_date_facet;
  ...
  {
    autoboost::io::ios_flags_saver iflags(is);
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const autoboost::gregorian::date_duration& dd) {
    autoboost::io::ios_flags_saver iflags(os);
    typedef autoboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const autoboost::gregorian::date_period& dp) {
    autoboost::io::ios_flags_saver iflags(os);
    typedef autoboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const autoboost::gregorian::greg_month& gm) {
    autoboost::io::ios_flags_saver iflags(os);
    typedef autoboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const autoboost::gregorian::greg_weekday& gw) {
    autoboost::io::ios_flags_saver iflags(os);
    typedef autoboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const autoboost::gregorian::partial_date& pd) {
    autoboost::io::ios_flags_saver iflags(os);
    typedef autoboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const autoboost::gregorian::nth_day_of_the_week_in_month& nkd) {
    autoboost::io::ios_flags_saver iflags(os);
    typedef autoboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const autoboost::gregorian::first_day_of_the_week_in_month& fkd) {
    autoboost::io::ios_flags_saver iflags(os);
    typedef autoboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const autoboost::gregorian::last_day_of_the_week_in_month& lkd) {
    autoboost::io::ios_flags_saver iflags(os);
    typedef autoboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const autoboost::gregorian::first_day_of_the_week_after& fda) {
    autoboost::io::ios_flags_saver iflags(os);
    typedef autoboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const autoboost::gregorian::first_day_of_the_week_before& fdb) {
    autoboost::io::ios_flags_saver iflags(os);
    typedef autoboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
