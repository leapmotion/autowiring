...
// NOTE: these macros define template functions in the autoboost::serialization namespace.
// They must be expanded *outside* of any namespace
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::date_duration)
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::date_duration::duration_rep)
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::date_period)
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::greg_year)
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::greg_month)
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::greg_day)
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::greg_weekday)
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::partial_date)
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::nth_kday_of_month)
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::first_kday_of_month)
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::last_kday_of_month)
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::first_kday_before)
AUTOBOOST_SERIALIZATION_SPLIT_FREE(::autoboost::gregorian::first_kday_after)
...
void save(Archive & ar,
          const ::autoboost::gregorian::date & d,
          ...
          unsigned int /*version*/)
{
  ...
  ar & make_nvp("date", ds);
  try{
    d = ::autoboost::gregorian::from_undelimited_string(ds);
