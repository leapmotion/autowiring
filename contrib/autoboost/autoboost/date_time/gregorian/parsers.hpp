#ifndef AB_GREGORIAN_PARSERS_HPP___
#define AB_GREGORIAN_PARSERS_HPP___
...
namespace gregorian {
   ...
   * return 'not_special' */
  AUTOBOOST_DATE_TIME_DECL special_values special_value_from_string(const std::string& s);
