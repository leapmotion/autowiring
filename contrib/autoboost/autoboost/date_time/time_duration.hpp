...
#include <autoboost/date_time/time_defs.hpp>
...
namespace date_time {
  ...
  */
  ...
  class AUTOBOOST_SYMBOL_VISIBLE time_duration : private
   ...
   */
  template<class base_duration, autoboost::int64_t frac_of_second>
  class AUTOBOOST_SYMBOL_VISIBLE subsecond_duration : public base_duration
  {
  public:
  ...
  private:
    ...
    AUTOBOOST_STATIC_ASSERT_MSG((traits_type::ticks_per_second >= frac_of_second ? traits_type::ticks_per_second % frac_of_second : frac_of_second % traits_type::ticks_per_second) == 0,\
      "The base duration resolution must be a multiple of the subsecond duration resolution");
    AUTOBOOST_STATIC_CONSTANT(autoboost::int64_t, adjustment_ratio = (traits_type::ticks_per_second >= frac_of_second ? traits_type::ticks_per_second / frac_of_second : frac_of_second / traits_type::ticks_per_second));

  public:
    explicit subsecond_duration(autoboost::int64_t ss) :
