...
#include "autoboost/limits.hpp" //work around compilers without limits
#include "autoboost/date_time/special_defs.hpp"
#include "autoboost/date_time/locale_config.hpp"
...
public:
  ...
  static  int_adapter max AUTOBOOST_PREVENT_MACRO_SUBSTITUTION ()
  {
    return (::std::numeric_limits<int_type>::max)()-2;
  }
  static  int_adapter min AUTOBOOST_PREVENT_MACRO_SUBSTITUTION ()
  {
