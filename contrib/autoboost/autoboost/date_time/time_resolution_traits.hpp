...
namespace date_time {
  ...
  struct time_resolution_traits_bi32_impl {
    typedef autoboost::int32_t int_type;
    typedef autoboost::int32_t impl_type;
  ...
  struct time_resolution_traits_adapted32_impl {
    typedef autoboost::int32_t int_type;
    typedef autoboost::date_time::int_adapter<autoboost::int32_t> impl_type;
  ...
  struct time_resolution_traits_bi64_impl {
    typedef autoboost::int64_t int_type;
    typedef autoboost::int64_t impl_type;
    static int_type as_number(impl_type i){ return i;}
    //! Used to determine if implemented type is int_adapter or int
    static bool is_adapted() { return false;}
  };
  ...
  struct time_resolution_traits_adapted64_impl {
    typedef autoboost::int64_t int_type;
    typedef autoboost::date_time::int_adapter<autoboost::int64_t> impl_type;
    static int_type as_number(impl_type i){ return i.as_number();}
    //! Used to determine if implemented type is int_adapter or int
    static bool is_adapted() { return true;}
  };
  ...
  template<typename frac_sec_type,
           ...
           autoboost::int64_t resolution_adjust,
#else
...
#if (defined(AUTOBOOST_MSVC) && (_MSC_VER < 1300))
    AUTOBOOST_STATIC_CONSTANT(autoboost::int64_t, ticks_per_second = resolution_adjust);
#else
    AUTOBOOST_STATIC_CONSTANT(fractional_seconds_type, ticks_per_second = resolution_adjust);
#endif
