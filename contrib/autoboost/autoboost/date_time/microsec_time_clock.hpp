#ifndef AB_DATE_TIME_HIGHRES_TIME_CLOCK_HPP___
#define AB_DATE_TIME_HIGHRES_TIME_CLOCK_HPP___
...
namespace date_time {
  ...
  private:
    ...
    {
#ifdef AUTOBOOST_HAS_GETTIMEOFDAY
      timeval tv;
      gettimeofday(&tv, 0); //gettimeofday does not support TZ adjust on Linux.
      std::time_t t = tv.tv_sec;
      autoboost::uint32_t sub_sec = tv.tv_usec;
#elif defined(AUTOBOOST_HAS_FTIME)
      winapi::file_time ft;
      ...
      autoboost::uint32_t sub_sec = static_cast<autoboost::uint32_t>(micros % 1000000UL);
#else
#error Internal Boost.DateTime error: AUTOBOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK is defined, however neither gettimeofday nor FILETIME support is detected.
#endif
...
#endif //AUTOBOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK
