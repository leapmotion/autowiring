...
#include "autoboost/date_time/string_parse_tree.hpp"
#include "autoboost/date_time/strings_from_facet.hpp"
                    ...
                    const charT& fill_char)
{
  ...
  try {
    i = autoboost::lexical_cast<int_type>(mr.cache);
                  ...
                  unsigned int max_length)
{
  ...
  int_type i = static_cast<int_type>(-1);
  if(!s.empty()) {
    i = autoboost::lexical_cast<int_type>(s);
  }
  return i;
}
