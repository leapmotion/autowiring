#ifndef AB_DATE_TIME_DATE_GENERATORS_HPP__
#define AB_DATE_TIME_DATE_GENERATORS_HPP__
...
namespace date_time {
 ...
 public:
   ...
   date_type get_date(year_type y) const
   {
     if((day_ == 29) && (month_ == 2) && !(calendar_type::is_leap_year(y))) {
       ...
       autoboost::throw_exception(std::invalid_argument(ss.str()));
     }
 ...
 private:
  ...
  AUTOBOOST_DATE_TIME_DECL const char* nth_as_str(int n);
   ...
   *@code
     typedef autoboost::date_time::first_kday_after<date> firstkdayafter;
  ...
  /*! Date generator that takes a date and finds kday after
   *@code
     typedef autoboost::date_time::first_kday_before<date> firstkdaybefore;
