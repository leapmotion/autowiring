 ...
 */
#ifndef AUTOBOOST_SMART_PTR_DETAIL_ARRAY_UTILITY_HPP
#define AUTOBOOST_SMART_PTR_DETAIL_ARRAY_UTILITY_HPP
...
namespace autoboost {
    namespace detail {
        typedef autoboost::true_type  ms_is_trivial;
        typedef autoboost::false_type ms_no_trivial;
        ...
        inline void ms_destroy(T* memory, std::size_t size) {
            autoboost::has_trivial_destructor<T> trivial;
        ...
        inline void ms_init(T* memory, std::size_t size) {
            autoboost::has_trivial_default_constructor<T> trivial;
