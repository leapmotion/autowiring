 ...
 */
#ifndef AUTOBOOST_SMART_PTR_DETAIL_ARRAY_COUNT_IMPL_HPP
#define AUTOBOOST_SMART_PTR_DETAIL_ARRAY_COUNT_IMPL_HPP

#include <autoboost/smart_ptr/detail/array_allocator.hpp>
