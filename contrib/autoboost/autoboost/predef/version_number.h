...
/*`
``
AUTOBOOST_VERSION_NUMBER_MAJOR(N), AUTOBOOST_VERSION_NUMBER_MINOR(N), AUTOBOOST_VERSION_NUMBER_PATCH(N)
``
...
respectively.
*/
#define AUTOBOOST_VERSION_NUMBER_MAJOR(N) \
    ( ((N)/10000000)%100 )

#define AUTOBOOST_VERSION_NUMBER_MINOR(N) \
    ( ((N)/100000)%100 )

#define AUTOBOOST_VERSION_NUMBER_PATCH(N) \
    ( (N)%100000 )
