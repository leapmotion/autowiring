...
#endif
#if !defined(AUTOBOOST_HW_SIMD_X86) && (defined(__SSE2__) || defined(_M_X64) || (defined(_M_IX86_FP) && _M_IX86_FP >= 2))
#   define AUTOBOOST_HW_SIMD_X86 AUTOBOOST_HW_SIMD_X86_SSE2_VERSION
#endif
#if !defined(AUTOBOOST_HW_SIMD_X86) && (defined(__SSE__) || defined(_M_X64) || (defined(_M_IX86_FP) && _M_IX86_FP >= 1))
