...
#ifndef AB_UUID_1A590226753311DD9E4CCF6156D89593
#define AB_UUID_1A590226753311DD9E4CCF6156D89593
...
autoboost
        ...
        get_info
            ...
            get( exception const & x )
                ...
                if( exception_detail::error_info_container * c=x.data_.get() )
                    if( shared_ptr<exception_detail::error_info_base> eib = c->get(AUTOBOOST_EXCEPTION_STATIC_TYPEID(ErrorInfo)) )
                        {
#ifndef AUTOBOOST_NO_RTTI
                        AUTOBOOST_ASSERT( 0!=dynamic_cast<ErrorInfo *>(eib.get()) );
#endif
    ...
    get_error_info( autoboost::exception const & x )
        {
    ...
    inline
    typename ErrorInfo::value_type *
    get_error_info( autoboost::exception & x )
        {
        return exception_detail::get_info<ErrorInfo>::get(x);
        }
#else
