...
namespace autoboost {
    ...
    public:
        ...
        // construct/copy
        AUTOBOOST_CONSTEXPR basic_string_ref ()
            : ptr_(NULL), len_(0) {}

        AUTOBOOST_CONSTEXPR basic_string_ref (const basic_string_ref &rhs)
        ...
        AUTOBOOST_CONSTEXPR basic_string_ref(const charT* str, size_type len)
            : ptr_(str), len_(len) {}
