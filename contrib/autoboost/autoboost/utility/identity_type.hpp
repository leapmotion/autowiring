...
#ifndef AUTOBOOST_IDENTITY_TYPE_HPP_
#define AUTOBOOST_IDENTITY_TYPE_HPP_
...
*/
#define AUTOBOOST_IDENTITY_TYPE(parenthesized_type) \
    /* must NOT prefix this with `::` to work with parenthesized syntax */ \
    autoboost::function_traits< void parenthesized_type >::arg1_type
