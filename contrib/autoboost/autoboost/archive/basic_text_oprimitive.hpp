#ifndef AUTOBOOST_ARCHIVE_BASIC_TEXT_OPRIMITIVE_HPP
#define AUTOBOOST_ARCHIVE_BASIC_TEXT_OPRIMITIVE_HPP
...
protected:
    ...
    struct is_float {
        typedef typename mpl::bool_<
            autoboost::is_floating_point<T>::value
...
#endif // AUTOBOOST_ARCHIVE_BASIC_TEXT_OPRIMITIVE_HPP
