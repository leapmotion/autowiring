#ifndef AUTOBOOST_ARCHIVE_CODECVT_NULL_HPP
#define AUTOBOOST_ARCHIVE_CODECVT_NULL_HPP
...
namespace std {
// For STLport on WinCE, AUTOBOOST_NO_STDC_NAMESPACE can get defined if STLport is putting symbols in its own namespace.
...
template<>
class AUTOBOOST_SYMBOL_VISIBLE codecvt_null<wchar_t> : public std::codecvt<wchar_t, char, std::mbstate_t>
{
    virtual AUTOBOOST_WARCHIVE_DECL std::codecvt_base::result
    do_out(
        std::mbstate_t & state,
...
#endif //AUTOBOOST_ARCHIVE_CODECVT_NULL_HPP
