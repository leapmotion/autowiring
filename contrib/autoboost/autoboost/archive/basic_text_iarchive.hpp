#ifndef AUTOBOOST_ARCHIVE_BASIC_TEXT_IARCHIVE_HPP
#define AUTOBOOST_ARCHIVE_BASIC_TEXT_IARCHIVE_HPP
...
class AUTOBOOST_SYMBOL_VISIBLE basic_text_iarchive :
...
#endif // AUTOBOOST_ARCHIVE_BASIC_TEXT_IARCHIVE_HPP
