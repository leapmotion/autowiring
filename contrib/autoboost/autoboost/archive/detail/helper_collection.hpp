#ifndef AUTOBOOST_ARCHIVE_DETAIL_HELPER_COLLECTION_HPP
#define AUTOBOOST_ARCHIVE_DETAIL_HELPER_COLLECTION_HPP
...
#endif // AUTOBOOST_ARCHIVE_DETAIL_HELPER_COLLECTION_HPP
