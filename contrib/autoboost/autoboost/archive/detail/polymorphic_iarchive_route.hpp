#ifndef AUTOBOOST_ARCHIVE_DETAIL_POLYMORPHIC_IARCHIVE_ROUTE_HPP
#define AUTOBOOST_ARCHIVE_DETAIL_POLYMORPHIC_IARCHIVE_ROUTE_HPP
...
#include <autoboost/archive/polymorphic_iarchive.hpp>
...
private:
    ...
    virtual void load(autoboost::long_long_type & t){
        ArchiveImplementation::load(t);
    }
    virtual void load(autoboost::ulong_long_type & t){
        ArchiveImplementation::load(t);
    }
...
#endif // AUTOBOOST_ARCHIVE_DETAIL_POLYMORPHIC_IARCHIVE_DISPATCH_HPP
