#ifndef AUTOBOOST_ARCHIVE_DETAIL_COMMON_IARCHIVE_HPP
#define AUTOBOOST_ARCHIVE_DETAIL_COMMON_IARCHIVE_HPP
...
class AUTOBOOST_SYMBOL_VISIBLE common_iarchive :
...
#endif // AUTOBOOST_ARCHIVE_DETAIL_COMMON_IARCHIVE_HPP
