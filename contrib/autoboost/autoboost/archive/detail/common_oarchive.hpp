#ifndef AUTOBOOST_ARCHIVE_DETAIL_COMMON_OARCHIVE_HPP
#define AUTOBOOST_ARCHIVE_DETAIL_COMMON_OARCHIVE_HPP
...
class AUTOBOOST_SYMBOL_VISIBLE common_oarchive :
...
#endif // AUTOBOOST_ARCHIVE_DETAIL_COMMON_OARCHIVE_HPP
