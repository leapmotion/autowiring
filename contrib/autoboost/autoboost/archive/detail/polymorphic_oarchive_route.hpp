#ifndef AUTOBOOST_ARCHIVE_DETAIL_POLYMORPHIC_OARCHIVE_ROUTE_HPP
#define AUTOBOOST_ARCHIVE_DETAIL_POLYMORPHIC_OARCHIVE_ROUTE_HPP
...
private:
    ...
    virtual void save(const autoboost::long_long_type t){
        ArchiveImplementation::save(t);
    }
    virtual void save(const autoboost::ulong_long_type t){
        ArchiveImplementation::save(t);
    }
    #elif defined(AUTOBOOST_HAS_MS_INT64)
    virtual void save(const autoboost::int64_t t){
        ArchiveImplementation::save(t);
    }
    virtual void save(const autoboost::uint64_t t){
        ArchiveImplementation::save(t);
    }
    #endif
...
#endif // AUTOBOOST_ARCHIVE_DETAIL_POLYMORPHIC_OARCHIVE_DISPATCH_HPP
