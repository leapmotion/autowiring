...
class AUTOBOOST_SYMBOL_VISIBLE xml_iarchive_impl :
...
#endif
    // use autoboost:scoped_ptr to implement automatic deletion;
    autoboost::scoped_ptr<xml_grammar> gimpl;
...
class AUTOBOOST_SYMBOL_VISIBLE xml_iarchive :
