#ifndef AUTOBOOST_ARCHIVE_ITERATORS_ESCAPE_HPP
...
class escape :
    ...
    >
{
    typedef typename autoboost::iterator_value<Base>::type base_value_type;
    typedef typename autoboost::iterator_reference<Base>::type reference_type;
...
#endif // AUTOBOOST_ARCHIVE_ITERATORS_ESCAPE_HPP
