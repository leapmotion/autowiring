#ifndef AUTOBOOST_ARCHIVE_ITERATORS_XML_UNESCAPE_HPP
#define AUTOBOOST_ARCHIVE_ITERATORS_XML_UNESCAPE_HPP
    ...
    : public unescape<xml_unescape<Base>, Base>
{
    ...
    typedef typename autoboost::iterator_reference<this_t> reference_type;
...
#endif // AUTOBOOST_ARCHIVE_ITERATORS_XML_UNESCAPE_HPP
