#ifndef AUTOBOOST_ARCHIVE_ITERATORS_ISTREAM_ITERATOR_HPP
#define AUTOBOOST_ARCHIVE_ITERATORS_ISTREAM_ITERATOR_HPP
    ...
    >
{
    ...
    typedef typename autoboost::iterator_facade<
        istream_iterator<Elem>,
        Elem,
        std::input_iterator_tag,
        Elem
...
#endif // AUTOBOOST_ARCHIVE_ITERATORS_ISTREAM_ITERATOR_HPP
