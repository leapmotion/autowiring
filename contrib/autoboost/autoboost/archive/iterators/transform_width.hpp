#ifndef AUTOBOOST_ARCHIVE_ITERATORS_TRANSFORM_WIDTH_HPP
...
template<
    ...
    int BitsOut,
    int BitsIn,
    class CharType = typename autoboost::iterator_value<Base>::type // output character
>
...
public:
    ...
    template<class T>
    transform_width(AUTOBOOST_PFTO_WRAPPER(T) start) :
