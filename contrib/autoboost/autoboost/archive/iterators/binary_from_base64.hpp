#ifndef AUTOBOOST_ARCHIVE_ITERATORS_BINARY_FROM_BASE64_HPP
#define AUTOBOOST_ARCHIVE_ITERATORS_BINARY_FROM_BASE64_HPP
...
struct to_6_bit {
    ...
    CharType operator()(CharType t) const{
        ...
        AUTOBOOST_STATIC_ASSERT(128 == sizeof(lookup_table));
        #endif
        signed char value = -1;
        if((unsigned)t <= 127)
...
#endif // AUTOBOOST_ARCHIVE_ITERATORS_BINARY_FROM_BASE64_HPP
