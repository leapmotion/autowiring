 ...
 */
  ...
  *   FILE         autoboost/regex/config/cwchar.hpp
  *   VERSION      see <autoboost/version.hpp>
  *   DESCRIPTION: regex wide character string fixes.
  */

#ifndef AUTOBOOST_REGEX_CONFIG_CWCHAR_HPP
#define AUTOBOOST_REGEX_CONFIG_CWCHAR_HPP
...
{ return iswalnum(i); }
#undef iswalnum
#elif defined(AUTOBOOST_NO_STDC_NAMESPACE)
using ::iswalnum;
#endif
...
#undef wcscoll
#elif defined(AUTOBOOST_NO_STDC_NAMESPACE) && !defined(UNDER_CE)
using ::wcscoll;
#endif
