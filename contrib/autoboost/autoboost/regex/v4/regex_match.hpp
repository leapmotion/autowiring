...
#define AUTOBOOST_REGEX_MATCH_HPP
...
{
   AUTOBOOST_REGEX_DETAIL_NS::perl_matcher<BidiIterator, Allocator, traits> matcher(first, last, m, e, flags, first);
...
#endif   // AUTOBOOST_REGEX_MATCH_HPP
