...
#define AUTOBOOST_REGEX_MATCHER_HPP

#include <autoboost/regex/v4/iterator_category.hpp>
...
// error checking API:
//
AUTOBOOST_REGEX_DECL void AUTOBOOST_REGEX_CALL verify_options(autoboost::regex_constants::syntax_option_type ef, match_flag_type mf);
//
// function can_start:
//
...
private:
   ...
   {
      return ::autoboost::is_random_access_iterator<BidiIterator>::value ? match_dot_repeat_fast() : match_dot_repeat_slow();
   }
   bool match_backstep();
...
private:
   ...
   const ::autoboost::regex_traits_wrapper<traits>& traits_inst;
...
//
#ifdef AUTOBOOST_REGEX_RECURSIVE
#include <autoboost/regex/v4/perl_matcher_recursive.hpp>
#else
#include <autoboost/regex/v4/perl_matcher_non_recursive.hpp>
#endif
// this one has to be last:
#include <autoboost/regex/v4/perl_matcher_common.hpp>
