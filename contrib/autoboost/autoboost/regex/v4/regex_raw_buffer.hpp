...
#define AUTOBOOST_REGEX_RAW_BUFFER_HPP
...
class AUTOBOOST_REGEX_DECL raw_storage
{
public:
...
public:
   ...
   void* AUTOBOOST_REGEX_CALL insert(size_type pos, size_type n);

   size_type AUTOBOOST_REGEX_CALL size()
   {
      return end - start;
   }

   size_type AUTOBOOST_REGEX_CALL capacity()
   {
      return last - start;
   }

   void* AUTOBOOST_REGEX_CALL data()const
   {
      return start;
   }

   size_type AUTOBOOST_REGEX_CALL index(void* ptr)
   {
      return static_cast<pointer>(ptr) - static_cast<pointer>(data());
   }

   void AUTOBOOST_REGEX_CALL clear()
   {
      end = start;
   }

   void AUTOBOOST_REGEX_CALL align()
   {
...
inline raw_storage::raw_storage(size_type n)
{
   ...
   AUTOBOOST_REGEX_NOEH_ASSERT(start)
   last = start + n;
}
