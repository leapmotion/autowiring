...
#ifndef AUTOBOOST_REGEX_V4_U32REGEX_TOKEN_ITERATOR_HPP
#define AUTOBOOST_REGEX_V4_U32REGEX_TOKEN_ITERATOR_HPP

#if (AUTOBOOST_WORKAROUND(__BORLANDC__, >= 0x560) && AUTOBOOST_WORKAROUND(__BORLANDC__, AUTOBOOST_TESTED_AT(0x570)))\
...
public:
      ...
      : end(last), re(*p), flags(f)
   {
      ...
      AUTOBOOST_STATIC_ASSERT(::autoboost::is_array<T>::value);
...
#endif // AUTOBOOST_REGEX_V4_REGEX_TOKEN_ITERATOR_HPP
