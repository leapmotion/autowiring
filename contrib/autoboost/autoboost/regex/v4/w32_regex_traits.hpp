...
public:
   ...
   regex_constants::escape_syntax_type escape_syntax_type(charT c) const
   {
      ...
      if(i == m_char_map.end())
      {
         if(::autoboost::re_detail::w32_is_lower(c, this->m_locale)) return regex_constants::escape_type_class;
         if(::autoboost::re_detail::w32_is_upper(c, this->m_locale)) return regex_constants::escape_type_not_class;
         return 0;
      }
      return i->second;
   }
   ...
   {
      return ::autoboost::re_detail::w32_tolower(c, this->m_locale);
   }
   bool isctype(autoboost::uint32_t mask, charT c)const
   {
      return ::autoboost::re_detail::w32_is(this->m_locale, mask, c);
   }
   ...
   : w32_regex_traits_base<charT>(l)
{
   ...
   if(cat_name.size())
   {
      cat = ::autoboost::re_detail::w32_cat_open(cat_name);
      if(!cat)
      {
   ...
   if(cat)
   {
      ...
      {
         string_type mss = ::autoboost::re_detail::w32_cat_get(cat, this->m_locale, i, get_default_message(i));
...
public:
   w32_regex_traits_char_layer(::autoboost::re_detail::lcid_type l)
...
public:
   ...
   w32_regex_traits_implementation(::autoboost::re_detail::lcid_type l);
   ...
   {
      return ::autoboost::re_detail::w32_transform(this->m_locale, p1, p2);
   }
private:
...
template <class charT>
w32_regex_traits_implementation<charT>::w32_regex_traits_implementation(::autoboost::re_detail::lcid_type l)
: w32_regex_traits_char_layer<charT>(l)
{
   ...
   if(cat)
   {
         ...
         i = static_cast<autoboost::regex_constants::error_type>(i + 1))
      {
         ...
         string_type s = ::autoboost::re_detail::w32_cat_get(cat, this->m_locale, i+200, default_message);
         std::string result;
      ...
      {
         string_type s(::autoboost::re_detail::w32_cat_get(cat, this->m_locale, j+300, null_string));
         if(s.size())
...
template <class charT>
autoboost::shared_ptr<const w32_regex_traits_implementation<charT> > create_w32_regex_traits(::autoboost::re_detail::lcid_type l)
{
   // TODO: create a cache for previously constructed objects.
   return autoboost::object_cache< ::autoboost::re_detail::lcid_type, w32_regex_traits_implementation<charT> >::get(l, 5);
}
...
public:
   ...
   {
      return ::autoboost::re_detail::w32_toupper(c, this->m_pimpl->m_locale);
   }
   string_type transform(const charT* p1, const charT* p2) const
   {
      return ::autoboost::re_detail::w32_transform(this->m_pimpl->m_locale, p1, p2);
   }
   string_type transform_primary(const charT* p1, const charT* p2) const
   {
   ...
   {
      int result = ::autoboost::re_detail::global_value(c);
      return result < radix ? result : -1;
   }
   locale_type imbue(locale_type l)
   {
      ::autoboost::re_detail::lcid_type result(getloc());
...
private:
   autoboost::shared_ptr<const re_detail::w32_regex_traits_implementation<charT> > m_pimpl;
   //
