...
#define AUTOBOOST_REGEX_V4_MATCH_FLAGS
...
#if defined(__BORLANDC__) || AUTOBOOST_WORKAROUND(AUTOBOOST_MSVC, <= 1310)
...
{ return static_cast<match_flags>(static_cast<autoboost::int32_t>(m1) & static_cast<autoboost::int32_t>(m2)); }
inline match_flags operator|(match_flags m1, match_flags m2)
{ return static_cast<match_flags>(static_cast<autoboost::int32_t>(m1) | static_cast<autoboost::int32_t>(m2)); }
inline match_flags operator^(match_flags m1, match_flags m2)
{ return static_cast<match_flags>(static_cast<autoboost::int32_t>(m1) ^ static_cast<autoboost::int32_t>(m2)); }
inline match_flags operator~(match_flags m1)
{ return static_cast<match_flags>(~static_cast<autoboost::int32_t>(m1)); }
inline match_flags& operator&=(match_flags& m1, match_flags m2)
{ m1 = m1&m2; return m1; }
inline match_flags& operator|=(match_flags& m1, match_flags m2)
{ m1 = m1|m2; return m1; }
