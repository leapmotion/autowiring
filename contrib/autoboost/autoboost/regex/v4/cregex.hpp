 ...
 */
  ...
  *                + autoboost::RegEx high level wrapper.
  */

#ifndef AUTOBOOST_RE_CREGEX_HPP_INCLUDED
#define AUTOBOOST_RE_CREGEX_HPP_INCLUDED
...
#if defined(__cplusplus) && !defined(AUTOBOOST_NO_STDC_NAMESPACE)
...
AUTOBOOST_REGEX_DECL int AUTOBOOST_REGEX_CCALL regcompA(regex_tA*, const char*, int);
AUTOBOOST_REGEX_DECL regsize_t AUTOBOOST_REGEX_CCALL regerrorA(int, const regex_tA*, char*, regsize_t);
AUTOBOOST_REGEX_DECL int AUTOBOOST_REGEX_CCALL regexecA(const regex_tA*, const char*, regsize_t, regmatch_t*, int);
AUTOBOOST_REGEX_DECL void AUTOBOOST_REGEX_CCALL regfreeA(regex_tA*);

#ifndef AUTOBOOST_NO_WREGEX
AUTOBOOST_REGEX_DECL int AUTOBOOST_REGEX_CCALL regcompW(regex_tW*, const wchar_t*, int);
AUTOBOOST_REGEX_DECL regsize_t AUTOBOOST_REGEX_CCALL regerrorW(int, const regex_tW*, wchar_t*, regsize_t);
AUTOBOOST_REGEX_DECL int AUTOBOOST_REGEX_CCALL regexecW(const regex_tW*, const wchar_t*, regsize_t, regmatch_t*, int);
AUTOBOOST_REGEX_DECL void AUTOBOOST_REGEX_CCALL regfreeW(regex_tW*);
#endif
