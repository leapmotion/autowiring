...
#define AUTOBOOST_REGEX_V4_REGEX_GREP_HPP
                               ...
                               match_flag_type flags = match_default)
{
   ...
   AUTOBOOST_REGEX_DETAIL_NS::perl_matcher<BidiIterator, match_allocator_type, traits> matcher(first, last, m, e, flags, first);
...
#endif  // AUTOBOOST_REGEX_V4_REGEX_GREP_HPP
