...
// want AUTOBOOST_REGEX_DYN_LINK to set up dll exports/imports
// with __declspec(dllexport)/__declspec(dllimport.)
// #define AUTOBOOST_REGEX_HAS_DLL_RUNTIME

// define this if you want to dynamically link to regex,
// if the runtime library is also a dll (Probably Win32 specific,
// and has no effect unless AUTOBOOST_REGEX_HAS_DLL_RUNTIME is set):
// #define AUTOBOOST_REGEX_DYN_LINK
...
// #define AUTOBOOST_REGEX_NO_BOOL
...
// even if AUTOBOOST_REGEX_HAS_MS_STACK_GUARD is not defined.
