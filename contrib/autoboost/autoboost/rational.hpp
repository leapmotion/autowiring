...
#include <autoboost/config.hpp>      // for AUTOBOOST_NO_STDC_NAMESPACE, AUTOBOOST_MSVC
#include <autoboost/detail/workaround.hpp> // for AUTOBOOST_WORKAROUND
#include <autoboost/assert.hpp>      // for AUTOBOOST_ASSERT
#include <autoboost/math/common_factor_rt.hpp>  // for autoboost::math::gcd, lcm
...
inline T rational_cast(
    const rational<IntType>& src AUTOBOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
