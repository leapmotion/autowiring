...
#include <autoboost/atomic/detail/casts.hpp>
...
public:
    AUTOBOOST_FORCEINLINE explicit base_atomic(value_type const& v = value_type()) AUTOBOOST_NOEXCEPT : m_storage(atomics::detail::memcpy_cast< storage_type >(v))
    {
    }
...
public:
    AUTOBOOST_DEFAULTED_FUNCTION(base_atomic(), {})
    AUTOBOOST_FORCEINLINE explicit base_atomic(value_type const& v) AUTOBOOST_NOEXCEPT : m_storage(atomics::detail::union_cast< storage_type >(v))
    {
    }
...
public:
    ...
    AUTOBOOST_FORCEINLINE storage_type& storage() AUTOBOOST_NOEXCEPT { return this->m_storage; }
    AUTOBOOST_FORCEINLINE storage_type volatile& storage() volatile AUTOBOOST_NOEXCEPT { return this->m_storage; }
    AUTOBOOST_FORCEINLINE storage_type const& storage() const AUTOBOOST_NOEXCEPT { return this->m_storage; }
    AUTOBOOST_FORCEINLINE storage_type const volatile& storage() const volatile AUTOBOOST_NOEXCEPT { return this->m_storage; }
