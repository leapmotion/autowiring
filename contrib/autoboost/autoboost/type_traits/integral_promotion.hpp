...
// 4.5/2
template <class T> struct need_promotion : public autoboost::is_enum<T> {};
...
#define AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(T) \
...
AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(__int8          )
AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(unsigned __int8 )
AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(__int16         )
AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(unsigned __int16)
AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(__int32         )
AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(unsigned __int32)
#ifdef __BORLANDC__
AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(unsigned __int64)
AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(         __int64)
#endif
#endif

#if defined(AUTOBOOST_HAS_LONG_LONG)
AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(autoboost::ulong_long_type)
AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(autoboost::long_long_type )
#elif defined(AUTOBOOST_HAS_MS_INT64)
AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(unsigned __int64)
AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(         __int64)
#endif

#undef AUTOBOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE
...
#define AUTOBOOST_TT_AUX_PROMOTE_FROM_INDEX(N,T)                                   \
...
AUTOBOOST_TT_AUX_PROMOTE_FROM_INDEX(1, int          )
AUTOBOOST_TT_AUX_PROMOTE_FROM_INDEX(2, unsigned int )
AUTOBOOST_TT_AUX_PROMOTE_FROM_INDEX(3, long         )
AUTOBOOST_TT_AUX_PROMOTE_FROM_INDEX(4, unsigned long)
...
#if defined(AUTOBOOST_HAS_LONG_LONG)
AUTOBOOST_TT_AUX_PROMOTE_FROM_INDEX(5, autoboost::long_long_type )
AUTOBOOST_TT_AUX_PROMOTE_FROM_INDEX(6, autoboost::ulong_long_type)
#elif defined(AUTOBOOST_HAS_MS_INT64)
AUTOBOOST_TT_AUX_PROMOTE_FROM_INDEX(7, __int64         )
AUTOBOOST_TT_AUX_PROMOTE_FROM_INDEX(8, unsigned __int64)
#endif

#undef AUTOBOOST_TT_AUX_PROMOTE_FROM_INDEX


// Define AUTOBOOST_TT_AUX_PROMOTED_INDEX_TESTER:
...
#define AUTOBOOST_TT_AUX_PROMOTED_INDEX_TESTER(I,T) \
...
AUTOBOOST_TT_AUX_PROMOTED_INDEX_TESTER(1, int          )
AUTOBOOST_TT_AUX_PROMOTED_INDEX_TESTER(2, unsigned int )
AUTOBOOST_TT_AUX_PROMOTED_INDEX_TESTER(3, long         )
AUTOBOOST_TT_AUX_PROMOTED_INDEX_TESTER(4, unsigned long)

#if defined(AUTOBOOST_HAS_LONG_LONG)
AUTOBOOST_TT_AUX_PROMOTED_INDEX_TESTER(5, autoboost::long_long_type )
AUTOBOOST_TT_AUX_PROMOTED_INDEX_TESTER(6, autoboost::ulong_long_type)
#elif defined(AUTOBOOST_HAS_MS_INT64)
AUTOBOOST_TT_AUX_PROMOTED_INDEX_TESTER(7, __int64         )
AUTOBOOST_TT_AUX_PROMOTED_INDEX_TESTER(8, unsigned __int64)
#endif

#undef AUTOBOOST_TT_AUX_PROMOTED_INDEX_TESTER
...
struct promoted_index
{
    ...
    AUTOBOOST_STATIC_CONSTANT(int, value = sizeof(promoted_index_tester(+testee)) );
...
{
    typedef AUTOBOOST_DEDUCED_TYPENAME promote_from_index<
        (autoboost::type_traits::detail::promoted_index<T>::value)
