...
#ifndef AUTOBOOST_TT_ADD_POINTER_HPP_INCLUDED
#define AUTOBOOST_TT_ADD_POINTER_HPP_INCLUDED
...
AUTOBOOST_TT_AUX_TYPE_TRAIT_DEF1(add_pointer,T,typename autoboost::detail::add_pointer_impl<T>::type)

} // namespace autoboost

#include <autoboost/type_traits/detail/type_trait_undef.hpp>

#endif // AUTOBOOST_TT_ADD_POINTER_HPP_INCLUDED
