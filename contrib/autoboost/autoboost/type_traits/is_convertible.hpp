...
#ifndef AUTOBOOST_TT_IS_CONVERTIBLE_HPP_INCLUDED
...
#  define AUTOBOOST_TT_CXX11_IS_CONVERTIBLE
...
#pragma option push -w-8074
    ...
    template <typename T> struct checker
    {
        ...
        static ::autoboost::type_traits::yes_type AUTOBOOST_TT_DECL _m_check(T);
    };
...
#if !defined(AUTOBOOST_NO_CXX11_RVALUE_REFERENCES) && ((__GNUC__ > 4) || ((__GNUC__ == 4) && (__GNUC_MINOR__ > 6)))
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::autoboost::type_traits::no_type AUTOBOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::autoboost::type_traits::yes_type AUTOBOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
