...
#ifndef AUTOBOOST_TT_HAS_PLUS_ASSIGN_HPP_INCLUDED
#define AUTOBOOST_TT_HAS_PLUS_ASSIGN_HPP_INCLUDED

#define AUTOBOOST_TT_TRAIT_NAME has_plus_assign
...
#define AUTOBOOST_TT_FORBIDDEN_IF\
   (\
      ...
      (\
         ::autoboost::is_pointer< Rhs_noref >::value && \
         ::autoboost::is_fundamental< Lhs_nocv >::value && \
         (!  ::autoboost::is_same< Lhs_nocv, bool >::value )\
      ) || \
