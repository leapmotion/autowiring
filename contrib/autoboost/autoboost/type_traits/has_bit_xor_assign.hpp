...
#ifndef AUTOBOOST_TT_HAS_BIT_XOR_ASSIGN_HPP_INCLUDED
#define AUTOBOOST_TT_HAS_BIT_XOR_ASSIGN_HPP_INCLUDED

#define AUTOBOOST_TT_TRAIT_NAME has_bit_xor_assign
