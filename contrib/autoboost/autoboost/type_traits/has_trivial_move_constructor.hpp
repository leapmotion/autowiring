...
struct has_trivial_move_ctor_impl
{
   ...
   AUTOBOOST_STATIC_CONSTANT(bool, value = (AUTOBOOST_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T)));
#else
...
AUTOBOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_move_constructor,T,::autoboost::detail::has_trivial_move_ctor_impl<T>::value)

AUTOBOOST_TT_AUX_BOOL_TRAIT_SPEC1(has_trivial_move_constructor,void,false)
#ifndef AUTOBOOST_NO_CV_VOID_SPECIALIZATIONS
AUTOBOOST_TT_AUX_BOOL_TRAIT_SPEC1(has_trivial_move_constructor,void const,false)
AUTOBOOST_TT_AUX_BOOL_TRAIT_SPEC1(has_trivial_move_constructor,void const volatile,false)
AUTOBOOST_TT_AUX_BOOL_TRAIT_SPEC1(has_trivial_move_constructor,void volatile,false)
#endif
