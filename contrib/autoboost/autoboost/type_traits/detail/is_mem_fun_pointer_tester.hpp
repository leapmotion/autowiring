...
#ifndef AUTOBOOST_TT_DETAIL_IS_MEM_FUN_POINTER_TESTER_HPP_INCLUDED
...
#define AUTOBOOST_PP_ITERATION_PARAMS_1 \
    (3, (0, 25, "autoboost/type_traits/detail/is_mem_fun_pointer_tester.hpp"))
...
#endif // AUTOBOOST_TT_DETAIL_IS_MEM_FUN_POINTER_TESTER_HPP_INCLUDED
...
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)));

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)) const);

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)) volatile);

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)) const volatile);
...
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T) ...) const volatile);
@#endif
@#ifdef AUTOBOOST_TT_TEST_MS_FUNC_SIGS // Other calling conventions used by MS compatible compilers:
template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)));

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)) const);

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)) volatile);

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)) const volatile);

@#ifndef _MANAGED
template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)));

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)) const);

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)) volatile);

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)) const volatile);

@#endif

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)));

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)) const);

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)) volatile);

template <class R, class T AUTOBOOST_PP_COMMA_IF(AUTOBOOST_PP_COUNTER) AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(AUTOBOOST_PP_ENUM_PARAMS(AUTOBOOST_PP_COUNTER,T)) const volatile);
