...
no_operator operator AUTOBOOST_TT_TRAIT_OP (const any&);
...
// (AUTOBOOST_TT_TRAIT_OP rhs, returns_void_t()) to deduce if
// operator AUTOBOOST_TT_TRAIT_OP returns void or not:
// - operator AUTOBOOST_TT_TRAIT_OP returns void   -> (AUTOBOOST_TT_TRAIT_OP rhs, returns_void_t()) returns returns_void_t
// - operator AUTOBOOST_TT_TRAIT_OP returns !=void -> (AUTOBOOST_TT_TRAIT_OP rhs, returns_void_t()) returns int
...
struct operator_returns_void {
   ...
   AUTOBOOST_STATIC_CONSTANT(bool, value = (sizeof(::autoboost::type_traits::yes_type)==sizeof(returns_void((AUTOBOOST_TT_TRAIT_OP make<Rhs>(),returns_void_t())))));
};
...
struct operator_returns_Ret < Rhs, Ret, false > {
   ...
   AUTOBOOST_STATIC_CONSTANT(bool, value = (sizeof(is_convertible_to_Ret(AUTOBOOST_TT_TRAIT_OP make<Rhs>()))==sizeof(::autoboost::type_traits::yes_type)));
};
...
struct operator_exists {
   ...
   AUTOBOOST_STATIC_CONSTANT(bool, value = (sizeof(s_check(((AUTOBOOST_TT_TRAIT_OP make<Rhs>()),make<has_operator>())))==sizeof(::autoboost::type_traits::yes_type)));
};


// 6. main trait: to avoid any compilation error, this class behaves
// differently when operator AUTOBOOST_TT_TRAIT_OP(Rhs) is forbidden by the
// standard.
// Forbidden_if is a bool that is:
// - true when the operator AUTOBOOST_TT_TRAIT_OP(Rhs) is forbidden by the standard
...
template < typename Rhs, typename Ret >
struct trait_impl {
   typedef typename ::autoboost::remove_reference<Rhs>::type Rhs_noref;
   typedef typename ::autoboost::remove_cv<Rhs_noref>::type Rhs_nocv;
   typedef typename ::autoboost::remove_cv< typename ::autoboost::remove_reference< typename ::autoboost::remove_pointer<Rhs_noref>::type >::type >::type Rhs_noptr;
   AUTOBOOST_STATIC_CONSTANT(bool, value = (trait_impl1 < Rhs_noref, Ret, AUTOBOOST_TT_FORBIDDEN_IF >::value));
};
...
template <class Rhs, class Ret=::autoboost::detail::AUTOBOOST_JOIN(AUTOBOOST_TT_TRAIT_NAME,_impl)::dont_care>
struct AUTOBOOST_TT_TRAIT_NAME : public integral_constant<bool, (::autoboost::detail::AUTOBOOST_JOIN(AUTOBOOST_TT_TRAIT_NAME, _impl)::trait_impl < Rhs, Ret >::value)>{};
