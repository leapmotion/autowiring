...
AUTOBOOST_TT_AUX_BOOL_TRAIT_DEF2(AUTOBOOST_TT_TRAIT_NAME, Rhs, Ret=::autoboost::detail::AUTOBOOST_JOIN(AUTOBOOST_TT_TRAIT_NAME,_impl)::dont_care, (::autoboost::detail::AUTOBOOST_JOIN(AUTOBOOST_TT_TRAIT_NAME,_impl)::trait_impl < Rhs, Ret >::value))
