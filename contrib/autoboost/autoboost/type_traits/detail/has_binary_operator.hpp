...
no_operator operator AUTOBOOST_TT_TRAIT_OP (const any&, const any&);
...
// (lhs AUTOBOOST_TT_TRAIT_OP rhs, returns_void_t()) to deduce if
// operator AUTOBOOST_TT_TRAIT_OP returns void or not:
// - operator AUTOBOOST_TT_TRAIT_OP returns void   -> (lhs AUTOBOOST_TT_TRAIT_OP rhs, returns_void_t()) returns returns_void_t
// - operator AUTOBOOST_TT_TRAIT_OP returns !=void -> (lhs AUTOBOOST_TT_TRAIT_OP rhs, returns_void_t()) returns int
...
struct operator_returns_void {
   ...
   AUTOBOOST_STATIC_CONSTANT(bool, value = (sizeof(::autoboost::type_traits::yes_type)==sizeof(returns_void((make<Lhs>() AUTOBOOST_TT_TRAIT_OP make<Rhs>(),returns_void_t())))));
};
...
struct operator_returns_Ret < Lhs, Rhs, Ret, false > {
   ...
   AUTOBOOST_STATIC_CONSTANT(bool, value = (sizeof(is_convertible_to_Ret(make<Lhs>() AUTOBOOST_TT_TRAIT_OP make<Rhs>()))==sizeof(::autoboost::type_traits::yes_type)));
};
...
struct operator_exists {
   ...
   AUTOBOOST_STATIC_CONSTANT(bool, value = (sizeof(s_check(((make<Lhs>() AUTOBOOST_TT_TRAIT_OP make<Rhs>()),make<has_operator>())))==sizeof(::autoboost::type_traits::yes_type)));
};


// 6. main trait: to avoid any compilation error, this class behaves
// differently when operator AUTOBOOST_TT_TRAIT_OP(Lhs, Rhs) is forbidden by the
// standard.
// Forbidden_if is a bool that is:
// - true when the operator AUTOBOOST_TT_TRAIT_OP(Lhs, Rhs) is forbidden by the standard
...
struct trait_impl {
   ...
   AUTOBOOST_STATIC_CONSTANT(bool, value = (trait_impl1 < Lhs_noref, Rhs_noref, Ret, AUTOBOOST_TT_FORBIDDEN_IF >::value));
};
