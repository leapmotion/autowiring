/*******************************************************************************
 * autoboost/type_traits/detail/common_type_imp.hpp
 *
 * Copyright 2010, Jeffrey Hellrung.
 * Distributed under the Boost Software License, Version 1.0.  (See accompanying
 * file LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
 *
 * struct autoboost::common_type<T,U>
 *
...
#ifndef AUTOBOOST_TYPE_TRAITS_DETAIL_COMMON_TYPE_IMP_HPP
#define AUTOBOOST_TYPE_TRAITS_DETAIL_COMMON_TYPE_IMP_HPP
...
AUTOBOOST_MPL_ASSERT_RELATION( sizeof( yes_type ), ==, 1 );
AUTOBOOST_MPL_ASSERT_RELATION( sizeof( no_type ), ==, 2 );
...
struct common_type_impl
    : public common_type_dispatch_on_rvalueness<T,U, sizeof( ::autoboost::detail_type_traits_common_type::rvalue_test(
...
#endif // AUTOBOOST_TYPE_TRAITS_DETAIL_COMMON_TYPE_HPP
