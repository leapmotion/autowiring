#ifndef AUTOBOOST_TYPE_TRAITS_DETAIL_COMPOSITE_MEMBER_POINTER_TYPE_HPP_INCLUDED
#define AUTOBOOST_TYPE_TRAITS_DETAIL_COMPOSITE_MEMBER_POINTER_TYPE_HPP_INCLUDED
...
template<class C1, class C2> struct common_member_class
{
    typedef typename autoboost::conditional<
        ...
        autoboost::is_base_of<C1, C2>::value,
        C2,
        typename autoboost::conditional<autoboost::is_base_of<C2, C1>::value, C1, void>::type
...
private:
    ...
    typedef typename autoboost::remove_pointer<CPT>::type CT;
...
#endif // #ifndef AUTOBOOST_TYPE_TRAITS_DETAIL_COMPOSITE_MEMBER_POINTER_TYPE_HPP_INCLUDED
