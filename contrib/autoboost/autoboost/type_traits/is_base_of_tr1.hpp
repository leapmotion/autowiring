...
namespace autoboost { namespace tr1{
   ...
   namespace detail{
      ...
      struct is_base_of_imp
      {
          ...
          AUTOBOOST_STATIC_CONSTANT(bool, value = ((::autoboost::detail::is_base_and_derived_impl<ncvB,ncvD>::value) || (::autoboost::is_same<ncvB,ncvD>::value)));
      };
   }

   template <class Base, class Derived> struct is_base_of
      : public integral_constant<bool, (::autoboost::tr1::detail::is_base_of_imp<Base, Derived>::value)>{};
