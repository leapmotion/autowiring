...
#ifndef AUTOBOOST_TT_HAS_BIT_AND_ASSIGN_HPP_INCLUDED
#define AUTOBOOST_TT_HAS_BIT_AND_ASSIGN_HPP_INCLUDED

#define AUTOBOOST_TT_TRAIT_NAME has_bit_and_assign
