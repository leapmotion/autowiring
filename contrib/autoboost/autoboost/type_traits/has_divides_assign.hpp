...
#ifndef AUTOBOOST_TT_HAS_DIVIDES_ASSIGN_HPP_INCLUDED
#define AUTOBOOST_TT_HAS_DIVIDES_ASSIGN_HPP_INCLUDED

#define AUTOBOOST_TT_TRAIT_NAME has_divides_assign
