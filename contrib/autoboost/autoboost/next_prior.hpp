...
#ifndef AUTOBOOST_NEXT_PRIOR_HPP_INCLUDED
#define AUTOBOOST_NEXT_PRIOR_HPP_INCLUDED
...
//    const std::list<T>::iterator prev = autoboost::prior(p);
//    const std::list<T>::iterator next = autoboost::next(prev, 2);
...
#endif  // AUTOBOOST_NEXT_PRIOR_HPP_INCLUDED
