...
#ifndef AUTOBOOST_MPL_ORDER_HPP_INCLUDED
#define AUTOBOOST_MPL_ORDER_HPP_INCLUDED
...
{
    AUTOBOOST_MPL_AUX_LAMBDA_SUPPORT(2,order,(AssociativeSequence,Key))
};

AUTOBOOST_MPL_AUX_NA_SPEC(2, order)

}}

#endif // AUTOBOOST_MPL_ORDER_HPP_INCLUDED
