...
// Preprocessed version of "autoboost/mpl/inherit.hpp" header
...
AUTOBOOST_MPL_AUX_NA_SPEC(3, inherit3)
...
AUTOBOOST_MPL_AUX_NA_SPEC(4, inherit4)
...
AUTOBOOST_MPL_AUX_NA_SPEC(5, inherit5)
...
AUTOBOOST_MPL_AUX_NA_SPEC_LAMBDA(5, inherit)
AUTOBOOST_MPL_AUX_NA_SPEC_ARITY(5, inherit)
AUTOBOOST_MPL_AUX_NA_SPEC_TEMPLATE_ARITY(5, 5, inherit)
}}
