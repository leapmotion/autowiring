...
#   define AUX778076_ITER_FOLD_FORWARD_STEP(unused, n_, unused2) \
    typedef typename apply2< \
          ForwardOp \
        , AUTOBOOST_PP_CAT(fwd_state,n_) \
        , AUX778076_FOLD_IMPL_OP(AUTOBOOST_PP_CAT(iter,n_)) \
        >::type AUTOBOOST_PP_CAT(fwd_state,AUTOBOOST_PP_INC(n_)); \
    typedef typename mpl::next<AUTOBOOST_PP_CAT(iter,n_)>::type \
        AUTOBOOST_PP_CAT(iter,AUTOBOOST_PP_INC(n_)); \
    /**/

#   define AUX778076_ITER_FOLD_BACKWARD_STEP_FUNC(n_) \
    typedef typename apply2< \
          BackwardOp \
        , AUTOBOOST_PP_CAT(bkwd_state,n_) \
        , AUX778076_FOLD_IMPL_OP(AUTOBOOST_PP_CAT(iter,AUTOBOOST_PP_DEC(n_))) \
        >::type AUTOBOOST_PP_CAT(bkwd_state,AUTOBOOST_PP_DEC(n_)); \
    /**/

#   define AUX778076_ITER_FOLD_BACKWARD_STEP(unused, n_, j) \
    AUX778076_ITER_FOLD_BACKWARD_STEP_FUNC( \
          AUTOBOOST_PP_SUB_D(1,j,n_) \
        ) \
    /**/

#   define AUX778076_FIRST_BACKWARD_STATE_TYPEDEF(n_) \
    typedef typename nested_chunk::state AUTOBOOST_PP_CAT(bkwd_state,n_);
    /**/
...
#   define AUTOBOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, AUTOBOOST_MPL_LIMIT_UNROLLING, <autoboost/mpl/aux_/reverse_fold_impl_body.hpp>))
...
struct AUX778076_FOLD_IMPL_NAME
{
    ...
    typedef AUX778076_FOLD_IMPL_NAME<
        ...
        , AUTOBOOST_PP_CAT(iter,AUTOBOOST_MPL_LIMIT_UNROLLING)
        , Last
        , AUTOBOOST_PP_CAT(fwd_state,AUTOBOOST_MPL_LIMIT_UNROLLING)
        , BackwardOp
        , ForwardOp
        > nested_chunk;
...
struct AUX778076_FOLD_CHUNK_NAME<-1>
{
    ...
    struct result_
    {
        typedef typename if_<
            ...
            , AUTOBOOST_PP_CAT(AUX778076_FOLD_IMPL_NAME_PREFIX,_step)<First,Last,State,BackwardOp,ForwardOp>
            >::type res_;
...
struct AUX778076_FOLD_IMPL_NAME<n_,First,Last,State,BackwardOp,ForwardOp>
{
    ...
    typedef AUTOBOOST_PP_CAT(fwd_state,n_) AUTOBOOST_PP_CAT(bkwd_state,n_);
