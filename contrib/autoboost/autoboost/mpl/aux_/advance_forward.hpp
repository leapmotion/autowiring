...
#ifndef AUTOBOOST_MPL_AUX_ADVANCE_FORWARD_HPP_INCLUDED
#define AUTOBOOST_MPL_AUX_ADVANCE_FORWARD_HPP_INCLUDED
...
#   define AUTOBOOST_MPL_PREPROCESSED_HEADER advance_forward.hpp
...
// forward declaration
template< AUTOBOOST_MPL_AUX_NTTP_DECL(long, N) > struct advance_forward;

#   define AUTOBOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, AUTOBOOST_MPL_LIMIT_UNROLLING, <autoboost/mpl/aux_/advance_forward.hpp>))
...
struct advance_forward
{
    template< typename Iterator > struct apply
    {
        typedef typename apply_wrap1<
              advance_forward<AUTOBOOST_MPL_LIMIT_UNROLLING>
            , Iterator
            >::type chunk_result_;
...
#endif // AUTOBOOST_MPL_AUX_ADVANCE_FORWARD_HPP_INCLUDED
...
template<>
struct advance_forward< AUTOBOOST_PP_FRAME_ITERATION(1) >
{
    template< typename Iterator > struct apply
    {
...
#   define AUTOBOOST_PP_ITERATION_PARAMS_2 \
    (3,(1, i_, <autoboost/mpl/aux_/advance_forward.hpp>))
#   include AUTOBOOST_PP_ITERATE()
#endif
        typedef AUTOBOOST_PP_CAT(iter,i_) type;
    };
