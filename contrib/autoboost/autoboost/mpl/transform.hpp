...
#ifndef AUTOBOOST_MPL_TRANSFORM_HPP_INCLUDED
#define AUTOBOOST_MPL_TRANSFORM_HPP_INCLUDED
...
#include <autoboost/mpl/pair_view.hpp>
...
template<                                                               \
    ...
    , typename AUTOBOOST_MPL_AUX_NA_PARAM(Seq2OrOperation)                  \
    , typename AUTOBOOST_MPL_AUX_NA_PARAM(OperationOrInserter)              \
    , typename AUTOBOOST_MPL_AUX_NA_PARAM(Inserter)                         \
    >                                                                   \
struct name                                                             \
{                                                                       \
...
AUTOBOOST_MPL_AUX_NA_SPEC(4, name)                                          \
/**/
...
#endif // AUTOBOOST_MPL_TRANSFORM_HPP_INCLUDED
