...
#ifndef AUTOBOOST_MPL_SET_C_HPP_INCLUDED
#define AUTOBOOST_MPL_SET_C_HPP_INCLUDED
...
#   include <autoboost/mpl/limits/set.hpp>
...
#   define AUX778076_SET_C_HEADER \
    AUTOBOOST_PP_CAT(AUTOBOOST_PP_CAT(set,AUTOBOOST_MPL_LIMIT_SET_SIZE),_c).hpp \
    /**/
#else
#   define AUX778076_SET_C_HEADER \
    AUTOBOOST_PP_CAT(AUTOBOOST_PP_CAT(set,AUTOBOOST_MPL_LIMIT_SET_SIZE),_c)##.hpp \
...
#   include AUTOBOOST_PP_STRINGIZE(autoboost/mpl/set/AUX778076_SET_C_HEADER)
...
#   define AUTOBOOST_MPL_PREPROCESSED_HEADER set_c.hpp
...
#   define AUX778076_SEQUENCE_LIMIT AUTOBOOST_MPL_LIMIT_SET_SIZE
#   define AUX778076_SEQUENCE_NAME_N(n) AUTOBOOST_PP_CAT(AUTOBOOST_PP_CAT(set,n),_c)
...
#endif // AUTOBOOST_MPL_SET_C_HPP_INCLUDED
