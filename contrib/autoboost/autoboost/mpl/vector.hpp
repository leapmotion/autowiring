...
#ifndef AUTOBOOST_MPL_VECTOR_HPP_INCLUDED
#define AUTOBOOST_MPL_VECTOR_HPP_INCLUDED
...
#   define AUX778076_VECTOR_HEADER \
    AUTOBOOST_PP_CAT(vector, AUTOBOOST_MPL_LIMIT_VECTOR_SIZE).hpp \
    /**/
#else
#   define AUX778076_VECTOR_HEADER \
    AUTOBOOST_PP_CAT(vector, AUTOBOOST_MPL_LIMIT_VECTOR_SIZE)##.hpp \
...
#   include AUTOBOOST_PP_STRINGIZE(autoboost/mpl/vector/AUX778076_VECTOR_HEADER)
...
#   define AUTOBOOST_MPL_PREPROCESSED_HEADER vector.hpp
...
#endif // AUTOBOOST_MPL_VECTOR_HPP_INCLUDED
