...
#ifndef AUTOBOOST_MPL_CHAR_FWD_HPP_INCLUDED
#define AUTOBOOST_MPL_CHAR_FWD_HPP_INCLUDED
...
template< AUTOBOOST_MPL_AUX_NTTP_DECL(char, N) > struct char_;

AUTOBOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE
AUTOBOOST_MPL_AUX_ADL_BARRIER_DECL(char_)

#endif // AUTOBOOST_MPL_CHAR_FWD_HPP_INCLUDED
