...
#ifndef AUTOBOOST_MPL_MAP_AUX_ITEM_HPP_INCLUDED
#define AUTOBOOST_MPL_MAP_AUX_ITEM_HPP_INCLUDED
    ...
    : Base
{
    ...
    AUTOBOOST_MPL_AUX_MAP_OVERLOAD( aux::type_wrapper<T>, VALUE_BY_KEY, m_item, aux::type_wrapper<Key>* );
    AUTOBOOST_MPL_AUX_MAP_OVERLOAD( aux::type_wrapper<item>, ITEM_BY_ORDER, m_item, order* );
    AUTOBOOST_MPL_AUX_MAP_OVERLOAD( order_tag_, ORDER_BY_KEY, m_item, aux::type_wrapper<Key>* );
};
    ...
    : Base
{
    ...
    AUTOBOOST_MPL_AUX_MAP_OVERLOAD( aux::type_wrapper<void_>, VALUE_BY_KEY, m_mask, aux::type_wrapper<Key>* );
    AUTOBOOST_MPL_AUX_MAP_OVERLOAD( aux::type_wrapper<void_>, ITEM_BY_ORDER, m_mask, key_order_* );
};
    ...
    : Base
{
    ...
    AUTOBOOST_MPL_AUX_MAP_OVERLOAD( order_tag_, ORDER_BY_KEY, m_item_, aux::type_wrapper<Key>* );
};
    ...
    : Base
{
    ...
    AUTOBOOST_MPL_AUX_MAP_OVERLOAD( aux::no_tag, ORDER_BY_KEY, m_mask, aux::type_wrapper<Key>* );
    AUTOBOOST_MPL_AUX_MAP_OVERLOAD( aux::yes_tag, IS_MASKED, m_mask, key_order_* );
};
...
#endif // AUTOBOOST_MPL_MAP_AUX_ITEM_HPP_INCLUDED
