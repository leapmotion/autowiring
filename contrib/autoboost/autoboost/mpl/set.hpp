...
#ifndef AUTOBOOST_MPL_SET_HPP_INCLUDED
#define AUTOBOOST_MPL_SET_HPP_INCLUDED
...
#   define AUX778076_SET_HEADER \
    AUTOBOOST_PP_CAT(set, AUTOBOOST_MPL_LIMIT_SET_SIZE).hpp \
    /**/
#else
#   define AUX778076_SET_HEADER \
    AUTOBOOST_PP_CAT(set, AUTOBOOST_MPL_LIMIT_SET_SIZE)##.hpp \
...
#   include AUTOBOOST_PP_STRINGIZE(autoboost/mpl/set/AUX778076_SET_HEADER)
...
#   define AUTOBOOST_MPL_PREPROCESSED_HEADER set.hpp
...
#endif // AUTOBOOST_MPL_SET_HPP_INCLUDED
