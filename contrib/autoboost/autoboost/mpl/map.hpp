...
#ifndef AUTOBOOST_MPL_MAP_HPP_INCLUDED
#define AUTOBOOST_MPL_MAP_HPP_INCLUDED
...
#   include <autoboost/mpl/limits/map.hpp>
...
#   define AUX778076_MAP_HEADER \
    AUTOBOOST_PP_CAT(map, AUTOBOOST_MPL_LIMIT_MAP_SIZE).hpp \
    /**/
#else
#   define AUX778076_MAP_HEADER \
    AUTOBOOST_PP_CAT(map, AUTOBOOST_MPL_LIMIT_MAP_SIZE)##.hpp \
...
#   include AUTOBOOST_PP_STRINGIZE(autoboost/mpl/map/AUX778076_MAP_HEADER)
...
#   define AUTOBOOST_MPL_PREPROCESSED_HEADER map.hpp
...
#   define AUX778076_SEQUENCE_LIMIT AUTOBOOST_MPL_LIMIT_MAP_SIZE
#   include <autoboost/mpl/aux_/sequence_wrapper.hpp>

#endif // AUTOBOOST_MPL_CFG_NO_PREPROCESSED_HEADERS
#endif // AUTOBOOST_MPL_MAP_HPP_INCLUDED
