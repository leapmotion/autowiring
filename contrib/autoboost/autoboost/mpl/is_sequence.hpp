...
#ifndef AUTOBOOST_MPL_IS_SEQUENCE_HPP_INCLUDED
#define AUTOBOOST_MPL_IS_SEQUENCE_HPP_INCLUDED
...
struct is_sequence
    : if_<
        ...
        >::type
{
    AUTOBOOST_MPL_AUX_LAMBDA_SUPPORT(1, is_sequence, (T))
};

#elif defined(AUTOBOOST_MPL_CFG_NO_HAS_XXX)
...
AUTOBOOST_MPL_AUX_NA_SPEC_NO_ETI(1, is_sequence)

}}

#endif // AUTOBOOST_MPL_IS_SEQUENCE_HPP_INCLUDED
