...
#ifndef AUTOBOOST_CONTEXT_EXECUTION_CONTEXT_H
#define AUTOBOOST_CONTEXT_EXECUTION_CONTEXT_H
...
#if defined(AUTOBOOST_NO_CXX17_STD_APPLY)
#include <autoboost/context/detail/apply.hpp>
#endif
#include <autoboost/context/detail/disable_overload.hpp>
#include <autoboost/context/detail/fcontext.hpp>
#include <autoboost/context/fixedsize_stack.hpp>
#include <autoboost/context/flags.hpp>
#include <autoboost/context/preallocated.hpp>
#include <autoboost/context/segmented_stack.hpp>
...
struct AUTOBOOST_CONTEXT_DECL activation_record {
    typedef autoboost::intrusive_ptr< activation_record >    ptr_t;
    ...
    activation_record( fcontext_t fctx_, stack_context sctx_) noexcept :
        fctx{ fctx_ },
        sctx( sctx_ ), // sctx{ sctx_ } - clang-3.6: no viable conversion from 'autoboost::context::stack_context' to 'std::size_t'
        main_ctx{ false } {
    }
...
struct AUTOBOOST_CONTEXT_DECL activation_record_initializer {
...
#endif
        AUTOBOOST_ASSERT_MSG( ! main_ctx, "main-context does not execute activation-record::run()");
    }
};

}

class AUTOBOOST_CONTEXT_DECL execution_context {
private:
    // tampoline function
    ...
    typedef autoboost::intrusive_ptr< detail::activation_record >    ptr_t;
...
#if defined(AUTOBOOST_NO_CXX11_CONSTEXPR) || defined(AUTOBOOST_NO_CXX11_STD_ALIGN)
...
#endif // AUTOBOOST_CONTEXT_EXECUTION_CONTEXT_H
