...
#if ! defined(AUTOBOOST_CONTEXT_NO_EXECUTION_CONTEXT)
...
# include <autoboost/context/fcontext.hpp>
...
public:
    ...
    void run() noexcept {
        ...
        AUTOBOOST_ASSERT( 0 == (flags & flag_main_ctx) );
    }
};
...
#if defined(AUTOBOOST_NO_CXX14_CONSTEXPR) || defined(AUTOBOOST_NO_CXX11_STD_ALIGN)
