...
# endif
    ...
    void * resume( void * vp, bool fpu) noexcept {
        ...
        if ( nullptr == from->fiber) {
            ...
            AUTOBOOST_ASSERT( ERROR_ALREADY_FIBER == err);
            from->fiber = ::GetCurrentFiber();
            AUTOBOOST_ASSERT( nullptr != from->fiber);
            AUTOBOOST_ASSERT( reinterpret_cast< LPVOID >( 0x1E00) != from->fiber);
        }
#endif
...
private:
    ...
    static detail::activation_record * create_context(
        ...
        AUTOBOOST_ASSERT( nullptr != cr->fiber);
        return cr;
    }
