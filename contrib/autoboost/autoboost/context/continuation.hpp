...
#ifndef AUTOBOOST_CONTEXT_CONTINUATION_H
#define AUTOBOOST_CONTEXT_CONTINUATION_H
...
#endif
#if defined(AUTOBOOST_NO_CXX14_STD_EXCHANGE)
#include <autoboost/context/detail/exchange.hpp>
#endif
...
#include <autoboost/context/detail/exception.hpp>
#include <autoboost/context/detail/fcontext.hpp>
#include <autoboost/context/detail/tuple.hpp>
...
void context_entry( transfer_t t_) noexcept {
    ...
    AUTOBOOST_ASSERT( nullptr != t_.fctx);
    AUTOBOOST_ASSERT( nullptr != rec);
    ...
    AUTOBOOST_ASSERT( nullptr != t.fctx);
    // destroy context-stack of `this`context on next context
    ontop_fcontext( t.fctx, rec, context_exit< Rec >);
    AUTOBOOST_ASSERT_MSG( false, "context already terminated");
}
...
public:
    ...
    typename detail::result_type< Arg ... >::type get_data() {
        AUTOBOOST_ASSERT( nullptr != t_.data);
...
#endif // AUTOBOOST_CONTEXT_CONTINUATION_H
