...
{
    static bool is_unbounded() AUTOBOOST_NOEXCEPT;

    static std::size_t page_size() AUTOBOOST_NOEXCEPT;

    static std::size_t default_size() AUTOBOOST_NOEXCEPT;

    static std::size_t minimum_size() AUTOBOOST_NOEXCEPT;

    static std::size_t maximum_size() AUTOBOOST_NOEXCEPT;
};
