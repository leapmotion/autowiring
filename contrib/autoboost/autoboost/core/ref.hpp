#ifndef AUTOBOOST_CORE_REF_HPP
#define AUTOBOOST_CORE_REF_HPP
...
#if defined( AUTOBOOST_MSVC ) && AUTOBOOST_WORKAROUND( AUTOBOOST_MSVC, == 1600 )
...
public:
    ...
    */
    AUTOBOOST_FORCEINLINE explicit reference_wrapper(T& t): t_(autoboost::addressof(t)) {}

#if defined( AUTOBOOST_MSVC ) && AUTOBOOST_WORKAROUND( AUTOBOOST_MSVC, == 1600 )

    AUTOBOOST_FORCEINLINE explicit reference_wrapper( T & t, ref_workaround_tag ): t_( autoboost::addressof( t ) ) {}
    ...
    */
    AUTOBOOST_DELETED_FUNCTION(reference_wrapper(T&& t))
public:
#endif
    ...
    /**
     ...
     @remark Does not throw.
    */
    AUTOBOOST_FORCEINLINE operator T& () const { return *t_; }

    /**
     @return The stored reference.
     @remark Does not throw.
    */
    AUTOBOOST_FORCEINLINE T& get() const { return *t_; }
    ...
    /**
     ...
     @remark Does not throw.
    */
    AUTOBOOST_FORCEINLINE T* get_pointer() const { return t_; }
...
/**
 @cond
*/
#if defined( __BORLANDC__ ) && AUTOBOOST_WORKAROUND( __BORLANDC__, AUTOBOOST_TESTED_AT(0x581) )
#  define AUTOBOOST_REF_CONST
#else
#  define AUTOBOOST_REF_CONST const
#endif
/**
 @endcond
*/
...
/**
 ...
 @remark Does not throw.
*/
template<class T> AUTOBOOST_FORCEINLINE reference_wrapper<T> AUTOBOOST_REF_CONST ref( T & t )
{
#if defined( AUTOBOOST_MSVC ) && AUTOBOOST_WORKAROUND( AUTOBOOST_MSVC, == 1600 )
...
/**
 ...
 @remark Does not throw.
*/
template<class T> AUTOBOOST_FORCEINLINE reference_wrapper<T const> AUTOBOOST_REF_CONST cref( T const & t )
{
    return reference_wrapper<T const>(t);
}

#undef AUTOBOOST_REF_CONST
...
#  define AUTOBOOST_REF_DELETE
#else
#  define AUTOBOOST_REF_DELETE = delete
#endif
/**
 @endcond
*/
...
/**
 @remark Construction from a temporary object is disabled.
*/
template<class T> void ref(T const&&) AUTOBOOST_REF_DELETE;

/**
 @remark Construction from a temporary object is disabled.
*/
template<class T> void cref(T const&&) AUTOBOOST_REF_DELETE;

#undef AUTOBOOST_REF_DELETE
...
#endif // !defined(AUTOBOOST_NO_CV_SPECIALIZATIONS)
...
/**
 ...
 @remark Does not throw.
*/
template<class T> AUTOBOOST_FORCEINLINE typename unwrap_reference<T>::type& unwrap_ref( T & t )
{
    return t;
}
...
/**
 @cond
*/
template<class T> AUTOBOOST_FORCEINLINE T* get_pointer( reference_wrapper<T> const & r )
{
...
#endif // #ifndef AUTOBOOST_CORE_REF_HPP
