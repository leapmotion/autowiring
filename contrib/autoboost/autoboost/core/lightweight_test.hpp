#ifndef AUTOBOOST_CORE_LIGHTWEIGHT_TEST_HPP
#define AUTOBOOST_CORE_LIGHTWEIGHT_TEST_HPP
...
#ifndef AUTOBOOST_LIGHTWEIGHT_TEST_OSTREAM
# define AUTOBOOST_LIGHTWEIGHT_TEST_OSTREAM std::cerr
#endif
                      ...
                      InputIterator2 second_begin, InputIterator2 second_end)
{
    ...
    if (error_count == 0)
    {
        autoboost::detail::report_errors_remind();
    }
    else
    {
        output << std::endl;
        ++autoboost::detail::test_errors();
    }
}
...
{
    autoboost::detail::report_errors_remind().called_report_errors_function = true;

    int errors = autoboost::detail::test_errors();
...
#define AUTOBOOST_TEST(expr) ((expr)? (void)0: ::autoboost::detail::test_failed_impl(#expr, __FILE__, __LINE__, AUTOBOOST_CURRENT_FUNCTION))
#define AUTOBOOST_TEST_NOT(expr) AUTOBOOST_TEST(!(expr))

#define AUTOBOOST_ERROR(msg) ( ::autoboost::detail::error_impl(msg, __FILE__, __LINE__, AUTOBOOST_CURRENT_FUNCTION) )

#define AUTOBOOST_TEST_EQ(expr1,expr2) ( ::autoboost::detail::test_eq_impl(#expr1, #expr2, __FILE__, __LINE__, AUTOBOOST_CURRENT_FUNCTION, expr1, expr2) )
#define AUTOBOOST_TEST_NE(expr1,expr2) ( ::autoboost::detail::test_ne_impl(#expr1, #expr2, __FILE__, __LINE__, AUTOBOOST_CURRENT_FUNCTION, expr1, expr2) )

#define AUTOBOOST_TEST_CSTR_EQ(expr1,expr2) ( ::autoboost::detail::test_cstr_eq_impl(#expr1, #expr2, __FILE__, __LINE__, AUTOBOOST_CURRENT_FUNCTION, expr1, expr2) )
#define AUTOBOOST_TEST_CSTR_NE(expr1,expr2) ( ::autoboost::detail::test_cstr_ne_impl(#expr1, #expr2, __FILE__, __LINE__, AUTOBOOST_CURRENT_FUNCTION, expr1, expr2) )

#define AUTOBOOST_TEST_ALL_EQ(begin1, end1, begin2, end2) ( ::autoboost::detail::test_all_eq_impl(AUTOBOOST_LIGHTWEIGHT_TEST_OSTREAM, __FILE__, __LINE__, AUTOBOOST_CURRENT_FUNCTION, begin1, end1, begin2, end2) )
#define AUTOBOOST_TEST_ALL_WITH(begin1, end1, begin2, end2, predicate) ( ::autoboost::detail::test_all_with_impl(AUTOBOOST_LIGHTWEIGHT_TEST_OSTREAM, __FILE__, __LINE__, AUTOBOOST_CURRENT_FUNCTION, begin1, end1, begin2, end2, predicate) )

#ifndef AUTOBOOST_NO_EXCEPTIONS
   #define AUTOBOOST_TEST_THROWS( EXPR, EXCEP )                    \
      try {                                                    \
         EXPR;                                                 \
         ::autoboost::detail::throw_failed_impl                    \
...
#endif // #ifndef AUTOBOOST_CORE_LIGHTWEIGHT_TEST_HPP
