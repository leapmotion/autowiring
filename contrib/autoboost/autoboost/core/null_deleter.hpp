...
#ifndef AUTOBOOST_CORE_NULL_DELETER_HPP
#define AUTOBOOST_CORE_NULL_DELETER_HPP
...
struct null_deleter
{
     ...
     */
    template< typename T >
    void operator() (T*) const AUTOBOOST_NOEXCEPT {}
};

} // namespace autoboost

#endif // AUTOBOOST_CORE_NULL_DELETER_HPP
